...
assert_exists 1 '/oval_results/results/system/definitions/definition[@definition_id="oval:x:def:5"]/criteria/criterion[@result="true"]'
assert_exists 1 '/oval_results/results/system/definitions/definition[@definition_id="oval:x:def:6"]'
assert_exists 1 '/oval_results/results/system/definitions/definition[@definition_id="oval:x:def:6"][@result="false"]'
...
assert_exists 1 '/oval_results/results/system/definitions/definition[@definition_id="oval:x:def:6"]/criteria/criterion[@result="false"]'
...
assert_exists 1 '/oval_results/results/system/tests/test[@test_id="oval:x:tst:5"][@result="true"]'
...
assert_exists 1 '/oval_results/results/system/tests/test[@test_id="oval:x:tst:5"]/tested_item[@result="true"]'
...
assert_exists 1 '/oval_results/results/system/tests/test[@test_id="oval:x:tst:6"]/tested_item[@result="false"]'
