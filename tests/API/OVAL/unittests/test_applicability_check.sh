...
[ $($xpath $result 'count(/oval_results/results/system/definitions/definition[@definition_id="oval:gov.irs.rhel5:def:1"]/criteria/extend_definition[@applicability_check="true"])') == "1" ] && rm $result
