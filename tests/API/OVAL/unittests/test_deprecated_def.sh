...
[ $($xpath $result 'count(/oval_results/results/system/definitions/definition[@definition_id="oval:org.mitre.oval.test:def:282"][@result="not evaluated"])') == "1" ] && rm -rf $result
