...
function xccdf_eval_2_multiset(){
	...
	assert_exists 2 '/oval_results/results/system/tests/test[@version="1"]'
	assert_exists 2 '/oval_results/results/system/tests/test[@check="at least one"]'
	assert_exists 1 '/oval_results/results/system/tests/test[@result="true"]'
	assert_exists 1 '/oval_results/results/system/tests/test[not(@variable_instance)]'
	assert_exists 1 '/oval_results/results/system/tests/test[not(@variable_instance) and @result="true"]'
	assert_exists 1 '/oval_results/results/system/tests/test[@result="false"]'
	assert_exists 1 '/oval_results/results/system/tests/test[@variable_instance="2"]'
	assert_exists 1 '/oval_results/results/system/tests/test[@variable_instance="2" and @result="false"]'
	...
	assert_exists 2 '/oval_results/results/system/definitions/*'
