...
$OSCAP xccdf generate fix --fix-type blueprint --profile 'common' "$input_xml" | grep -v "This file was generated by OpenSCAP" | grep -v "This Blueprint is generated from an OpenSCAP profile without preliminary evaluation" > "$result"
