...
void load_oval_definitions(struct oval_object_model *, struct import_source *, oval_xml_error_handler, void *);
struct oval_definition *get_oval_definition(struct oval_object_model *, char *def_urn);
...
struct oval_variable *get_oval_variable(struct oval_object_model *, char *var_urn);
...
struct oval_iterator_object_content *oval_object_object_content(struct oval_object *);
...
struct oval_result_item *oval_iterator_result_item_next(struct oval_iterator_result_item *);
...
struct oval_result_test *oval_iterator_result_test_next(struct oval_iterator_result_test *);
...
int oval_iterator_result_criteria_node_has_more(struct oval_iterator_result_criteria_node *);
struct oval_result_criteria_node *oval_iterator_result_criteria_node_next(struct oval_iterator_result_criteria_node *);

oval_criteria_node_type_enum oval_result_criteria_node_type(struct oval_result_criteria_node *);
...
int oval_result_directives_definition_not_evaluated(struct oval_result_directives *);
int oval_result_directives_definition_not_applicable(struct oval_result_directives *);
...
struct oval_iterator_variable_binding *oval_syschar_variable_bindings(struct oval_syschar *);
