...
will warn you:
 ...
 $ oscap xccdf eval --profile xccdf_org.ssgproject.content_profile_common ./ssg-rhel7-ds.xml
...
`oscap` tool.
 ...
 $ oscap xccdf eval --fetch-remote-resources --profile xccdf_org.ssgproject.content_profile_common ./ssg-rhel7-ds.xml
