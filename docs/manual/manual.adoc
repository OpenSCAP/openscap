...
OVAL directives file can be used to control, whether results should be "thin" or "full".
...
Another place, where these identifiers are located are machine-readable Result Datastream files.
