...
<!--PATTERN oval_none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M29">
...
<!--PATTERN oval-sc_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*|oval-sc:system_data/*/*/*" priority="1001" mode="M30">
...
<axsl:choose><axsl:when test="not(@mask) or @mask='false' or .=''"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a value for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity should only be supplied if the mask attribute is 'false'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M30"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*[not(@xsi:nil=true()) and @datatype='int']|oval-sc:system_data/*/*/*[not(@xsi:nil=true()) and @datatype='int']" priority="1000" mode="M30">
...
<!--PATTERN ind-sc_filehash_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item" priority="1000" mode="M31">
...
<!--PATTERN ind-sc_environmentvariable_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:environmentvariable_item" priority="1000" mode="M32">
...
<!--PATTERN ind-sc_ldap_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap_item" priority="1000" mode="M33">
...
<!--PATTERN ind-sc_ldapitemrelative_dn-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:relative_dn" priority="1000" mode="M34">
...
<!--PATTERN ind-sc_ldap57itemrelative_dn-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap57_item/ind-sc:relative_dn" priority="1000" mode="M35">
...
<!--PATTERN ind-sc_sql_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item" priority="1000" mode="M36">
...
<!--PATTERN ind-sc_txtitemline-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:line" priority="1000" mode="M37">
...
<!--PATTERN ind-sc_ldaptype_email_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap_item/ind-sc:ldaptype|oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap57_item/ind-sc:ldaptype" priority="1000" mode="M39">
...
<!--PATTERN apache-sc_httpd_item_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item" priority="1000" mode="M40">
...
<!--PATTERN catos-sc_versionitemcatos_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_major_release" priority="1000" mode="M41">
...
<!--PATTERN catos-sc_versionitemcatos_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_individual_release" priority="1000" mode="M42">
...
<!--PATTERN catos-sc_versionitemcatos_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_version_id" priority="1000" mode="M43">
...
<!--PATTERN esx-sc_patchitempatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:patch_number" priority="1000" mode="M44">
...
<!--PATTERN ios-sc_versionitemmajor_release-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:major_release" priority="1000" mode="M45">
...
<!--PATTERN ios-sc_versionitemtrain_number-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:train_number" priority="1000" mode="M46">
...
<!--PATTERN unix-sc_processitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item" priority="1000" mode="M47">
...
<!--PATTERN win-sc_activedirectory_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item" priority="1000" mode="M48">
...
<!--PATTERN win-sc_aditemrelative_dn-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:relative_dn" priority="1000" mode="M49">
...
<!--PATTERN win-sc_activedirectory57_item_relative_dn-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item/win-sc:relative_dn" priority="1000" mode="M50">
...
<!--PATTERN win-sc_fileaudititemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M51">
...
<!--PATTERN win-sc_feritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M52">
...
<!--PATTERN win-sc_regitemkey-->
	...
	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:key" priority="1000" mode="M53">
...
<!--PATTERN win-sc_rapitemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M54">
...
<!--PATTERN win-sc_rapitemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M55">
...
<!--PATTERN win-sc_reritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M56">
...
<!--PATTERN win-sc_reritemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M57">
...
<!--PATTERN win-sc_wmi_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi_item" priority="1000" mode="M58">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M58"/></axsl:template><axsl:template match="text()" priority="-1" mode="M58"/><axsl:template match="@*|node()" priority="-2" mode="M58"><axsl:apply-templates select="@*|*" mode="M58"/></axsl:template></axsl:stylesheet>
