...
<!--PATTERN oval_schema_version_one_core_element-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator" priority="1000" mode="M36">
...
<!--PATTERN oval_schema_version_empty_platform-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M37">
...
<!--PATTERN oval_schema_version_core_matches_platforms-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M38"><axsl:variable name="core_version_portion" select="parent::oval-def:generator/oval:schema_version[not(@platform)]"/>
...
<!--PATTERN oval_none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M39">
...
<!--PATTERN oval-def_empty_def_doc-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions" priority="1000" mode="M40">
...
<!--PATTERN oval_def_notes_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:notes" priority="1000" mode="M41">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> parent ID: <axsl:text/><axsl:value-of select="../@id"/><axsl:text/>
...
<!--PATTERN oval-def_required_criteria-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:definitions/oval-def:definition[(@deprecated='false' or @deprecated='0') or not(@deprecated)]" priority="1000" mode="M42">
...
<!--PATTERN oval-def_test_type-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/*[@check_existence='none_exist']" priority="1000" mode="M43">
...
<!--PATTERN oval-def_setobjref-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:object_reference" priority="1002" mode="M44">
...
<axsl:choose><axsl:when test="name(./../..) = name(ancestor::oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:object_reference" priority="1001" mode="M44">
...
<axsl:choose><axsl:when test="name(./../../..) = name(ancestor::oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:set/oval-def:object_reference" priority="1000" mode="M44">
...
<!--PATTERN oval-def_literal_component-->
	...
	<!--RULE -->
<axsl:template match="oval-def:literal_component" priority="1000" mode="M45">
...
<!--PATTERN oval-def_arithmeticfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:literal_component" priority="1001" mode="M46">
...
<axsl:choose><axsl:when test="@datatype='float' or @datatype='int'"/><axsl:otherwise>A literal_component used by an arithmetic function must have a datatype of float or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M46"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:variable_component" priority="1000" mode="M46"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_beginfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:literal_component" priority="1001" mode="M47">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the begin function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M47"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:variable_component" priority="1000" mode="M47"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_concatfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:literal_component" priority="1001" mode="M48">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the concat function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M48"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:variable_component" priority="1000" mode="M48"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_endfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:literal_component" priority="1001" mode="M49">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the end function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M49"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:variable_component" priority="1000" mode="M49"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_escaperegexfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:literal_component" priority="1001" mode="M50">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the escape_regex function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M50"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:variable_component" priority="1000" mode="M50"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_splitfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:literal_component" priority="1001" mode="M51">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the split function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M51"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:variable_component" priority="1000" mode="M51"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_substringfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:literal_component" priority="1001" mode="M52">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the substring function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M52"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:variable_component" priority="1000" mode="M52"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_timedifferencefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:literal_component" priority="1001" mode="M53">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string' or @datatype='int'"/><axsl:otherwise>A literal_component used by the time_difference function must have a datatype of string or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M53"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:variable_component" priority="1000" mode="M53"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_regexcapturefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:literal_component" priority="1001" mode="M54">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the regex_capture function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M54"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:variable_component" priority="1000" mode="M54"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_globtoregexfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:glob_to_regex/oval-def:literal_component" priority="1001" mode="M55">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the glob_to_regex function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M55"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:glob_to_regex/oval-def:variable_component" priority="1000" mode="M55"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_definition_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]|oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1018" mode="M56"><axsl:variable name="var_ref" select="@var_ref"/>
...
<axsl:choose><axsl:when test="( (not(@datatype)) and ('string' = ancestor::oval-def:oval_definitions/oval-def:variables/*[@id=$var_ref]/@datatype) ) or (@datatype = ancestor::oval-def:oval_definitions/oval-def:variables/*[@id=$var_ref]/@datatype)"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]" priority="1017" mode="M56">

		<!--REPORT -->
<axsl:if test="not(@var_check)">
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a var_ref has been supplied for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity so a var_check should also be provided<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M56"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_check]|oval-def:objects/*/*/*[@var_check]" priority="1016" mode="M56">
...
<axsl:choose><axsl:when test="@var_ref"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1015" mode="M56">
...
<axsl:if test="not(@var_check)">
	...
	<!--RULE -->
<axsl:template match="oval-def:states/*/*[@var_check]|oval-def:states/*/*/*[@var_check]" priority="1014" mode="M56">
...
<axsl:choose><axsl:when test="@var_ref"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[not(@datatype)]|oval-def:objects/*/*/*[not(@datatype)]|oval-def:states/*/*[not(@datatype)]|oval-def:states/*/*/*[not(@datatype)]" priority="1013" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='binary']|oval-def:objects/*/*/*[@datatype='binary']|oval-def:states/*/*[@datatype='binary']|oval-def:states/*/*/*[@datatype='binary']" priority="1012" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='boolean']|oval-def:objects/*/*/*[@datatype='boolean']|oval-def:states/*/*[@datatype='boolean']|oval-def:states/*/*/*[@datatype='boolean']" priority="1011" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='evr_string']|oval-def:objects/*/*/*[@datatype='evr_string']|oval-def:states/*/*[@datatype='evr_string']|oval-def:states/*/*/*[@datatype='evr_string']" priority="1010" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='debian_evr_string']|oval-def:objects/*/*/*[@datatype='debian_evr_string']|oval-def:states/*/*[@datatype='debian_evr_string']|oval-def:states/*/*/*[@datatype='debian_evr_string']" priority="1009" mode="M56">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of debian_evr_string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M56"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='fileset_revision']|oval-def:objects/*/*/*[@datatype='fileset_revision']|oval-def:states/*/*[@datatype='fileset_revision']|oval-def:states/*/*/*[@datatype='fileset_revision']" priority="1008" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='float']|oval-def:objects/*/*/*[@datatype='float']|oval-def:states/*/*[@datatype='float']|oval-def:states/*/*/*[@datatype='float']" priority="1007" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ios_version']|oval-def:objects/*/*/*[@datatype='ios_version']|oval-def:states/*/*[@datatype='ios_version']|oval-def:states/*/*/*[@datatype='ios_version']" priority="1006" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='int']|oval-def:objects/*/*/*[@datatype='int']|oval-def:states/*/*[@datatype='int']|oval-def:states/*/*/*[@datatype='int']" priority="1005" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='bitwise and' or @operation='bitwise or'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ipv4_address']|oval-def:objects/*/*/*[@datatype='ipv4_address']|oval-def:states/*/*[@datatype='ipv4_address']|oval-def:states/*/*/*[@datatype='ipv4_address']" priority="1004" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='subset of' or @operation='superset of'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ipv6_address']|oval-def:objects/*/*/*[@datatype='ipv6_address']|oval-def:states/*/*[@datatype='ipv6_address']|oval-def:states/*/*/*[@datatype='ipv6_address']" priority="1003" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='subset of' or @operation='superset of'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='string']|oval-def:objects/*/*/*[@datatype='string']|oval-def:states/*/*[@datatype='string']|oval-def:states/*/*/*[@datatype='string']" priority="1002" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='version']|oval-def:objects/*/*/*[@datatype='version']|oval-def:states/*/*[@datatype='version']|oval-def:states/*/*/*[@datatype='version']" priority="1001" mode="M56">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='record']|oval-def:states/*/*[@datatype='record']" priority="1000" mode="M56">
...
<!--PATTERN oval-def_no_var_ref_with_records-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='record']|oval-def:states/*/*[@datatype='record']" priority="1000" mode="M57">
...
<!--PATTERN oval-def_definition_entity_type_check_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:objects/*/*/*[not(@var_ref) and @datatype='int']|oval-def:states/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:states/*/*/*[not(@var_ref) and @datatype='int']" priority="1000" mode="M58">
...
<!--PATTERN ind-def_famtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:object" priority="1001" mode="M59">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:family_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:state" priority="1000" mode="M59">
...
<!--PATTERN ind-def_filehash_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test" priority="1000" mode="M60">
...
<!--PATTERN ind-def_hashtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:object" priority="1001" mode="M61">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:filehash_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:state" priority="1000" mode="M61">
...
<!--PATTERN ind-def_filehash_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object" priority="1000" mode="M62">
...
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M62"/></axsl:template><axsl:template match="text()" priority="-1" mode="M62"/><axsl:template match="@*|node()" priority="-2" mode="M62"><axsl:apply-templates select="@*|*" mode="M62"/></axsl:template>

<!--PATTERN ind-def_hashobjfilepath-->


	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filepath" priority="1000" mode="M63">
...
<!--PATTERN ind-def_hashobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M64">
...
<!--PATTERN ind-def_hashobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M65">
...
<!--PATTERN ind-def_hashobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filename" priority="1000" mode="M66">
...
<!--PATTERN ind-def_filehash_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state" priority="1000" mode="M67">
...
<!--PATTERN ind-def_filehash58_test-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_test/ind-def:object" priority="1001" mode="M68">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:filehash58_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_test/ind-def:state" priority="1000" mode="M68">
...
<!--PATTERN ind-def_hash58objfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filepath" priority="1000" mode="M70">
...
<!--PATTERN ind-def_hash58objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M71">
...
<!--PATTERN ind-def_hash58objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M72">
...
<!--PATTERN ind-def_hash58objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filename" priority="1000" mode="M73">
...
<!--PATTERN ind-def_environmentvariable_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test" priority="1000" mode="M74">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M74"/></axsl:template><axsl:template match="text()" priority="-1" mode="M74"/><axsl:template match="@*|node()" priority="-2" mode="M74"><axsl:apply-templates select="@*|*" mode="M74"/></axsl:template>

<!--PATTERN ind-def_envtst-->


	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:object" priority="1001" mode="M75">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:environmentvariable_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:state" priority="1000" mode="M75">
...
<!--PATTERN ind-def_environmentvariable_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_object" priority="1000" mode="M76">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M76"/></axsl:template><axsl:template match="text()" priority="-1" mode="M76"/><axsl:template match="@*|node()" priority="-2" mode="M76"><axsl:apply-templates select="@*|*" mode="M76"/></axsl:template>

<!--PATTERN ind-def_environmentvariable_state_dep-->


	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_state" priority="1000" mode="M77">
...
<!--PATTERN ind-def_env58tst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_test/ind-def:object" priority="1001" mode="M78">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:environmentvariable58_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_test/ind-def:state" priority="1000" mode="M78">
...
<!--PATTERN ind-def_environmentvariable58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_object//oval-def:filter" priority="1000" mode="M79"><axsl:variable name="parent_object" select="ancestor::ind-def:environmentvariable58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_ldaptst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap_test/ind-def:object" priority="1001" mode="M80">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:ldap_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap_test/ind-def:state" priority="1000" mode="M80">
...
<!--PATTERN ind-def_ldap57_test-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_test/ind-def:object" priority="1001" mode="M81">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:ldap57_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_test/ind-def:state" priority="1000" mode="M81">
...
<!--PATTERN ind-def_ldap57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_object//oval-def:filter" priority="1000" mode="M82"><axsl:variable name="parent_object" select="ancestor::ind-def:ldap57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_ldap57stevalue-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_state/ind-def:value" priority="1000" mode="M83">
...
<!--PATTERN ind-def_sql_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test" priority="1000" mode="M84">
...
<!--PATTERN ind-def_sqltst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:object" priority="1001" mode="M85">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:sql_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:state" priority="1000" mode="M85">
...
<!--PATTERN ind-def_sql_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object" priority="1000" mode="M86">
...
<!--PATTERN ind-def_sqlobjdengine-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:engine" priority="1000" mode="M87">
...
<!--PATTERN ind-def_sqlobjversion-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:version" priority="1000" mode="M88">
...
<!--PATTERN ind-def_sqlobjconnection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:connection_string" priority="1000" mode="M89">
...
<!--PATTERN ind-def_sqlobjsql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:sql" priority="1000" mode="M90">
...
<!--PATTERN ind-def_sql_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state" priority="1000" mode="M91">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M91"/></axsl:template><axsl:template match="text()" priority="-1" mode="M91"/><axsl:template match="@*|node()" priority="-2" mode="M91"><axsl:apply-templates select="@*|*" mode="M91"/></axsl:template>

<!--PATTERN ind-def_sql57_test-->


	<!--RULE -->
<axsl:template match="ind-def:sql57_test/ind-def:object" priority="1001" mode="M92">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:sql57_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_test/ind-def:state" priority="1000" mode="M92">
...
<!--PATTERN ind-def_sql57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object//oval-def:filter" priority="1000" mode="M93"><axsl:variable name="parent_object" select="ancestor::ind-def:sql57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_sql57_object_dengine-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:engine" priority="1000" mode="M94">
...
<!--PATTERN ind-def_sql57_object_version-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:version" priority="1000" mode="M95">
...
<!--PATTERN ind-def_sql57_object_connection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:connection_string" priority="1000" mode="M96">
...
<!--PATTERN ind-def_sql57_object_sql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:sql" priority="1000" mode="M97">
...
<!--PATTERN ind-def_sql57steresult-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_state/ind-def:result" priority="1000" mode="M98">
...
<!--PATTERN ind-def_txt54tst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_test/ind-def:object" priority="1001" mode="M99">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:textfilecontent54_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_test/ind-def:state" priority="1000" mode="M99">
...
<!--PATTERN ind-def_textfilecontent54_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object//oval-def:filter" priority="1000" mode="M100"><axsl:variable name="parent_object" select="ancestor::ind-def:textfilecontent54_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_txt54objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M102">
...
<!--PATTERN ind-def_txt54objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M103">
...
<!--PATTERN ind-def_txt54objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filename" priority="1000" mode="M104">
...
<!--PATTERN ind-def_txt54objpattern-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:pattern" priority="1000" mode="M105">
...
<!--PATTERN ind-def_txttst_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test" priority="1000" mode="M106">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M106"/></axsl:template><axsl:template match="text()" priority="-1" mode="M106"/><axsl:template match="@*|node()" priority="-2" mode="M106"><axsl:apply-templates select="@*|*" mode="M106"/></axsl:template>

<!--PATTERN ind-def_txttst-->


	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:object" priority="1001" mode="M107">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:textfilecontent_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a textfilecontent_test must reference a textfilecontent_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M107"/></axsl:template>

	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:state" priority="1000" mode="M107">
...
<!--PATTERN ind-def_txtobj_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object" priority="1000" mode="M108">
...
<!--PATTERN ind-def_txtobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:filename" priority="1000" mode="M109">
...
<!--PATTERN ind-def_txtobjline-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:line" priority="1000" mode="M110">
...
<!--PATTERN ind-def_txtste_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state" priority="1000" mode="M111">
...
<!--PATTERN ind-def_vattst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:object" priority="1001" mode="M112">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:variable_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:state" priority="1000" mode="M112">
...
<!--PATTERN ind-def_varobjvar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M114">
...
<!--PATTERN ind-def_varobjvar_ref_exists-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M115"><axsl:variable name="varId" select="."/>
...
<!--PATTERN ind-def_varstevar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M116">
...
<!--PATTERN ind-def_varstevar_ref_exists-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M117"><axsl:variable name="varId" select="."/>
...
<!--PATTERN ind-def_xmltst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:object" priority="1001" mode="M118">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:xmlfilecontent_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:state" priority="1000" mode="M118">
...
<!--PATTERN ind-def_xmlfilecontent_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object//oval-def:filter" priority="1000" mode="M119"><axsl:variable name="parent_object" select="ancestor::ind-def:xmlfilecontent_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_xmlobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filepath" priority="1000" mode="M120">
...
<!--PATTERN ind-def_xmlobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M121">
...
<!--PATTERN ind-def_xmlobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M122">
...
<!--PATTERN ind-def_xmlobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filename" priority="1000" mode="M123">
...
<!--PATTERN ind-def_xmlobjxpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:xpath" priority="1000" mode="M124">
...
<!--PATTERN ind-def_ldaptype_timestamp_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/ind-def:ldap_state/ind-def:ldaptype|oval-def:oval_definitions/oval-def:states/ind-def:ldap57_state/ind-def:ldaptype" priority="1000" mode="M125">
...
<!--PATTERN ind-def_ldaptype_email_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/ind-def:ldap_state/ind-def:ldaptype|oval-def:oval_definitions/oval-def:states/ind-def:ldap57_state/ind-def:ldaptype" priority="1000" mode="M126">
...
<!--PATTERN aix-def_interimfixtst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:interim_fix_test/aix-def:object" priority="1001" mode="M127">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:interim_fix_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:interim_fix_test/aix-def:state" priority="1000" mode="M127">
...
<!--PATTERN aix-def_interim_fix_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="aix-def:interim_fix_object//oval-def:filter" priority="1000" mode="M128"><axsl:variable name="parent_object" select="ancestor::aix-def:interim_fix_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN aix-def_filesettst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:object" priority="1001" mode="M129">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:fileset_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:state" priority="1000" mode="M129">
...
<!--PATTERN aix-def_fileset_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_object//oval-def:filter" priority="1000" mode="M130"><axsl:variable name="parent_object" select="ancestor::aix-def:fileset_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN aix-def_fixtst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_test/aix-def:object" priority="1001" mode="M131">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:fix_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_test/aix-def:state" priority="1000" mode="M131">
...
<!--PATTERN aix-def_fix_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_object//oval-def:filter" priority="1000" mode="M132"><axsl:variable name="parent_object" select="ancestor::aix-def:fix_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN aix-def_notst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:no_test/aix-def:object" priority="1001" mode="M133">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:no_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:no_test/aix-def:state" priority="1000" mode="M133">
...
<!--PATTERN aix-def_osleveltst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:object" priority="1001" mode="M134">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:oslevel_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:state" priority="1000" mode="M134">
...
<!--PATTERN apache-def_httpd_test_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test" priority="1000" mode="M135">
...
<!--PATTERN apache-def_httpdtst-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test/apache-def:object" priority="1001" mode="M136">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/apache-def:httpd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test/apache-def:state" priority="1000" mode="M136">
...
<!--PATTERN apache-def_httpd_object_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_object" priority="1000" mode="M137">
...
<!--PATTERN apache-def_httpd_state_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_state" priority="1000" mode="M138">
...
<!--PATTERN catos-def_linetst-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:object" priority="1001" mode="M139">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:line_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:state" priority="1000" mode="M139">
...
<!--PATTERN catos-def_moduletst-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_test/catos-def:object" priority="1001" mode="M141">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:module_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="catos-def:module_test/catos-def:state" priority="1000" mode="M141">
...
<!--PATTERN catos-def_version55_test-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version55_test/catos-def:object" priority="1001" mode="M143">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:version55_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="catos-def:version55_test/catos-def:state" priority="1000" mode="M143">
...
<!--PATTERN catos-def_version_test_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_test" priority="1000" mode="M144">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M144"/></axsl:template><axsl:template match="text()" priority="-1" mode="M144"/><axsl:template match="@*|node()" priority="-2" mode="M144"><axsl:apply-templates select="@*|*" mode="M144"/></axsl:template>

<!--PATTERN catos-def_version_test-->


	<!--RULE -->
<axsl:template match="catos-def:version_test/catos-def:object" priority="1001" mode="M145">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:version_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="catos-def:version_test/catos-def:state" priority="1000" mode="M145">
...
<!--PATTERN catos-def_version_object_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_object" priority="1000" mode="M146">
...
<!--PATTERN catos-def_version_state_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state" priority="1000" mode="M147">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M147"/></axsl:template><axsl:template match="text()" priority="-1" mode="M147"/><axsl:template match="@*|node()" priority="-2" mode="M147"><axsl:apply-templates select="@*|*" mode="M147"/></axsl:template>

<!--PATTERN esx-def_patch56tst-->


	<!--RULE -->
<axsl:template match="esx-def:patch56_test/esx-def:object" priority="1001" mode="M148">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:patch56_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="esx-def:patch56_test/esx-def:state" priority="1000" mode="M148">
...
<!--PATTERN esx-def_patch56_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch56_object//oval-def:filter" priority="1000" mode="M149"><axsl:variable name="parent_object" select="ancestor::esx-def:patch56_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN esx-def_patchtst_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_test" priority="1000" mode="M150">
...
<!--PATTERN esx-def_patchtst-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_test/esx-def:object" priority="1001" mode="M151">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:patch_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_test/esx-def:state" priority="1000" mode="M151">
...
<!--PATTERN esx-def_patchobj_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_object" priority="1000" mode="M152">
...
<!--PATTERN esx-def_patchste_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_state" priority="1000" mode="M153">
...
<!--PATTERN esx-def_versiontst-->
	...
	<!--RULE -->
<axsl:template match="esx-def:version_test/esx-def:object" priority="1001" mode="M154">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:version_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="esx-def:version_test/esx-def:state" priority="1000" mode="M154">
...
<!--PATTERN esx-def_visdkmanagedobjecttst-->
	...
	<!--RULE -->
<axsl:template match="esx-def:visdkmanagedobject_test/esx-def:object" priority="1001" mode="M155">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:visdkmanagedobject_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="esx-def:visdkmanagedobject_test/esx-def:state" priority="1000" mode="M155">
...
<!--PATTERN esx-def_visdkmanagedobject_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="esx-def:visdkmanagedobject_object//oval-def:filter" priority="1000" mode="M156"><axsl:variable name="parent_object" select="ancestor::esx-def:visdkmanagedobject_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN freebsd-def_portinfotst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:object" priority="1001" mode="M157">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/freebsd-def:portinfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:state" priority="1000" mode="M157">
...
<!--PATTERN freebsd-def_portinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_object//oval-def:filter" priority="1000" mode="M158"><axsl:variable name="parent_object" select="ancestor::freebsd-def:portinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_getconf_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_test/hpux-def:object" priority="1001" mode="M159">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:getconf_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_test/hpux-def:state" priority="1000" mode="M159">
...
<!--PATTERN hpux-def_getconf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_object//oval-def:filter" priority="1000" mode="M160"><axsl:variable name="parent_object" select="ancestor::hpux-def:getconf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_ndd_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:ndd_test/hpux-def:object" priority="1001" mode="M161">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:ndd_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an ndd_test must reference an ndd_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M161"/></axsl:template>

	<!--RULE -->
<axsl:template match="hpux-def:ndd_test/hpux-def:state" priority="1000" mode="M161">
...
<!--PATTERN hpux-def_ndd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:ndd_object//oval-def:filter" priority="1000" mode="M162"><axsl:variable name="parent_object" select="ancestor::hpux-def:ndd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_patch53_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_test/hpux-def:object" priority="1001" mode="M163">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:patch53_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_test/hpux-def:state" priority="1000" mode="M163">
...
<!--PATTERN hpux-def_patch_test_dep-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_test" priority="1000" mode="M165">
...
<!--PATTERN hpux-def_patch_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_test/hpux-def:object" priority="1001" mode="M166">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:patch_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_test/hpux-def:state" priority="1000" mode="M166">
...
<!--PATTERN hpux-def_patch_object_dep-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_object" priority="1000" mode="M167">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M167"/></axsl:template><axsl:template match="text()" priority="-1" mode="M167"/><axsl:template match="@*|node()" priority="-2" mode="M167"><axsl:apply-templates select="@*|*" mode="M167"/></axsl:template>

<!--PATTERN hpux-def_patch_state_dep-->


	<!--RULE -->
<axsl:template match="hpux-def:patch_state" priority="1000" mode="M168">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M168"/></axsl:template><axsl:template match="text()" priority="-1" mode="M168"/><axsl:template match="@*|node()" priority="-2" mode="M168"><axsl:apply-templates select="@*|*" mode="M168"/></axsl:template>

<!--PATTERN hpux-def_swlist_test-->


	<!--RULE -->
<axsl:template match="hpux-def:swlist_test/hpux-def:object" priority="1001" mode="M169">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:swlist_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_test/hpux-def:state" priority="1000" mode="M169">
...
<!--PATTERN hpux-def_swlist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_object//oval-def:filter" priority="1000" mode="M170"><axsl:variable name="parent_object" select="ancestor::hpux-def:swlist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_trusted_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_test/hpux-def:object" priority="1001" mode="M171">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:trusted_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_test/hpux-def:state" priority="1000" mode="M171">
...
<!--PATTERN hpux-def_trusted_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_object//oval-def:filter" priority="1000" mode="M172"><axsl:variable name="parent_object" select="ancestor::hpux-def:trusted_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_acltst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:acl_test/ios-def:object" priority="1001" mode="M173">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:acl_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:acl_test/ios-def:state" priority="1000" mode="M173">
...
<!--PATTERN ios_acl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:acl_object//oval-def:filter" priority="1000" mode="M174"><axsl:variable name="parent_object" select="ancestor::ios-def:acl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_bgpneighbortst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:bgpneighbor_test/ios-def:object" priority="1001" mode="M175">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:bgpneighbor_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:bgpneighbor_test/ios-def:state" priority="1000" mode="M175">
...
<!--PATTERN ios_bgpneighbor_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:bgpneighbor_object//oval-def:filter" priority="1000" mode="M176"><axsl:variable name="parent_object" select="ancestor::ios-def:bgpneighbor_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_globaltst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:object" priority="1001" mode="M177">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:global_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:state" priority="1000" mode="M177">
...
<!--PATTERN ios-def_global_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_object//oval-def:filter" priority="1000" mode="M178"><axsl:variable name="parent_object" select="ancestor::ios-def:global_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_interfacetst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:object" priority="1001" mode="M179">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:interface_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:state" priority="1000" mode="M179">
...
<!--PATTERN ios-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_object//oval-def:filter" priority="1000" mode="M180"><axsl:variable name="parent_object" select="ancestor::ios-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_interfacestenoipdbc-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:no_ip_directed_broadcast_command" priority="1000" mode="M181">
...
<!--PATTERN ios-def_interfaceste_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:urpf_command" priority="1000" mode="M182">
...
<!--PATTERN ios-def_linetst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:object" priority="1001" mode="M183">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:line_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:state" priority="1000" mode="M183">
...
<!--PATTERN ios-def_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_object//oval-def:filter" priority="1000" mode="M184"><axsl:variable name="parent_object" select="ancestor::ios-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_routertst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:router_test/ios-def:object" priority="1001" mode="M185">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:router_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:router_test/ios-def:state" priority="1000" mode="M185">
...
<!--PATTERN ios_router_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:router_object//oval-def:filter" priority="1000" mode="M186"><axsl:variable name="parent_object" select="ancestor::ios-def:router_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_routingprotocolauthintftst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_test/ios-def:object" priority="1001" mode="M187">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:routingprotocolauthintf_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_test/ios-def:state" priority="1000" mode="M187">
...
<!--PATTERN ios_routingprotocolauthintf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_object//oval-def:filter" priority="1000" mode="M188"><axsl:variable name="parent_object" select="ancestor::ios-def:routingprotocolauthintf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_sectiontst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:section_test/ios-def:object" priority="1001" mode="M189">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:section_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:section_test/ios-def:state" priority="1000" mode="M189">
...
<!--PATTERN ios_section_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:section_object//oval-def:filter" priority="1000" mode="M190"><axsl:variable name="parent_object" select="ancestor::ios-def:section_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_snmptst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:object" priority="1001" mode="M191">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmp_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:state" priority="1000" mode="M191">
...
<!--PATTERN ios_communitytst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpcommunity_test/ios-def:object" priority="1001" mode="M192">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmpcommunity_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpcommunity_test/ios-def:state" priority="1000" mode="M192">
...
<!--PATTERN ios_snmpcommunity_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpcommunity_object//oval-def:filter" priority="1000" mode="M193"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpcommunity_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_grouptst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpgroup_test/ios-def:object" priority="1001" mode="M194">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmpgroup_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpgroup_test/ios-def:state" priority="1000" mode="M194">
...
<!--PATTERN ios_snmpgroup_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpgroup_object//oval-def:filter" priority="1000" mode="M195"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpgroup_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_hosttst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmphost_test/ios-def:object" priority="1001" mode="M196">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmphost_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmphost_test/ios-def:state" priority="1000" mode="M196">
...
<!--PATTERN ios_snmphost_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmphost_object//oval-def:filter" priority="1000" mode="M197"><axsl:variable name="parent_object" select="ancestor::ios-def:snmphost_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_usertst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpuser_test/ios-def:object" priority="1001" mode="M198">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmpuser_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpuser_test/ios-def:state" priority="1000" mode="M198">
...
<!--PATTERN ios_snmpuser_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpuser_object//oval-def:filter" priority="1000" mode="M199"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpuser_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_viewtst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpview_test/ios-def:object" priority="1001" mode="M200">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmpview_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpview_test/ios-def:state" priority="1000" mode="M200">
...
<!--PATTERN ios_snmpview_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpview_object//oval-def:filter" priority="1000" mode="M201"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpview_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_tclshtst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:object" priority="1001" mode="M202">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:tclsh_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:state" priority="1000" mode="M202">
...
<!--PATTERN ios-def_ver55tst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:object" priority="1001" mode="M203">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:version55_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:state" priority="1000" mode="M203">
...
<!--PATTERN ios-def_vertst_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_test" priority="1000" mode="M204">
...
<!--PATTERN ios-def_verobj_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_object" priority="1000" mode="M206">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M206"/></axsl:template><axsl:template match="text()" priority="-1" mode="M206"/><axsl:template match="@*|node()" priority="-2" mode="M206"><axsl:apply-templates select="@*|*" mode="M206"/></axsl:template>

<!--PATTERN ios-def_verste_dep-->


	<!--RULE -->
<axsl:template match="ios-def:version_state" priority="1000" mode="M207">
...
<!--PATTERN linux-def_dpkginfo_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_test/linux-def:object" priority="1001" mode="M208">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:dpkginfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_test/linux-def:state" priority="1000" mode="M208">
...
<!--PATTERN linux-def_dpkginfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_object//oval-def:filter" priority="1000" mode="M209"><axsl:variable name="parent_object" select="ancestor::linux-def:dpkginfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_dpkginfosteevr_id-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:evr" priority="1000" mode="M210">

		<!--REPORT -->
<axsl:if test="@datatype='evr_string'">
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> Warning: There are differences in the algorithms for how the version strings of Debian and RPM packages are compared. As a result, a new debian_evr_string datatype was added to the OVAL Language and should be used, for this entity, instead of the evr_string datatype.<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M210"/></axsl:template><axsl:template match="text()" priority="-1" mode="M210"/><axsl:template match="@*|node()" priority="-2" mode="M210"><axsl:apply-templates select="@*|*" mode="M210"/></axsl:template>

<!--PATTERN linux-def_iflisteners_test-->


	<!--RULE -->
<axsl:template match="linux-def:iflisteners_test/linux-def:object" priority="1001" mode="M211">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:iflisteners_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:iflisteners_test/linux-def:state" priority="1000" mode="M211">
...
<!--PATTERN linux-def_iflisteners_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:iflisteners_object//oval-def:filter" priority="1000" mode="M212"><axsl:variable name="parent_object" select="ancestor::linux-def:iflisteners_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_inetlisteningservers_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_test/linux-def:object" priority="1001" mode="M213">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:inetlisteningservers_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_test/linux-def:state" priority="1000" mode="M213">
...
<!--PATTERN linux-def_inetlisteningservers_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_object//oval-def:filter" priority="1000" mode="M214"><axsl:variable name="parent_object" select="ancestor::linux-def:inetlisteningservers_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_partitiontst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_test/linux-def:object" priority="1001" mode="M215">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:partition_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_test/linux-def:state" priority="1000" mode="M215">
...
<!--PATTERN linux-def_partition_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_object//oval-def:filter" priority="1000" mode="M216"><axsl:variable name="parent_object" select="ancestor::linux-def:partition_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpminfo_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_test/linux-def:object" priority="1001" mode="M217">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpminfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_test/linux-def:state" priority="1000" mode="M217">
...
<!--PATTERN linux-def_rpminfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_object//oval-def:filter" priority="1000" mode="M218"><axsl:variable name="parent_object" select="ancestor::linux-def:rpminfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifytst_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test" priority="1000" mode="M219">
...
<!--PATTERN linux-def_rpmverify_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test/linux-def:object" priority="1001" mode="M220">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverify_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test/linux-def:state" priority="1000" mode="M220">
...
<!--PATTERN linux-def_rpmverify_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_object//oval-def:filter" priority="1000" mode="M221"><axsl:variable name="parent_object" select="ancestor::linux-def:rpmverify_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifyobj_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_object" priority="1000" mode="M222">
...
<!--PATTERN linux-def_rpmverifyste_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_state" priority="1000" mode="M223">
...
<!--PATTERN linux-def_rpmverifyfile_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_test/linux-def:object" priority="1001" mode="M224">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverifyfile_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_test/linux-def:state" priority="1000" mode="M224">
...
<!--PATTERN linux-def_rpmverifyfile_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_object//oval-def:filter" priority="1000" mode="M225"><axsl:variable name="parent_object" select="ancestor::linux-def:rpmverifyfile_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifypackage_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_test/linux-def:object" priority="1001" mode="M226">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverifypackage_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_test/linux-def:state" priority="1000" mode="M226">
...
<!--PATTERN linux-def_rpmverifypackage_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object//oval-def:filter" priority="1000" mode="M227"><axsl:variable name="parent_object" select="ancestor::linux-def:rpmverifypackage_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifypackage_dicp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_state/linux-def:digest_check_passed" priority="1000" mode="M228">
...
<!--PATTERN linux-def_rpmverifypackage_scp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_state/linux-def:signature_check_passed" priority="1000" mode="M229">
...
<!--PATTERN linux-def_rpmverifypackage_nodi_beh_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object/linux-def:behaviors/@nodigest" priority="1000" mode="M230">
...
<axsl:if test="true()">DEPRECATED BEHAVIOR: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="../../@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M230"/></axsl:template><axsl:template match="text()" priority="-1" mode="M230"/><axsl:template match="@*|node()" priority="-2" mode="M230"><axsl:apply-templates select="@*|*" mode="M230"/></axsl:template>

<!--PATTERN linux-def_rpmverifypackage_nosi_beh_dep-->


	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object/linux-def:behaviors/@nosignature" priority="1000" mode="M231">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED BEHAVIOR: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="../../@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M231"/></axsl:template><axsl:template match="text()" priority="-1" mode="M231"/><axsl:template match="@*|node()" priority="-2" mode="M231"><axsl:apply-templates select="@*|*" mode="M231"/></axsl:template>

<!--PATTERN linux-def_selinuxbooleantst-->


	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_test/linux-def:object" priority="1001" mode="M232">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:selinuxboolean_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_test/linux-def:state" priority="1000" mode="M232">
...
<!--PATTERN linux-def_selinuxboolean_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_object//oval-def:filter" priority="1000" mode="M233"><axsl:variable name="parent_object" select="ancestor::linux-def:selinuxboolean_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_selinuxsecuritycontexttst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_test/linux-def:object" priority="1001" mode="M234">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:selinuxsecuritycontext_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_test/linux-def:state" priority="1000" mode="M234">
...
<!--PATTERN linux-def_selinuxsecuritycontext_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object//oval-def:filter" priority="1000" mode="M235"><axsl:variable name="parent_object" select="ancestor::linux-def:selinuxsecuritycontext_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilepath-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filepath" priority="1000" mode="M236">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilepath2-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M237">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectpath-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M238">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filename" priority="1000" mode="M239">
...
<!--PATTERN linux-def_slackwarepkginfo_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_test/linux-def:object" priority="1001" mode="M240">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:slackwarepkginfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_test/linux-def:state" priority="1000" mode="M240">
...
<!--PATTERN linux-def_slackwarepkginfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_object//oval-def:filter" priority="1000" mode="M241"><axsl:variable name="parent_object" select="ancestor::linux-def:slackwarepkginfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_systemdunitdependencytst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_test/linux-def:object" priority="1001" mode="M242">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:systemdunitdependency_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_test/linux-def:state" priority="1000" mode="M242">
...
<!--PATTERN linux-def_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_object//oval-def:filter" priority="1000" mode="M243"><axsl:variable name="parent_object" select="ancestor::linux-def:systemdunitdependency_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_systemdunitpropertytst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_test/linux-def:object" priority="1001" mode="M244">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:systemdunitproperty_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_test/linux-def:state" priority="1000" mode="M244">
...
<!--PATTERN linux-def_systemdunitproperty_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_object//oval-def:filter" priority="1000" mode="M245"><axsl:variable name="parent_object" select="ancestor::linux-def:systemdunitproperty_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_accountinfo_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_test/macos-def:object" priority="1001" mode="M246">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:accountinfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_test/macos-def:state" priority="1000" mode="M246">
...
<!--PATTERN macos-def_accountinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_object//oval-def:filter" priority="1000" mode="M247"><axsl:variable name="parent_object" select="ancestor::macos-def:accountinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_authorizationdbtst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_test/macos-def:object" priority="1001" mode="M248">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:authorizationdb_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_test/macos-def:state" priority="1000" mode="M248">
...
<!--PATTERN macos-def_authorizationdb_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_object//oval-def:filter" priority="1000" mode="M249"><axsl:variable name="parent_object" select="ancestor::macos-def:authorizationdb_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_authdbobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_object/macos-def:xpath" priority="1000" mode="M250">
...
<!--PATTERN macos-def_corestoragetst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_test/macos-def:object" priority="1001" mode="M251">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:corestorage_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_test/macos-def:state" priority="1000" mode="M251">
...
<!--PATTERN macos-def_corestorage_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_object//oval-def:filter" priority="1000" mode="M252"><axsl:variable name="parent_object" select="ancestor::macos-def:corestorage_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_corestorageobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_object/macos-def:xpath" priority="1000" mode="M253">
...
<!--PATTERN macos-def_diskutiltst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:diskutil_test/macos-def:object" priority="1001" mode="M254">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:diskutil_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:diskutil_test/macos-def:state" priority="1000" mode="M254">
...
<!--PATTERN macos-def_diskutil_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:diskutil_object//oval-def:filter" priority="1000" mode="M255"><axsl:variable name="parent_object" select="ancestor::macos-def:diskutil_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_gatekeepertst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:gatekeeper_test/macos-def:object" priority="1001" mode="M256">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:gatekeeper_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:gatekeeper_test/macos-def:state" priority="1000" mode="M256">
...
<!--PATTERN macos-def_inetlisteningserverstst_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test" priority="1000" mode="M257">
...
<!--PATTERN macos-def_inetlisteningservers_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test/macos-def:object" priority="1001" mode="M258">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:inetlisteningservers_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test/macos-def:state" priority="1000" mode="M258">
...
<!--PATTERN macos-def_inetlisteningserversobj_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_object" priority="1000" mode="M259">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M259"/></axsl:template><axsl:template match="text()" priority="-1" mode="M259"/><axsl:template match="@*|node()" priority="-2" mode="M259"><axsl:apply-templates select="@*|*" mode="M259"/></axsl:template>

<!--PATTERN macos-def_inetlisteningservers_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_object//oval-def:filter" priority="1000" mode="M260"><axsl:variable name="parent_object" select="ancestor::macos-def:inetlisteningservers_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_inetlisteningserversste_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state" priority="1000" mode="M261">
...
<!--PATTERN macos-def_inetlisteningserver510_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_test/macos-def:object" priority="1001" mode="M262">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:inetlisteningserver510_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_test/macos-def:state" priority="1000" mode="M262">
...
<!--PATTERN macos-def_inetlisteningserver510_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_object//oval-def:filter" priority="1000" mode="M263"><axsl:variable name="parent_object" select="ancestor::macos-def:inetlisteningserver510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_keychaintst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:keychain_test/macos-def:object" priority="1001" mode="M264">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:keychain_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:keychain_test/macos-def:state" priority="1000" mode="M264">
...
<!--PATTERN macos-def_keychain_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:keychain_object//oval-def:filter" priority="1000" mode="M265"><axsl:variable name="parent_object" select="ancestor::macos-def:keychain_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_launchdtst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:launchd_test/macos-def:object" priority="1001" mode="M266">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:launchd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:launchd_test/macos-def:state" priority="1000" mode="M266">
...
<!--PATTERN macos-def_launchd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:macos_object//oval-def:filter" priority="1000" mode="M267"><axsl:variable name="parent_object" select="ancestor::macos-def:launchd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_nvram_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_test/macos-def:object" priority="1001" mode="M268">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:nvram_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_test/macos-def:state" priority="1000" mode="M268">
...
<!--PATTERN macos-def_nvram_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_object//oval-def:filter" priority="1000" mode="M269"><axsl:variable name="parent_object" select="ancestor::macos-def:nvram_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plist_test_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_test" priority="1000" mode="M270">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M270"/></axsl:template><axsl:template match="text()" priority="-1" mode="M270"/><axsl:template match="@*|node()" priority="-2" mode="M270"><axsl:apply-templates select="@*|*" mode="M270"/></axsl:template>

<!--PATTERN macos-def_plist_test-->


	<!--RULE -->
<axsl:template match="macos-def:plist_test/macos-def:object" priority="1001" mode="M271">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:plist_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_test/macos-def:state" priority="1000" mode="M271">
...
<!--PATTERN macos-def_plist_object_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object" priority="1000" mode="M272">
...
<!--PATTERN macos-def_plist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object//oval-def:filter" priority="1000" mode="M273"><axsl:variable name="parent_object" select="ancestor::macos-def:plist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plistobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object/macos-def:filepath" priority="1000" mode="M274">
...
<!--PATTERN macos-def_plist_state_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_state" priority="1000" mode="M275">
...
<!--PATTERN macos-def_plist510_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_test/macos-def:object" priority="1001" mode="M276">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:plist510_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_test/macos-def:state" priority="1000" mode="M276">
...
<!--PATTERN macos-def_plist510_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object//oval-def:filter" priority="1000" mode="M277"><axsl:variable name="parent_object" select="ancestor::macos-def:plist510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plist510objappid-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object/macos-def:app_id" priority="1000" mode="M278">
...
<!--PATTERN macos-def_plist510objfilepath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object/macos-def:filepath" priority="1000" mode="M279">
...
<!--PATTERN macos-def_pwpolicy_test_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test" priority="1000" mode="M280">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M280"/></axsl:template><axsl:template match="text()" priority="-1" mode="M280"/><axsl:template match="@*|node()" priority="-2" mode="M280"><axsl:apply-templates select="@*|*" mode="M280"/></axsl:template>

<!--PATTERN macos-def_pwpolicy_test-->


	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test/macos-def:object" priority="1001" mode="M281">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:pwpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test/macos-def:state" priority="1000" mode="M281">
...
<!--PATTERN macos-def_pwpolicy_object_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object" priority="1000" mode="M282">
...
<!--PATTERN macos-def_pwpolicy_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object//oval-def:filter" priority="1000" mode="M283"><axsl:variable name="parent_object" select="ancestor::macos-def:pwpolicy_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_pwpobjuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:userpass" priority="1000" mode="M284">
...
<!--PATTERN macos-def_pwpolicy_state_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state" priority="1000" mode="M285">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M285"/></axsl:template><axsl:template match="text()" priority="-1" mode="M285"/><axsl:template match="@*|node()" priority="-2" mode="M285"><axsl:apply-templates select="@*|*" mode="M285"/></axsl:template>

<!--PATTERN macos-def_pwpolicy59_test-->


	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_test/macos-def:object" priority="1001" mode="M286">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:pwpolicy59_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_test/macos-def:state" priority="1000" mode="M286">
...
<!--PATTERN macos-def_pwpolicy59_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object//oval-def:filter" priority="1000" mode="M287"><axsl:variable name="parent_object" select="ancestor::macos-def:pwpolicy59_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_pwp59objusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object/macos-def:username" priority="1000" mode="M288">
...
<!--PATTERN macos-def_pwp59objuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object/macos-def:userpass" priority="1000" mode="M289">
...
<!--PATTERN macos-def_rlimittst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:rlimit_test/macos-def:object" priority="1001" mode="M290">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:rlimit_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:rlimit_test/macos-def:state" priority="1000" mode="M290">
...
<!--PATTERN macos-def_softwareupdatetst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:softwareupdate_test/macos-def:object" priority="1001" mode="M291">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:softwareupdate_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:softwareupdate_test/macos-def:state" priority="1000" mode="M291">
...
<!--PATTERN macos-def_systemprofilertst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_test/macos-def:object" priority="1001" mode="M292">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:systemprofiler_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_test/macos-def:state" priority="1000" mode="M292">
...
<!--PATTERN macos-def_systemprofiler_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_object//oval-def:filter" priority="1000" mode="M293"><axsl:variable name="parent_object" select="ancestor::macos-def:systemprofiler_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_systemprofilerobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_object/macos-def:xpath" priority="1000" mode="M294">
...
<!--PATTERN macos-def_systemsetuptst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemsetup_test/macos-def:object" priority="1001" mode="M295">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:systemsetup_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="macos-def:systemsetup_test/macos-def:state" priority="1000" mode="M295">
...
<!--PATTERN pixos-def_linetst-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_test/pixos-def:object" priority="1001" mode="M296">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/pixos-def:line_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_test/pixos-def:state" priority="1000" mode="M296">
...
<!--PATTERN pixos-def_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_object//oval-def:filter" priority="1000" mode="M297"><axsl:variable name="parent_object" select="ancestor::pixos-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN pixos-def_vertst-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:version_test/pixos-def:object" priority="1001" mode="M298">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/pixos-def:version_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="pixos-def:version_test/pixos-def:state" priority="1000" mode="M298">
...
<!--PATTERN sp-def_webapptst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_test/sp-def:object" priority="1001" mode="M299">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spwebapplication_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_test/sp-def:state" priority="1000" mode="M299">
...
<!--PATTERN sp-def_spwebapplication_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_object//oval-def:filter" priority="1000" mode="M300"><axsl:variable name="parent_object" select="ancestor::sp-def:spwebapplication_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_grptst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spgroup_test/sp-def:object" priority="1001" mode="M301">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spgroup_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spgroup_test/sp-def:state" priority="1000" mode="M301">
...
<!--PATTERN sp-def_webtst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spweb_test/sp-def:object" priority="1001" mode="M303">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spweb_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spweb_test/sp-def:state" priority="1000" mode="M303">
...
<!--PATTERN sp-def_listtst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:splist_test/sp-def:object" priority="1001" mode="M305">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:splist_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:splist_test/sp-def:state" priority="1000" mode="M305">
...
<!--PATTERN sp-def_avstst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spantivirussettings_test/sp-def:object" priority="1001" mode="M307">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spantivirussettings_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spantivirussettings_test/sp-def:state" priority="1000" mode="M307">
...
<!--PATTERN sp-def_siteadmintst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_test/sp-def:object" priority="1001" mode="M309">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spsiteadministration_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_test/sp-def:state" priority="1000" mode="M309">
...
<!--PATTERN sp-def_spsiteadministration_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_object//oval-def:filter" priority="1000" mode="M310"><axsl:variable name="parent_object" select="ancestor::sp-def:spsiteadministration_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_sitetst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spsite_test/sp-def:object" priority="1001" mode="M311">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spsite_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spsite_test/sp-def:state" priority="1000" mode="M311">
...
<!--PATTERN sp_def_spsite_state_url_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/sp-def:spsite_state/sp-def:url" priority="1000" mode="M313">
...
<!--PATTERN sp-def_crtst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spcrawlrule_test/sp-def:object" priority="1001" mode="M314">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spcrawlrule_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spcrawlrule_test/sp-def:state" priority="1000" mode="M314">
...
<!--PATTERN sp-def_spjobdefinition_test_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test" priority="1000" mode="M316">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M316"/></axsl:template><axsl:template match="text()" priority="-1" mode="M316"/><axsl:template match="@*|node()" priority="-2" mode="M316"><axsl:apply-templates select="@*|*" mode="M316"/></axsl:template>

<!--PATTERN sp-def_jobdeftst-->


	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test/sp-def:object" priority="1001" mode="M317">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spjobdefinition_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test/sp-def:state" priority="1000" mode="M317">
...
<!--PATTERN sp-def_spjobdefinition_object_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_object" priority="1000" mode="M318">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M318"/></axsl:template><axsl:template match="text()" priority="-1" mode="M318"/><axsl:template match="@*|node()" priority="-2" mode="M318"><axsl:apply-templates select="@*|*" mode="M318"/></axsl:template>

<!--PATTERN sp-def_spjobdefinition_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_object//oval-def:filter" priority="1000" mode="M319"><axsl:variable name="parent_object" select="ancestor::sp-def:spjobdefinition_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_spjobdefinition_state_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_state" priority="1000" mode="M320">
...
<!--PATTERN sp-def_jobdef510tst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_test/sp-def:object" priority="1001" mode="M321">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spjobdefinition510_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_test/sp-def:state" priority="1000" mode="M321">
...
<!--PATTERN sp-def_spjobdefinition510_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_object//oval-def:filter" priority="1000" mode="M322"><axsl:variable name="parent_object" select="ancestor::sp-def:spjobdefinition510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_bbtst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:bestbet_test/sp-def:object" priority="1001" mode="M323">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:bestbet_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:bestbet_test/sp-def:state" priority="1000" mode="M323">
...
<!--PATTERN sp-def_infopolicycolltst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:policycoll_test/sp-def:object" priority="1001" mode="M325">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:policycoll_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:policycoll_test/sp-def:state" priority="1000" mode="M325">
...
<!--PATTERN sp-def_infopolicycoll_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:infopolicycoll_object//oval-def:filter" priority="1000" mode="M326"><axsl:variable name="parent_object" select="ancestor::sp-def:infopolicycoll_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_diagnosticsservicetest-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticsservice_test/sp-def:object" priority="1001" mode="M327">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spdiagnosticsservice_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticsservice_test/sp-def:state" priority="1000" mode="M327">
...
<!--PATTERN sp-def_diagnostics_level_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticslevel_test/sp-def:object" priority="1001" mode="M329">
...
<!--PATTERN sp-def_policyfeature_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicyfeature_test/sp-def:object" priority="1001" mode="M331">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:sppolicyfeature_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicyfeature_test/sp-def:state" priority="1000" mode="M331">
...
<!--PATTERN sp-def_policy_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicy_test/sp-def:object" priority="1001" mode="M333">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:sppolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicy_test/sp-def:state" priority="1000" mode="M333">
...
<!--PATTERN sol-def_facet_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:facet_test/sol-def:object" priority="1001" mode="M334">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:facet_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:facet_test/sol-def:state" priority="1000" mode="M334">
...
<!--PATTERN sol-def_facet_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:facet_object//oval-def:filter" priority="1000" mode="M335"><axsl:variable name="parent_object" select="ancestor::sol-def:facet_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_image_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:image_test/sol-def:object" priority="1001" mode="M336">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:image_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an image_test must reference an image_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M336"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:image_test/sol-def:state" priority="1000" mode="M336">
...
<!--PATTERN sol-def_image_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:image_object//oval-def:filter" priority="1000" mode="M337"><axsl:variable name="parent_object" select="ancestor::sol-def:image_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_isainfotst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:object" priority="1001" mode="M338">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:isainfo_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an isainfo_test must reference an isainfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M338"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:state" priority="1000" mode="M338">
...
<!--PATTERN sol-def_ndd_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:ndd_test/sol-def:object" priority="1001" mode="M339">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:ndd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:ndd_test/sol-def:state" priority="1000" mode="M339">
...
<!--PATTERN sol-def_ndd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:ndd_object//oval-def:filter" priority="1000" mode="M340"><axsl:variable name="parent_object" select="ancestor::sol-def:ndd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagetst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:object" priority="1001" mode="M341">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:package_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:state" priority="1000" mode="M341">
...
<!--PATTERN sol-def_package_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_object//oval-def:filter" priority="1000" mode="M342"><axsl:variable name="parent_object" select="ancestor::sol-def:package_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_package511_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_test/sol-def:object" priority="1001" mode="M343">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:package511_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_test/sol-def:state" priority="1000" mode="M343">
...
<!--PATTERN sol-def_package511_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_object//oval-def:filter" priority="1000" mode="M344"><axsl:variable name="parent_object" select="ancestor::sol-def:package511_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packageavoidlist_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packageavoidlist_test/sol-def:object" priority="1001" mode="M345">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:packageavoidlist_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:packageavoidlist_test/sol-def:state" priority="1000" mode="M345">
...
<!--PATTERN sol-def_packageavoidlist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packageavoidlist_object//oval-def:filter" priority="1000" mode="M346"><axsl:variable name="parent_object" select="ancestor::sol-def:packageavoidlist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagechecktst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagecheck_test/sol-def:object" priority="1001" mode="M347">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:packagecheck_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:packagecheck_test/sol-def:state" priority="1000" mode="M347">
...
<!--PATTERN sol-def_packagecheck_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagecheck_object//oval-def:filter" priority="1000" mode="M348"><axsl:variable name="parent_object" select="ancestor::sol-def:packagecheck_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagefreezelist_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagefreezelist_test/sol-def:object" priority="1001" mode="M349">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:packagefreezelist_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:packagefreezelist_test/sol-def:state" priority="1000" mode="M349">
...
<!--PATTERN sol-def_packagefreezelist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagefreezelist_object//oval-def:filter" priority="1000" mode="M350"><axsl:variable name="parent_object" select="ancestor::sol-def:packagefreezelist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagepublisher_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagepublisher_test/sol-def:object" priority="1001" mode="M351">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:packagepublisher_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:packagepublisher_test/sol-def:state" priority="1000" mode="M351">
...
<!--PATTERN sol-def_packagepublisher_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagepublisher_object//oval-def:filter" priority="1000" mode="M352"><axsl:variable name="parent_object" select="ancestor::sol-def:packagepublisher_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_patch54tst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:object" priority="1001" mode="M353">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:patch54_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a patch54_test must reference a patch54_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M353"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:state" priority="1000" mode="M353">
...
<!--PATTERN sol-def_patchtst_dep-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_test" priority="1000" mode="M354">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M354"/></axsl:template><axsl:template match="text()" priority="-1" mode="M354"/><axsl:template match="@*|node()" priority="-2" mode="M354"><axsl:apply-templates select="@*|*" mode="M354"/></axsl:template>

<!--PATTERN sol-def_patchtst-->


	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:object" priority="1001" mode="M355">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:patch_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:state" priority="1000" mode="M355">
...
<!--PATTERN sol-def_patch54_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_object//oval-def:filter" priority="1000" mode="M356"><axsl:variable name="parent_object" select="ancestor::sol-def:patch54_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_patchobj_dep-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_object" priority="1000" mode="M357">
...
<!--PATTERN sol-def_smftst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:object" priority="1001" mode="M358">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:smf_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:state" priority="1000" mode="M358">
...
<!--PATTERN sol-def_smf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_object//oval-def:filter" priority="1000" mode="M359"><axsl:variable name="parent_object" select="ancestor::sol-def:smf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_smfproperty_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_test/sol-def:object" priority="1001" mode="M360">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:smfproperty_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_test/sol-def:state" priority="1000" mode="M360">
...
<!--PATTERN sol-def_smfproperty_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_object//oval-def:filter" priority="1000" mode="M361"><axsl:variable name="parent_object" select="ancestor::sol-def:smfproperty_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_variant_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:variant_test/sol-def:object" priority="1001" mode="M362">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:variant_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:variant_test/sol-def:state" priority="1000" mode="M362">
...
<!--PATTERN sol-def_variant_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:variant_object//oval-def:filter" priority="1000" mode="M363"><axsl:variable name="parent_object" select="ancestor::sol-def:variant_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_virtualizationinfo_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_test/sol-def:object" priority="1001" mode="M364">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:virtualizationinfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_test/sol-def:state" priority="1000" mode="M364">
...
<!--PATTERN sol-def_virtualizationinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_object//oval-def:filter" priority="1000" mode="M365"><axsl:variable name="parent_object" select="ancestor::sol-def:virtualizationinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_dnscachetst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:dnscache_test/unix-def:object" priority="1001" mode="M366">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:dnscache_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:dnscache_test/unix-def:state" priority="1000" mode="M366">
...
<!--PATTERN unix-def_dnscache_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:dnscache_object//oval-def:filter" priority="1000" mode="M367"><axsl:variable name="parent_object" select="ancestor::unix-def:dnscache_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_filetst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_test/unix-def:object" priority="1001" mode="M368">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:file_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:file_test/unix-def:state" priority="1000" mode="M368">
...
<!--PATTERN unix-def_file_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object//oval-def:filter" priority="1000" mode="M369"><axsl:variable name="parent_object" select="ancestor::unix-def:file_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_fileobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filepath" priority="1000" mode="M370">
...
<!--PATTERN unix-def_fileobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M371">
...
<!--PATTERN unix-def_fileobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M372">
...
<!--PATTERN unix-def_file_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filename" priority="1000" mode="M373">
...
<!--PATTERN unix-def_recurse_value_file_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/unix-def:file_object/unix-def:behaviors" priority="1000" mode="M374">
...
<axsl:if test="@recurse='none'"> DEPRECATED ATTRIBUTE VALUE IN: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ATTRIBUTE VALUE: <axsl:text/><axsl:value-of select="@recurse"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M374"/></axsl:template><axsl:template match="text()" priority="-1" mode="M374"/><axsl:template match="@*|node()" priority="-2" mode="M374"><axsl:apply-templates select="@*|*" mode="M374"/></axsl:template>

<!--PATTERN unix-def_file_ea_tst-->


	<!--RULE -->
<axsl:template match="unix-def:filextendedattribute_test/unix-def:object" priority="1001" mode="M375">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:fileextendedattribute_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_test/unix-def:state" priority="1000" mode="M375">
...
<!--PATTERN unix-def_fileextendedattribute_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object//oval-def:filter" priority="1000" mode="M376"><axsl:variable name="parent_object" select="ancestor::unix-def:fileextendedattribute_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_file_ea_objfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filepath" priority="1000" mode="M377">
...
<!--PATTERN unix-def_file_ea_objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M378">
...
<!--PATTERN unix-def_file_ea_objpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M379">
...
<!--PATTERN unix-def_fileextendedattribute_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filename" priority="1000" mode="M380">
...
<!--PATTERN unix-def_gconf_test-->
	...
	<!--RULE -->
<axsl:template match="unix-def:gconf_test/unix-def:object" priority="1001" mode="M381">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:gconf_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a gconf_test must reference an gconf_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M381"/></axsl:template>

	<!--RULE -->
<axsl:template match="unix-def:gconf_test/unix-def:state" priority="1000" mode="M381">
...
<!--PATTERN unix-def_gconf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:gconf_object//oval-def:filter" priority="1000" mode="M382"><axsl:variable name="parent_object" select="ancestor::unix-def:gconf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_gconfobjsource-->
	...
	<!--RULE -->
<axsl:template match="unix-def:gconf_object/unix-def:source" priority="1000" mode="M383">
...
<!--PATTERN unix-def_inetdtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_test/unix-def:object" priority="1001" mode="M384">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:inetd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_test/unix-def:state" priority="1000" mode="M384">
...
<!--PATTERN unix-def_inetd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_object//oval-def:filter" priority="1000" mode="M385"><axsl:variable name="parent_object" select="ancestor::unix-def:inetd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_interfacetst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_test/unix-def:object" priority="1001" mode="M386">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:interface_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_test/unix-def:state" priority="1000" mode="M386">
...
<!--PATTERN unix-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_object//oval-def:filter" priority="1000" mode="M387"><axsl:variable name="parent_object" select="ancestor::unix-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_passwordtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:password_test/unix-def:object" priority="1001" mode="M388">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:password_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:password_test/unix-def:state" priority="1000" mode="M388">
...
<!--PATTERN unix-def_password_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:password_object//oval-def:filter" priority="1000" mode="M389"><axsl:variable name="parent_object" select="ancestor::unix-def:password_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_processtst_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_test" priority="1000" mode="M390">
...
<!--PATTERN unix-def_processtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_test/unix-def:object" priority="1001" mode="M391">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:process_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:process_test/unix-def:state" priority="1000" mode="M391">
...
<!--PATTERN unix-def_processobj_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_object" priority="1000" mode="M392">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M392"/></axsl:template><axsl:template match="text()" priority="-1" mode="M392"/><axsl:template match="@*|node()" priority="-2" mode="M392"><axsl:apply-templates select="@*|*" mode="M392"/></axsl:template>

<!--PATTERN unix-def_processste_dep-->


	<!--RULE -->
<axsl:template match="unix-def:process_state" priority="1000" mode="M393">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M393"/></axsl:template><axsl:template match="text()" priority="-1" mode="M393"/><axsl:template match="@*|node()" priority="-2" mode="M393"><axsl:apply-templates select="@*|*" mode="M393"/></axsl:template>

<!--PATTERN unix-def_process58tst-->


	<!--RULE -->
<axsl:template match="unix-def:process58_test/unix-def:object" priority="1001" mode="M394">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:process58_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process58_test must reference a process58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M394"/></axsl:template>

	<!--RULE -->
<axsl:template match="unix-def:process58_test/unix-def:state" priority="1000" mode="M394">
...
<!--PATTERN unix-def_process58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process58_object//oval-def:filter" priority="1000" mode="M395"><axsl:variable name="parent_object" select="ancestor::unix-def:process58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_routingtable_test-->
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_test/unix-def:object" priority="1001" mode="M396">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:routingtable_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_test/unix-def:state" priority="1000" mode="M396">
...
<!--PATTERN unix-def_routingtable_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_object//oval-def:filter" priority="1000" mode="M397"><axsl:variable name="parent_object" select="ancestor::unix-def:routingtable_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_runleveltst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_test/unix-def:object" priority="1001" mode="M398">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:runlevel_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a runlevel_test must reference a runlevel_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M398"/></axsl:template>

	<!--RULE -->
<axsl:template match="unix-def:runlevel_test/unix-def:state" priority="1000" mode="M398">
...
<!--PATTERN unix-def_runlevel_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_object//oval-def:filter" priority="1000" mode="M399"><axsl:variable name="parent_object" select="ancestor::unix-def:runlevel_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sccstst_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_test" priority="1000" mode="M400">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M400"/></axsl:template><axsl:template match="text()" priority="-1" mode="M400"/><axsl:template match="@*|node()" priority="-2" mode="M400"><axsl:apply-templates select="@*|*" mode="M400"/></axsl:template>

<!--PATTERN unix-def_sccstst-->


	<!--RULE -->
<axsl:template match="unix-def:sccs_test/unix-def:object" priority="1001" mode="M401">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:sccs_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_test/unix-def:state" priority="1000" mode="M401">
...
<!--PATTERN unix-def_sccsobj_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object" priority="1000" mode="M402">
...
<!--PATTERN unix-def_sccs_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object//oval-def:filter" priority="1000" mode="M403"><axsl:variable name="parent_object" select="ancestor::unix-def:sccs_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sccsobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filepath" priority="1000" mode="M404">
...
<!--PATTERN unix-def_sccsobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M405">
...
<!--PATTERN unix-def_sccsobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M406">
...
<!--PATTERN unix-def_sccs_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filename" priority="1000" mode="M407">
...
<!--PATTERN unix-def_sccsste_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state" priority="1000" mode="M408">
...
<!--PATTERN unix-def_shadowtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_test/unix-def:object" priority="1001" mode="M409">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:shadow_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_test/unix-def:state" priority="1000" mode="M409">
...
<!--PATTERN unix-def_shadow_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_object//oval-def:filter" priority="1000" mode="M410"><axsl:variable name="parent_object" select="ancestor::unix-def:shadow_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_symlinktst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:symlink_test/unix-def:object" priority="1001" mode="M411">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:symlink_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:symlink_test/unix-def:state" priority="1000" mode="M411">
...
<!--PATTERN unix-def_symlink_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:symlink_object//oval-def:filter" priority="1000" mode="M412"><axsl:variable name="parent_object" select="ancestor::unix-def:symlink_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sysctltst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_test/unix-def:object" priority="1001" mode="M413">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:sysctl_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_test/unix-def:state" priority="1000" mode="M413">
...
<!--PATTERN unix-def_sysctl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_object//oval-def:filter" priority="1000" mode="M414"><axsl:variable name="parent_object" select="ancestor::unix-def:sysctl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_unametst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_test/unix-def:object" priority="1001" mode="M415">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:uname_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_test/unix-def:state" priority="1000" mode="M415">
...
<!--PATTERN unix-def_xinetdtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_test/unix-def:object" priority="1001" mode="M416">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:xinetd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_test/unix-def:state" priority="1000" mode="M416">
...
<!--PATTERN unix-def_xinetd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_object//oval-def:filter" priority="1000" mode="M417"><axsl:variable name="parent_object" select="ancestor::unix-def:xinetd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_accesstokentst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test" priority="1000" mode="M418">
...
<!--PATTERN win-def_attst-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test/win-def:object" priority="1001" mode="M419">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:accesstoken_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test/win-def:state" priority="1000" mode="M419">
...
<!--PATTERN win-def_accesstokenobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_object" priority="1000" mode="M420">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M420"/></axsl:template><axsl:template match="text()" priority="-1" mode="M420"/><axsl:template match="@*|node()" priority="-2" mode="M420"><axsl:apply-templates select="@*|*" mode="M420"/></axsl:template>

<!--PATTERN win-def_accesstoken_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="win-def:accesstoken_object//oval-def:filter" priority="1000" mode="M421"><axsl:variable name="parent_object" select="ancestor::win-def:accesstoken_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_accesstokenste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state" priority="1000" mode="M422">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M422"/></axsl:template><axsl:template match="text()" priority="-1" mode="M422"/><axsl:template match="@*|node()" priority="-2" mode="M422"><axsl:apply-templates select="@*|*" mode="M422"/></axsl:template>

<!--PATTERN win-def_at_include_group_value_dep-->


	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:accesstoken_object/win-def:behaviors" priority="1000" mode="M423">

		<!--REPORT -->
<axsl:if test="@include_group">DEPRECATED BEHAVIOR IN: win-def:accesstoken_object<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M423"/></axsl:template><axsl:template match="text()" priority="-1" mode="M423"/><axsl:template match="@*|node()" priority="-2" mode="M423"><axsl:apply-templates select="@*|*" mode="M423"/></axsl:template>

<!--PATTERN win-def_at_resolve_group_value_dep-->


	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:accesstoken_object/win-def:behaviors" priority="1000" mode="M424">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: win-def:accesstoken_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M424"/></axsl:template><axsl:template match="text()" priority="-1" mode="M424"/><axsl:template match="@*|node()" priority="-2" mode="M424"><axsl:apply-templates select="@*|*" mode="M424"/></axsl:template>

<!--PATTERN win-def_adtst-->


	<!--RULE -->
<axsl:template match="win-def:activedirectory_test/win-def:object" priority="1001" mode="M425">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:activedirectory_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_test/win-def:state" priority="1000" mode="M425">
...
<!--PATTERN win-def_activedirectory57_test-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_test/win-def:object" priority="1001" mode="M426">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:activedirectory57_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_test/win-def:state" priority="1000" mode="M426">
...
<!--PATTERN win-def_activedirectory57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_object//oval-def:filter" priority="1000" mode="M427"><axsl:variable name="parent_object" select="ancestor::win-def:activedirectory57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_ad57stevalue-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_state/win-def:value" priority="1000" mode="M428">
...
<!--PATTERN win-def_aeptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:object" priority="1001" mode="M429">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:state" priority="1000" mode="M429">
...
<!--PATTERN win-def_aepstst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:object" priority="1001" mode="M430">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicysubcategories_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:state" priority="1000" mode="M430">
...
<!--PATTERN win-def_auditeventpolicysubcategoriesstatekerberos_ticket_events-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:kerberos_ticket_events" priority="1000" mode="M431">
...
<!--PATTERN win-def_cmdlet_test-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_test/win-def:object" priority="1001" mode="M432">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:cmdlet_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a cmdlet_test must reference a cmdlet_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M432"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:cmdlet_test/win-def:state" priority="1000" mode="M432">
...
<!--PATTERN win-def_cmdlet_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object//oval-def:filter" priority="1000" mode="M433"><axsl:variable name="parent_object" select="ancestor::win-def:cmdlet_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_cmdletobjmodule_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:module_name" priority="1000" mode="M434">
...
<!--PATTERN win-def_cmdletobjmodule_id-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:module_id" priority="1000" mode="M435">
...
<!--PATTERN win-def_cmdletobjmodule_version-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:module_version" priority="1000" mode="M436">
...
<!--PATTERN win-def_cmdletobjverb-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:verb" priority="1000" mode="M437">
...
<!--PATTERN win-def_cmdletobjnoun-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:noun" priority="1000" mode="M438">
...
<!--PATTERN win-def_cmdletobjparameters-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:parameters" priority="1000" mode="M439">
...
<!--PATTERN win-def_cmdletobjselect-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:select" priority="1000" mode="M440">
...
<!--PATTERN win-def_cmdletsteparameters-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:parameters" priority="1000" mode="M441">
...
<!--PATTERN win-def_cmdletsteselect-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:select" priority="1000" mode="M442">
...
<!--PATTERN win-def_cmdletstevalue-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:value" priority="1000" mode="M443">
...
<!--PATTERN win-def_dnscachetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:dnscache_test/win-def:object" priority="1001" mode="M444">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:dnscache_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:dnscache_test/win-def:state" priority="1000" mode="M444">
...
<!--PATTERN win-def_dnscache_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:dnscache_object//oval-def:filter" priority="1000" mode="M445"><axsl:variable name="parent_object" select="ancestor::win-def:dnscache_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_filetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_test/win-def:object" priority="1001" mode="M446">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:file_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:file_test/win-def:state" priority="1000" mode="M446">
...
<!--PATTERN win-def_file_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object//oval-def:filter" priority="1000" mode="M447"><axsl:variable name="parent_object" select="ancestor::win-def:file_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fileobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filepath" priority="1000" mode="M448">
...
<!--PATTERN win-def_fileobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M449">
...
<!--PATTERN win-def_fileobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M450">
...
<!--PATTERN win-def_fileobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filename" priority="1000" mode="M451">
...
<!--PATTERN win-def_filestefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:filename" priority="1000" mode="M452">
...
<!--PATTERN win-def_fap53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:object" priority="1001" mode="M453">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:state" priority="1000" mode="M453">
...
<!--PATTERN win-def_fileauditedpermissions53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object//oval-def:filter" priority="1000" mode="M454"><axsl:variable name="parent_object" select="ancestor::win-def:fileauditedpermissions53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fap53objfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filepath" priority="1000" mode="M455">
...
<!--PATTERN win-def_fap53objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M456">
...
<!--PATTERN win-def_fap53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M457">
...
<!--PATTERN win-def_fap53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filename" priority="1000" mode="M458">
...
<!--PATTERN win-def_fap53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:filename" priority="1000" mode="M459">
...
<!--PATTERN win-def_fap53_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M460">
...
<!--PATTERN win-def_fap53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M461">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileauditedpermissions53_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M461"/></axsl:template><axsl:template match="text()" priority="-1" mode="M461"/><axsl:template match="@*|node()" priority="-2" mode="M461"><axsl:apply-templates select="@*|*" mode="M461"/></axsl:template>

<!--PATTERN win-def_faptst_dep-->


	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test" priority="1000" mode="M462">
...
<!--PATTERN win-def_faptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:object" priority="1001" mode="M463">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:state" priority="1000" mode="M463">
...
<!--PATTERN win-def_fapobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object" priority="1000" mode="M464">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M464"/></axsl:template><axsl:template match="text()" priority="-1" mode="M464"/><axsl:template match="@*|node()" priority="-2" mode="M464"><axsl:apply-templates select="@*|*" mode="M464"/></axsl:template>

<!--PATTERN win-def_fapobjfilename-->


	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object/win-def:filename" priority="1000" mode="M465">
...
<!--PATTERN win-def_fapste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state" priority="1000" mode="M466">
...
<!--PATTERN win-def_fapstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:filename" priority="1000" mode="M467">
...
<!--PATTERN win-def_fap_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/win-def:behaviors" priority="1000" mode="M468">
...
<!--PATTERN win-def_fap_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/win-def:behaviors" priority="1000" mode="M469">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileauditedpermissions_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M469"/></axsl:template><axsl:template match="text()" priority="-1" mode="M469"/><axsl:template match="@*|node()" priority="-2" mode="M469"><axsl:apply-templates select="@*|*" mode="M469"/></axsl:template>

<!--PATTERN win-def_fer53tst-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_test/win-def:object" priority="1001" mode="M470">
...
<!--PATTERN win-def_fileeffectiverights53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object//oval-def:filter" priority="1000" mode="M471"><axsl:variable name="parent_object" select="ancestor::win-def:fileeffectiverights53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fer53objfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filepath" priority="1000" mode="M472">
...
<!--PATTERN win-def_fer53objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M473">
...
<!--PATTERN win-def_fer53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M474">
...
<!--PATTERN win-def_fer53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filename" priority="1000" mode="M475">
...
<!--PATTERN win-def_fer53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:filename" priority="1000" mode="M476">
...
<!--PATTERN win-def_ffr53_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights53_object/win-def:behaviors" priority="1000" mode="M477">
...
<!--PATTERN win-def_ffr53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights53_object/win-def:behaviors" priority="1000" mode="M478">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileeffectiverights53_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M478"/></axsl:template><axsl:template match="text()" priority="-1" mode="M478"/><axsl:template match="@*|node()" priority="-2" mode="M478"><axsl:apply-templates select="@*|*" mode="M478"/></axsl:template>

<!--PATTERN win-def_fertst_dep-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test" priority="1000" mode="M479">
...
<!--PATTERN win-def_fertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:object" priority="1001" mode="M480">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:state" priority="1000" mode="M480">
...
<!--PATTERN win-def_ferobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object" priority="1000" mode="M481">
...
<!--PATTERN win-def_fefobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object/win-def:filename" priority="1000" mode="M482">
...
<!--PATTERN win-def_ferste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state" priority="1000" mode="M483">
...
<!--PATTERN win-def_ferstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:filename" priority="1000" mode="M484">
...
<!--PATTERN win-def_ffr_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/win-def:behaviors" priority="1000" mode="M485">
...
<!--PATTERN win-def_ffr_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/win-def:behaviors" priority="1000" mode="M486">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileeffectiverights_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M486"/></axsl:template><axsl:template match="text()" priority="-1" mode="M486"/><axsl:template match="@*|node()" priority="-2" mode="M486"><axsl:apply-templates select="@*|*" mode="M486"/></axsl:template>

<!--PATTERN win-def_grouptst_dep-->


	<!--RULE -->
<axsl:template match="win-def:group_test" priority="1000" mode="M487">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M487"/></axsl:template><axsl:template match="text()" priority="-1" mode="M487"/><axsl:template match="@*|node()" priority="-2" mode="M487"><axsl:apply-templates select="@*|*" mode="M487"/></axsl:template>

<!--PATTERN win-def_grouptst-->


	<!--RULE -->
<axsl:template match="win-def:group_test/win-def:object" priority="1001" mode="M488">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:group_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:group_test/win-def:state" priority="1000" mode="M488">
...
<!--PATTERN win-def_groupobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_object" priority="1000" mode="M489">
...
<!--PATTERN win-def_group_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_object//oval-def:filter" priority="1000" mode="M490"><axsl:variable name="parent_object" select="ancestor::win-def:group_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_groupste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_state" priority="1000" mode="M491">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M491"/></axsl:template><axsl:template match="text()" priority="-1" mode="M491"/><axsl:template match="@*|node()" priority="-2" mode="M491"><axsl:apply-templates select="@*|*" mode="M491"/></axsl:template>

<!--PATTERN win-def_groupsidtst-->


	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:object" priority="1001" mode="M492">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:group_sid_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a group_sid_test must reference a group_sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M492"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:state" priority="1000" mode="M492">
...
<!--PATTERN win-def_group_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_object//oval-def:filter" priority="1000" mode="M493"><axsl:variable name="parent_object" select="ancestor::win-def:group_sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wininterfacetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_test/win-def:object" priority="1001" mode="M494">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:interface_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an interface_test must reference an interface_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M494"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:interface_test/win-def:state" priority="1000" mode="M494">
...
<!--PATTERN win-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_object//oval-def:filter" priority="1000" mode="M495"><axsl:variable name="parent_object" select="ancestor::win-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_lptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_test/win-def:object" priority="1001" mode="M496">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:lockoutpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_test/win-def:state" priority="1000" mode="M496">
...
<!--PATTERN win-def_metabasetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_test/win-def:object" priority="1001" mode="M497">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:metabase_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_test/win-def:state" priority="1000" mode="M497">
...
<!--PATTERN win-def_metabase_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_object//oval-def:filter" priority="1000" mode="M498"><axsl:variable name="parent_object" select="ancestor::win-def:metabase_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_ntusertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_test/win-def:object" priority="1001" mode="M499">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:ntuser_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_test/win-def:state" priority="1000" mode="M499">
...
<!--PATTERN win-def_ntuser_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_object//oval-def:filter" priority="1000" mode="M500"><axsl:variable name="parent_object" select="ancestor::win-def:ntuser_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_ntuserobjkey2-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M501">
...
<!--PATTERN win-def_pptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_test/win-def:object" priority="1001" mode="M502">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:passwordpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_test/win-def:state" priority="1000" mode="M502">
...
<!--PATTERN win-def_peheaderobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filepath" priority="1000" mode="M503">
...
<!--PATTERN win-def_peheaderobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M504">
...
<!--PATTERN win-def_peheaderobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M505">
...
<!--PATTERN win-def_peheaderobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filename" priority="1000" mode="M506">
...
<!--PATTERN win-def_peheaderstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_state/win-def:filename" priority="1000" mode="M507">
...
<!--PATTERN win-def_winporttst-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_test/win-def:object" priority="1001" mode="M508">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:port_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:port_test/win-def:state" priority="1000" mode="M508">
...
<!--PATTERN win-def_port_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_object//oval-def:filter" priority="1000" mode="M509"><axsl:variable name="parent_object" select="ancestor::win-def:port_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_pertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_test/win-def:object" priority="1001" mode="M510">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:printereffectiverights_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_test/win-def:state" priority="1000" mode="M510">
...
<!--PATTERN win-def_printereffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_object//oval-def:filter" priority="1000" mode="M511"><axsl:variable name="parent_object" select="ancestor::win-def:printereffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_pef_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:printereffectiverights_object/win-def:behaviors" priority="1000" mode="M512">
...
<!--PATTERN win-def_pef_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:printereffectiverights_object/win-def:behaviors" priority="1000" mode="M513">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: printereffectiverights_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M513"/></axsl:template><axsl:template match="text()" priority="-1" mode="M513"/><axsl:template match="@*|node()" priority="-2" mode="M513"><axsl:apply-templates select="@*|*" mode="M513"/></axsl:template>

<!--PATTERN win-def_processtst_dep-->


	<!--RULE -->
<axsl:template match="win-def:process_test" priority="1000" mode="M514">
...
<!--PATTERN win-def_processtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:object" priority="1001" mode="M515">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:process_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process_test must reference a process_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M515"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:state" priority="1000" mode="M515">
...
<!--PATTERN win-def_processobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_object" priority="1000" mode="M516">
...
<!--PATTERN win-def_processste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state" priority="1000" mode="M517">
...
<!--PATTERN win-def_process58tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:process58_test/win-def:object" priority="1001" mode="M518">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:process58_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process58_test must reference a process58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M518"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:process58_test/win-def:state" priority="1000" mode="M518">
...
<!--PATTERN win-def_process58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:process58_object//oval-def:filter" priority="1000" mode="M519"><axsl:variable name="parent_object" select="ancestor::win-def:process58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_test/win-def:object" priority="1001" mode="M520">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:registry_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a registry_test must reference a registry_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M520"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:registry_test/win-def:state" priority="1000" mode="M520">
...
<!--PATTERN win-def_registry_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object//oval-def:filter" priority="1000" mode="M521"><axsl:variable name="parent_object" select="ancestor::win-def:registry_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regobjkey2-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M522">
...
<!--PATTERN win-def_rap53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_test/win-def:object" priority="1001" mode="M523">
...
<!--PATTERN win-def_regkeyauditedpermissions53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object//oval-def:filter" priority="1000" mode="M524"><axsl:variable name="parent_object" select="ancestor::win-def:regkeyauditedpermissions53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regkeyauditedpermissions53_objectkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M525">
...
<!--PATTERN win-def_rap53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_synchronize" priority="1000" mode="M526">
...
<!--PATTERN win-def_rka53_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M527">
...
<!--PATTERN win-def_rka53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M528">
...
<!--PATTERN win-def_raptst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test" priority="1000" mode="M529">
...
<!--PATTERN win-def_raptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test/win-def:object" priority="1001" mode="M530">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test/win-def:state" priority="1000" mode="M530">
...
<!--PATTERN win-def_rapobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object" priority="1000" mode="M531">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M531"/></axsl:template><axsl:template match="text()" priority="-1" mode="M531"/><axsl:template match="@*|node()" priority="-2" mode="M531"><axsl:apply-templates select="@*|*" mode="M531"/></axsl:template>

<!--PATTERN win-def_regkeyauditedpermissions_objectkey-->


	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M532">
...
<!--PATTERN win-def_rapste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state" priority="1000" mode="M533">
...
<!--PATTERN win-def_rka_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions_object/win-def:behaviors" priority="1000" mode="M534">
...
<!--PATTERN win-def_rka_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions_object/win-def:behaviors" priority="1000" mode="M535">
...
<!--PATTERN win-def_rer53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_test/win-def:object" priority="1001" mode="M536">
...
<!--PATTERN win-def_regkeyeffectiverights53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object//oval-def:filter" priority="1000" mode="M537"><axsl:variable name="parent_object" select="ancestor::win-def:regkeyeffectiverights53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regkeyeffectiverights53_objectkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M538">
...
<!--PATTERN win-def_rer53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_synchronize" priority="1000" mode="M539">
...
<!--PATTERN win-def_rke53_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights53_object/win-def:behaviors" priority="1000" mode="M540">
...
<!--PATTERN win-def_rke53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights53_object/win-def:behaviors" priority="1000" mode="M541">
...
<!--PATTERN win-def_rertst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test" priority="1000" mode="M542">
...
<!--PATTERN win-def_rertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test/win-def:object" priority="1001" mode="M543">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test/win-def:state" priority="1000" mode="M543">
...
<!--PATTERN win-def_rerobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object" priority="1000" mode="M544">
...
<!--PATTERN win-def_regkeyeffectiverights_objectkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M545">
...
<!--PATTERN win-def_rerste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state" priority="1000" mode="M546">
...
<!--PATTERN win-def_rke_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights_object/win-def:behaviors" priority="1000" mode="M547">

		<!--REPORT -->
<axsl:if test="@include_group">DEPRECATED BEHAVIOR IN: win-def:regkeyeffectiverights_object<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M547"/></axsl:template><axsl:template match="text()" priority="-1" mode="M547"/><axsl:template match="@*|node()" priority="-2" mode="M547"><axsl:apply-templates select="@*|*" mode="M547"/></axsl:template>

<!--PATTERN win-def_rke_resolve_group_value_dep-->


	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights_object/win-def:behaviors" priority="1000" mode="M548">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: regkeyeffectiverights_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M548"/></axsl:template><axsl:template match="text()" priority="-1" mode="M548"/><axsl:template match="@*|node()" priority="-2" mode="M548"><axsl:apply-templates select="@*|*" mode="M548"/></axsl:template>

<!--PATTERN win-def_servicetst-->


	<!--RULE -->
<axsl:template match="win-def:service_test/win-def:object" priority="1001" mode="M549">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:service_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:service_test/win-def:state" priority="1000" mode="M549">
...
<!--PATTERN win-def_service_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:service_object//oval-def:filter" priority="1000" mode="M550"><axsl:variable name="parent_object" select="ancestor::win-def:service_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_svcertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:serviceeffectiverights_test/win-def:object" priority="1001" mode="M551">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:serviceeffectiverights_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:serviceeffectiverights_test/win-def:state" priority="1000" mode="M551">
...
<!--PATTERN win-def_serviceeffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:serviceeffectiverights_object//oval-def:filter" priority="1000" mode="M552"><axsl:variable name="parent_object" select="ancestor::win-def:serviceeffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_srtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:object" priority="1001" mode="M553">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sharedresource_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sharedresource_test must reference a sharedresource_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M553"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:state" priority="1000" mode="M553">
...
<!--PATTERN win-def_sharedresource_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_object//oval-def:filter" priority="1000" mode="M554"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresource_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sraptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_test/win-def:object" priority="1001" mode="M555">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceauditedpermissions_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_test/win-def:state" priority="1000" mode="M555">
...
<!--PATTERN win-def_sharedresourceauditedpermissions_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_object//oval-def:filter" priority="1000" mode="M556"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresourceauditedpermissions_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sra_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceauditedpermissions_object/win-def:behaviors" priority="1000" mode="M557">
...
<!--PATTERN win-def_srertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceeffectiverights_test/win-def:object" priority="1001" mode="M558">
...
<!--PATTERN win-def_sharedresourceeffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceeffectiverights_object//oval-def:filter" priority="1000" mode="M559"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresourceeffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sre_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceeffectiverights_object/win-def:behaviors" priority="1000" mode="M560">
...
<!--PATTERN win-def_sidtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:object" priority="1001" mode="M561">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sid_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:state" priority="1000" mode="M561">
...
<!--PATTERN win-def_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_object//oval-def:filter" priority="1000" mode="M562"><axsl:variable name="parent_object" select="ancestor::win-def:sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sidsidtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_test/win-def:object" priority="1001" mode="M563">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sid_sid_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_test/win-def:state" priority="1000" mode="M563">
...
<!--PATTERN win-def_sid_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_object//oval-def:filter" priority="1000" mode="M564"><axsl:variable name="parent_object" select="ancestor::win-def:sid_sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_uactst-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_test/win-def:object" priority="1001" mode="M565">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:uac_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:uac_test/win-def:state" priority="1000" mode="M565">
...
<!--PATTERN win-def_usertst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_test" priority="1000" mode="M566">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M566"/></axsl:template><axsl:template match="text()" priority="-1" mode="M566"/><axsl:template match="@*|node()" priority="-2" mode="M566"><axsl:apply-templates select="@*|*" mode="M566"/></axsl:template>

<!--PATTERN win-def_usertst-->


	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:object" priority="1001" mode="M567">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_test must reference a user_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M567"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:state" priority="1000" mode="M567">
...
<!--PATTERN win-def_userobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_object" priority="1000" mode="M568">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M568"/></axsl:template><axsl:template match="text()" priority="-1" mode="M568"/><axsl:template match="@*|node()" priority="-2" mode="M568"><axsl:apply-templates select="@*|*" mode="M568"/></axsl:template>

<!--PATTERN win-def_user_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="win-def:user_object//oval-def:filter" priority="1000" mode="M569"><axsl:variable name="parent_object" select="ancestor::win-def:user_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_userste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_state" priority="1000" mode="M570">
...
<!--PATTERN win-def_usersid55tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:object" priority="1001" mode="M571">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_sid55_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:state" priority="1000" mode="M571">
...
<!--PATTERN win-def_user_sid55_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid55_object//oval-def:filter" priority="1000" mode="M572"><axsl:variable name="parent_object" select="ancestor::win-def:user_sid55_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_usersidtst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_test" priority="1000" mode="M573">
...
<!--PATTERN win-def_usersidtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:object" priority="1001" mode="M574">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_sid_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:state" priority="1000" mode="M574">
...
<!--PATTERN win-def_usersidobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_object" priority="1000" mode="M575">
...
<!--PATTERN win-def_usersidste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_state" priority="1000" mode="M576">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
         <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M576"/></axsl:template><axsl:template match="text()" priority="-1" mode="M576"/><axsl:template match="@*|node()" priority="-2" mode="M576"><axsl:apply-templates select="@*|*" mode="M576"/></axsl:template>

<!--PATTERN win-def_userrighttst-->


	<!--RULE -->
<axsl:template match="win-def:userright_test/win-def:object" priority="1001" mode="M577">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:userright_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a userright_test must reference a userright_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M577"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:userright_test/win-def:state" priority="1000" mode="M577">
...
<!--PATTERN win-def_userright_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:userright_object//oval-def:filter" priority="1000" mode="M578"><axsl:variable name="parent_object" select="ancestor::win-def:userright_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_volumetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:volume_test/win-def:object" priority="1001" mode="M579">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:volume_object/@id"/><axsl:otherwise>
            <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a volume_test must reference a volume_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M579"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:volume_test/win-def:state" priority="1000" mode="M579">
...
<!--PATTERN win-def_volume_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:volume_object//oval-def:filter" priority="1000" mode="M580"><axsl:variable name="parent_object" select="ancestor::win-def:volume_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wmitst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_test" priority="1000" mode="M581">
...
<!--PATTERN win-def_wmitst-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:object" priority="1001" mode="M582">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wmi_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:state" priority="1000" mode="M582">
...
<!--PATTERN win-def_wmiobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_object" priority="1000" mode="M583">
...
<!--PATTERN win-def_wmiobjnamespace-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:namespace" priority="1000" mode="M584">
...
<!--PATTERN win-def_wmiobjwql-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:wql" priority="1000" mode="M585">
...
<!--PATTERN win-def_wmiste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_state" priority="1000" mode="M586">
...
<!--PATTERN win-def_wmi57tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_test/win-def:object" priority="1001" mode="M587">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wmi57_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_test/win-def:state" priority="1000" mode="M587">
...
<!--PATTERN win-def_wmi57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object//oval-def:filter" priority="1000" mode="M588"><axsl:variable name="parent_object" select="ancestor::win-def:wmi57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wmi57objnamespace-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object/win-def:namespace" priority="1000" mode="M589">
...
<!--PATTERN win-def_wmi57objwql-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object/win-def:wql" priority="1000" mode="M590">
...
<!--PATTERN win-def_wmi57steresult-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_state/win-def:result" priority="1000" mode="M591">
...
<!--PATTERN win-def_wuaupdatesearchertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:object" priority="1001" mode="M592">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wuaupdatesearcher_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:state" priority="1000" mode="M592">
...
<!--PATTERN win-def_wuaupdatesearcher_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_object//oval-def:filter" priority="1000" mode="M593"><axsl:variable name="parent_object" select="ancestor::win-def:wuaupdatesearcher_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wuaupdatesearcherobjsearchcriteria-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_object/win-def:search_criteria" priority="1000" mode="M594">
...
<!--PATTERN win-def_ssr_stype_special_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/win-def:sharedresource_state/win-def:shared_type" priority="1000" mode="M595">
...
<!--PATTERN win-def_ssr_stype_temporary_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/win-def:sharedresource_state/win-def:shared_type" priority="1000" mode="M596">

		<!--REPORT -->
<axsl:if test=".='STYPE_TEMPORARY'">
                                                            DEPRECATED ELEMENT VALUE IN: sharedresource_state ELEMENT VALUE: <axsl:text/><axsl:value-of select="."/><axsl:text/>
                                                      <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M596"/></axsl:template><axsl:template match="text()" priority="-1" mode="M596"/><axsl:template match="@*|node()" priority="-2" mode="M596"><axsl:apply-templates select="@*|*" mode="M596"/></axsl:template></axsl:stylesheet>
