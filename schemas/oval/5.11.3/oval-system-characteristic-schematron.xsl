...
<!--PATTERN oval-sc_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*|oval-sc:system_data/*/*/*" priority="1001" mode="M19">
...
<axsl:choose><axsl:when test="not(@status) or @status='exists' or .=''"/><axsl:otherwise>Warning: item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a value for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity should only be supplied if the status attribute is 'exists'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M19"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']|oval-sc:system_data/*/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']" priority="1000" mode="M19">
...
<!--PATTERN oval_schema_version_one_core_element-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator" priority="1000" mode="M20">
...
<!--PATTERN oval_schema_version_empty_platform-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M21">
...
<!--PATTERN oval_schema_version_core_matches_platforms-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M22"><axsl:variable name="core_version_portion" select="parent::oval-def:generator/oval:schema_version[not(@platform)]"/>
...
<!--PATTERN oval_none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M23">
...
<!--PATTERN apache-sc_httpd_item_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item" priority="1000" mode="M24">
...
<!--PATTERN catos-sc_versionitemcatos_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_major_release" priority="1000" mode="M25">
...
<!--PATTERN catos-sc_versionitemcatos_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_individual_release" priority="1000" mode="M26">
...
<!--PATTERN catos-sc_versionitemcatos_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_version_id" priority="1000" mode="M27">
...
<!--PATTERN esx-sc_patchitempatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:patch_number" priority="1000" mode="M28">
...
<!--PATTERN ind-sc_filehash_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item" priority="1000" mode="M29">
...
<!--PATTERN ind-sc_environmentvariable_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:environmentvariable_item" priority="1000" mode="M30">
...
<!--PATTERN ind-sc_ldap57_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap57_item" priority="1000" mode="M31">
...
<!--PATTERN ind-sc_ldap57_itemvalue-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap57_item/ind-sc:value" priority="1000" mode="M32">
...
<!--PATTERN ind-sc_sql_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item" priority="1000" mode="M33">
...
<!--PATTERN ind-sc_sql57_itemresult-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql57_item/ind-sc:result" priority="1000" mode="M34">
...
<!--PATTERN win-sc_tfc_i-->
	...
	<!--RULE -->
<axsl:template match="win-sc:textfilecontent_item/win-sc:instance" priority="1000" mode="M35">
...
<!--PATTERN ind-sc_txtitemline-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:line" priority="1000" mode="M36">
...
<!--PATTERN ind-sc_ldaptype_timestamp_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap_item/ind-sc:ldaptype|oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap57_item/ind-sc:ldaptype" priority="1000" mode="M37">
...
<!--PATTERN ind-sc_ldaptype_email_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap_item/ind-sc:ldaptype|oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap57_item/ind-sc:ldaptype" priority="1000" mode="M38">
...
<!--PATTERN ios-sc_interfaceitemnoipdbc-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:no_ip_directed_broadcast_command" priority="1000" mode="M39">
...
<!--PATTERN ios-sc_interfaceitem_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:urpf_command" priority="1000" mode="M40">
...
<!--PATTERN ios-sc_versionitemmajor_release-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:major_release" priority="1000" mode="M41">
...
<!--PATTERN ios-sc_versionitemtrain_number-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:train_number" priority="1000" mode="M42">
...
<!--PATTERN linux-sc_dpkginfoitemevrstring_id-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:evr" priority="1000" mode="M43">
...
<!--PATTERN linux-sc_rpmverify_item_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverify_item" priority="1000" mode="M44">
...
<!--PATTERN linux-sc_rpmverifypackage_dicp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverifypackage_item/linux-sc:digest_check_passed" priority="1000" mode="M45">
...
<!--PATTERN linux-sc_rpmverifypackage_sigcp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverifypackage_item/linux-sc:signature_check_passed" priority="1000" mode="M46">
...
<!--PATTERN macos-sc_inetlisteningserveritem_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item" priority="1000" mode="M47">
...
<!--PATTERN macos-sc_plistitem_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:plist_item" priority="1000" mode="M48">
...
<!--PATTERN macos-sc_pwpolicy_item_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item" priority="1000" mode="M49">
...
<!--PATTERN sp-sc_spjobdefinition_item_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item" priority="1000" mode="M50">
...
<!--PATTERN unix-sc_file_gid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:group_id" priority="1000" mode="M51">
...
<!--PATTERN unix-sc_file_uid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:user_id" priority="1000" mode="M52">
...
<!--PATTERN unix-sc_processitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item" priority="1000" mode="M53">
...
<!--PATTERN unix-sc_sccsitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item" priority="1000" mode="M54">
...
<!--PATTERN win-sc_accesstoken_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item" priority="1000" mode="M55">
...
<!--PATTERN win-sc_activedirectory57_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item" priority="1000" mode="M56">
...
<!--PATTERN win-sc_activedirectory57_itemvalue-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item/win-sc:value" priority="1000" mode="M57">
...
<!--PATTERN win-sc_auditeventpolicysubcategoriesitemkerberos_ticket_events-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:kerberos_ticket_events" priority="1000" mode="M58">
...
<!--PATTERN win-sc_cmdletitemparameters-->
	...
	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:parameters" priority="1000" mode="M59">
...
<!--PATTERN win-sc_cmdletitemselect-->
	...
	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:select" priority="1000" mode="M60">
...
<!--PATTERN win-sc_cmdletitemvalue-->
	...
	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:value" priority="1000" mode="M61">
...
<!--PATTERN win-sc_fileaudititemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M62">
...
<!--PATTERN win-sc_feritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M63">
...
<!--PATTERN win-sc_group_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:group_item" priority="1000" mode="M64">
...
<!--PATTERN win-sc_lpi_fl-->
	...
	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:force_logoff" priority="1000" mode="M65">
...
<!--PATTERN win-sc_lpi_ld-->
	...
	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:lockout_duration" priority="1000" mode="M66">
...
<!--PATTERN win-sc_pwp_mpa-->
	...
	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:max_passwd_age" priority="1000" mode="M67">
...
<!--PATTERN win-sc_rapitemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M68">
...
<!--PATTERN win-sc_rapitemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M69">
...
<!--PATTERN win-sc_reritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M70">
...
<!--PATTERN win-sc_reritemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M71">
...
<!--PATTERN win-sc_user_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:user_item" priority="1000" mode="M72">
...
<!--PATTERN win-sc_wmi_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi_item" priority="1000" mode="M73">
...
<!--PATTERN win-sc_wmi57_itemresult-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi57_item/win-sc:result" priority="1000" mode="M74">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='record'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the result entity of a wmi57_item must be 'record'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M74"/></axsl:template><axsl:template match="text()" priority="-1" mode="M74"/><axsl:template match="@*|node()" priority="-2" mode="M74"><axsl:apply-templates select="@*|*" mode="M74"/></axsl:template></axsl:stylesheet>
