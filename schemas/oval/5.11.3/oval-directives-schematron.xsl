...
<!--PATTERN oval_schema_version_one_core_element-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator" priority="1000" mode="M42">
...
<!--PATTERN oval_schema_version_empty_platform-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M43">
...
<!--PATTERN oval_schema_version_core_matches_platforms-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:generator/oval:schema_version[@platform]" priority="1000" mode="M44"><axsl:variable name="core_version_portion" select="parent::oval-def:generator/oval:schema_version[not(@platform)]"/>
...
<!--PATTERN oval_none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M45">
...
<!--PATTERN oval-res_directives_include_oval_definitions-->
	...
	<!--RULE -->
<axsl:template match="oval-res:oval_results/oval-res:directives[@include_source_definitions='true' or @include_source_definitions='1' or not(@include_source_definitions)]" priority="1001" mode="M46">
...
<axsl:choose><axsl:when test="ancestor::oval-res:oval_results[oval-def:oval_definitions]"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:oval_results/oval-res:directives[@include_source_definitions='false' or @include_source_definitions='0']" priority="1000" mode="M46">
...
<!--PATTERN oval-res_system-->
	...
	<!--RULE -->
<axsl:template match="oval-res:system[oval-res:tests]" priority="1001" mode="M47">
...
<axsl:choose><axsl:when test="/oval-res:oval_results/oval-res:directives/*[@reported='true' or @reported='1']/@content='full'                                                 or /oval-res:oval_results/oval-res:directives/*[(@reported='true' or @reported='1') and not(@content)]                                                 or /oval-res:oval_results/oval-res:class_directives/*[@reported='true' or @reported='1']/@content='full'                                                 or /oval-res:oval_results/oval-res:class_directives/*[(@reported='true' or @reported='1') and not(@content)]"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:system[not(oval-res:tests)]" priority="1000" mode="M47">
...
<!--PATTERN oval-res_mask_rule-->
	...
	<!--RULE -->
<axsl:template match="/oval-res:oval_results/oval-res:results/oval-res:system/oval-sc:oval_system_characteristics/oval-sc:system_data/*/*|/oval-res:oval_results/oval-res:results/oval-res:system/oval-sc:oval_system_characteristics/oval-sc:system_data/*/*/*" priority="1000" mode="M48">
...
<!--PATTERN oval-res_directives-->
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='true' and oval-res:criteria]" priority="1011" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_true/@content='full')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_true/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='true' and not(oval-res:criteria)]" priority="1010" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_true/@content='thin')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_true/@content='thin')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='false' and oval-res:criteria]" priority="1009" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_false/@content='full')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_false/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='false' and not(oval-res:criteria)]" priority="1008" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_false/@content='thin')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_false/@content='thin')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='unknown' and oval-res:criteria]" priority="1007" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_unknown/@content='full')                                    and not(oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_unknown/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='unknown' and not(oval-res:criteria)]" priority="1006" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_unknown/@content='thin')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_unknown/@content='thin')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='error' and oval-res:criteria]" priority="1005" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_error/@content='full')                                    and not(oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_error/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='error' and not(oval-res:criteria)]" priority="1004" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_error/@content='thin')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_error/@content='thin')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='not evaluated' and oval-res:criteria]" priority="1003" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_not_evaluated/@content='full')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_not_evaluated/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='not evaluated' and not(oval-res:criteria)]" priority="1002" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_not_evaluated/@content='thin')                                    and not(/oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_not_evaluated/@content='thin')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='not applicable' and oval-res:criteria]" priority="1001" mode="M49">
...
<axsl:choose><axsl:when test="((/oval-res:oval_results/oval-res:directives/oval-res:definition_not_applicable/@content='full')                                    and not(oval-res:oval_results/oval-res:class_directives[@class = ./@class]))                                    or (/oval-res:oval_results/oval-res:class_directives[@class = ./@class]/oval-res:definition_not_applicable/@content='full')"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-res:definition[@result='not applicable' and not(oval-res:criteria)]" priority="1000" mode="M49">
...
<!--PATTERN oval-res_testids-->
	...
	<!--RULE -->
<axsl:template match="oval-res:test" priority="1000" mode="M50">
...
<!--PATTERN oval-def_empty_def_doc-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions" priority="1000" mode="M51">
...
<!--PATTERN oval_def_notes_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:notes" priority="1000" mode="M52">
...
<!--PATTERN oval-def_required_criteria-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:definitions/oval-def:definition[(@deprecated='false' or @deprecated='0') or not(@deprecated)]" priority="1000" mode="M53">
...
<!--PATTERN oval-def_test_type-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:tests/*[@check_existence='none_exist']" priority="1000" mode="M54">
...
<!--PATTERN oval-def_setobjref-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:object_reference" priority="1002" mode="M55">
...
<axsl:choose><axsl:when test="name(./../..) = name(ancestor::oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise><axsl:text/><axsl:value-of select="../../@id"/><axsl:text/> - Each object referenced by the set must be of the same type as parent object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M55"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:object_reference" priority="1001" mode="M55">

		<!--ASSERT -->
<axsl:choose><axsl:when test="name(./../../..) = name(ancestor::oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise><axsl:text/><axsl:value-of select="../../../@id"/><axsl:text/> - Each object referenced by the set must be of the same type as parent object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M55"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:set/oval-def:object_reference" priority="1000" mode="M55">
...
<!--PATTERN oval-def_literal_component-->
	...
	<!--RULE -->
<axsl:template match="oval-def:literal_component" priority="1000" mode="M56">
...
<!--PATTERN oval-def_arithmeticfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:literal_component" priority="1001" mode="M57">
...
<axsl:choose><axsl:when test="@datatype='float' or @datatype='int'"/><axsl:otherwise>A literal_component used by an arithmetic function must have a datatype of float or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M57"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:variable_component" priority="1000" mode="M57"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_beginfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:literal_component" priority="1001" mode="M58">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the begin function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M58"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:variable_component" priority="1000" mode="M58"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_concatfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:literal_component" priority="1001" mode="M59">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the concat function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M59"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:variable_component" priority="1000" mode="M59"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_endfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:literal_component" priority="1001" mode="M60">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the end function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M60"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:variable_component" priority="1000" mode="M60"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_escaperegexfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:literal_component" priority="1001" mode="M61">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the escape_regex function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M61"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:variable_component" priority="1000" mode="M61"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_splitfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:literal_component" priority="1001" mode="M62">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the split function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M62"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:variable_component" priority="1000" mode="M62"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_substringfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:literal_component" priority="1001" mode="M63">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the substring function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M63"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:variable_component" priority="1000" mode="M63"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_timedifferencefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:literal_component" priority="1001" mode="M64">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string' or @datatype='int'"/><axsl:otherwise>A literal_component used by the time_difference function must have a datatype of string or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M64"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:variable_component" priority="1000" mode="M64"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_regexcapturefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:literal_component" priority="1001" mode="M65">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the regex_capture function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M65"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:variable_component" priority="1000" mode="M65"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_globtoregexfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:glob_to_regex/oval-def:literal_component" priority="1001" mode="M66">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the glob_to_regex function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M66"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:glob_to_regex/oval-def:variable_component" priority="1000" mode="M66"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN oval-def_definition_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]|oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1018" mode="M67"><axsl:variable name="var_ref" select="@var_ref"/>
...
<axsl:choose><axsl:when test="( (not(@datatype)) and ('string' = ancestor::oval-def:oval_definitions/oval-def:variables/*[@id=$var_ref]/@datatype) ) or (@datatype = ancestor::oval-def:oval_definitions/oval-def:variables/*[@id=$var_ref]/@datatype)"/><axsl:otherwise><axsl:text/><axsl:value-of select="$var_ref"/><axsl:text/> - inconsistent datatype between the variable and an associated var_ref<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:objects/*/*/*[@var_ref]" priority="1017" mode="M67">

		<!--REPORT -->
<axsl:if test="not(@var_check)"><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a var_ref has been supplied for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity so a var_check should also be provided<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_check]|oval-def:objects/*/*/*[@var_check]" priority="1016" mode="M67">
...
<axsl:choose><axsl:when test="@var_ref"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a var_check has been supplied for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity so a var_ref must also be provided<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:states/*/*[@var_ref]|oval-def:states/*/*/*[@var_ref]" priority="1015" mode="M67">

		<!--REPORT -->
<axsl:if test="not(@var_check)"><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a var_ref has been supplied for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity so a var_check should also be provided<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:states/*/*[@var_check]|oval-def:states/*/*/*[@var_check]" priority="1014" mode="M67">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@var_ref"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a var_check has been supplied for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity so a var_ref must also be provided<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>

	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[not(@datatype)]|oval-def:objects/*/*/*[not(@datatype)]|oval-def:states/*/*[not(@datatype)]|oval-def:states/*/*/*[not(@datatype)]" priority="1013" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given the lack of a declared datatype (hence a default datatype of string).<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='binary']|oval-def:objects/*/*/*[@datatype='binary']|oval-def:states/*/*[@datatype='binary']|oval-def:states/*/*/*[@datatype='binary']" priority="1012" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of binary.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='boolean']|oval-def:objects/*/*/*[@datatype='boolean']|oval-def:states/*/*[@datatype='boolean']|oval-def:states/*/*/*[@datatype='boolean']" priority="1011" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of boolean.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='evr_string']|oval-def:objects/*/*/*[@datatype='evr_string']|oval-def:states/*/*[@datatype='evr_string']|oval-def:states/*/*/*[@datatype='evr_string']" priority="1010" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of evr_string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='debian_evr_string']|oval-def:objects/*/*/*[@datatype='debian_evr_string']|oval-def:states/*/*[@datatype='debian_evr_string']|oval-def:states/*/*/*[@datatype='debian_evr_string']" priority="1009" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of debian_evr_string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='fileset_revision']|oval-def:objects/*/*/*[@datatype='fileset_revision']|oval-def:states/*/*[@datatype='fileset_revision']|oval-def:states/*/*/*[@datatype='fileset_revision']" priority="1008" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of fileset_revision.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='float']|oval-def:objects/*/*/*[@datatype='float']|oval-def:states/*/*[@datatype='float']|oval-def:states/*/*/*[@datatype='float']" priority="1007" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of float.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ios_version']|oval-def:objects/*/*/*[@datatype='ios_version']|oval-def:states/*/*[@datatype='ios_version']|oval-def:states/*/*/*[@datatype='ios_version']" priority="1006" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of ios_version.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='int']|oval-def:objects/*/*/*[@datatype='int']|oval-def:states/*/*[@datatype='int']|oval-def:states/*/*/*[@datatype='int']" priority="1005" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='bitwise and' or @operation='bitwise or'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ipv4_address']|oval-def:objects/*/*/*[@datatype='ipv4_address']|oval-def:states/*/*[@datatype='ipv4_address']|oval-def:states/*/*/*[@datatype='ipv4_address']" priority="1004" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='subset of' or @operation='superset of'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of ipv4_address.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ipv6_address']|oval-def:objects/*/*/*[@datatype='ipv6_address']|oval-def:states/*/*[@datatype='ipv6_address']|oval-def:states/*/*/*[@datatype='ipv6_address']" priority="1003" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='subset of' or @operation='superset of'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of ipv6_address.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='string']|oval-def:objects/*/*/*[@datatype='string']|oval-def:states/*/*[@datatype='string']|oval-def:states/*/*/*[@datatype='string']" priority="1002" mode="M67">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The use of '<axsl:text/><axsl:value-of select="@operation"/><axsl:text/>' for the operation attribute of the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity is not valid given a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M67"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='version']|oval-def:objects/*/*/*[@datatype='version']|oval-def:states/*/*[@datatype='version']|oval-def:states/*/*/*[@datatype='version']" priority="1001" mode="M67">
...
<!--PATTERN oval-def_no_var_ref_with_records-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='record']|oval-def:states/*/*[@datatype='record']" priority="1000" mode="M68">
...
<!--PATTERN oval-def_definition_entity_type_check_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:objects/*/*/*[not(@var_ref) and @datatype='int']|oval-def:states/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and not(@var_ref) and @datatype='int']|oval-def:states/*/*/*[not(@var_ref) and @datatype='int']" priority="1000" mode="M69">
...
<!--PATTERN oval-sc_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*|oval-sc:system_data/*/*/*" priority="1001" mode="M70">
...
<axsl:choose><axsl:when test="not(@status) or @status='exists' or .=''"/><axsl:otherwise>Warning: item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - a value for the <axsl:text/><axsl:value-of select="name()"/><axsl:text/> entity should only be supplied if the status attribute is 'exists'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M70"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']|oval-sc:system_data/*/*/*[not((@xsi:nil='1' or @xsi:nil='true')) and @datatype='int']" priority="1000" mode="M70">
...
<!--PATTERN aix-def_interimfixtst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:interim_fix_test/aix-def:object" priority="1001" mode="M71">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:interim_fix_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a <axsl:text/><axsl:value-of select="name(..)"/><axsl:text/> must reference a interim_fix_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M71"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="aix-def:interim_fix_test/aix-def:state" priority="1000" mode="M71">
...
<!--PATTERN aix-def_filesettst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:object" priority="1001" mode="M73">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:fileset_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileset_test must reference a fileset_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M73"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:state" priority="1000" mode="M73">
...
<!--PATTERN aix-def_fileset_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_object//oval-def:filter" priority="1000" mode="M74"><axsl:variable name="parent_object" select="ancestor::aix-def:fileset_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN aix-def_fix_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_object//oval-def:filter" priority="1000" mode="M76"><axsl:variable name="parent_object" select="ancestor::aix-def:fix_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN aix-def_notst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:no_test/aix-def:object" priority="1001" mode="M77">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:no_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a <axsl:text/><axsl:value-of select="name(..)"/><axsl:text/> must reference a no_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M77"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="aix-def:no_test/aix-def:state" priority="1000" mode="M77">
...
<!--PATTERN aix-def_osleveltst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:object" priority="1001" mode="M78">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/aix-def:oslevel_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a oslevel_test must reference a oslevel_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M78"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:state" priority="1000" mode="M78">
...
<!--PATTERN android-def_appmanager_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="android-def:appmanager_object//oval-def:filter" priority="1000" mode="M80"><axsl:variable name="parent_object" select="ancestor::android-def:appmanager_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN android-def_bluetooth_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:bluetooth_test/android-def:object" priority="1001" mode="M81">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:bluetooth_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an bluetooth_test must reference an bluetooth_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M81"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:bluetooth_test/android-def:state" priority="1000" mode="M81">
...
<!--PATTERN android-def_cmrtst-->
	...
	<!--RULE -->
<axsl:template match="android-def:camera_test/android-def:object" priority="1001" mode="M82">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:camera_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a camera_test must reference a camera_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M82"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:camera_test/android-def:state" priority="1000" mode="M82">
...
<!--PATTERN android-def_certtst-->
	...
	<!--RULE -->
<axsl:template match="android-def:certificate_test/android-def:object" priority="1001" mode="M83">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:certificate_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a certificate_test must reference a certificate_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M83"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:certificate_test/android-def:state" priority="1000" mode="M83">
...
<!--PATTERN android-def_devicesettings_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:devicesettings_test/android-def:object" priority="1001" mode="M84">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:devicesettings_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an devicesettings_test must reference an devicesettings_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M84"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:devicesettings_test/android-def:state" priority="1000" mode="M84">
...
<!--PATTERN android-def_encryptiontst-->
	...
	<!--RULE -->
<axsl:template match="android-def:encryption_test/android-def:object" priority="1001" mode="M85">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:encryption_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a encryption_test must reference a encryption_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M85"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:encryption_test/android-def:state" priority="1000" mode="M85">
...
<!--PATTERN android-def_locationservice_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:locationservice_test/android-def:object" priority="1001" mode="M86">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:locationservice_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an locationservice_test must reference an locationservice_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M86"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:locationservice_test/android-def:state" priority="1000" mode="M86">
...
<!--PATTERN android-def_network_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:network_test/android-def:object" priority="1001" mode="M87">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:network_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an network_test must reference an network_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M87"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:network_test/android-def:state" priority="1000" mode="M87">
...
<!--PATTERN android-def_ptst-->
	...
	<!--RULE -->
<axsl:template match="android-def:password_test/android-def:object" priority="1001" mode="M88">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:password_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a password_test must reference a password_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M88"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:password_test/android-def:state" priority="1000" mode="M88">
...
<!--PATTERN android-def_systemdetails_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:systemdetails_test/android-def:object" priority="1001" mode="M89">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:systemdetails_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of systemdetails_test must reference systemdetails_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M89"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:systemdetails_test/android-def:state" priority="1000" mode="M89">
...
<!--PATTERN android-def_wifi_test-->
	...
	<!--RULE -->
<axsl:template match="android-def:wifi_test/android-def:object" priority="1001" mode="M90">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/android-def:wifi_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an wifi_test must reference an wifi_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M90"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="android-def:wifi_test/android-def:state" priority="1000" mode="M90">
...
<!--PATTERN android-def_wifinetwork_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="android-def:wifinetwork_object//oval-def:filter" priority="1000" mode="M92"><axsl:variable name="parent_object" select="ancestor::android-def:wifinetwork_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN apache-def_httpd_test_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test" priority="1000" mode="M94">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M94"/></axsl:template><axsl:template match="text()" priority="-1" mode="M94"/><axsl:template match="@*|node()" priority="-2" mode="M94"><axsl:apply-templates select="@*|*" mode="M94"/></axsl:template>
...
<!--PATTERN apache-def_httpd_object_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_object" priority="1000" mode="M96">
...
<!--PATTERN apache-def_httpd_state_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_state" priority="1000" mode="M97">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M97"/></axsl:template><axsl:template match="text()" priority="-1" mode="M97"/><axsl:template match="@*|node()" priority="-2" mode="M97"><axsl:apply-templates select="@*|*" mode="M97"/></axsl:template>

<!--PATTERN apple-ios-def_globalrestrictions_test-->


	<!--RULE -->
<axsl:template match="apple-ios-def:globalrestrictions_test/apple-ios-def:object" priority="1001" mode="M98">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/apple-ios-def:globalrestrictions_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a globalrestrictions_test must reference a globalrestrictions_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M98"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:globalrestrictions_test/apple-ios-def:state" priority="1000" mode="M98">
...
<!--PATTERN apple-ios-def_passcodepolicy_test-->
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:passcodepolicy_test/apple-ios-def:object" priority="1001" mode="M99">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/apple-ios-def:passcodepolicy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a passcodepolicy_test must reference a passcodepolicy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M99"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:passcodepolicy_test/apple-ios-def:state" priority="1000" mode="M99">
...
<!--PATTERN apple-ios-def_profile_test-->
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:profile_test/apple-ios-def:object" priority="1001" mode="M100">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/apple-ios-def:profile_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a profile_test must reference a profile_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M100"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:profile_test/apple-ios-def:state" priority="1000" mode="M100">
...
<!--PATTERN apple-ios-def_profile_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="apple-ios-def:profile_object//oval-def:filter" priority="1000" mode="M101"><axsl:variable name="parent_object" select="ancestor::apple-ios-def:profile_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_acltst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:acl_test/asa-def:object" priority="1001" mode="M102">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:acl_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="asa-def:acl_test/asa-def:state" priority="1000" mode="M102">
...
<!--PATTERN asa_acl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:acl_object//oval-def:filter" priority="1000" mode="M103"><axsl:variable name="parent_object" select="ancestor::asa-def:acl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa-class_maptst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:class_map_test/asa-def:object" priority="1001" mode="M104">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:class_map_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an class_map_test must reference an class_map_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M104"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="asa-def:class_map_test/asa-def:state" priority="1000" mode="M104">
...
<!--PATTERN asa_class_map_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:class_map_object//oval-def:filter" priority="1000" mode="M105"><axsl:variable name="parent_object" select="ancestor::asa-def:class_map_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:interface_object//oval-def:filter" priority="1000" mode="M107"><axsl:variable name="parent_object" select="ancestor::asa-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa-def_interfaceste_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="asa-def:interface_state/asa-def:urpf_command" priority="1000" mode="M108">
...
<!--PATTERN asa_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:line_object//oval-def:filter" priority="1000" mode="M110"><axsl:variable name="parent_object" select="ancestor::asa-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa-policy_maptst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:policy_map_test/asa-def:object" priority="1001" mode="M111">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:policy_map_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an policy_map_test must reference an policy_map_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M111"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="asa-def:policy_map_test/asa-def:state" priority="1000" mode="M111">
...
<!--PATTERN asa_policy_map_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:policy_map_object//oval-def:filter" priority="1000" mode="M112"><axsl:variable name="parent_object" select="ancestor::asa-def:policy_map_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa-service_policytst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:service_policy_test/asa-def:object" priority="1001" mode="M113">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:service_policy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an service_policy_test must reference an service_policy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M113"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="asa-def:service_policy_test/asa-def:state" priority="1000" mode="M113">
...
<!--PATTERN asa_service_policy_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:service_policy_object//oval-def:filter" priority="1000" mode="M114"><axsl:variable name="parent_object" select="ancestor::asa-def:service_policy_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_snmp_host_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:snmp_host_object//oval-def:filter" priority="1000" mode="M116"><axsl:variable name="parent_object" select="ancestor::asa-def:snmp_host_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_snmp_user_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:snmp_user_object//oval-def:filter" priority="1000" mode="M118"><axsl:variable name="parent_object" select="ancestor::asa-def:snmp_user_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_grouptst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:snmp_group_test/asa-def:object" priority="1001" mode="M119">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:snmp_group_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an snmp_group_test must reference an snmp_group_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M119"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="asa-def:snmp_group_test/asa-def:state" priority="1000" mode="M119">
...
<!--PATTERN asa_snmp_group_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:snmp_group_object//oval-def:filter" priority="1000" mode="M120"><axsl:variable name="parent_object" select="ancestor::asa-def:snmp_group_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asatst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:tcp_map_test/asa-def:object" priority="1001" mode="M121">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:service_policy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an service_policy_test must reference an service_policy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M121"/></axsl:template>

	<!--RULE -->
<axsl:template match="asa-def:tcp_map_test/asa-def:state" priority="1000" mode="M121">
...
<!--PATTERN asa_tcp_map_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="asa-def:tcp_map_object//oval-def:filter" priority="1000" mode="M122"><axsl:variable name="parent_object" select="ancestor::asa-def:tcp_map_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN asa_vertst-->
	...
	<!--RULE -->
<axsl:template match="asa-def:version_test/asa-def:object" priority="1001" mode="M123">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/asa-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M123"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="asa-def:version_test/asa-def:state" priority="1000" mode="M123">
...
<!--PATTERN catos-def_linetst-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:object" priority="1001" mode="M124">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:line_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a line_test must reference a line_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M124"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:state" priority="1000" mode="M124">
...
<!--PATTERN catos-def_moduletst-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_test/catos-def:object" priority="1001" mode="M126">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:module_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a module_test must reference a module_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M126"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="catos-def:module_test/catos-def:state" priority="1000" mode="M126">
...
<!--PATTERN catos-def_version55_test-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version55_test/catos-def:object" priority="1001" mode="M128">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:version55_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version55_test must reference a version55_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M128"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="catos-def:version55_test/catos-def:state" priority="1000" mode="M128">
...
<!--PATTERN catos-def_version_test_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_test" priority="1000" mode="M129">
...
<!--PATTERN catos-def_version_test-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_test/catos-def:object" priority="1001" mode="M130">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/catos-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M130"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="catos-def:version_test/catos-def:state" priority="1000" mode="M130">
...
<!--PATTERN catos-def_version_object_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_object" priority="1000" mode="M131">
...
<!--PATTERN catos-def_version_state_dep-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state" priority="1000" mode="M132">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M132"/></axsl:template><axsl:template match="text()" priority="-1" mode="M132"/><axsl:template match="@*|node()" priority="-2" mode="M132"><axsl:apply-templates select="@*|*" mode="M132"/></axsl:template>

<!--PATTERN esx-def_patch56tst-->


	<!--RULE -->
<axsl:template match="esx-def:patch56_test/esx-def:object" priority="1001" mode="M133">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:patch56_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a patch56_test must reference a patch56_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M133"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="esx-def:patch56_test/esx-def:state" priority="1000" mode="M133">
...
<!--PATTERN esx-def_patch56_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch56_object//oval-def:filter" priority="1000" mode="M134"><axsl:variable name="parent_object" select="ancestor::esx-def:patch56_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN esx-def_patchtst_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_test" priority="1000" mode="M135">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M135"/></axsl:template><axsl:template match="text()" priority="-1" mode="M135"/><axsl:template match="@*|node()" priority="-2" mode="M135"><axsl:apply-templates select="@*|*" mode="M135"/></axsl:template>

<!--PATTERN esx-def_patchtst-->


	<!--RULE -->
<axsl:template match="esx-def:patch_test/esx-def:object" priority="1001" mode="M136">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:patch_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a patch_test must reference a patch_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M136"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_test/esx-def:state" priority="1000" mode="M136">
...
<!--PATTERN esx-def_patchobj_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_object" priority="1000" mode="M137">
...
<!--PATTERN esx-def_patchste_dep-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_state" priority="1000" mode="M138">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M138"/></axsl:template><axsl:template match="text()" priority="-1" mode="M138"/><axsl:template match="@*|node()" priority="-2" mode="M138"><axsl:apply-templates select="@*|*" mode="M138"/></axsl:template>

<!--PATTERN esx-def_versiontst-->


	<!--RULE -->
<axsl:template match="esx-def:version_test/esx-def:object" priority="1001" mode="M139">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/esx-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M139"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="esx-def:version_test/esx-def:state" priority="1000" mode="M139">
...
<!--PATTERN esx-def_visdkmanagedobject_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="esx-def:visdkmanagedobject_object//oval-def:filter" priority="1000" mode="M141"><axsl:variable name="parent_object" select="ancestor::esx-def:visdkmanagedobject_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN freebsd-def_portinfotst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:object" priority="1001" mode="M142">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/freebsd-def:portinfo_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a portinfo_test must reference an portinfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M142"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:state" priority="1000" mode="M142">
...
<!--PATTERN freebsd-def_portinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_object//oval-def:filter" priority="1000" mode="M143"><axsl:variable name="parent_object" select="ancestor::freebsd-def:portinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_getconf_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_test/hpux-def:object" priority="1001" mode="M144">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:getconf_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an getconf_test must reference an getconf_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M144"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_test/hpux-def:state" priority="1000" mode="M144">
...
<!--PATTERN hpux-def_getconf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_object//oval-def:filter" priority="1000" mode="M145"><axsl:variable name="parent_object" select="ancestor::hpux-def:getconf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_ndd_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:ndd_test/hpux-def:object" priority="1001" mode="M146">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:ndd_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an ndd_test must reference an ndd_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M146"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:ndd_test/hpux-def:state" priority="1000" mode="M146">
...
<!--PATTERN hpux-def_ndd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:ndd_object//oval-def:filter" priority="1000" mode="M147"><axsl:variable name="parent_object" select="ancestor::hpux-def:ndd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_patch53_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_test/hpux-def:object" priority="1001" mode="M148">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:patch53_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an patch53_test must reference an patch53_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M148"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_test/hpux-def:state" priority="1000" mode="M148">
...
<!--PATTERN hpux-def_patch_test_dep-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_test" priority="1000" mode="M150">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M150"/></axsl:template><axsl:template match="text()" priority="-1" mode="M150"/><axsl:template match="@*|node()" priority="-2" mode="M150"><axsl:apply-templates select="@*|*" mode="M150"/></axsl:template>

<!--PATTERN hpux-def_patch_test-->


	<!--RULE -->
<axsl:template match="hpux-def:patch_test/hpux-def:object" priority="1001" mode="M151">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:patch_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an patch_test must reference an patch_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M151"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_test/hpux-def:state" priority="1000" mode="M151">
...
<!--PATTERN hpux-def_patch_object_dep-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_object" priority="1000" mode="M152">
...
<!--PATTERN hpux-def_patch_state_dep-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_state" priority="1000" mode="M153">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M153"/></axsl:template><axsl:template match="text()" priority="-1" mode="M153"/><axsl:template match="@*|node()" priority="-2" mode="M153"><axsl:apply-templates select="@*|*" mode="M153"/></axsl:template>

<!--PATTERN hpux-def_swlist_test-->


	<!--RULE -->
<axsl:template match="hpux-def:swlist_test/hpux-def:object" priority="1001" mode="M154">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:swlist_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an swlist_test must reference an swlist_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M154"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_test/hpux-def:state" priority="1000" mode="M154">
...
<!--PATTERN hpux-def_swlist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_object//oval-def:filter" priority="1000" mode="M155"><axsl:variable name="parent_object" select="ancestor::hpux-def:swlist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN hpux-def_trusted_test-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_test/hpux-def:object" priority="1001" mode="M156">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/hpux-def:trusted_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an trusted_test must reference an trusted_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M156"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_test/hpux-def:state" priority="1000" mode="M156">
...
<!--PATTERN hpux-def_trusted_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_object//oval-def:filter" priority="1000" mode="M157"><axsl:variable name="parent_object" select="ancestor::hpux-def:trusted_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_famtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:object" priority="1001" mode="M158">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:family_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a family_test must reference a family_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M158"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:state" priority="1000" mode="M158">
...
<!--PATTERN ind-def_filehash_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test" priority="1000" mode="M159">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M159"/></axsl:template><axsl:template match="text()" priority="-1" mode="M159"/><axsl:template match="@*|node()" priority="-2" mode="M159"><axsl:apply-templates select="@*|*" mode="M159"/></axsl:template>

<!--PATTERN ind-def_hashtst-->


	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:object" priority="1001" mode="M160">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:filehash_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a filehash_test must reference a filesha1_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M160"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:state" priority="1000" mode="M160">
...
<!--PATTERN ind-def_filehash_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object" priority="1000" mode="M161">
...
<!--PATTERN ind-def_hashobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filepath" priority="1000" mode="M162">
...
<!--PATTERN ind-def_hashobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M163">
...
<!--PATTERN ind-def_hashobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M164">
...
<!--PATTERN ind-def_hashobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filename" priority="1000" mode="M165">
...
<!--PATTERN ind-def_filehash_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state" priority="1000" mode="M166">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M166"/></axsl:template><axsl:template match="text()" priority="-1" mode="M166"/><axsl:template match="@*|node()" priority="-2" mode="M166"><axsl:apply-templates select="@*|*" mode="M166"/></axsl:template>

<!--PATTERN ind-def_filehash58_test-->


	<!--RULE -->
<axsl:template match="ind-def:filehash58_test/ind-def:object" priority="1001" mode="M167">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:filehash58_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a filehash58_test must reference a filehash58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M167"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_test/ind-def:state" priority="1000" mode="M167">
...
<!--PATTERN ind-def_filehash58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object//oval-def:filter" priority="1000" mode="M168"><axsl:variable name="parent_object" select="ancestor::ind-def:filehash58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_hash58objfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filepath" priority="1000" mode="M169">
...
<!--PATTERN ind-def_hash58objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M170">
...
<!--PATTERN ind-def_hash58objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M171">
...
<!--PATTERN ind-def_hash58objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash58_object/ind-def:filename" priority="1000" mode="M172">
...
<!--PATTERN ind-def_environmentvariable_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test" priority="1000" mode="M173">
...
<!--PATTERN ind-def_envtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:object" priority="1001" mode="M174">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:environmentvariable_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an environmentvariable_test must reference a environmentvariable_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M174"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:state" priority="1000" mode="M174">
...
<!--PATTERN ind-def_environmentvariable_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_object" priority="1000" mode="M175">
...
<!--PATTERN ind-def_environmentvariable_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_state" priority="1000" mode="M176">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M176"/></axsl:template><axsl:template match="text()" priority="-1" mode="M176"/><axsl:template match="@*|node()" priority="-2" mode="M176"><axsl:apply-templates select="@*|*" mode="M176"/></axsl:template>

<!--PATTERN ind-def_env58tst-->


	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_test/ind-def:object" priority="1001" mode="M177">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:environmentvariable58_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an environmentvariable58_test must reference a environmentvariable58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M177"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_test/ind-def:state" priority="1000" mode="M177">
...
<!--PATTERN ind-def_environmentvariable58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable58_object//oval-def:filter" priority="1000" mode="M178"><axsl:variable name="parent_object" select="ancestor::ind-def:environmentvariable58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_ldaptst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap_test/ind-def:object" priority="1001" mode="M179">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:ldap_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an ldap_test must reference an ldap_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M179"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap_test/ind-def:state" priority="1000" mode="M179">
...
<!--PATTERN ind-def_ldap57_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_test" priority="1000" mode="M180">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M180"/></axsl:template><axsl:template match="text()" priority="-1" mode="M180"/><axsl:template match="@*|node()" priority="-2" mode="M180"><axsl:apply-templates select="@*|*" mode="M180"/></axsl:template>

<!--PATTERN ind-def_ldap57_test-->


	<!--RULE -->
<axsl:template match="ind-def:ldap57_test/ind-def:object" priority="1001" mode="M181">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:ldap57_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an ldap57_test must reference an ldap57_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M181"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_test/ind-def:state" priority="1000" mode="M181">
...
<!--PATTERN ind-def_ldap57_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_object" priority="1000" mode="M182">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M182"/></axsl:template><axsl:template match="text()" priority="-1" mode="M182"/><axsl:template match="@*|node()" priority="-2" mode="M182"><axsl:apply-templates select="@*|*" mode="M182"/></axsl:template>

<!--PATTERN ind-def_ldap57_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="ind-def:ldap57_object//oval-def:filter" priority="1000" mode="M183"><axsl:variable name="parent_object" select="ancestor::ind-def:ldap57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_ldap57_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:ldap57_state" priority="1000" mode="M184">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M184"/></axsl:template><axsl:template match="text()" priority="-1" mode="M184"/><axsl:template match="@*|node()" priority="-2" mode="M184"><axsl:apply-templates select="@*|*" mode="M184"/></axsl:template>

<!--PATTERN ind-def_ldap57stevalue-->


	<!--RULE -->
<axsl:template match="ind-def:ldap57_state/ind-def:value" priority="1000" mode="M185">
...
<!--PATTERN ind-def_sql_test_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test" priority="1000" mode="M186">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M186"/></axsl:template><axsl:template match="text()" priority="-1" mode="M186"/><axsl:template match="@*|node()" priority="-2" mode="M186"><axsl:apply-templates select="@*|*" mode="M186"/></axsl:template>

<!--PATTERN ind-def_sqltst-->


	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:object" priority="1001" mode="M187">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:sql_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sql_test must reference a sql_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M187"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:state" priority="1000" mode="M187">
...
<!--PATTERN ind-def_sql_object_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object" priority="1000" mode="M188">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M188"/></axsl:template><axsl:template match="text()" priority="-1" mode="M188"/><axsl:template match="@*|node()" priority="-2" mode="M188"><axsl:apply-templates select="@*|*" mode="M188"/></axsl:template>

<!--PATTERN ind-def_sqlobjdengine-->


	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:engine" priority="1000" mode="M189">
...
<!--PATTERN ind-def_sqlobjversion-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:version" priority="1000" mode="M190">
...
<!--PATTERN ind-def_sqlobjconnection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:connection_string" priority="1000" mode="M191">
...
<!--PATTERN ind-def_sqlobjsql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:sql" priority="1000" mode="M192">
...
<!--PATTERN ind-def_sql_state_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state" priority="1000" mode="M193">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M193"/></axsl:template><axsl:template match="text()" priority="-1" mode="M193"/><axsl:template match="@*|node()" priority="-2" mode="M193"><axsl:apply-templates select="@*|*" mode="M193"/></axsl:template>

<!--PATTERN ind-def_sql57_test-->


	<!--RULE -->
<axsl:template match="ind-def:sql57_test/ind-def:object" priority="1001" mode="M194">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:sql57_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sql57_test must reference a sql57_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M194"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_test/ind-def:state" priority="1000" mode="M194">
...
<!--PATTERN ind-def_sql57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object//oval-def:filter" priority="1000" mode="M195"><axsl:variable name="parent_object" select="ancestor::ind-def:sql57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_sql57_object_dengine-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:engine" priority="1000" mode="M196">
...
<!--PATTERN ind-def_sql57_object_version-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:version" priority="1000" mode="M197">
...
<!--PATTERN ind-def_sql57_object_connection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:connection_string" priority="1000" mode="M198">
...
<!--PATTERN ind-def_sql57_object_sql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_object/ind-def:sql" priority="1000" mode="M199">
...
<!--PATTERN ind-def_sql57steresult-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql57_state/ind-def:result" priority="1000" mode="M200">
...
<!--PATTERN ind-def_textfilecontent54_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object//oval-def:filter" priority="1000" mode="M202"><axsl:variable name="parent_object" select="ancestor::ind-def:textfilecontent54_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_txt54objfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filepath" priority="1000" mode="M203">
...
<!--PATTERN ind-def_txt54objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M204">
...
<!--PATTERN ind-def_txt54objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M205">
...
<!--PATTERN ind-def_txt54objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filename" priority="1000" mode="M206">
...
<!--PATTERN ind-def_txt54objpattern-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:pattern" priority="1000" mode="M207">
...
<!--PATTERN win-def_tfc54_i-->
	...
	<!--RULE -->
<axsl:template match="win-def:textfilecontent54_state/win-def:instance" priority="1000" mode="M208">
...
<!--PATTERN ind-def_txttst_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test" priority="1000" mode="M209">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M209"/></axsl:template><axsl:template match="text()" priority="-1" mode="M209"/><axsl:template match="@*|node()" priority="-2" mode="M209"><axsl:apply-templates select="@*|*" mode="M209"/></axsl:template>

<!--PATTERN ind-def_txttst-->


	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:object" priority="1001" mode="M210">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:textfilecontent_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a textfilecontent_test must reference a textfilecontent_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M210"/></axsl:template>

	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:state" priority="1000" mode="M210">
...
<!--PATTERN ind-def_txtobj_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object" priority="1000" mode="M211">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M211"/></axsl:template><axsl:template match="text()" priority="-1" mode="M211"/><axsl:template match="@*|node()" priority="-2" mode="M211"><axsl:apply-templates select="@*|*" mode="M211"/></axsl:template>

<!--PATTERN ind-def_txtobjfilename-->


	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:filename" priority="1000" mode="M212">
...
<!--PATTERN ind-def_txtobjline-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:line" priority="1000" mode="M213">
...
<!--PATTERN ind-def_txtste_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state" priority="1000" mode="M214">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M214"/></axsl:template><axsl:template match="text()" priority="-1" mode="M214"/><axsl:template match="@*|node()" priority="-2" mode="M214"><axsl:apply-templates select="@*|*" mode="M214"/></axsl:template>

<!--PATTERN ind-def_vattst-->


	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:object" priority="1001" mode="M215">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:variable_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a variable_test must reference a variable_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M215"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:state" priority="1000" mode="M215">
...
<!--PATTERN ind-def_variable_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object//oval-def:filter" priority="1000" mode="M216"><axsl:variable name="parent_object" select="ancestor::ind-def:variable_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_varobjvar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M217">
...
<!--PATTERN ind-def_varobjvar_ref_exists-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M218"><axsl:variable name="varId" select="."/>
...
<!--PATTERN ind-def_varstevar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M219">
...
<!--PATTERN ind-def_varstevar_ref_exists-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M220"><axsl:variable name="varId" select="."/>
...
<!--PATTERN ind-def_xmltst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:object" priority="1001" mode="M221">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ind-def:xmlfilecontent_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a xmlfilecontent_test must reference a xmlfilecontent_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M221"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:state" priority="1000" mode="M221">
...
<!--PATTERN ind-def_xmlfilecontent_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object//oval-def:filter" priority="1000" mode="M222"><axsl:variable name="parent_object" select="ancestor::ind-def:xmlfilecontent_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ind-def_xmlobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filepath" priority="1000" mode="M223">
...
<!--PATTERN ind-def_xmlobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M224">
...
<!--PATTERN ind-def_xmlobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M225">
...
<!--PATTERN ind-def_xmlobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filename" priority="1000" mode="M226">
...
<!--PATTERN ind-def_xmlobjxpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:xpath" priority="1000" mode="M227">
...
<!--PATTERN ind-def_ldaptype_email_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/ind-def:ldap_state/ind-def:ldaptype|oval-def:oval_definitions/oval-def:states/ind-def:ldap57_state/ind-def:ldaptype" priority="1000" mode="M229">

		<!--REPORT -->
<axsl:if test=".='LDAPTYPE_EMAIL'">
                                                                    DEPRECATED ELEMENT VALUE IN: ldap_state ELEMENT VALUE: <axsl:text/><axsl:value-of select="."/><axsl:text/>
                                                              <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M229"/></axsl:template><axsl:template match="text()" priority="-1" mode="M229"/><axsl:template match="@*|node()" priority="-2" mode="M229"><axsl:apply-templates select="@*|*" mode="M229"/></axsl:template>

<!--PATTERN ios_acltst-->


	<!--RULE -->
<axsl:template match="ios-def:acl_test/ios-def:object" priority="1001" mode="M230">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:acl_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a acl_test must reference a acl_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M230"/></axsl:template>

	<!--RULE -->
<axsl:template match="ios-def:acl_test/ios-def:state" priority="1000" mode="M230">
...
<!--PATTERN ios_acl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:acl_object//oval-def:filter" priority="1000" mode="M231"><axsl:variable name="parent_object" select="ancestor::ios-def:acl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_bgpneighbor_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:bgpneighbor_object//oval-def:filter" priority="1000" mode="M233"><axsl:variable name="parent_object" select="ancestor::ios-def:bgpneighbor_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_globaltst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:object" priority="1001" mode="M234">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:global_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a global_test must reference a global_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M234"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:state" priority="1000" mode="M234">
...
<!--PATTERN ios-def_global_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_object//oval-def:filter" priority="1000" mode="M235"><axsl:variable name="parent_object" select="ancestor::ios-def:global_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_interfacetst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:object" priority="1001" mode="M236">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:interface_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an interface_test must reference an interface_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M236"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:state" priority="1000" mode="M236">
...
<!--PATTERN ios-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_object//oval-def:filter" priority="1000" mode="M237"><axsl:variable name="parent_object" select="ancestor::ios-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_interfacestenoipdbc-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:no_ip_directed_broadcast_command" priority="1000" mode="M238">
...
<!--PATTERN ios-def_interfaceste_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:urpf_command" priority="1000" mode="M239">

		<!--REPORT -->
<axsl:if test="true()">Warning: DEPRECATED ENTITY: <axsl:text/><axsl:value-of select="name()"/><axsl:text/>. This entity has been deprecated because it was replaced by the ipv4_urpf_command and ipv6_urpf_command entities.<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M239"/></axsl:template><axsl:template match="text()" priority="-1" mode="M239"/><axsl:template match="@*|node()" priority="-2" mode="M239"><axsl:apply-templates select="@*|*" mode="M239"/></axsl:template>

<!--PATTERN ios-def_linetst-->


	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:object" priority="1001" mode="M240">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:line_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a line_test must reference a line_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M240"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:state" priority="1000" mode="M240">
...
<!--PATTERN ios-def_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_object//oval-def:filter" priority="1000" mode="M241"><axsl:variable name="parent_object" select="ancestor::ios-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_routertst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:router_test/ios-def:object" priority="1001" mode="M242">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:router_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a router_test must reference a router_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M242"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:router_test/ios-def:state" priority="1000" mode="M242">
...
<!--PATTERN ios_router_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:router_object//oval-def:filter" priority="1000" mode="M243"><axsl:variable name="parent_object" select="ancestor::ios-def:router_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_routingprotocolauthintftst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_test/ios-def:object" priority="1001" mode="M244">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:routingprotocolauthintf_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a routingprotocolauthintf_test must reference a routingprotocolauthintf_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M244"/></axsl:template>

	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_test/ios-def:state" priority="1000" mode="M244">
...
<!--PATTERN ios_routingprotocolauthintf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:routingprotocolauthintf_object//oval-def:filter" priority="1000" mode="M245"><axsl:variable name="parent_object" select="ancestor::ios-def:routingprotocolauthintf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_sectiontst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:section_test/ios-def:object" priority="1001" mode="M246">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:section_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a section_test must reference a section_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M246"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:section_test/ios-def:state" priority="1000" mode="M246">
...
<!--PATTERN ios_section_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:section_object//oval-def:filter" priority="1000" mode="M247"><axsl:variable name="parent_object" select="ancestor::ios-def:section_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_snmptst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:object" priority="1001" mode="M248">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:snmp_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a snmp_test must reference a snmp_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M248"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:state" priority="1000" mode="M248">
...
<!--PATTERN ios_snmpcommunity_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpcommunity_object//oval-def:filter" priority="1000" mode="M250"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpcommunity_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_snmpgroup_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpgroup_object//oval-def:filter" priority="1000" mode="M252"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpgroup_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_snmphost_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmphost_object//oval-def:filter" priority="1000" mode="M254"><axsl:variable name="parent_object" select="ancestor::ios-def:snmphost_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_snmpuser_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpuser_object//oval-def:filter" priority="1000" mode="M256"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpuser_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios_snmpview_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmpview_object//oval-def:filter" priority="1000" mode="M258"><axsl:variable name="parent_object" select="ancestor::ios-def:snmpview_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN ios-def_tclshtst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:object" priority="1001" mode="M259">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:tclsh_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a tclsh_test must reference a tclsh_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M259"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:state" priority="1000" mode="M259">
...
<!--PATTERN ios-def_ver55tst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:object" priority="1001" mode="M260">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:version55_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version55_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M260"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:state" priority="1000" mode="M260">
...
<!--PATTERN ios-def_vertst_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_test" priority="1000" mode="M261">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M261"/></axsl:template><axsl:template match="text()" priority="-1" mode="M261"/><axsl:template match="@*|node()" priority="-2" mode="M261"><axsl:apply-templates select="@*|*" mode="M261"/></axsl:template>

<!--PATTERN ios-def_vertst-->


	<!--RULE -->
<axsl:template match="ios-def:version_test/ios-def:object" priority="1001" mode="M262">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/ios-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M262"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="ios-def:version_test/ios-def:state" priority="1000" mode="M262">
...
<!--PATTERN ios-def_verobj_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_object" priority="1000" mode="M263">
...
<!--PATTERN ios-def_verste_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_state" priority="1000" mode="M264">
...
<!--PATTERN ios-def_salut_none_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/ios-def:acl_state/ios-def:use" priority="1000" mode="M265">
...
<!--PATTERN ios-def_sratst_null_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/ios-def:routingprotocolauthintf_state/ios-def:auth_type" priority="1000" mode="M266">
...
<!--PATTERN iosxe-def_global_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:global_object//oval-def:filter" priority="1000" mode="M268"><axsl:variable name="parent_object" select="ancestor::iosxe-def:global_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:line_object//oval-def:filter" priority="1000" mode="M270"><axsl:variable name="parent_object" select="ancestor::iosxe-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_versiontst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_test/iosxe-def:object" priority="1001" mode="M271">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M271"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_test/iosxe-def:state" priority="1000" mode="M271">
...
<!--PATTERN iosxe-def_versionste_platform_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_state/iosxe-def:platform" priority="1000" mode="M272">
...
<!--PATTERN iosxe-def_versionste_rp_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_state/iosxe-def:rp" priority="1000" mode="M273">
...
<!--PATTERN iosxe-def_versionste_pkg_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_state/iosxe-def:pkg" priority="1000" mode="M274">
...
<!--PATTERN iosxe-def_versionste_ios_release_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_state/iosxe-def:ios_release" priority="1000" mode="M275">
...
<!--PATTERN iosxe-def_versionste_ios_train_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:version_state/iosxe-def:ios_train" priority="1000" mode="M276">
...
<!--PATTERN iosxe-def_interfacetst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:interface_test/iosxe-def:object" priority="1001" mode="M277">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:interface_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an interface_test must reference an interface_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M277"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:interface_test/iosxe-def:state" priority="1000" mode="M277">
...
<!--PATTERN iosxe-def_interfaceste_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:interface_state/iosxe-def:urpf_command" priority="1000" mode="M278">
...
<!--PATTERN iosxe-def_section_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:section_object//oval-def:filter" priority="1000" mode="M280"><axsl:variable name="parent_object" select="ancestor::iosxe-def:section_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_routertst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:router_test/iosxe-def:object" priority="1001" mode="M281">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:router_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a router_test must reference a router_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M281"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:router_test/iosxe-def:state" priority="1000" mode="M281">
...
<!--PATTERN iosxe-def_router_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:router_object//oval-def:filter" priority="1000" mode="M282"><axsl:variable name="parent_object" select="ancestor::iosxe-def:router_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_bgpneighbortst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:bgpneighbor_test/iosxe-def:object" priority="1001" mode="M283">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:bgpneighbor_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a bgpneighbor_test must reference a bgpneighbor_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M283"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:bgpneighbor_test/iosxe-def:state" priority="1000" mode="M283">
...
<!--PATTERN iosxe-def_bgpneighbor_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:bgpneighbor_object//oval-def:filter" priority="1000" mode="M284"><axsl:variable name="parent_object" select="ancestor::iosxe-def:bgpneighbor_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_routingprotocolauthintftst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:routingprotocolauthintf_test/iosxe-def:object" priority="1001" mode="M285">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:routingprotocolauthintf_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a routingprotocolauthintf_test must reference a routingprotocolauthintf_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M285"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:routingprotocolauthintf_test/iosxe-def:state" priority="1000" mode="M285">
...
<!--PATTERN iosxe-def_routingprotocolauthintf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:routingprotocolauthintf_object//oval-def:filter" priority="1000" mode="M286"><axsl:variable name="parent_object" select="ancestor::iosxe-def:routingprotocolauthintf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_acl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:acl_object//oval-def:filter" priority="1000" mode="M288"><axsl:variable name="parent_object" select="ancestor::iosxe-def:acl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_hosttst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmphost_test/iosxe-def:object" priority="1001" mode="M289">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:snmphost_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an snmphost_test must reference an snmphost_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M289"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmphost_test/iosxe-def:state" priority="1000" mode="M289">
...
<!--PATTERN iosxe-def_snmphost_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmphost_object//oval-def:filter" priority="1000" mode="M290"><axsl:variable name="parent_object" select="ancestor::iosxe-def:snmphost_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_snmpcommunity_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpcommunity_object//oval-def:filter" priority="1000" mode="M292"><axsl:variable name="parent_object" select="ancestor::iosxe-def:snmpcommunity_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_usertst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpuser_test/iosxe-def:object" priority="1001" mode="M293">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:snmpuser_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an snmpuser_test must reference an snmpuser_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M293"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpuser_test/iosxe-def:state" priority="1000" mode="M293">
...
<!--PATTERN iosxe-def_snmpuser_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpuser_object//oval-def:filter" priority="1000" mode="M294"><axsl:variable name="parent_object" select="ancestor::iosxe-def:snmpuser_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_grouptst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpgroup_test/iosxe-def:object" priority="1001" mode="M295">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:snmpgroup_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an snmpgroup_test must reference an snmpgroup_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M295"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpgroup_test/iosxe-def:state" priority="1000" mode="M295">
...
<!--PATTERN iosxe-def_snmpgroup_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpgroup_object//oval-def:filter" priority="1000" mode="M296"><axsl:variable name="parent_object" select="ancestor::iosxe-def:snmpgroup_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_viewtst-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpview_test/iosxe-def:object" priority="1001" mode="M297">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/iosxe-def:snmpview_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an snmpview_test must reference an snmpview_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M297"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpview_test/iosxe-def:state" priority="1000" mode="M297">
...
<!--PATTERN iosxe-def_snmpview_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="iosxe-def:snmpview_object//oval-def:filter" priority="1000" mode="M298"><axsl:variable name="parent_object" select="ancestor::iosxe-def:snmpview_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN iosxe-def_sratst_null_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/iosxe-def:routingprotocolauthintf_state/iosxe-def:auth_type" priority="1000" mode="M299">
...
<!--PATTERN iosxe-def_salut_none_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/iosxe-def:acl_state/iosxe-def:use" priority="1000" mode="M300">
...
<!--PATTERN junos-def_xmlconfigtst-->
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_config_test/junos-def:object" priority="1001" mode="M301">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/junos-def:xml_config_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a xml_config_test must reference a xml_config_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M301"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_config_test/junos-def:state" priority="1000" mode="M301">
...
<!--PATTERN junos-def_xml_config_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_config_object//oval-def:filter" priority="1000" mode="M302"><axsl:variable name="parent_object" select="ancestor::junos-def:xml_config_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN junos-def_xmlconfigobjxpath-->
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_config_object/junos-def:xpath" priority="1000" mode="M303">
...
<!--PATTERN junos-def_show_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="junos-def:show_object//oval-def:filter" priority="1000" mode="M304"><axsl:variable name="parent_object" select="ancestor::junos-def:show_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN junos-def_version_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="junos-def:version_object//oval-def:filter" priority="1000" mode="M305"><axsl:variable name="parent_object" select="ancestor::junos-def:version_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN junos-def_xml_show_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_show_object//oval-def:filter" priority="1000" mode="M306"><axsl:variable name="parent_object" select="ancestor::junos-def:xml_show_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN junos-def_xml_showobjxpath-->
	...
	<!--RULE -->
<axsl:template match="junos-def:xml_show_object/junos-def:xpath" priority="1000" mode="M307">
...
<!--PATTERN suse-def_apparmorstatus_tst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:apparmorstatus_test/linux-def:object" priority="1001" mode="M308">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:apparmorstatus_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a apparmorstatus_test must reference a apparmorstatus_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M308"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:apparmorstatus_test/linux-def:state" priority="1000" mode="M308">
...
<!--PATTERN linux-def_dpkginfo_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_test/linux-def:object" priority="1001" mode="M309">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:dpkginfo_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an dpkginfo_test must reference an dpkginfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M309"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_test/linux-def:state" priority="1000" mode="M309">
...
<!--PATTERN linux-def_dpkginfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_object//oval-def:filter" priority="1000" mode="M310"><axsl:variable name="parent_object" select="ancestor::linux-def:dpkginfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_iflisteners_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:iflisteners_object//oval-def:filter" priority="1000" mode="M313"><axsl:variable name="parent_object" select="ancestor::linux-def:iflisteners_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_inetlisteningservers_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_test/linux-def:object" priority="1001" mode="M314">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:inetlisteningservers_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an inetlisteningservers_test must reference an inetlisteningservers_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M314"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_test/linux-def:state" priority="1000" mode="M314">
...
<!--PATTERN linux-def_inetlisteningservers_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_object//oval-def:filter" priority="1000" mode="M315"><axsl:variable name="parent_object" select="ancestor::linux-def:inetlisteningservers_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_partitiontst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_test/linux-def:object" priority="1001" mode="M316">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:partition_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a partition_test must reference a partition_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M316"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_test/linux-def:state" priority="1000" mode="M316">
...
<!--PATTERN linux-def_partition_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:partition_object//oval-def:filter" priority="1000" mode="M317"><axsl:variable name="parent_object" select="ancestor::linux-def:partition_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpminfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_object//oval-def:filter" priority="1000" mode="M319"><axsl:variable name="parent_object" select="ancestor::linux-def:rpminfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifytst_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test" priority="1000" mode="M320">
...
<!--PATTERN linux-def_rpmverify_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test/linux-def:object" priority="1001" mode="M321">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverify_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an rpmverify_test must reference an rpmverify_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M321"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_test/linux-def:state" priority="1000" mode="M321">
...
<!--PATTERN linux-def_rpmverifyobj_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_object" priority="1000" mode="M323">
...
<!--PATTERN linux-def_rpmverifyste_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverify_state" priority="1000" mode="M324">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M324"/></axsl:template><axsl:template match="text()" priority="-1" mode="M324"/><axsl:template match="@*|node()" priority="-2" mode="M324"><axsl:apply-templates select="@*|*" mode="M324"/></axsl:template>

<!--PATTERN linux-def_rpmverifyfile_test-->


	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_test/linux-def:object" priority="1001" mode="M325">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverifyfile_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an rpmverifyfile_test must reference an rpmverifyfile_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M325"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_test/linux-def:state" priority="1000" mode="M325">
...
<!--PATTERN linux-def_rpmverifyfile_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifyfile_object//oval-def:filter" priority="1000" mode="M326"><axsl:variable name="parent_object" select="ancestor::linux-def:rpmverifyfile_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifypackage_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_test/linux-def:object" priority="1001" mode="M327">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:rpmverifypackage_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an rpmverifypackage_test must reference an rpmverifypackage_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M327"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_test/linux-def:state" priority="1000" mode="M327">
...
<!--PATTERN linux-def_rpmverifypackage_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object//oval-def:filter" priority="1000" mode="M328"><axsl:variable name="parent_object" select="ancestor::linux-def:rpmverifypackage_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_rpmverifypackage_dicp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_state/linux-def:digest_check_passed" priority="1000" mode="M329">
...
<!--PATTERN linux-def_rpmverifypackage_scp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_state/linux-def:signature_check_passed" priority="1000" mode="M330">
...
<!--PATTERN linux-def_rpmverifypackage_nodi_beh_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object/linux-def:behaviors/@nodigest" priority="1000" mode="M331">
...
<!--PATTERN linux-def_rpmverifypackage_nosi_beh_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpmverifypackage_object/linux-def:behaviors/@nosignature" priority="1000" mode="M332">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED BEHAVIOR: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="../../@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M332"/></axsl:template><axsl:template match="text()" priority="-1" mode="M332"/><axsl:template match="@*|node()" priority="-2" mode="M332"><axsl:apply-templates select="@*|*" mode="M332"/></axsl:template>

<!--PATTERN linux-def_selinuxbooleantst-->


	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_test/linux-def:object" priority="1001" mode="M333">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:selinuxboolean_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an selinuxboolean_test must reference an selinuxboolean_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M333"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_test/linux-def:state" priority="1000" mode="M333">
...
<!--PATTERN linux-def_selinuxboolean_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxboolean_object//oval-def:filter" priority="1000" mode="M334"><axsl:variable name="parent_object" select="ancestor::linux-def:selinuxboolean_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_selinuxsecuritycontexttst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_test/linux-def:object" priority="1001" mode="M335">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:selinuxsecuritycontext_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an selinuxsecuritycontext_test must reference an selinuxsecuritycontext_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M335"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_test/linux-def:state" priority="1000" mode="M335">
...
<!--PATTERN linux-def_selinuxsecuritycontext_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object//oval-def:filter" priority="1000" mode="M336"><axsl:variable name="parent_object" select="ancestor::linux-def:selinuxsecuritycontext_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilepath-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filepath" priority="1000" mode="M337">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilepath2-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M338">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectpath-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M339">
...
<!--PATTERN linux-def_selinuxsecuritycontext_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="linux-def:selinuxsecuritycontext_object/linux-def:filename" priority="1000" mode="M340">
...
<!--PATTERN linux-def_slackwarepkginfo_test-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_test/linux-def:object" priority="1001" mode="M341">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:slackwarepkginfo_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an slackwarepkginfo_test must reference an slackwarepkginfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M341"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_test/linux-def:state" priority="1000" mode="M341">
...
<!--PATTERN linux-def_slackwarepkginfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_object//oval-def:filter" priority="1000" mode="M342"><axsl:variable name="parent_object" select="ancestor::linux-def:slackwarepkginfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_systemdunitdependencytst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_test/linux-def:object" priority="1001" mode="M343">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:systemdunitdependency_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a systemdunitdependency_test must reference a systemdunitdependency_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M343"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_test/linux-def:state" priority="1000" mode="M343">
...
<!--PATTERN linux-def_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitdependency_object//oval-def:filter" priority="1000" mode="M344"><axsl:variable name="parent_object" select="ancestor::linux-def:systemdunitdependency_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN linux-def_systemdunitpropertytst-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_test/linux-def:object" priority="1001" mode="M345">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/linux-def:systemdunitproperty_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a systemdunitproperty_test must reference a systemdunitproperty_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M345"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_test/linux-def:state" priority="1000" mode="M345">
...
<!--PATTERN linux-def_systemdunitproperty_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="linux-def:systemdunitproperty_object//oval-def:filter" priority="1000" mode="M346"><axsl:variable name="parent_object" select="ancestor::linux-def:systemdunitproperty_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_accountinfo_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_test/macos-def:object" priority="1001" mode="M347">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:accountinfo_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an accountinfo_test must reference an accountinfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M347"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_test/macos-def:state" priority="1000" mode="M347">
...
<!--PATTERN macos-def_accountinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_object//oval-def:filter" priority="1000" mode="M348"><axsl:variable name="parent_object" select="ancestor::macos-def:accountinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_authorizationdbtst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_test/macos-def:object" priority="1001" mode="M349">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:authorizationdb_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a authorizationdb_test must reference an authorizationdb_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M349"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_test/macos-def:state" priority="1000" mode="M349">
...
<!--PATTERN macos-def_authorizationdb_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_object//oval-def:filter" priority="1000" mode="M350"><axsl:variable name="parent_object" select="ancestor::macos-def:authorizationdb_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_authdbobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:authorizationdb_object/macos-def:xpath" priority="1000" mode="M351">
...
<!--PATTERN macos-def_corestoragetst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_test/macos-def:object" priority="1001" mode="M352">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:corestorage_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a corestorage_test must reference an corestorage_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M352"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_test/macos-def:state" priority="1000" mode="M352">
...
<!--PATTERN macos-def_corestorage_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_object//oval-def:filter" priority="1000" mode="M353"><axsl:variable name="parent_object" select="ancestor::macos-def:corestorage_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_corestorageobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:corestorage_object/macos-def:xpath" priority="1000" mode="M354">
...
<!--PATTERN macos-def_diskutiltst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:diskutil_test/macos-def:object" priority="1001" mode="M355">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:diskutil_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a diskutil_test must reference a diskutil_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M355"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:diskutil_test/macos-def:state" priority="1000" mode="M355">
...
<!--PATTERN macos-def_diskutil_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:diskutil_object//oval-def:filter" priority="1000" mode="M356"><axsl:variable name="parent_object" select="ancestor::macos-def:diskutil_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_inetlisteningserverstst_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test" priority="1000" mode="M358">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M358"/></axsl:template><axsl:template match="text()" priority="-1" mode="M358"/><axsl:template match="@*|node()" priority="-2" mode="M358"><axsl:apply-templates select="@*|*" mode="M358"/></axsl:template>

<!--PATTERN macos-def_inetlisteningservers_test-->


	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test/macos-def:object" priority="1001" mode="M359">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:inetlisteningservers_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an inetlisteningservers_test must reference an inetlisteningservers_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M359"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_test/macos-def:state" priority="1000" mode="M359">
...
<!--PATTERN macos-def_inetlisteningserversobj_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_object" priority="1000" mode="M360">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M360"/></axsl:template><axsl:template match="text()" priority="-1" mode="M360"/><axsl:template match="@*|node()" priority="-2" mode="M360"><axsl:apply-templates select="@*|*" mode="M360"/></axsl:template>

<!--PATTERN macos-def_inetlisteningservers_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_object//oval-def:filter" priority="1000" mode="M361"><axsl:variable name="parent_object" select="ancestor::macos-def:inetlisteningservers_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_inetlisteningserversste_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state" priority="1000" mode="M362">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M362"/></axsl:template><axsl:template match="text()" priority="-1" mode="M362"/><axsl:template match="@*|node()" priority="-2" mode="M362"><axsl:apply-templates select="@*|*" mode="M362"/></axsl:template>

<!--PATTERN macos-def_inetlisteningserver510_test-->


	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_test/macos-def:object" priority="1001" mode="M363">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:inetlisteningserver510_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an inetlisteningserver510_test must reference an inetlisteningserver510_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M363"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_test/macos-def:state" priority="1000" mode="M363">
...
<!--PATTERN macos-def_inetlisteningserver510_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningserver510_object//oval-def:filter" priority="1000" mode="M364"><axsl:variable name="parent_object" select="ancestor::macos-def:inetlisteningserver510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_keychain_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:keychain_object//oval-def:filter" priority="1000" mode="M366"><axsl:variable name="parent_object" select="ancestor::macos-def:keychain_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_launchd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:macos_object//oval-def:filter" priority="1000" mode="M368"><axsl:variable name="parent_object" select="ancestor::macos-def:launchd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_nvram_test-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_test/macos-def:object" priority="1001" mode="M369">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:nvram_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an nvram_test must reference an nvram_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M369"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_test/macos-def:state" priority="1000" mode="M369">
...
<!--PATTERN macos-def_nvram_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_object//oval-def:filter" priority="1000" mode="M370"><axsl:variable name="parent_object" select="ancestor::macos-def:nvram_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plist_test_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_test" priority="1000" mode="M371">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M371"/></axsl:template><axsl:template match="text()" priority="-1" mode="M371"/><axsl:template match="@*|node()" priority="-2" mode="M371"><axsl:apply-templates select="@*|*" mode="M371"/></axsl:template>

<!--PATTERN macos-def_plist_test-->


	<!--RULE -->
<axsl:template match="macos-def:plist_test/macos-def:object" priority="1001" mode="M372">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:plist_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a plist_test must reference a plist_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M372"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:plist_test/macos-def:state" priority="1000" mode="M372">
...
<!--PATTERN macos-def_plist_object_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object" priority="1000" mode="M373">
...
<axsl:if test="true()"> DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
                                    <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M373"/></axsl:template><axsl:template match="text()" priority="-1" mode="M373"/><axsl:template match="@*|node()" priority="-2" mode="M373"><axsl:apply-templates select="@*|*" mode="M373"/></axsl:template>

<!--PATTERN macos-def_plist_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="macos-def:plist_object//oval-def:filter" priority="1000" mode="M374"><axsl:variable name="parent_object" select="ancestor::macos-def:plist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plistobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object/macos-def:filepath" priority="1000" mode="M375">
...
<!--PATTERN macos-def_plist_state_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_state" priority="1000" mode="M376">
...
<!--PATTERN macos-def_plist510_test_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_test" priority="1000" mode="M377">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M377"/></axsl:template><axsl:template match="text()" priority="-1" mode="M377"/><axsl:template match="@*|node()" priority="-2" mode="M377"><axsl:apply-templates select="@*|*" mode="M377"/></axsl:template>

<!--PATTERN macos-def_plist510_test-->


	<!--RULE -->
<axsl:template match="macos-def:plist510_test/macos-def:object" priority="1001" mode="M378">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:plist510_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a plist510_test must reference a plist510_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M378"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_test/macos-def:state" priority="1000" mode="M378">
...
<!--PATTERN macos-def_plist510_object_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object" priority="1000" mode="M379">

		<!--REPORT -->
<axsl:if test="true()"> DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
                                    <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M379"/></axsl:template><axsl:template match="text()" priority="-1" mode="M379"/><axsl:template match="@*|node()" priority="-2" mode="M379"><axsl:apply-templates select="@*|*" mode="M379"/></axsl:template>

<!--PATTERN macos-def_plist510_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="macos-def:plist510_object//oval-def:filter" priority="1000" mode="M380"><axsl:variable name="parent_object" select="ancestor::macos-def:plist510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plist510objappid-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object/macos-def:app_id" priority="1000" mode="M381">
...
<!--PATTERN macos-def_plist510objfilepath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_object/macos-def:filepath" priority="1000" mode="M382">
...
<!--PATTERN macos-def_plist510_state_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist510_state" priority="1000" mode="M383">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M383"/></axsl:template><axsl:template match="text()" priority="-1" mode="M383"/><axsl:template match="@*|node()" priority="-2" mode="M383"><axsl:apply-templates select="@*|*" mode="M383"/></axsl:template>

<!--PATTERN macos-def_plist511_test-->


	<!--RULE -->
<axsl:template match="macos-def:plist511_test/macos-def:object" priority="1001" mode="M384">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:plist511_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a plist511_test must reference a plist511_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M384"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:plist511_test/macos-def:state" priority="1000" mode="M384">
...
<!--PATTERN macos-def_plist511_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist511_object//oval-def:filter" priority="1000" mode="M385"><axsl:variable name="parent_object" select="ancestor::macos-def:plist511_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_plist511objfilepath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist511_object/macos-def:filepath" priority="1000" mode="M386">
...
<!--PATTERN macos-def_plist511objxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:plist_object/macos-def:xpath" priority="1000" mode="M387">
...
<!--PATTERN macos-def_pwpolicy_test_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test" priority="1000" mode="M388">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M388"/></axsl:template><axsl:template match="text()" priority="-1" mode="M388"/><axsl:template match="@*|node()" priority="-2" mode="M388"><axsl:apply-templates select="@*|*" mode="M388"/></axsl:template>

<!--PATTERN macos-def_pwpolicy_test-->


	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test/macos-def:object" priority="1001" mode="M389">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:pwpolicy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an pwpolicy_test must reference an pwpolicy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M389"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_test/macos-def:state" priority="1000" mode="M389">
...
<!--PATTERN macos-def_pwpolicy_object_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object" priority="1000" mode="M390">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M390"/></axsl:template><axsl:template match="text()" priority="-1" mode="M390"/><axsl:template match="@*|node()" priority="-2" mode="M390"><axsl:apply-templates select="@*|*" mode="M390"/></axsl:template>

<!--PATTERN macos-def_pwpolicy_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object//oval-def:filter" priority="1000" mode="M391"><axsl:variable name="parent_object" select="ancestor::macos-def:pwpolicy_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_pwpobjusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:username" priority="1000" mode="M392">
...
<!--PATTERN macos-def_pwpobjuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:userpass" priority="1000" mode="M393">
...
<!--PATTERN macos-def_pwpobjdirnode-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:directory_node" priority="1000" mode="M394">
...
<!--PATTERN macos-def_pwpolicy_state_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state" priority="1000" mode="M395">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M395"/></axsl:template><axsl:template match="text()" priority="-1" mode="M395"/><axsl:template match="@*|node()" priority="-2" mode="M395"><axsl:apply-templates select="@*|*" mode="M395"/></axsl:template>

<!--PATTERN macos-def_pwpolicy59_test-->


	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_test/macos-def:object" priority="1001" mode="M396">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:pwpolicy59_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an pwpolicy59_test must reference an pwpolicy59_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M396"/></axsl:template>

	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_test/macos-def:state" priority="1000" mode="M396">
...
<!--PATTERN macos-def_pwpolicy59_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object//oval-def:filter" priority="1000" mode="M397"><axsl:variable name="parent_object" select="ancestor::macos-def:pwpolicy59_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_pwp59objusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object/macos-def:username" priority="1000" mode="M398">
...
<!--PATTERN macos-def_pwp59objuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object/macos-def:userpass" priority="1000" mode="M399">
...
<!--PATTERN macos-def_pwp59dirnode-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy59_object/macos-def:directory_node" priority="1000" mode="M400">
...
<!--PATTERN macos-def_rlimittst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:rlimit_test/macos-def:object" priority="1001" mode="M401">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:rlimit_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a rlimit_test must reference an rlimit_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M401"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:rlimit_test/macos-def:state" priority="1000" mode="M401">
...
<!--PATTERN macos-def_softwareupdatetst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:softwareupdate_test/macos-def:object" priority="1001" mode="M402">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:softwareupdate_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a softwareupdate_test must reference an softwareupdate_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M402"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:softwareupdate_test/macos-def:state" priority="1000" mode="M402">
...
<!--PATTERN macos-def_systemprofilertst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_test/macos-def:object" priority="1001" mode="M403">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:systemprofiler_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a systemprofiler_test must reference an systemprofiler_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M403"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_test/macos-def:state" priority="1000" mode="M403">
...
<!--PATTERN macos-def_systemprofiler_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_object//oval-def:filter" priority="1000" mode="M404"><axsl:variable name="parent_object" select="ancestor::macos-def:systemprofiler_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN macos-def_systemprofilerobjxpath-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemprofiler_object/macos-def:xpath" priority="1000" mode="M405">
...
<!--PATTERN macos-def_systemsetuptst-->
	...
	<!--RULE -->
<axsl:template match="macos-def:systemsetup_test/macos-def:object" priority="1001" mode="M406">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/macos-def:systemsetup_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a systemsetup_test must reference an systemsetup_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M406"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="macos-def:systemsetup_test/macos-def:state" priority="1000" mode="M406">
...
<!--PATTERN netconf-def_configtst-->
	...
	<!--RULE -->
<axsl:template match="netconf-def:config_test/netconf-def:object" priority="1001" mode="M407">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/netconf-def:config_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a config_test must reference a config_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M407"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="netconf-def:config_test/netconf-def:state" priority="1000" mode="M407">
...
<!--PATTERN netconf-def_xmlobjxpath-->
	...
	<!--RULE -->
<axsl:template match="netconf-def:config_object/netconf-def:xpath" priority="1000" mode="M409">
...
<!--PATTERN pixos-def_linetst-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_test/pixos-def:object" priority="1001" mode="M410">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/pixos-def:line_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a line_test must reference a line_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M410"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_test/pixos-def:state" priority="1000" mode="M410">
...
<!--PATTERN pixos-def_line_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:line_object//oval-def:filter" priority="1000" mode="M411"><axsl:variable name="parent_object" select="ancestor::pixos-def:line_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN pixos-def_vertst-->
	...
	<!--RULE -->
<axsl:template match="pixos-def:version_test/pixos-def:object" priority="1001" mode="M412">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/pixos-def:version_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a version_test must reference a version_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M412"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="pixos-def:version_test/pixos-def:state" priority="1000" mode="M412">
...
<!--PATTERN sp-def_webapptst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_test/sp-def:object" priority="1001" mode="M413">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spwebapplication_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spwebapplication_test must reference an spwebapplication_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M413"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_test/sp-def:state" priority="1000" mode="M413">
...
<!--PATTERN sp-def_spwebapplication_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spwebapplication_object//oval-def:filter" priority="1000" mode="M414"><axsl:variable name="parent_object" select="ancestor::sp-def:spwebapplication_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_listtst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:splist_test/sp-def:object" priority="1001" mode="M419">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:splist_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a splist_test must reference an splist_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M419"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sp-def:splist_test/sp-def:state" priority="1000" mode="M419">
...
<!--PATTERN sp-def_avstst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spantivirussettings_test/sp-def:object" priority="1001" mode="M421">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spantivirussettings_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spantivirussettings_test must reference an spantivirussettings_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M421"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spantivirussettings_test/sp-def:state" priority="1000" mode="M421">
...
<!--PATTERN sp-def_siteadmintst-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_test/sp-def:object" priority="1001" mode="M423">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spsiteadministration_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spsiteadministration_test must reference an spsiteadministration_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M423"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_test/sp-def:state" priority="1000" mode="M423">
...
<!--PATTERN sp-def_spsiteadministration_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spsiteadministration_object//oval-def:filter" priority="1000" mode="M424"><axsl:variable name="parent_object" select="ancestor::sp-def:spsiteadministration_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp_def_spsite_state_url_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/sp-def:spsite_state/sp-def:url" priority="1000" mode="M427">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ENTITY IN: sp-def:spsite_state <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M427"/></axsl:template><axsl:template match="text()" priority="-1" mode="M427"/><axsl:template match="@*|node()" priority="-2" mode="M427"><axsl:apply-templates select="@*|*" mode="M427"/></axsl:template>

<!--PATTERN sp-def_crtst-->


	<!--RULE -->
<axsl:template match="sp-def:spcrawlrule_test/sp-def:object" priority="1001" mode="M428">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spcrawlrule_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spcrawlrule_test must reference an spcrawlrule_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M428"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spcrawlrule_test/sp-def:state" priority="1000" mode="M428">
...
<!--PATTERN sp-def_spjobdefinition_test_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test" priority="1000" mode="M430">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M430"/></axsl:template><axsl:template match="text()" priority="-1" mode="M430"/><axsl:template match="@*|node()" priority="-2" mode="M430"><axsl:apply-templates select="@*|*" mode="M430"/></axsl:template>

<!--PATTERN sp-def_jobdeftst-->


	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test/sp-def:object" priority="1001" mode="M431">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spjobdefinition_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spjobdefinition_test must reference an spjobdefinition_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M431"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_test/sp-def:state" priority="1000" mode="M431">
...
<!--PATTERN sp-def_spjobdefinition_object_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_object" priority="1000" mode="M432">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M432"/></axsl:template><axsl:template match="text()" priority="-1" mode="M432"/><axsl:template match="@*|node()" priority="-2" mode="M432"><axsl:apply-templates select="@*|*" mode="M432"/></axsl:template>

<!--PATTERN sp-def_spjobdefinition_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_object//oval-def:filter" priority="1000" mode="M433"><axsl:variable name="parent_object" select="ancestor::sp-def:spjobdefinition_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_spjobdefinition_state_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition_state" priority="1000" mode="M434">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M434"/></axsl:template><axsl:template match="text()" priority="-1" mode="M434"/><axsl:template match="@*|node()" priority="-2" mode="M434"><axsl:apply-templates select="@*|*" mode="M434"/></axsl:template>

<!--PATTERN sp-def_jobdef510tst-->


	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_test/sp-def:object" priority="1001" mode="M435">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spjobdefinition510_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a spjobdefinition510_test must reference an spjobdefinition510_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M435"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_test/sp-def:state" priority="1000" mode="M435">
...
<!--PATTERN sp-def_spjobdefinition510_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spjobdefinition510_object//oval-def:filter" priority="1000" mode="M436"><axsl:variable name="parent_object" select="ancestor::sp-def:spjobdefinition510_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_infopolicycoll_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sp-def:infopolicycoll_object//oval-def:filter" priority="1000" mode="M440"><axsl:variable name="parent_object" select="ancestor::sp-def:infopolicycoll_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sp-def_diagnosticsservicetest-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticsservice_test/sp-def:object" priority="1001" mode="M441">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spdiagnosticsservice_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an spdiagnosticsservice_test must reference an spdiagnosticsservice_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M441"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticsservice_test/sp-def:state" priority="1000" mode="M441">
...
<!--PATTERN sp-def_diagnostics_level_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticslevel_test/sp-def:object" priority="1001" mode="M443">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:spdiagnosticslevel_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an spdiagnosticslevel_test must reference an spdiagnosticslevel_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M443"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:spdiagnosticslevel_test/sp-def:state" priority="1000" mode="M443">
...
<!--PATTERN sp-def_policyfeature_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicyfeature_test/sp-def:object" priority="1001" mode="M445">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:sppolicyfeature_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an sppolicyfeature_test must reference an sppolicyfeature_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M445"/></axsl:template>

	<!--RULE -->
<axsl:template match="sp-def:sppolicyfeature_test/sp-def:state" priority="1000" mode="M445">
...
<!--PATTERN sp-def_policy_test-->
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicy_test/sp-def:object" priority="1001" mode="M447">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sp-def:sppolicy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an sppolicy_test must reference an sppolicy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M447"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sp-def:sppolicy_test/sp-def:state" priority="1000" mode="M447">
...
<!--PATTERN sol-def_facet_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:facet_object//oval-def:filter" priority="1000" mode="M449"><axsl:variable name="parent_object" select="ancestor::sol-def:facet_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_image_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:image_object//oval-def:filter" priority="1000" mode="M451"><axsl:variable name="parent_object" select="ancestor::sol-def:image_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_isainfotst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:object" priority="1001" mode="M452">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:isainfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:state" priority="1000" mode="M452">
...
<!--PATTERN sol-def_ndd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:ndd_object//oval-def:filter" priority="1000" mode="M454"><axsl:variable name="parent_object" select="ancestor::sol-def:ndd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagetst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:object" priority="1001" mode="M455">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:package_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a package_test must reference a package_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M455"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:state" priority="1000" mode="M455">
...
<!--PATTERN sol-def_package_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_object//oval-def:filter" priority="1000" mode="M456"><axsl:variable name="parent_object" select="ancestor::sol-def:package_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_package511_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_test/sol-def:object" priority="1001" mode="M457">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:package511_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an package511_test must reference an package511_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M457"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_test/sol-def:state" priority="1000" mode="M457">
...
<!--PATTERN sol-def_package511_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package511_object//oval-def:filter" priority="1000" mode="M458"><axsl:variable name="parent_object" select="ancestor::sol-def:package511_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packageavoidlist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packageavoidlist_object//oval-def:filter" priority="1000" mode="M460"><axsl:variable name="parent_object" select="ancestor::sol-def:packageavoidlist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagechecktst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagecheck_test/sol-def:object" priority="1001" mode="M461">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:packagecheck_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a packagecheck_test must reference a packagecheck_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M461"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:packagecheck_test/sol-def:state" priority="1000" mode="M461">
...
<!--PATTERN sol-def_packagecheck_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagecheck_object//oval-def:filter" priority="1000" mode="M462"><axsl:variable name="parent_object" select="ancestor::sol-def:packagecheck_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagefreezelist_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagefreezelist_object//oval-def:filter" priority="1000" mode="M464"><axsl:variable name="parent_object" select="ancestor::sol-def:packagefreezelist_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_packagepublisher_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:packagepublisher_object//oval-def:filter" priority="1000" mode="M466"><axsl:variable name="parent_object" select="ancestor::sol-def:packagepublisher_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_patch54tst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:object" priority="1001" mode="M467">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:patch54_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a patch54_test must reference a patch54_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M467"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:state" priority="1000" mode="M467">
...
<!--PATTERN sol-def_patchtst_dep-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_test" priority="1000" mode="M468">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M468"/></axsl:template><axsl:template match="text()" priority="-1" mode="M468"/><axsl:template match="@*|node()" priority="-2" mode="M468"><axsl:apply-templates select="@*|*" mode="M468"/></axsl:template>

<!--PATTERN sol-def_patchtst-->


	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:object" priority="1001" mode="M469">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:patch_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a patch_test must reference a patch_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M469"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:state" priority="1000" mode="M469">
...
<!--PATTERN sol-def_patch54_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_object//oval-def:filter" priority="1000" mode="M470"><axsl:variable name="parent_object" select="ancestor::sol-def:patch54_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_patchobj_dep-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_object" priority="1000" mode="M471">
...
<!--PATTERN sol-def_smftst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:object" priority="1001" mode="M472">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:smf_object/@id"/><axsl:otherwise>
                                          <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a smf_test must reference a smf_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M472"/></axsl:template>

	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:state" priority="1000" mode="M472">
...
<!--PATTERN sol-def_smf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_object//oval-def:filter" priority="1000" mode="M473"><axsl:variable name="parent_object" select="ancestor::sol-def:smf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_smfproperty_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_test/sol-def:object" priority="1001" mode="M474">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:smfproperty_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an smfproperty_test must reference an smfproperty_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M474"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_test/sol-def:state" priority="1000" mode="M474">
...
<!--PATTERN sol-def_smfproperty_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smfproperty_object//oval-def:filter" priority="1000" mode="M475"><axsl:variable name="parent_object" select="ancestor::sol-def:smfproperty_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_variant_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:variant_object//oval-def:filter" priority="1000" mode="M477"><axsl:variable name="parent_object" select="ancestor::sol-def:variant_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN sol-def_virtualizationinfo_test-->
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_test/sol-def:object" priority="1001" mode="M478">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/sol-def:virtualizationinfo_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an virtualizationinfo_test must reference a virtualizationinfo_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M478"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_test/sol-def:state" priority="1000" mode="M478">
...
<!--PATTERN sol-def_virtualizationinfo_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="sol-def:virtualizationinfo_object//oval-def:filter" priority="1000" mode="M479"><axsl:variable name="parent_object" select="ancestor::sol-def:virtualizationinfo_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_dnscache_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:dnscache_object//oval-def:filter" priority="1000" mode="M481"><axsl:variable name="parent_object" select="ancestor::unix-def:dnscache_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_filetst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_test/unix-def:object" priority="1001" mode="M482">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:file_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a file_test must reference a file_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M482"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:file_test/unix-def:state" priority="1000" mode="M482">
...
<!--PATTERN unix-def_file_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object//oval-def:filter" priority="1000" mode="M483"><axsl:variable name="parent_object" select="ancestor::unix-def:file_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_fileobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filepath" priority="1000" mode="M484">
...
<!--PATTERN unix-def_fileobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M485">
...
<!--PATTERN unix-def_fileobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M486">
...
<!--PATTERN unix-def_file_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filename" priority="1000" mode="M487">
...
<!--PATTERN unix-def_file_gid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:group_id" priority="1000" mode="M488">
...
<!--PATTERN unix-def_file_uid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:user_id" priority="1000" mode="M489">
...
<!--PATTERN unix-def_recurse_value_file_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/unix-def:file_object/unix-def:behaviors" priority="1000" mode="M490">
...
<axsl:if test="@recurse='files and directories'">DEPRECATED ATTRIBUTE VALUE IN: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ATTRIBUTE VALUE: <axsl:text/><axsl:value-of select="@recurse"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if>
		...
		<!--REPORT -->
<axsl:if test="@recurse='none'"> DEPRECATED ATTRIBUTE VALUE IN: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ATTRIBUTE VALUE: <axsl:text/><axsl:value-of select="@recurse"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M490"/></axsl:template><axsl:template match="text()" priority="-1" mode="M490"/><axsl:template match="@*|node()" priority="-2" mode="M490"><axsl:apply-templates select="@*|*" mode="M490"/></axsl:template>

<!--PATTERN unix-def_file_ea_tst-->


	<!--RULE -->
<axsl:template match="unix-def:filextendedattribute_test/unix-def:object" priority="1001" mode="M491">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:fileextendedattribute_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileextendedattribute_test must reference a fileextendedattribute_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M491"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_test/unix-def:state" priority="1000" mode="M491">
...
<!--PATTERN unix-def_fileextendedattribute_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object//oval-def:filter" priority="1000" mode="M492"><axsl:variable name="parent_object" select="ancestor::unix-def:fileextendedattribute_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_file_ea_objfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filepath" priority="1000" mode="M493">
...
<!--PATTERN unix-def_file_ea_objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M494">
...
<!--PATTERN unix-def_file_ea_objpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M495">
...
<!--PATTERN unix-def_fileextendedattribute_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:fileextendedattribute_object/unix-def:filename" priority="1000" mode="M496">
...
<!--PATTERN unix-def_gconf_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:gconf_object//oval-def:filter" priority="1000" mode="M498"><axsl:variable name="parent_object" select="ancestor::unix-def:gconf_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_gconfobjsource-->
	...
	<!--RULE -->
<axsl:template match="unix-def:gconf_object/unix-def:source" priority="1000" mode="M499">
...
<!--PATTERN unix-def_inetd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_object//oval-def:filter" priority="1000" mode="M501"><axsl:variable name="parent_object" select="ancestor::unix-def:inetd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_interfacetst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_test/unix-def:object" priority="1001" mode="M502">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:interface_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an interface_test must reference an interface_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M502"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_test/unix-def:state" priority="1000" mode="M502">
...
<!--PATTERN unix-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_object//oval-def:filter" priority="1000" mode="M503"><axsl:variable name="parent_object" select="ancestor::unix-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_passwordtst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:password_test/unix-def:object" priority="1001" mode="M504">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:password_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a password_test must reference a password_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M504"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:password_test/unix-def:state" priority="1000" mode="M504">
...
<!--PATTERN unix-def_password_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:password_object//oval-def:filter" priority="1000" mode="M505"><axsl:variable name="parent_object" select="ancestor::unix-def:password_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_processtst_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_test" priority="1000" mode="M506">
...
<!--PATTERN unix-def_processobj_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_object" priority="1000" mode="M508">
...
<!--PATTERN unix-def_processste_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state" priority="1000" mode="M509">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M509"/></axsl:template><axsl:template match="text()" priority="-1" mode="M509"/><axsl:template match="@*|node()" priority="-2" mode="M509"><axsl:apply-templates select="@*|*" mode="M509"/></axsl:template>

<!--PATTERN unix-def_process58tst-->


	<!--RULE -->
<axsl:template match="unix-def:process58_test/unix-def:object" priority="1001" mode="M510">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:process58_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process58_test must reference a process58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M510"/></axsl:template>

	<!--RULE -->
<axsl:template match="unix-def:process58_test/unix-def:state" priority="1000" mode="M510">
...
<!--PATTERN unix-def_process58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process58_object//oval-def:filter" priority="1000" mode="M511"><axsl:variable name="parent_object" select="ancestor::unix-def:process58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_routingtable_test-->
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_test/unix-def:object" priority="1001" mode="M512">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:routingtable_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a routingtable_test must reference an routingtable_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M512"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_test/unix-def:state" priority="1000" mode="M512">
...
<!--PATTERN unix-def_routingtable_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:routingtable_object//oval-def:filter" priority="1000" mode="M513"><axsl:variable name="parent_object" select="ancestor::unix-def:routingtable_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_runleveltst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_test/unix-def:object" priority="1001" mode="M514">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:runlevel_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a runlevel_test must reference a runlevel_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M514"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_test/unix-def:state" priority="1000" mode="M514">
...
<!--PATTERN unix-def_runlevel_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_object//oval-def:filter" priority="1000" mode="M515"><axsl:variable name="parent_object" select="ancestor::unix-def:runlevel_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sccstst_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_test" priority="1000" mode="M516">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M516"/></axsl:template><axsl:template match="text()" priority="-1" mode="M516"/><axsl:template match="@*|node()" priority="-2" mode="M516"><axsl:apply-templates select="@*|*" mode="M516"/></axsl:template>

<!--PATTERN unix-def_sccstst-->


	<!--RULE -->
<axsl:template match="unix-def:sccs_test/unix-def:object" priority="1001" mode="M517">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:sccs_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sccs_test must reference a sccs_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M517"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_test/unix-def:state" priority="1000" mode="M517">
...
<!--PATTERN unix-def_sccsobj_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object" priority="1000" mode="M518">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M518"/></axsl:template><axsl:template match="text()" priority="-1" mode="M518"/><axsl:template match="@*|node()" priority="-2" mode="M518"><axsl:apply-templates select="@*|*" mode="M518"/></axsl:template>

<!--PATTERN unix-def_sccs_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="unix-def:sccs_object//oval-def:filter" priority="1000" mode="M519"><axsl:variable name="parent_object" select="ancestor::unix-def:sccs_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sccsobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filepath" priority="1000" mode="M520">
...
<!--PATTERN unix-def_sccsobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M521">
...
<!--PATTERN unix-def_sccsobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M522">
...
<!--PATTERN unix-def_sccs_objectfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_object/unix-def:filename" priority="1000" mode="M523">
...
<!--PATTERN unix-def_sccsste_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state" priority="1000" mode="M524">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M524"/></axsl:template><axsl:template match="text()" priority="-1" mode="M524"/><axsl:template match="@*|node()" priority="-2" mode="M524"><axsl:apply-templates select="@*|*" mode="M524"/></axsl:template>

<!--PATTERN unix-def_shadowtst-->


	<!--RULE -->
<axsl:template match="unix-def:shadow_test/unix-def:object" priority="1001" mode="M525">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:shadow_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a shadow_test must reference a shadow_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M525"/></axsl:template>

	<!--RULE -->
<axsl:template match="unix-def:shadow_test/unix-def:state" priority="1000" mode="M525">
...
<!--PATTERN unix-def_shadow_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_object//oval-def:filter" priority="1000" mode="M526"><axsl:variable name="parent_object" select="ancestor::unix-def:shadow_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_symlink_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:symlink_object//oval-def:filter" priority="1000" mode="M528"><axsl:variable name="parent_object" select="ancestor::unix-def:symlink_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_sysctltst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_test/unix-def:object" priority="1001" mode="M529">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:sysctl_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sysctl_test must reference a sysctl_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M529"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_test/unix-def:state" priority="1000" mode="M529">
...
<!--PATTERN unix-def_sysctl_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sysctl_object//oval-def:filter" priority="1000" mode="M530"><axsl:variable name="parent_object" select="ancestor::unix-def:sysctl_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN unix-def_unametst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_test/unix-def:object" priority="1001" mode="M531">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/unix-def:uname_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a uname_test must reference a uname_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M531"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_test/unix-def:state" priority="1000" mode="M531">
...
<!--PATTERN unix-def_xinetd_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_object//oval-def:filter" priority="1000" mode="M533"><axsl:variable name="parent_object" select="ancestor::unix-def:xinetd_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_accesstokentst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test" priority="1000" mode="M534">
...
<!--PATTERN win-def_accesstokenobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_object" priority="1000" mode="M536">
...
<!--PATTERN win-def_accesstoken_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_object//oval-def:filter" priority="1000" mode="M537"><axsl:variable name="parent_object" select="ancestor::win-def:accesstoken_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_accesstokenste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state" priority="1000" mode="M538">
...
<!--PATTERN win-def_at_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:accesstoken_object/win-def:behaviors" priority="1000" mode="M540">
...
<!--PATTERN win-def_activedirectory57tst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_test" priority="1000" mode="M542">
...
<!--PATTERN win-def_activedirectory57_test-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_test/win-def:object" priority="1001" mode="M543">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:activedirectory57_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an activedirectory57_test must reference an activedirectory57_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M543"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_test/win-def:state" priority="1000" mode="M543">
...
<!--PATTERN win-def_activedirectory57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_object//oval-def:filter" priority="1000" mode="M544"><axsl:variable name="parent_object" select="ancestor::win-def:activedirectory57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_activedirectory57obj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_object" priority="1000" mode="M545">
...
<!--PATTERN win-def_activedirectory57ste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory57_state" priority="1000" mode="M546">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M546"/></axsl:template><axsl:template match="text()" priority="-1" mode="M546"/><axsl:template match="@*|node()" priority="-2" mode="M546"><axsl:apply-templates select="@*|*" mode="M546"/></axsl:template>

<!--PATTERN win-def_ad57stevalue-->


	<!--RULE -->
<axsl:template match="win-def:activedirectory57_state/win-def:value" priority="1000" mode="M547">
...
<!--PATTERN win-def_aeptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:object" priority="1001" mode="M548">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicy_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an auditeventpolicy_test must reference an auditeventpolicy_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M548"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:state" priority="1000" mode="M548">
...
<!--PATTERN win-def_aepstst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:object" priority="1001" mode="M549">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicysubcategories_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an auditeventpolicysubcategories_test must reference an auditeventpolicysubcategories_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M549"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:state" priority="1000" mode="M549">
...
<!--PATTERN win-def_auditeventpolicysubcategoriesstatekerberos_ticket_events-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:kerberos_ticket_events" priority="1000" mode="M550">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M550"/></axsl:template><axsl:template match="text()" priority="-1" mode="M550"/><axsl:template match="@*|node()" priority="-2" mode="M550"><axsl:apply-templates select="@*|*" mode="M550"/></axsl:template>

<!--PATTERN win-def_cmdlet_test-->


	<!--RULE -->
<axsl:template match="win-def:cmdlet_test/win-def:object" priority="1001" mode="M551">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:cmdlet_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a cmdlet_test must reference a cmdlet_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M551"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:cmdlet_test/win-def:state" priority="1000" mode="M551">
...
<!--PATTERN win-def_cmdlet_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object//oval-def:filter" priority="1000" mode="M552"><axsl:variable name="parent_object" select="ancestor::win-def:cmdlet_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_cmdletobjmodule_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:module_name" priority="1000" mode="M553">
...
<!--PATTERN win-def_cmdletobjmodule_id-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:module_id" priority="1000" mode="M554">
...
<!--PATTERN win-def_cmdletobjverb-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:verb" priority="1000" mode="M555">
...
<!--PATTERN win-def_cmdletobjnoun-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:noun" priority="1000" mode="M556">
...
<!--PATTERN win-def_cmdletobjparameters-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:parameters" priority="1000" mode="M557">
...
<!--PATTERN win-def_cmdletobjselect-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_object/win-def:select" priority="1000" mode="M558">
...
<!--PATTERN win-def_cmdletsteparameters-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:parameters" priority="1000" mode="M559">
...
<!--PATTERN win-def_cmdletsteselect-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:select" priority="1000" mode="M560">
...
<!--PATTERN win-def_cmdletstevalue-->
	...
	<!--RULE -->
<axsl:template match="win-def:cmdlet_state/win-def:value" priority="1000" mode="M561">
...
<!--PATTERN win-def_dnscache_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:dnscache_object//oval-def:filter" priority="1000" mode="M563"><axsl:variable name="parent_object" select="ancestor::win-def:dnscache_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_file_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object//oval-def:filter" priority="1000" mode="M565"><axsl:variable name="parent_object" select="ancestor::win-def:file_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fileobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filepath" priority="1000" mode="M566">
...
<!--PATTERN win-def_fileobjfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M567">
...
<!--PATTERN win-def_fileobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M568">
...
<!--PATTERN win-def_fileobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filename" priority="1000" mode="M569">
...
<!--PATTERN win-def_filestefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:filename" priority="1000" mode="M570">
...
<!--PATTERN win-def_fap53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:object" priority="1001" mode="M571">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileauditedpermissions53_test must reference a fileauditedpermissions53_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M571"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:state" priority="1000" mode="M571">
...
<!--PATTERN win-def_fileauditedpermissions53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object//oval-def:filter" priority="1000" mode="M572"><axsl:variable name="parent_object" select="ancestor::win-def:fileauditedpermissions53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fap53objfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filepath" priority="1000" mode="M573">
...
<!--PATTERN win-def_fap53objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M574">
...
<!--PATTERN win-def_fap53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M575">
...
<!--PATTERN win-def_fap53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filename" priority="1000" mode="M576">
...
<!--PATTERN win-def_fap53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:filename" priority="1000" mode="M577">
...
<!--PATTERN win-def_fap53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M579">
...
<!--PATTERN win-def_faptst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test" priority="1000" mode="M580">
...
<!--PATTERN win-def_faptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:object" priority="1001" mode="M581">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileauditedpermissions_test must reference a fileauditedpermissions_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M581"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:state" priority="1000" mode="M581">
...
<!--PATTERN win-def_fapobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object" priority="1000" mode="M582">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M582"/></axsl:template><axsl:template match="text()" priority="-1" mode="M582"/><axsl:template match="@*|node()" priority="-2" mode="M582"><axsl:apply-templates select="@*|*" mode="M582"/></axsl:template>

<!--PATTERN win-def_fapobjfilename-->


	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object/win-def:filename" priority="1000" mode="M583">
...
<!--PATTERN win-def_fapste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state" priority="1000" mode="M584">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M584"/></axsl:template><axsl:template match="text()" priority="-1" mode="M584"/><axsl:template match="@*|node()" priority="-2" mode="M584"><axsl:apply-templates select="@*|*" mode="M584"/></axsl:template>

<!--PATTERN win-def_fapstefilename-->


	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:filename" priority="1000" mode="M585">
...
<!--PATTERN win-def_fap_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/win-def:behaviors" priority="1000" mode="M587">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: fileauditedpermissions_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M587"/></axsl:template><axsl:template match="text()" priority="-1" mode="M587"/><axsl:template match="@*|node()" priority="-2" mode="M587"><axsl:apply-templates select="@*|*" mode="M587"/></axsl:template>

<!--PATTERN win-def_fer53tst-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_test/win-def:object" priority="1001" mode="M588">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights53_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileeffectiverights53_test must reference a fileeffectiverights53_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M588"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_test/win-def:state" priority="1000" mode="M588">
...
<!--PATTERN win-def_fileeffectiverights53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object//oval-def:filter" priority="1000" mode="M589"><axsl:variable name="parent_object" select="ancestor::win-def:fileeffectiverights53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_fer53objfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filepath" priority="1000" mode="M590">
...
<!--PATTERN win-def_fer53objfilepath2-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M591">
...
<!--PATTERN win-def_fer53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:path[not(@operation='equals' or not(@operation))]" priority="1000" mode="M592">
...
<!--PATTERN win-def_fer53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filename" priority="1000" mode="M593">
...
<!--PATTERN win-def_fer53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:filename" priority="1000" mode="M594">
...
<!--PATTERN win-def_ffr53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights53_object/win-def:behaviors" priority="1000" mode="M596">
...
<!--PATTERN win-def_fertst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test" priority="1000" mode="M597">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M597"/></axsl:template><axsl:template match="text()" priority="-1" mode="M597"/><axsl:template match="@*|node()" priority="-2" mode="M597"><axsl:apply-templates select="@*|*" mode="M597"/></axsl:template>

<!--PATTERN win-def_fertst-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:object" priority="1001" mode="M598">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileeffectiverights_test must reference a fileeffectiverights_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M598"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:state" priority="1000" mode="M598">
...
<!--PATTERN win-def_ferobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object" priority="1000" mode="M599">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M599"/></axsl:template><axsl:template match="text()" priority="-1" mode="M599"/><axsl:template match="@*|node()" priority="-2" mode="M599"><axsl:apply-templates select="@*|*" mode="M599"/></axsl:template>

<!--PATTERN win-def_fefobjfilename-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object/win-def:filename" priority="1000" mode="M600">
...
<!--PATTERN win-def_ferste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state" priority="1000" mode="M601">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M601"/></axsl:template><axsl:template match="text()" priority="-1" mode="M601"/><axsl:template match="@*|node()" priority="-2" mode="M601"><axsl:apply-templates select="@*|*" mode="M601"/></axsl:template>

<!--PATTERN win-def_ferstefilename-->


	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:filename" priority="1000" mode="M602">
...
<!--PATTERN win-def_ffr_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/win-def:behaviors" priority="1000" mode="M604">
...
<!--PATTERN win-def_grouptst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_test" priority="1000" mode="M605">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M605"/></axsl:template><axsl:template match="text()" priority="-1" mode="M605"/><axsl:template match="@*|node()" priority="-2" mode="M605"><axsl:apply-templates select="@*|*" mode="M605"/></axsl:template>

<!--PATTERN win-def_grouptst-->


	<!--RULE -->
<axsl:template match="win-def:group_test/win-def:object" priority="1001" mode="M606">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:group_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a group_test must reference a group_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M606"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:group_test/win-def:state" priority="1000" mode="M606">
...
<!--PATTERN win-def_groupobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_object" priority="1000" mode="M607">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M607"/></axsl:template><axsl:template match="text()" priority="-1" mode="M607"/><axsl:template match="@*|node()" priority="-2" mode="M607"><axsl:apply-templates select="@*|*" mode="M607"/></axsl:template>

<!--PATTERN win-def_group_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="win-def:group_object//oval-def:filter" priority="1000" mode="M608"><axsl:variable name="parent_object" select="ancestor::win-def:group_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_groupste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_state" priority="1000" mode="M609">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M609"/></axsl:template><axsl:template match="text()" priority="-1" mode="M609"/><axsl:template match="@*|node()" priority="-2" mode="M609"><axsl:apply-templates select="@*|*" mode="M609"/></axsl:template>

<!--PATTERN win-def_groupsidtst-->


	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:object" priority="1001" mode="M610">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:group_sid_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a group_sid_test must reference a group_sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M610"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:state" priority="1000" mode="M610">
...
<!--PATTERN win-def_group_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_object//oval-def:filter" priority="1000" mode="M611"><axsl:variable name="parent_object" select="ancestor::win-def:group_sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_interface_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_object//oval-def:filter" priority="1000" mode="M613"><axsl:variable name="parent_object" select="ancestor::win-def:interface_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_junction_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:junction_object//oval-def:filter" priority="1000" mode="M615"><axsl:variable name="parent_object" select="ancestor::win-def:junction_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_lps_fl-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:force_logoff" priority="1000" mode="M617">
...
<!--PATTERN win-def_lps_ld-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:lockout_duration" priority="1000" mode="M618">
...
<!--PATTERN win-def_metabase_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_object//oval-def:filter" priority="1000" mode="M620"><axsl:variable name="parent_object" select="ancestor::win-def:metabase_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_ntusertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_test/win-def:object" priority="1001" mode="M621">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:ntuser_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child
                                          element of a ntuser_test must reference a ntuser_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M621"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:ntuser_test/win-def:state" priority="1000" mode="M621">
...
<!--PATTERN win-def_ntuser_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_object//oval-def:filter" priority="1000" mode="M622"><axsl:variable name="parent_object" select="ancestor::win-def:ntuser_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_ntuserobjkey2-->
	...
	<!--RULE -->
<axsl:template match="win-def:ntuser_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M623">
...
<!--PATTERN win-def_pwp_mpa-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:max_passwd_age" priority="1000" mode="M625">
...
<!--PATTERN win-def_peheaderobjfilepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filepath" priority="1000" mode="M626">
...
<!--PATTERN win-def_peheaderobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filepath[not(@operation='equals' or not(@operation))]" priority="1000" mode="M628">
...
<!--PATTERN win-def_peheaderobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_object/win-def:filename" priority="1000" mode="M629">
...
<!--PATTERN win-def_peheaderstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:peheader_state/win-def:filename" priority="1000" mode="M630">
...
<!--PATTERN win-def_port_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_object//oval-def:filter" priority="1000" mode="M632"><axsl:variable name="parent_object" select="ancestor::win-def:port_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_printereffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_object//oval-def:filter" priority="1000" mode="M634"><axsl:variable name="parent_object" select="ancestor::win-def:printereffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_pef_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:printereffectiverights_object/win-def:behaviors" priority="1000" mode="M636">
...
<!--PATTERN win-def_processtst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_test" priority="1000" mode="M637">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M637"/></axsl:template><axsl:template match="text()" priority="-1" mode="M637"/><axsl:template match="@*|node()" priority="-2" mode="M637"><axsl:apply-templates select="@*|*" mode="M637"/></axsl:template>

<!--PATTERN win-def_processtst-->


	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:object" priority="1001" mode="M638">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:process_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process_test must reference a process_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M638"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:state" priority="1000" mode="M638">
...
<!--PATTERN win-def_processobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_object" priority="1000" mode="M639">
...
<!--PATTERN win-def_processste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state" priority="1000" mode="M640">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M640"/></axsl:template><axsl:template match="text()" priority="-1" mode="M640"/><axsl:template match="@*|node()" priority="-2" mode="M640"><axsl:apply-templates select="@*|*" mode="M640"/></axsl:template>

<!--PATTERN win-def_process58tst-->


	<!--RULE -->
<axsl:template match="win-def:process58_test/win-def:object" priority="1001" mode="M641">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:process58_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process58_test must reference a process58_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M641"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:process58_test/win-def:state" priority="1000" mode="M641">
...
<!--PATTERN win-def_process58_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:process58_object//oval-def:filter" priority="1000" mode="M642"><axsl:variable name="parent_object" select="ancestor::win-def:process58_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_registry_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object//oval-def:filter" priority="1000" mode="M644"><axsl:variable name="parent_object" select="ancestor::win-def:registry_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regobjkey2-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M645">
...
<!--PATTERN win-def_regkeyauditedpermissions53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object//oval-def:filter" priority="1000" mode="M647"><axsl:variable name="parent_object" select="ancestor::win-def:regkeyauditedpermissions53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regkeyauditedpermissions53_objectkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M648">
...
<!--PATTERN win-def_rap53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_synchronize" priority="1000" mode="M649">
...
<!--PATTERN win-def_rka53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions53_object/win-def:behaviors" priority="1000" mode="M651">
...
<!--PATTERN win-def_raptst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test" priority="1000" mode="M652">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M652"/></axsl:template><axsl:template match="text()" priority="-1" mode="M652"/><axsl:template match="@*|node()" priority="-2" mode="M652"><axsl:apply-templates select="@*|*" mode="M652"/></axsl:template>

<!--PATTERN win-def_raptst-->


	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test/win-def:object" priority="1001" mode="M653">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a regkeyauditedpermissions_test must reference a regkeyauditedpermissions_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M653"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test/win-def:state" priority="1000" mode="M653">
...
<!--PATTERN win-def_rapobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object" priority="1000" mode="M654">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M654"/></axsl:template><axsl:template match="text()" priority="-1" mode="M654"/><axsl:template match="@*|node()" priority="-2" mode="M654"><axsl:apply-templates select="@*|*" mode="M654"/></axsl:template>

<!--PATTERN win-def_regkeyauditedpermissions_objectkey-->


	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M655">
...
<!--PATTERN win-def_rapste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state" priority="1000" mode="M656">
...
<!--PATTERN win-def_rka_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyauditedpermissions_object/win-def:behaviors" priority="1000" mode="M658">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: regkeyauditedpermissions_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M658"/></axsl:template><axsl:template match="text()" priority="-1" mode="M658"/><axsl:template match="@*|node()" priority="-2" mode="M658"><axsl:apply-templates select="@*|*" mode="M658"/></axsl:template>

<!--PATTERN win-def_rer53tst-->


	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_test/win-def:object" priority="1001" mode="M659">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights53_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a regkeyeffectiverights53_test must reference a regkeyeffectiverights53_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M659"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_test/win-def:state" priority="1000" mode="M659">
...
<!--PATTERN win-def_regkeyeffectiverights53_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object//oval-def:filter" priority="1000" mode="M660"><axsl:variable name="parent_object" select="ancestor::win-def:regkeyeffectiverights53_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_regkeyeffectiverights53_objectkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M661">
...
<!--PATTERN win-def_rer53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_synchronize" priority="1000" mode="M662">
...
<!--PATTERN win-def_rke53_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights53_object/win-def:behaviors" priority="1000" mode="M664">
...
<!--PATTERN win-def_rertst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test" priority="1000" mode="M665">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M665"/></axsl:template><axsl:template match="text()" priority="-1" mode="M665"/><axsl:template match="@*|node()" priority="-2" mode="M665"><axsl:apply-templates select="@*|*" mode="M665"/></axsl:template>

<!--PATTERN win-def_rertst-->


	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test/win-def:object" priority="1001" mode="M666">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a regkeyeffectiverights_test must reference a regkeyeffectiverights_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M666"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test/win-def:state" priority="1000" mode="M666">
...
<!--PATTERN win-def_rerobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object" priority="1000" mode="M667">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M667"/></axsl:template><axsl:template match="text()" priority="-1" mode="M667"/><axsl:template match="@*|node()" priority="-2" mode="M667"><axsl:apply-templates select="@*|*" mode="M667"/></axsl:template>

<!--PATTERN win-def_regkeyeffectiverights_objectkey-->


	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object/win-def:key[not(@operation='equals' or not(@operation))]" priority="1000" mode="M668">
...
<!--PATTERN win-def_rerste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state" priority="1000" mode="M669">
...
<!--PATTERN win-def_rke_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:regkeyeffectiverights_object/win-def:behaviors" priority="1000" mode="M671">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: regkeyeffectiverights_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M671"/></axsl:template><axsl:template match="text()" priority="-1" mode="M671"/><axsl:template match="@*|node()" priority="-2" mode="M671"><axsl:apply-templates select="@*|*" mode="M671"/></axsl:template>

<!--PATTERN win-def_servicetst-->


	<!--RULE -->
<axsl:template match="win-def:service_test/win-def:object" priority="1001" mode="M672">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:service_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a service_test must reference a service_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M672"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:service_test/win-def:state" priority="1000" mode="M672">
...
<!--PATTERN win-def_service_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:service_object//oval-def:filter" priority="1000" mode="M673"><axsl:variable name="parent_object" select="ancestor::win-def:service_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_serviceeffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:serviceeffectiverights_object//oval-def:filter" priority="1000" mode="M675"><axsl:variable name="parent_object" select="ancestor::win-def:serviceeffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sef_resolve_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:serviceeffectiverights_object/win-def:behaviors" priority="1000" mode="M677">

		<!--REPORT -->
<axsl:if test="@resolve_group">DEPRECATED BEHAVIOR IN: serviceeffectiverights_object <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M677"/></axsl:template><axsl:template match="text()" priority="-1" mode="M677"/><axsl:template match="@*|node()" priority="-2" mode="M677"><axsl:apply-templates select="@*|*" mode="M677"/></axsl:template>

<!--PATTERN win-def_srtst-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:object" priority="1001" mode="M678">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sharedresource_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sharedresource_test must reference a sharedresource_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M678"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:state" priority="1000" mode="M678">
...
<!--PATTERN win-def_sharedresource_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_object//oval-def:filter" priority="1000" mode="M679"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresource_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sraptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_test/win-def:object" priority="1001" mode="M680">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceauditedpermissions_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sharedresourceauditedpermissions_test must reference a sharedresourceauditedpermissions_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M680"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_test/win-def:state" priority="1000" mode="M680">
...
<!--PATTERN win-def_sharedresourceauditedpermissions_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceauditedpermissions_object//oval-def:filter" priority="1000" mode="M681"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresourceauditedpermissions_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sra_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceauditedpermissions_object/win-def:behaviors" priority="1000" mode="M682">

		<!--REPORT -->
<axsl:if test="@include_group">DEPRECATED BEHAVIOR IN: win-def:sharedresourceauditedpermissions_object<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M682"/></axsl:template><axsl:template match="text()" priority="-1" mode="M682"/><axsl:template match="@*|node()" priority="-2" mode="M682"><axsl:apply-templates select="@*|*" mode="M682"/></axsl:template>

<!--PATTERN win-def_srertst-->


	<!--RULE -->
<axsl:template match="win-def:sharedresourceeffectiverights_test/win-def:object" priority="1001" mode="M683">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceeffectiverights_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sharedresourceeffectiverights_test must reference a sharedresourceeffectiverights_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M683"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sharedresourceeffectiverights_test/win-def:state" priority="1000" mode="M683">
...
<!--PATTERN win-def_sharedresourceeffectiverights_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresourceeffectiverights_object//oval-def:filter" priority="1000" mode="M684"><axsl:variable name="parent_object" select="ancestor::win-def:sharedresourceeffectiverights_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sre_include_group_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:objects/win-def:sharedresourceeffectiverights_object/win-def:behaviors" priority="1000" mode="M685">

		<!--REPORT -->
<axsl:if test="@include_group">DEPRECATED BEHAVIOR IN: win-def:sharedresourceeffectiverights_object<axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M685"/></axsl:template><axsl:template match="text()" priority="-1" mode="M685"/><axsl:template match="@*|node()" priority="-2" mode="M685"><axsl:apply-templates select="@*|*" mode="M685"/></axsl:template>

<!--PATTERN win-def_sidtst-->


	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:object" priority="1001" mode="M686">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:sid_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sid_test must reference a sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M686"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:state" priority="1000" mode="M686">
...
<!--PATTERN win-def_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_object//oval-def:filter" priority="1000" mode="M687"><axsl:variable name="parent_object" select="ancestor::win-def:sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_sid_sid_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_object//oval-def:filter" priority="1000" mode="M689"><axsl:variable name="parent_object" select="ancestor::win-def:sid_sid_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_usertst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_test" priority="1000" mode="M691">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M691"/></axsl:template><axsl:template match="text()" priority="-1" mode="M691"/><axsl:template match="@*|node()" priority="-2" mode="M691"><axsl:apply-templates select="@*|*" mode="M691"/></axsl:template>

<!--PATTERN win-def_usertst-->


	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:object" priority="1001" mode="M692">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_test must reference a user_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M692"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:state" priority="1000" mode="M692">
...
<!--PATTERN win-def_userobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_object" priority="1000" mode="M693">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M693"/></axsl:template><axsl:template match="text()" priority="-1" mode="M693"/><axsl:template match="@*|node()" priority="-2" mode="M693"><axsl:apply-templates select="@*|*" mode="M693"/></axsl:template>

<!--PATTERN win-def_user_object_verify_filter_state-->


	<!--RULE -->
<axsl:template match="win-def:user_object//oval-def:filter" priority="1000" mode="M694"><axsl:variable name="parent_object" select="ancestor::win-def:user_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_userste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_state" priority="1000" mode="M695">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M695"/></axsl:template><axsl:template match="text()" priority="-1" mode="M695"/><axsl:template match="@*|node()" priority="-2" mode="M695"><axsl:apply-templates select="@*|*" mode="M695"/></axsl:template>

<!--PATTERN win-def_usersid55tst-->


	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:object" priority="1001" mode="M696">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_sid55_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_sid55_test must reference a user_sid55_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M696"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:state" priority="1000" mode="M696">
...
<!--PATTERN win-def_user_sid55_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid55_object//oval-def:filter" priority="1000" mode="M697"><axsl:variable name="parent_object" select="ancestor::win-def:user_sid55_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_usersidtst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_test" priority="1000" mode="M698">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M698"/></axsl:template><axsl:template match="text()" priority="-1" mode="M698"/><axsl:template match="@*|node()" priority="-2" mode="M698"><axsl:apply-templates select="@*|*" mode="M698"/></axsl:template>

<!--PATTERN win-def_usersidtst-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:object" priority="1001" mode="M699">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:user_sid_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_sid_test must reference a user_sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M699"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:state" priority="1000" mode="M699">
...
<!--PATTERN win-def_usersidobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_object" priority="1000" mode="M700">
...
<!--PATTERN win-def_usersidste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid_state" priority="1000" mode="M701">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M701"/></axsl:template><axsl:template match="text()" priority="-1" mode="M701"/><axsl:template match="@*|node()" priority="-2" mode="M701"><axsl:apply-templates select="@*|*" mode="M701"/></axsl:template>

<!--PATTERN win-def_userrighttst-->


	<!--RULE -->
<axsl:template match="win-def:userright_test/win-def:object" priority="1001" mode="M702">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:userright_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a userright_test must reference a userright_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M702"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:userright_test/win-def:state" priority="1000" mode="M702">
...
<!--PATTERN win-def_userright_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:userright_object//oval-def:filter" priority="1000" mode="M703"><axsl:variable name="parent_object" select="ancestor::win-def:userright_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_volume_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:volume_object//oval-def:filter" priority="1000" mode="M705"><axsl:variable name="parent_object" select="ancestor::win-def:volume_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wmitst_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_test" priority="1000" mode="M706">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED TEST: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M706"/></axsl:template><axsl:template match="text()" priority="-1" mode="M706"/><axsl:template match="@*|node()" priority="-2" mode="M706"><axsl:apply-templates select="@*|*" mode="M706"/></axsl:template>

<!--PATTERN win-def_wmitst-->


	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:object" priority="1001" mode="M707">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wmi_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a wmi_test must reference a wmi_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M707"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:state" priority="1000" mode="M707">
...
<!--PATTERN win-def_wmiobj_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_object" priority="1000" mode="M708">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED OBJECT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M708"/></axsl:template><axsl:template match="text()" priority="-1" mode="M708"/><axsl:template match="@*|node()" priority="-2" mode="M708"><axsl:apply-templates select="@*|*" mode="M708"/></axsl:template>

<!--PATTERN win-def_wmiobjnamespace-->


	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:namespace" priority="1000" mode="M709">
...
<!--PATTERN win-def_wmiobjwql-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:wql" priority="1000" mode="M710">
...
<!--PATTERN win-def_wmiste_dep-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi_state" priority="1000" mode="M711">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED STATE: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M711"/></axsl:template><axsl:template match="text()" priority="-1" mode="M711"/><axsl:template match="@*|node()" priority="-2" mode="M711"><axsl:apply-templates select="@*|*" mode="M711"/></axsl:template>

<!--PATTERN win-def_wmi57tst-->


	<!--RULE -->
<axsl:template match="win-def:wmi57_test/win-def:object" priority="1001" mode="M712">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wmi57_object/@id"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a wmi57_test must reference a wmi57_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M712"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:wmi57_test/win-def:state" priority="1000" mode="M712">
...
<!--PATTERN win-def_wmi57_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object//oval-def:filter" priority="1000" mode="M713"><axsl:variable name="parent_object" select="ancestor::win-def:wmi57_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wmi57objnamespace-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object/win-def:namespace" priority="1000" mode="M714">
...
<!--PATTERN win-def_wmi57objwql-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_object/win-def:wql" priority="1000" mode="M715">
...
<!--PATTERN win-def_wmi57steresult-->
	...
	<!--RULE -->
<axsl:template match="win-def:wmi57_state/win-def:result" priority="1000" mode="M716">
...
<!--PATTERN win-def_wuaupdatesearchertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:object" priority="1001" mode="M717">
...
<axsl:choose><axsl:when test="@object_ref=ancestor::oval-def:oval_definitions/oval-def:objects/win-def:wuaupdatesearcher_object/@id"/><axsl:otherwise>
                        ...
                        <axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M717"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:state" priority="1000" mode="M717">
...
<!--PATTERN win-def_wuaupdatesearcher_object_verify_filter_state-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_object//oval-def:filter" priority="1000" mode="M718"><axsl:variable name="parent_object" select="ancestor::win-def:wuaupdatesearcher_object"/><axsl:variable name="parent_object_id" select="$parent_object/@id"/><axsl:variable name="state_ref" select="."/><axsl:variable name="reffed_state" select="ancestor::oval-def:oval_definitions/oval-def:states/*[@id=$state_ref]"/><axsl:variable name="state_name" select="local-name($reffed_state)"/><axsl:variable name="state_namespace" select="namespace-uri($reffed_state)"/>
...
<!--PATTERN win-def_wuaupdatesearcherobjsearchcriteria-->
	...
	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_object/win-def:search_criteria" priority="1000" mode="M719">
...
<!--PATTERN win-def_sft_file_attribute_directory_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/win-def:file_state/win-def:type" priority="1000" mode="M720">
...
<!--PATTERN win-def_ssr_stype_temporary_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions/oval-def:states/win-def:sharedresource_state/win-def:shared_type" priority="1000" mode="M722">
...
<!--PATTERN apache-sc_httpd_item_dep-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item" priority="1000" mode="M723">
...
<!--PATTERN catos-sc_versionitemcatos_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_major_release" priority="1000" mode="M724">
...
<!--PATTERN catos-sc_versionitemcatos_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_individual_release" priority="1000" mode="M725">
...
<!--PATTERN catos-sc_versionitemcatos_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_version_id" priority="1000" mode="M726">
...
<!--PATTERN esx-sc_patchitempatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:patch_number" priority="1000" mode="M727">
...
<!--PATTERN ind-sc_filehash_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item" priority="1000" mode="M728">
...
<!--PATTERN ind-sc_environmentvariable_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:environmentvariable_item" priority="1000" mode="M729">
...
<!--PATTERN ind-sc_ldap57_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:ldap57_item" priority="1000" mode="M730">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M730"/></axsl:template><axsl:template match="text()" priority="-1" mode="M730"/><axsl:template match="@*|node()" priority="-2" mode="M730"><axsl:apply-templates select="@*|*" mode="M730"/></axsl:template>

<!--PATTERN ind-sc_ldap57_itemvalue-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap57_item/ind-sc:value" priority="1000" mode="M731">
...
<!--PATTERN ind-sc_sql_item_dep-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item" priority="1000" mode="M732">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M732"/></axsl:template><axsl:template match="text()" priority="-1" mode="M732"/><axsl:template match="@*|node()" priority="-2" mode="M732"><axsl:apply-templates select="@*|*" mode="M732"/></axsl:template>

<!--PATTERN ind-sc_sql57_itemresult-->


	<!--RULE -->
<axsl:template match="ind-sc:sql57_item/ind-sc:result" priority="1000" mode="M733">
...
<!--PATTERN win-sc_tfc_i-->
	...
	<!--RULE -->
<axsl:template match="win-sc:textfilecontent_item/win-sc:instance" priority="1000" mode="M734">
...
<!--PATTERN ind-sc_txtitemline-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:line" priority="1000" mode="M735">
...
<!--PATTERN ind-sc_ldaptype_email_value_dep-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap_item/ind-sc:ldaptype|oval-sc:oval_system_characteristics/oval-sc:system_data/ind-sc:ldap57_item/ind-sc:ldaptype" priority="1000" mode="M737">
...
<!--PATTERN ios-sc_interfaceitemnoipdbc-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:no_ip_directed_broadcast_command" priority="1000" mode="M738">
...
<!--PATTERN ios-sc_interfaceitem_urpf_command_dep-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:urpf_command" priority="1000" mode="M739">
...
<!--PATTERN ios-sc_versionitemmajor_release-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:major_release" priority="1000" mode="M740">
...
<!--PATTERN ios-sc_versionitemtrain_number-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:train_number" priority="1000" mode="M741">
...
<!--PATTERN linux-sc_dpkginfoitemevrstring_id-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:evr" priority="1000" mode="M742">
...
<!--PATTERN linux-sc_rpmverify_item_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverify_item" priority="1000" mode="M743">
...
<!--PATTERN linux-sc_rpmverifypackage_dicp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverifypackage_item/linux-sc:digest_check_passed" priority="1000" mode="M744">
...
<!--PATTERN linux-sc_rpmverifypackage_sigcp_dep-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpmverifypackage_item/linux-sc:signature_check_passed" priority="1000" mode="M745">
...
<!--PATTERN macos-sc_inetlisteningserveritem_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item" priority="1000" mode="M746">
...
<!--PATTERN macos-sc_plistitem_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:plist_item" priority="1000" mode="M747">
...
<!--PATTERN macos-sc_pwpolicy_item_dep-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item" priority="1000" mode="M748">
...
<!--PATTERN sp-sc_spjobdefinition_item_dep-->
	...
	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item" priority="1000" mode="M749">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M749"/></axsl:template><axsl:template match="text()" priority="-1" mode="M749"/><axsl:template match="@*|node()" priority="-2" mode="M749"><axsl:apply-templates select="@*|*" mode="M749"/></axsl:template>

<!--PATTERN unix-sc_file_gid-->


	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:group_id" priority="1000" mode="M750">
...
<!--PATTERN unix-sc_file_uid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:user_id" priority="1000" mode="M751">
...
<!--PATTERN unix-sc_processitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item" priority="1000" mode="M752">
...
<!--PATTERN unix-sc_sccsitem_dep-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item" priority="1000" mode="M753">
...
<!--PATTERN win-sc_accesstoken_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item" priority="1000" mode="M754">
...
<!--PATTERN win-sc_activedirectory57_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item" priority="1000" mode="M755">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M755"/></axsl:template><axsl:template match="text()" priority="-1" mode="M755"/><axsl:template match="@*|node()" priority="-2" mode="M755"><axsl:apply-templates select="@*|*" mode="M755"/></axsl:template>

<!--PATTERN win-sc_activedirectory57_itemvalue-->


	<!--RULE -->
<axsl:template match="win-sc:activedirectory57_item/win-sc:value" priority="1000" mode="M756">
...
<!--PATTERN win-sc_auditeventpolicysubcategoriesitemkerberos_ticket_events-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:kerberos_ticket_events" priority="1000" mode="M757">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M757"/></axsl:template><axsl:template match="text()" priority="-1" mode="M757"/><axsl:template match="@*|node()" priority="-2" mode="M757"><axsl:apply-templates select="@*|*" mode="M757"/></axsl:template>

<!--PATTERN win-sc_cmdletitemparameters-->


	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:parameters" priority="1000" mode="M758">
...
<!--PATTERN win-sc_cmdletitemselect-->
	...
	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:select" priority="1000" mode="M759">
...
<!--PATTERN win-sc_cmdletitemvalue-->
	...
	<!--RULE -->
<axsl:template match="win-sc:cmdlet_item/win-sc:value" priority="1000" mode="M760">
...
<!--PATTERN win-sc_fileaudititemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M761">
...
<!--PATTERN win-sc_feritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M762">
...
<!--PATTERN win-sc_group_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:group_item" priority="1000" mode="M763">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M763"/></axsl:template><axsl:template match="text()" priority="-1" mode="M763"/><axsl:template match="@*|node()" priority="-2" mode="M763"><axsl:apply-templates select="@*|*" mode="M763"/></axsl:template>

<!--PATTERN win-sc_lpi_fl-->


	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:force_logoff" priority="1000" mode="M764">
...
<!--PATTERN win-sc_lpi_ld-->
	...
	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:lockout_duration" priority="1000" mode="M765">
...
<!--PATTERN win-sc_pwp_mpa-->
	...
	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:max_passwd_age" priority="1000" mode="M766">
...
<!--PATTERN win-sc_rapitemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M767">
...
<!--PATTERN win-sc_rapitemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M768">
...
<!--PATTERN win-sc_reritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M769">
...
<!--PATTERN win-sc_reritemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M770">
...
<!--PATTERN win-sc_user_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:user_item" priority="1000" mode="M771">
...
<!--PATTERN win-sc_wmi_item_dep-->
	...
	<!--RULE -->
<axsl:template match="win-sc:wmi_item" priority="1000" mode="M772">

		<!--REPORT -->
<axsl:if test="true()">DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/><axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*" mode="M772"/></axsl:template><axsl:template match="text()" priority="-1" mode="M772"/><axsl:template match="@*|node()" priority="-2" mode="M772"><axsl:apply-templates select="@*|*" mode="M772"/></axsl:template>

<!--PATTERN win-sc_wmi57_itemresult-->


	<!--RULE -->
<axsl:template match="win-sc:wmi57_item/win-sc:result" priority="1000" mode="M773">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='record'"/><axsl:otherwise><axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the result entity of a wmi57_item must be 'record'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M773"/></axsl:template><axsl:template match="text()" priority="-1" mode="M773"/><axsl:template match="@*|node()" priority="-2" mode="M773"><axsl:apply-templates select="@*|*" mode="M773"/></axsl:template></axsl:stylesheet>
