...
<!--SCHEMA METADATA-->
<axsl:template match="/"><axsl:apply-templates select="/" mode="M4"/></axsl:template>
...
<!--PATTERN none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M4">
