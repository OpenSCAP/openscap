...
<!--PATTERN none_exist_value_dep-->
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:tests/child::*" priority="1000" mode="M20">
...
<!--PATTERN sc_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-sc:system_data/*/*" priority="1000" mode="M21">
...
<!--PATTERN famitemfamily-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:family_item/ind-sc:family" priority="1000" mode="M22">
...
<!--PATTERN filemd5_item_dep-->


	<!--RULE -->
<axsl:template match="ind-sc:filemd5_item" priority="1000" mode="M23">
...
<!--PATTERN md5itempath-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filemd5_item/ind-sc:path" priority="1000" mode="M24">
...
<!--PATTERN md5itemfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filemd5_item/ind-sc:filename" priority="1000" mode="M25">
...
<!--PATTERN md5itemmd5-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filemd5_item/ind-sc:md5" priority="1000" mode="M26">
...
<!--PATTERN hashitemfilepath-->


	<!--RULE -->
<axsl:template match="ind-sc:filehash_item/ind-sc:filepath" priority="1000" mode="M27">
...
<!--PATTERN hashitempath-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item/ind-sc:path" priority="1000" mode="M28">
...
<!--PATTERN hashitemfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item/ind-sc:filename" priority="1000" mode="M29">
...
<!--PATTERN hashitemmd5-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item/ind-sc:md5" priority="1000" mode="M30">
...
<!--PATTERN hashitemsha1-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:filehash_item/ind-sc:sha1" priority="1000" mode="M31">
...
<!--PATTERN envitemname-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:environmentvariable_item/ind-sc:name" priority="1000" mode="M32">
...
<!--PATTERN envitemvalue-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:environmentvariable_item/ind-sc:value" priority="1000" mode="M33">
...
<!--PATTERN ldapitemsuffix-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:suffix" priority="1000" mode="M34">
...
<!--PATTERN ldapitemrelative_dn-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:relative_dn" priority="1000" mode="M35">
...
<!--PATTERN ldapitemattribute-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:attribute" priority="1000" mode="M36">
...
<!--PATTERN ldapitemobject_class-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:object_class" priority="1000" mode="M37">
...
<!--PATTERN ldapitemldaptype-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:ldaptype" priority="1000" mode="M38">
...
<!--PATTERN ldapitemvalue-->


	<!--RULE -->
<axsl:template match="ind-sc:ldap_item/ind-sc:value" priority="1000" mode="M39">
...
<!--PATTERN sqlitemengine-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item/ind-sc:engine" priority="1000" mode="M40">
...
<!--PATTERN sqlitemversion-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item/ind-sc:version" priority="1000" mode="M41">
...
<!--PATTERN sqlitemconnection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item/ind-sc:connection_string" priority="1000" mode="M42">
...
<!--PATTERN sqlitemsql-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item/ind-sc:sql" priority="1000" mode="M43">
...
<!--PATTERN sqlitemresult-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:sql_item/ind-sc:result" priority="1000" mode="M44">
...
<!--PATTERN txtitemfilepath-->


	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:filepath" priority="1000" mode="M45">
...
<!--PATTERN txtitempath-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:path" priority="1000" mode="M46">
...
<!--PATTERN txtitemfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:filename" priority="1000" mode="M47">
...
<!--PATTERN txtitempattern-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:pattern" priority="1000" mode="M48">
...
<!--PATTERN txtiteminstance-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:instance" priority="1000" mode="M49">
...
<!--PATTERN txtitemline-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:line" priority="1000" mode="M50">
...
<!--PATTERN txtitemtext-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:text" priority="1000" mode="M51">
...
<!--PATTERN txtitemsubexpression-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:textfilecontent_item/ind-sc:subexpression" priority="1000" mode="M52">
...
<!--PATTERN varitemvar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:variable_item/ind-sc:var_ref" priority="1000" mode="M53">
...
<!--PATTERN varitemvalue-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:variable_item/ind-sc:value" priority="1000" mode="M54">
...
<!--PATTERN xmlitemfilepath-->


	<!--RULE -->
<axsl:template match="ind-sc:xmlfilecontent_item/ind-sc:filepath" priority="1000" mode="M55">
...
<!--PATTERN xmlitempath-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:xmlfilecontent_item/ind-sc:path" priority="1000" mode="M56">
...
<!--PATTERN xmlitemfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:xmlfilecontent_item/ind-sc:filename" priority="1000" mode="M57">
...
<!--PATTERN xmlitemxpath-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:xmlfilecontent_item/ind-sc:xpath" priority="1000" mode="M58">
...
<!--PATTERN xmlitemvalue_of-->
	...
	<!--RULE -->
<axsl:template match="ind-sc:xmlfilecontent_item/ind-sc:value_of" priority="1000" mode="M59">
...
<!--PATTERN interimfixitemvuid-->


	<!--RULE -->
<axsl:template match="aix-sc:interim_fix_item/aix-sc:vuid" priority="1000" mode="M60">
...
<!--PATTERN interimfixitemlabel-->


	<!--RULE -->
<axsl:template match="aix-sc:interim_fix_item/aix-sc:label" priority="1000" mode="M61">
...
<!--PATTERN interimfixitemabstract-->


	<!--RULE -->
<axsl:template match="aix-sc:interim_fix_item/aix-sc:abstract" priority="1000" mode="M62">
...
<!--PATTERN interimfixitemstate-->


	<!--RULE -->
<axsl:template match="aix-sc:interim_fix_item/aix-sc:state" priority="1000" mode="M63">
...
<!--PATTERN filesetitemflstinst-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fileset_item/aix-sc:flstinst" priority="1000" mode="M64">
...
<!--PATTERN filesetitemlevel-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fileset_item/aix-sc:level" priority="1000" mode="M65">
...
<!--PATTERN filesetitemstate-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fileset_item/aix-sc:state" priority="1000" mode="M66">
...
<!--PATTERN filesetitemdescription-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fileset_item/aix-sc:description" priority="1000" mode="M67">
...
<!--PATTERN fixitemapar_number-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fix_item/aix-sc:apar_number" priority="1000" mode="M68">
...
<!--PATTERN fixitemabstract-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fix_item/aix-sc:abstract" priority="1000" mode="M69">
...
<!--PATTERN fixitemsymptom-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fix_item/aix-sc:symptom" priority="1000" mode="M70">
...
<!--PATTERN fixiteminstallation_status-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:fix_item/aix-sc:installation_status" priority="1000" mode="M71">
...
<!--PATTERN oslevelitemmaintenance_level-->
	...
	<!--RULE -->
<axsl:template match="aix-sc:oslevel_item/aix-sc:maintenance_level" priority="1000" mode="M72">
...
<!--PATTERN httpditempath-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item/apache-sc:path" priority="1000" mode="M73">
...
<!--PATTERN httpditembinaryname-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item/apache-sc:binary_name" priority="1000" mode="M74">
...
<!--PATTERN httpditemversion-->
	...
	<!--RULE -->
<axsl:template match="apache-sc:httpd_item/apache-sc:version" priority="1000" mode="M75">
...
<!--PATTERN apacheveritem_dep-->


	<!--RULE -->
<axsl:template match="apache-sc:version_item" priority="1000" mode="M76">

		<!--REPORT -->
<axsl:if test="true()"> DEPRECATED ITEM: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
            <axsl:value-of select="string('&#10;')"/></axsl:if><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M76"/></axsl:template><axsl:template match="text()" priority="-1" mode="M76"/><axsl:template match="@*|node()" priority="-2" mode="M76"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M76"/></axsl:template>

<!--PATTERN apacheveritemversion-->


	<!--RULE -->
<axsl:template match="apache-sc:version_item/apache-sc:version" priority="1000" mode="M77">
...
<!--PATTERN catoslineitemshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:line_item/catos-sc:show_subcommand" priority="1000" mode="M78">
...
<!--PATTERN catoslineitemconfig_line-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:line_item/catos-sc:config_line" priority="1000" mode="M79">
...
<!--PATTERN catosmoduleitemmodule_number-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:module_number" priority="1000" mode="M80">
...
<!--PATTERN catosmoduleitemtype-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:type" priority="1000" mode="M81">
...
<!--PATTERN catosmoduleitemmodel-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:model" priority="1000" mode="M82">
...
<!--PATTERN catosmoduleitemsoftware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:software_major_release" priority="1000" mode="M83">
...
<!--PATTERN catosmoduleitemsoftware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:software_individual_release" priority="1000" mode="M84">
...
<!--PATTERN catosmoduleitemsoftware_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:software_version_id" priority="1000" mode="M85">
...
<!--PATTERN catosmoduleitemhardware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:hardware_major_release" priority="1000" mode="M86">
...
<!--PATTERN catosmoduleitemhardware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:hardware_individual_release" priority="1000" mode="M87">
...
<!--PATTERN catosmoduleitemfirmware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:firmware_major_release" priority="1000" mode="M88">
...
<!--PATTERN catosmoduleitemfirmware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:module_item/catos-sc:firmware_individual_release" priority="1000" mode="M89">
...
<!--PATTERN versionitemswitch_series-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:switch_series" priority="1000" mode="M90">
...
<!--PATTERN versionitemimage_name-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:image_name" priority="1000" mode="M91">
...
<!--PATTERN versionitemcatos_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_release" priority="1000" mode="M92">
...
<!--PATTERN versionitemcatos_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_major_release" priority="1000" mode="M93">
...
<!--PATTERN versionitemcatos_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_individual_release" priority="1000" mode="M94">
...
<!--PATTERN versionitemcatos_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-sc:version_item/catos-sc:catos_version_id" priority="1000" mode="M95">
...
<!--PATTERN esxpatchitempatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:patch_number" priority="1000" mode="M96">
...
<!--PATTERN esxpatchitempatch_name-->


	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:patch_name" priority="1000" mode="M97">
...
<!--PATTERN esxpatchitemkb_id-->


	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:knowledge_base_id" priority="1000" mode="M98">
...
<!--PATTERN esxpatchitembundle_id-->


	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:bundle_id" priority="1000" mode="M99">
...
<!--PATTERN esxpatchitemclassification-->


	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:classification" priority="1000" mode="M100">
...
<!--PATTERN esxpatchitemsupport_level-->


	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:support_level" priority="1000" mode="M101">
...
<!--PATTERN esxpatchitemstatus-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:patch_item/esx-sc:status" priority="1000" mode="M102">
...
<!--PATTERN versionitemrelease-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:version_item/esx-sc:release" priority="1000" mode="M103">
...
<!--PATTERN versionitembuild-->
	...
	<!--RULE -->
<axsl:template match="esx-sc:version_item/esx-sc:build" priority="1000" mode="M104">
...
<!--PATTERN portinfoitempkginst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:pkginst" priority="1000" mode="M105">
...
<!--PATTERN portinfoitemname-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:name" priority="1000" mode="M106">
...
<!--PATTERN portinfoitemcategory-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:category" priority="1000" mode="M107">
...
<!--PATTERN portinfoitemversion-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:version" priority="1000" mode="M108">
...
<!--PATTERN portinfoitemvendor-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:vendor" priority="1000" mode="M109">
...
<!--PATTERN portinfoitemdescription-->
	...
	<!--RULE -->
<axsl:template match="freebsd-sc:portinfo_item/freebsd-sc:description" priority="1000" mode="M110">
...
<!--PATTERN gcitemparameter_name-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:getconf_item/hpux-sc:parameter_name" priority="1000" mode="M111">
...
<!--PATTERN gcitempathname-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:getconf_item/hpux-sc:pathname" priority="1000" mode="M112">
...
<!--PATTERN gcitemoutput-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:getconf_item/hpux-sc:output" priority="1000" mode="M113">
...
<!--PATTERN patchitemswtype-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:patch_item/hpux-sc:swtype" priority="1000" mode="M114">
...
<!--PATTERN patchitemarea_patched-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:patch_item/hpux-sc:area_patched" priority="1000" mode="M115">
...
<!--PATTERN patchitempatch_number-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:patch_item/hpux-sc:patch_number" priority="1000" mode="M116">
...
<!--PATTERN swlistitemswlist-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:swlist" priority="1000" mode="M117">
...
<!--PATTERN swlistitembundle-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:bundle" priority="1000" mode="M118">
...
<!--PATTERN swlistitemfileset-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:fileset" priority="1000" mode="M119">
...
<!--PATTERN swlistitemversion-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:version" priority="1000" mode="M120">
...
<!--PATTERN swlistitemtitle-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:title" priority="1000" mode="M121">
...
<!--PATTERN swlistitemvendor-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:swlist_item/hpux-sc:vendor" priority="1000" mode="M122">
...
<!--PATTERN trustitemtrustitem-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:trustitem" priority="1000" mode="M123">
...
<!--PATTERN trustitemuid-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:uid" priority="1000" mode="M124">
...
<!--PATTERN trustitempassword-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:password" priority="1000" mode="M125">
...
<!--PATTERN trustitemaccount_owner-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:account_owner" priority="1000" mode="M126">
...
<!--PATTERN trustitemboot_auth-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:boot_auth" priority="1000" mode="M127">
...
<!--PATTERN trustitemaudit_id-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:audit_id" priority="1000" mode="M128">
...
<!--PATTERN trustitemaudit_flag-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:audit_flag" priority="1000" mode="M129">
...
<!--PATTERN trustitempw_change_min-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_change_min" priority="1000" mode="M130">
...
<!--PATTERN trustitempw_max_size-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_max_size" priority="1000" mode="M131">
...
<!--PATTERN trustitempw_expiration-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_expiration" priority="1000" mode="M132">
...
<!--PATTERN trustitempw_life-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_life" priority="1000" mode="M133">
...
<!--PATTERN trustitempw_change_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_change_s" priority="1000" mode="M134">
...
<!--PATTERN trustitempw_change_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_change_u" priority="1000" mode="M135">
...
<!--PATTERN trustitemacct_expire-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:acct_expire" priority="1000" mode="M136">
...
<!--PATTERN trustitemmax_llogin-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:max_llogin" priority="1000" mode="M137">
...
<!--PATTERN trustitemexp_warning-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:exp_warning" priority="1000" mode="M138">
...
<!--PATTERN trustitemusr_chg_pw-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:usr_chg_pw" priority="1000" mode="M139">
...
<!--PATTERN trustitemgen_pw-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:gen_pw" priority="1000" mode="M140">
...
<!--PATTERN trustitempw_restrict-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_restrict" priority="1000" mode="M141">
...
<!--PATTERN trustitempw_null-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_null" priority="1000" mode="M142">
...
<!--PATTERN trustitempw_gen_char-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_gen_char" priority="1000" mode="M143">
...
<!--PATTERN trustitempw_gen_let-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:swlistpw_gen_let" priority="1000" mode="M144">
...
<!--PATTERN trustitemlogin_time-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:login_time" priority="1000" mode="M145">
...
<!--PATTERN trustitempw_changer-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:pw_changer" priority="1000" mode="M146">
...
<!--PATTERN trustitemlogin_time_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:login_time_s" priority="1000" mode="M147">
...
<!--PATTERN trustitemlogin_time_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:login_time_u" priority="1000" mode="M148">
...
<!--PATTERN trustitemlogin_tty_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:login_tty_s" priority="1000" mode="M149">
...
<!--PATTERN trustitemlogin_tty_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:login_tty_u" priority="1000" mode="M150">
...
<!--PATTERN trustitemnum_u_logins-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:num_u_logins" priority="1000" mode="M151">
...
<!--PATTERN trustitemmax_u_logins-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:max_u_logins" priority="1000" mode="M152">
...
<!--PATTERN trustitemlock_flag-->
	...
	<!--RULE -->
<axsl:template match="hpux-sc:trusted_item/hpux-sc:lock_flag" priority="1000" mode="M153">
...
<!--PATTERN globalitemglobal_command-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:global_item/ios-sc:global_command" priority="1000" mode="M154">
...
<!--PATTERN iosinterfaceitemname-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:name" priority="1000" mode="M155">
...
<!--PATTERN iosinterfaceitemip_directed_broadcast_command-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:ip_directed_broadcast_command" priority="1000" mode="M156">
...
<!--PATTERN iosinterfaceitemno_ip_directed_broadcast_command-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:no_ip_directed_broadcast_command" priority="1000" mode="M157">
...
<!--PATTERN iosinterfaceitemproxy_arp_command-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:proxy_arp_command" priority="1000" mode="M158">
...
<!--PATTERN iosinterfaceitemshutdown_command-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:interface_item/ios-sc:shutdown_command" priority="1000" mode="M159">
...
<!--PATTERN ioslineitemshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:line_item/ios-sc:show_subcommand" priority="1000" mode="M160">
...
<!--PATTERN ioslineitemconfig_line-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:line_item/ios-sc:config_line" priority="1000" mode="M161">
...
<!--PATTERN snmpitemaccess_list-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:snmp_item/ios-sc:access_list" priority="1000" mode="M162">
...
<!--PATTERN snmpitemcommunity_name-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:snmp_item/ios-sc:community_name" priority="1000" mode="M163">
...
<!--PATTERN tclshitemavailable-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:tclsh_item/ios-sc:available" priority="1000" mode="M164">
...
<!--PATTERN iosversionitemmajor_release-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:major_release" priority="1000" mode="M165">
...
<!--PATTERN iosversionitemtrain_number-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:train_number" priority="1000" mode="M166">
...
<!--PATTERN iosversionitemmajorversion-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:major_version" priority="1000" mode="M167">
...
<!--PATTERN iosversionitemminorversion-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:minor_version" priority="1000" mode="M168">
...
<!--PATTERN iosversionitemrelease-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:release" priority="1000" mode="M169">
...
<!--PATTERN iosversionitemtrain_identifier-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:train_identifier" priority="1000" mode="M170">
...
<!--PATTERN iosversionitemrebuild-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:rebuild" priority="1000" mode="M171">
...
<!--PATTERN iosversionitemsubrebuild-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:subrebuild" priority="1000" mode="M172">
...
<!--PATTERN iosversionitemmainlinerebuild-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:mainline_rebuild" priority="1000" mode="M173">
...
<!--PATTERN iosversionitemversion_string-->
	...
	<!--RULE -->
<axsl:template match="ios-sc:version_item/ios-sc:version_string" priority="1000" mode="M174">
...
<!--PATTERN dpkgitemname-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:name" priority="1000" mode="M175">
...
<!--PATTERN dpkgitemarch-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:arch" priority="1000" mode="M176">
...
<!--PATTERN dpkgitemepoch-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:epoch" priority="1000" mode="M177">
...
<!--PATTERN dpkgitemrelease-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:release" priority="1000" mode="M178">
...
<!--PATTERN dpkgitemversion-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:version" priority="1000" mode="M179">
...
<!--PATTERN dpkgitemevr-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:dpkginfo_item/linux-sc:evr" priority="1000" mode="M180">
...
<!--PATTERN ilsitemprotocol-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:protocol" priority="1000" mode="M181">
...
<!--PATTERN ilsitemlocal_address-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:local_address" priority="1000" mode="M182">
...
<!--PATTERN ilsitemlocal_port-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:local_port" priority="1000" mode="M183">
...
<!--PATTERN ilsitemlocal_full_address-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:local_full_address" priority="1000" mode="M184">
...
<!--PATTERN ilsitemprogram_name-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:program_name" priority="1000" mode="M185">
...
<!--PATTERN ilsitemforeign_address-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:foreign_address" priority="1000" mode="M186">
...
<!--PATTERN ilsitemforeign_port-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:foreign_port" priority="1000" mode="M187">
...
<!--PATTERN ilsitemforeign_full_address-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:foreign_full_address" priority="1000" mode="M188">
...
<!--PATTERN ilsitempid-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:pid" priority="1000" mode="M189">
...
<!--PATTERN ilsitemuser_id-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:inetlisteningserver_item/linux-sc:user_id" priority="1000" mode="M190">
...
<!--PATTERN rpmitemname-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:name" priority="1000" mode="M191">
...
<!--PATTERN rpmitemarch-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:arch" priority="1000" mode="M192">
...
<!--PATTERN rpmitemepoch-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:epoch" priority="1000" mode="M193">
...
<!--PATTERN rpmitemrelease-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:release" priority="1000" mode="M194">
...
<!--PATTERN rpmitemversion-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:version" priority="1000" mode="M195">
...
<!--PATTERN rpmitemevr-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:evr" priority="1000" mode="M196">
...
<!--PATTERN rpmitemsignature_keyid-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:rpminfo_item/linux-sc:signature_keyid" priority="1000" mode="M197">
...
<!--PATTERN spkginfoitemname-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:slackwarepkginfo_item/linux-sc:name" priority="1000" mode="M198">
...
<!--PATTERN spkginfoitemversion-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:slackwarepkginfo_item/linux-sc:version" priority="1000" mode="M199">
...
<!--PATTERN spkginfoitemarchitecture-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:slackwarepkginfo_item/linux-sc:architecture" priority="1000" mode="M200">
...
<!--PATTERN spkginfoitemrevision-->
	...
	<!--RULE -->
<axsl:template match="linux-sc:slackwarepkginfo_item/linux-sc:revision" priority="1000" mode="M201">
...
<!--PATTERN accountitemusername-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:username" priority="1000" mode="M202">
...
<!--PATTERN accountitempassword-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:password" priority="1000" mode="M203">
...
<!--PATTERN accountitemuid-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:uid" priority="1000" mode="M204">
...
<!--PATTERN accountitemgid-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:gid" priority="1000" mode="M205">
...
<!--PATTERN accountitemrealname-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:realname" priority="1000" mode="M206">
...
<!--PATTERN accountitemhome_dir-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:home_dir" priority="1000" mode="M207">
...
<!--PATTERN accountitemlogin_shell-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:accountinfo_item/macos-sc:login_shell" priority="1000" mode="M208">
...
<!--PATTERN macosilsitemprogram_name-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:program_name" priority="1000" mode="M209">
...
<!--PATTERN macosilsitemlocal_address-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:local_address" priority="1000" mode="M210">
...
<!--PATTERN macosilsitemlocal_full_address-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:local_full_address" priority="1000" mode="M211">
...
<!--PATTERN macosilsitemlocal_port-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:local_port" priority="1000" mode="M212">
...
<!--PATTERN macosilsitemforeign_address-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:foreign_address" priority="1000" mode="M213">
...
<!--PATTERN macosilsitemforeign_full_address-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:foreign_full_address" priority="1000" mode="M214">
...
<!--PATTERN macosilsitemforeign_port-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:foreign_port" priority="1000" mode="M215">
...
<!--PATTERN macosilsitempid-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:pid" priority="1000" mode="M216">
...
<!--PATTERN macosilsitemprotocol-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:protocol" priority="1000" mode="M217">
...
<!--PATTERN macosilsitemuser_id-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:inetlisteningserver_item/macos-sc:user_id" priority="1000" mode="M218">
...
<!--PATTERN nvramitemnvram_var-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:nvram_item/macos-sc:nvram_var" priority="1000" mode="M219">
...
<!--PATTERN nvramitemnvram_value-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:nvram_item/macos-sc:nvram_value" priority="1000" mode="M220">
...
<!--PATTERN pwpitemusername-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:username" priority="1000" mode="M221">
...
<!--PATTERN pwpitemuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:userpass" priority="1000" mode="M222">
...
<!--PATTERN pwpitemdirectory_node-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:directory_node" priority="1000" mode="M223">
...
<!--PATTERN pwpitemmaxChars-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:maxChars" priority="1000" mode="M224">
...
<!--PATTERN pwpitemmaxFailedLoginAttempts-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:maxFailedLoginAttempts" priority="1000" mode="M225">
...
<!--PATTERN pwpitemminChars-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:minChars" priority="1000" mode="M226">
...
<!--PATTERN pwpitempasswordCannotBeName-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:passwordCannotBeName" priority="1000" mode="M227">
...
<!--PATTERN pwpitemrequiresAlpha-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:requiresAlpha" priority="1000" mode="M228">
...
<!--PATTERN pwpitemrequiresNumeric-->
	...
	<!--RULE -->
<axsl:template match="macos-sc:pwpolicy_item/macos-sc:requiresNumeric" priority="1000" mode="M229">
...
<!--PATTERN pixoslineitemshow_subcommand-->


	<!--RULE -->
<axsl:template match="pixos-sc:line_item/pixos-sc:show_subcommand" priority="1000" mode="M230">
...
<!--PATTERN pixoslineitemconfig_line-->


	<!--RULE -->
<axsl:template match="pixos-sc:line_item/pixos-sc:config_line" priority="1000" mode="M231">
...
<!--PATTERN versionitempix_release-->


	<!--RULE -->
<axsl:template match="pixos-sc:version_item/pixos-sc:pix_release" priority="1000" mode="M232">
...
<!--PATTERN versionitempix_major_release-->


	<!--RULE -->
<axsl:template match="pixos-sc:version_item/pixos-sc:pix_major_release" priority="1000" mode="M233">
...
<!--PATTERN versionitempix_minor_release-->


	<!--RULE -->
<axsl:template match="pixos-sc:version_item/pixos-sc:pix_minor_release" priority="1000" mode="M234">
...
<!--PATTERN versionitempix_build-->


	<!--RULE -->
<axsl:template match="pixos-sc:version_item/pixos-sc:pix_build" priority="1000" mode="M235">
...
<!--PATTERN spwebappitemwebapplicationurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:webapplicationurl" priority="1000" mode="M236">
...
<!--PATTERN spwebappitemallowparttopartcommunication-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:allowparttopartcommunication" priority="1000" mode="M237">
...
<!--PATTERN spwebappitemallowaccesstowebpartcatalog-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:allowaccesstowebpartcatalog" priority="1000" mode="M238">
...
<!--PATTERN spwebappitemblockedfileextention-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:blockedfileextentions" priority="1000" mode="M239">
...
<!--PATTERN spwebappitemdefaultquotatemplate-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:defaultquotatemplate" priority="1000" mode="M240">
...
<!--PATTERN spwebappitemexternalworkflowparticipantsenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:externalworkflowparticipantsenabled" priority="1000" mode="M241">
...
<!--PATTERN spwebappitemrecyclebinenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:recyclebinenabled" priority="1000" mode="M242">
...
<!--PATTERN spwebappitemautomaticallydeleteunusedsitecollections-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:automaticallydeleteunusedsitecollections" priority="1000" mode="M243">
...
<!--PATTERN spwebappitemselfservicesitecreationenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:selfservicesitecreationenabled" priority="1000" mode="M244">
...
<!--PATTERN spwebappitemsecondstagerecyclebinquota-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:secondstagerecyclebinquota" priority="1000" mode="M245">
...
<!--PATTERN spwebappitemrecyclebinretentionperiod-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:recyclebinretentionperiod" priority="1000" mode="M246">
...
<!--PATTERN spwebappitemoutboundmailserverinstance-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:outboundmailserverinstance" priority="1000" mode="M247">
...
<!--PATTERN spwebappitemoutboundmailsenderaddress-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:outboundmailsenderaddress" priority="1000" mode="M248">
...
<!--PATTERN spwebappitemoutboundmailreplytoaddress-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:outboundmailreplytoaddress" priority="1000" mode="M249">
...
<!--PATTERN spwebappitemsecvalexpires-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:secvalexpires" priority="1000" mode="M250">
...
<!--PATTERN spwebappitemtimeout-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:timeout" priority="1000" mode="M251">
...
<!--PATTERN spwebappitemisadministrationwebapplication-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:isadministrationwebapplication" priority="1000" mode="M252">
...
<!--PATTERN spwebappitemapplicationpoolname-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:applicationpoolname" priority="1000" mode="M253">
...
<!--PATTERN spwebappitemapplicationpoolusername-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:applicationpoolusername" priority="1000" mode="M254">
...
<!--PATTERN spwebappitemopenitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:openitems" priority="1000" mode="M255">
...
<!--PATTERN spwebappitemaddlistitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:addlistitems" priority="1000" mode="M256">
...
<!--PATTERN spwebappitemapproveitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:approveitems" priority="1000" mode="M257">
...
<!--PATTERN spwebappitemdeletelistitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:deletelistitems" priority="1000" mode="M258">
...
<!--PATTERN spwebappitemdeleteversions-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:deleteversions" priority="1000" mode="M259">
...
<!--PATTERN spwebappitemeditlistitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:editlistitems" priority="1000" mode="M260">
...
<!--PATTERN spwebappitemmanagelists-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:managelists" priority="1000" mode="M261">
...
<!--PATTERN spwebappitemviewversions-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:viewversions" priority="1000" mode="M262">
...
<!--PATTERN spwebappitemviewlistitems-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:viewlistitems" priority="1000" mode="M263">
...
<!--PATTERN spwebappitemcancelcheckout-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:cancelcheckout" priority="1000" mode="M264">
...
<!--PATTERN spwebappitemcreatealerts-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:createalerts" priority="1000" mode="M265">
...
<!--PATTERN spwebappitemviewformpages-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:viewformpages" priority="1000" mode="M266">
...
<!--PATTERN spwebappitemviewpages-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:viewpages" priority="1000" mode="M267">
...
<!--PATTERN spwebappitemaddandcustomizepages-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:addandcustomizepages" priority="1000" mode="M268">
...
<!--PATTERN spwebappitemapplystylesheets-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:applystylesheets" priority="1000" mode="M269">
...
<!--PATTERN spwebappitemapplythemeandborder-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:applythemeandborder" priority="1000" mode="M270">
...
<!--PATTERN spwebappitembrowsedirectories-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:browsedirectories" priority="1000" mode="M271">
...
<!--PATTERN spwebappitembrowseuserinfo-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:browseuserinfo" priority="1000" mode="M272">
...
<!--PATTERN spwebappitemcreategroups-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:creategroups" priority="1000" mode="M273">
...
<!--PATTERN spwebappitemcreatesscsite-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:createsscsite" priority="1000" mode="M274">
...
<!--PATTERN spwebappitemeditmyuserinfo-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:editmyuserinfo" priority="1000" mode="M275">
...
<!--PATTERN spwebappitemenumeratepermissions-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:enumeratepermissions" priority="1000" mode="M276">
...
<!--PATTERN spwebappitemmanagealerts-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:managealerts" priority="1000" mode="M277">
...
<!--PATTERN spwebappitemmanagepermissions-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:managepermissions" priority="1000" mode="M278">
...
<!--PATTERN spwebappitemmanagesubwebs-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:managesubwebs" priority="1000" mode="M279">
...
<!--PATTERN spwebappitemmanageweb-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:manageweb" priority="1000" mode="M280">
...
<!--PATTERN spwebappitemopens-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:open" priority="1000" mode="M281">
...
<!--PATTERN spwebappitemuseclientintegration-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:useclientintegration" priority="1000" mode="M282">
...
<!--PATTERN spwebappitemuseremoteapis-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:useremoteapis" priority="1000" mode="M283">
...
<!--PATTERN spwebappitemviewusagedata-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:viewusagedata" priority="1000" mode="M284">
...
<!--PATTERN spwebappitemmanagepersonalviews-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:managepersonalviews" priority="1000" mode="M285">
...
<!--PATTERN spwebappitemadddelprivatewebparts-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:adddelprivatewebparts" priority="1000" mode="M286">
...
<!--PATTERN spwebappitemupdatepersonalwebparts-->


	<!--RULE -->
<axsl:template match="sp-sc:spwebapplication_item/sp-sc:updatepersonalwebparts" priority="1000" mode="M287">
...
<!--PATTERN spgrpitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spgroup_item/sp-sc:sitecollectionurl" priority="1000" mode="M288">
...
<!--PATTERN spgrpitemgname-->


	<!--RULE -->
<axsl:template match="sp-sc:spgroup_item/sp-sc:gname" priority="1000" mode="M289">
...
<!--PATTERN spgrpitemautoacceptrequesttojoinleave-->


	<!--RULE -->
<axsl:template match="sp-sc:spgroup_item/sp-sc:autoacceptrequesttojoinleave" priority="1000" mode="M290">
...
<!--PATTERN spgrpitemallowmemberseditmembership-->


	<!--RULE -->
<axsl:template match="sp-sc:spgroup_item/sp-sc:allowmemberseditmembership" priority="1000" mode="M291">
...
<!--PATTERN spgrpitemonlyallowmembersviewmembership-->


	<!--RULE -->
<axsl:template match="sp-sc:spgroup_item/sp-sc:onlyallowmembersviewmembership" priority="1000" mode="M292">
...
<!--PATTERN spwebitemwebcollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spweb_item/sp-sc:webcollectionurl" priority="1000" mode="M293">
...
<!--PATTERN spwebitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spweb_item/sp-sc:sitecollectionurl" priority="1000" mode="M294">
...
<!--PATTERN spwebitemsecondarysitecolladmin-->


	<!--RULE -->
<axsl:template match="sp-sc:spweb_item/sp-sc:secondarysitecolladmin" priority="1000" mode="M295">
...
<!--PATTERN spwebitemsecondsitecolladminenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spweb_item/sp-sc:secondsitecolladminenabled" priority="1000" mode="M296">
...
<!--PATTERN spwebitemallowanonymousaccess-->


	<!--RULE -->
<axsl:template match="sp-sc:spweb_item/sp-sc:allowanonymousaccess" priority="1000" mode="M297">
...
<!--PATTERN splistitemspwebsiteurl-->


	<!--RULE -->
<axsl:template match="sp-sc:splist_item/sp-sc:spwebsiteurl" priority="1000" mode="M298">
...
<!--PATTERN splistitemirmenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:splist_item/sp-sc:irmenabled" priority="1000" mode="M299">
...
<!--PATTERN splistitemenableversioning-->


	<!--RULE -->
<axsl:template match="sp-sc:splist_item/sp-sc:enableversioning" priority="1000" mode="M300">
...
<!--PATTERN splistitemnocrawl-->


	<!--RULE -->
<axsl:template match="sp-sc:splist_item/sp-sc:nocrawl" priority="1000" mode="M301">
...
<!--PATTERN spavsitemspwebservicename-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:spwebservicename" priority="1000" mode="M302">
...
<!--PATTERN spavsitemspfarmname-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:spfarmname" priority="1000" mode="M303">
...
<!--PATTERN spavsitemallowdownload-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:allowdownload" priority="1000" mode="M304">
...
<!--PATTERN spavsitemcleaningenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:cleaningenabled" priority="1000" mode="M305">
...
<!--PATTERN spavsitemdownloadscanenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:downloadscanenabled" priority="1000" mode="M306">
...
<!--PATTERN spavsitemnumberofthreads-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:numberofthreads" priority="1000" mode="M307">
...
<!--PATTERN spavsitemskipsearchcrawl-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:skipsearchcrawl" priority="1000" mode="M308">
...
<!--PATTERN spavsitemtimeout-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:timeout" priority="1000" mode="M309">
...
<!--PATTERN spavsitemuploadscanenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:uploadscanenabled" priority="1000" mode="M310">
...
<!--PATTERN spavsitemvendorupdatecount-->


	<!--RULE -->
<axsl:template match="sp-sc:spantivirussettings_item/sp-sc:vendorupdatecount" priority="1000" mode="M311">
...
<!--PATTERN spsiteadminitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spsiteadministration_item/sp-sc:sitecollectionurl" priority="1000" mode="M312">
...
<!--PATTERN spsiteadminitemstoragemaxlevel-->


	<!--RULE -->
<axsl:template match="sp-sc:spsiteadministration_item/sp-sc:storagemaxlevel" priority="1000" mode="M313">
...
<!--PATTERN spsiteadminitemstoragewarninglevel-->


	<!--RULE -->
<axsl:template match="sp-sc:spsiteadministration_item/sp-sc:storagewarninglevel" priority="1000" mode="M314">
...
<!--PATTERN spsiteitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spsite_item/sp-sc:sitecollectionurl" priority="1000" mode="M315">
...
<!--PATTERN spsiteitemquotaname-->


	<!--RULE -->
<axsl:template match="sp-sc:spsite_item/sp-sc:quotaname" priority="1000" mode="M316">
...
<!--PATTERN spsiteitemurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spsite_item/sp-sc:url" priority="1000" mode="M317">
...
<!--PATTERN spcritemsiteurl-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:siteurl" priority="1000" mode="M318">
...
<!--PATTERN spcritemcrawlashttp-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:crawlashttp" priority="1000" mode="M319">
...
<!--PATTERN spcritemenabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:enabled" priority="1000" mode="M320">
...
<!--PATTERN spcritemfollowcomplexurls-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:followcomplexurls" priority="1000" mode="M321">
...
<!--PATTERN spcritempath-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:path" priority="1000" mode="M322">
...
<!--PATTERN spcritempriority-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:priority" priority="1000" mode="M323">
...
<!--PATTERN spcritemsuppressindexing-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:suppressindexing" priority="1000" mode="M324">
...
<!--PATTERN spcritemaccountname-->


	<!--RULE -->
<axsl:template match="sp-sc:spcrawlrule_item/sp-sc:accountname" priority="1000" mode="M325">
...
<!--PATTERN spjobdefitemwebappuri-->


	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item/sp-sc:webappuri" priority="1000" mode="M326">
...
<!--PATTERN spjobdefitemdisplayname-->


	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item/sp-sc:displayname" priority="1000" mode="M327">
...
<!--PATTERN spjobdefitemisdisabled-->


	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item/sp-sc:isdisabled" priority="1000" mode="M328">
...
<!--PATTERN spjobdefitemretry-->


	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item/sp-sc:retry" priority="1000" mode="M329">
...
<!--PATTERN spjobdefitemtitle-->


	<!--RULE -->
<axsl:template match="sp-sc:spjobdefinition_item/sp-sc:title" priority="1000" mode="M330">
...
<!--PATTERN bbitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:bestbet_item/sp-sc:sitecollectionurl" priority="1000" mode="M331">
...
<!--PATTERN bbitembestbeturl-->


	<!--RULE -->
<axsl:template match="sp-sc:bestbet_item/sp-sc:bestbeturl" priority="1000" mode="M332">
...
<!--PATTERN bbitemtitle-->
	...
	<!--RULE -->
<axsl:template match="sp-sc:bestbet_item/sp-sc:title" priority="1000" mode="M333">
...
<!--PATTERN bbitemdescription-->


	<!--RULE -->
<axsl:template match="sp-sc:bestbet_item/sp-sc:description" priority="1000" mode="M334">
...
<!--PATTERN policycollitemsitecollectionurl-->


	<!--RULE -->
<axsl:template match="sp-sc:policycoll_item/sp-sc:sitecollectionurl" priority="1000" mode="M335">
...
<!--PATTERN policycollitemid-->


	<!--RULE -->
<axsl:template match="sp-sc:policycoll_item/sp-sc:id" priority="1000" mode="M336">
...
<!--PATTERN policycollitemname-->


	<!--RULE -->
<axsl:template match="sp-sc:policycoll_item/sp-sc:name" priority="1000" mode="M337">
...
<!--PATTERN policycollitemdescription-->


	<!--RULE -->
<axsl:template match="sp-sc:policycoll_item/sp-sc:description" priority="1000" mode="M338">
...
<!--PATTERN policycollitemlongdescription-->


	<!--RULE -->
<axsl:template match="sp-sc:infopolicy_item/sp-sc:longdescription" priority="1000" mode="M339">
...
<!--PATTERN spdiagnosticserviceitemfarmname-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:farmname" priority="1000" mode="M340">
...
<!--PATTERN spdiagnosticsserviceitemdisplayname-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:displayname" priority="1000" mode="M341">
...
<!--PATTERN spdiagnosticsserviceitemlogcutinterval-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:logcutinterval" priority="1000" mode="M342">
...
<!--PATTERN spdiagnosticsserviceitemloglocation-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:loglocation" priority="1000" mode="M343">
...
<!--PATTERN spdiagnosticsserviceitemlogstokeep-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:logstokeep" priority="1000" mode="M344">
...
<!--PATTERN spdiagnosticsserviceitemrequired-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:required" priority="1000" mode="M345">
...
<!--PATTERN spdiagnosticsserviceitemtypename-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticsservice_item/sp-sc:typename" priority="1000" mode="M346">
...
<!--PATTERN spdiagnosticslevelitemfarmname-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:farmname" priority="1000" mode="M347">
...
<!--PATTERN spdiagnosticslevelitemeventseverity-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:eventseverity" priority="1000" mode="M348">
...
<!--PATTERN spdiagnosticslevelitemhidden-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:hidden" priority="1000" mode="M349">
...
<!--PATTERN spdiagnosticsitemlevelid-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:levelid" priority="1000" mode="M350">
...
<!--PATTERN spdiagnosticsitemlevelname-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:levelname" priority="1000" mode="M351">
...
<!--PATTERN spdiagnosticslevelitemtraceseverity-->


	<!--RULE -->
<axsl:template match="sp-sc:spdiagnosticslevel_item/sp-sc:traceseverity" priority="1000" mode="M352">
...
<!--PATTERN sppolicyfeatureitemfarmname-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:farmname" priority="1000" mode="M353">
...
<!--PATTERN sppolicyfeatureitemconfigpage-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:configpage" priority="1000" mode="M354">
...
<!--PATTERN sppolicyfeatureitemdefaultcustomdata-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:defaultcustomdata" priority="1000" mode="M355">
...
<!--PATTERN sppolicyfeatureitemdescription-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:description" priority="1000" mode="M356">
...
<!--PATTERN sppolicyfeatureitemglobalconfigpage-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:globalconfigpage" priority="1000" mode="M357">
...
<!--PATTERN sppolicyfeatureitemglobalcustomdata-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:globalcustomdata" priority="1000" mode="M358">
...
<!--PATTERN sppolicyfeatureitemgroup-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:group" priority="1000" mode="M359">
...
<!--PATTERN sppolicyfeatureitemname-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:name" priority="1000" mode="M360">
...
<!--PATTERN sppolicyfeatureitempublisher-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:publisher" priority="1000" mode="M361">
...
<!--PATTERN sppolicyfeatureitemstate-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicyfeature_item/sp-sc:state" priority="1000" mode="M362">
...
<!--PATTERN sppolicyitemwebappuri-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:webappuri" priority="1000" mode="M363">
...
<!--PATTERN sppolicyitemurlzone-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:urlzone" priority="1000" mode="M364">
...
<!--PATTERN sppolicyitemdisplayname-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:displayname" priority="1000" mode="M365">
...
<!--PATTERN sppolicyitemissystemuser-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:issystemuser" priority="1000" mode="M366">
...
<!--PATTERN sppolicyitemusername-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:username" priority="1000" mode="M367">
...
<!--PATTERN sppolicyitempolicyroletype-->


	<!--RULE -->
<axsl:template match="sp-sc:sppolicy_item/sp-sc:policyroletype" priority="1000" mode="M368">
...
<!--PATTERN isaitembits-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:isainfo_item/sol-sc:bits" priority="1000" mode="M369">
...
<!--PATTERN isaitemkernel_isa-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:isainfo_item/sol-sc:kernel_isa" priority="1000" mode="M370">
...
<!--PATTERN isaitemapplication_isa-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:isainfo_item/sol-sc:application_isa" priority="1000" mode="M371">
...
<!--PATTERN packageitempkginst-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:pkginst" priority="1000" mode="M372">
...
<!--PATTERN packageitemname-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:name" priority="1000" mode="M373">
...
<!--PATTERN packageitemcategory-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:category" priority="1000" mode="M374">
...
<!--PATTERN packageitemversion-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:version" priority="1000" mode="M375">
...
<!--PATTERN packageitemvendor-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:vendor" priority="1000" mode="M376">
...
<!--PATTERN packageitemdescription-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:package_item/sol-sc:description" priority="1000" mode="M377">
...
<!--PATTERN patchitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:patch_item/sol-sc:base" priority="1000" mode="M378">
...
<!--PATTERN patchitemversion-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:patch_item/sol-sc:version" priority="1000" mode="M379">
...
<!--PATTERN fmriitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:fmri" priority="1000" mode="M380">
...
<!--PATTERN srvnameitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:service_name" priority="1000" mode="M381">
...
<!--PATTERN srvstateitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:service_state" priority="1000" mode="M382">
...
<!--PATTERN protocolitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:protocol" priority="1000" mode="M383">
...
<!--PATTERN srvexeitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:server_executable" priority="1000" mode="M384">
...
<!--PATTERN srvargsitembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:server_arguements" priority="1000" mode="M385">
...
<!--PATTERN execasuseritembase-->
	...
	<!--RULE -->
<axsl:template match="sol-sc:smf_item/sol-sc:exec_as_user" priority="1000" mode="M386">
...
<!--PATTERN unixfileitemfilepath-->


	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:filepath" priority="1000" mode="M387">
...
<!--PATTERN unixfileitempath-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:path" priority="1000" mode="M388">
...
<!--PATTERN unixfileitemfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:filename" priority="1000" mode="M389">
...
<!--PATTERN unixfileitemtype-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:type" priority="1000" mode="M390">
...
<!--PATTERN unixfileitemgroup_id-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:group_id" priority="1000" mode="M391">
...
<!--PATTERN unixfileitemuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:user_id" priority="1000" mode="M392">
...
<!--PATTERN unixfileitema_time-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:a_time" priority="1000" mode="M393">
...
<!--PATTERN unixfileitemc_time-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:c_time" priority="1000" mode="M394">
...
<!--PATTERN unixfileitemm_time-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:m_time" priority="1000" mode="M395">
...
<!--PATTERN unixfileitemsize-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:size" priority="1000" mode="M396">
...
<!--PATTERN unixfileitemsuid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:suid" priority="1000" mode="M397">
...
<!--PATTERN unixfileitemsgid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:sgid" priority="1000" mode="M398">
...
<!--PATTERN unixfileitemsticky-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:sticky" priority="1000" mode="M399">
...
<!--PATTERN unixfileitemuread-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:uread" priority="1000" mode="M400">
...
<!--PATTERN unixfileitemuwrite-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:uwrite" priority="1000" mode="M401">
...
<!--PATTERN unixfileitemuexec-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:uexec" priority="1000" mode="M402">
...
<!--PATTERN unixfileitemgread-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:gread" priority="1000" mode="M403">
...
<!--PATTERN unixfileitemgwrite-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:gwrite" priority="1000" mode="M404">
...
<!--PATTERN unixfileitemgexec-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:gexec" priority="1000" mode="M405">
...
<!--PATTERN unixfileitemoread-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:oread" priority="1000" mode="M406">
...
<!--PATTERN unixfileitemowrite-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:owrite" priority="1000" mode="M407">
...
<!--PATTERN unixfileitemoexec-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:file_item/unix-sc:oexec" priority="1000" mode="M408">
...
<!--PATTERN inetditemprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:protocol" priority="1000" mode="M409">
...
<!--PATTERN inetditemservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:service_name" priority="1000" mode="M410">
...
<!--PATTERN inetditemserver_program-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:server_program" priority="1000" mode="M411">
...
<!--PATTERN inetditemserver_arguments-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:server_arguments" priority="1000" mode="M412">
...
<!--PATTERN inetditemendpoint_type-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:endpoint_type" priority="1000" mode="M413">
...
<!--PATTERN inetditemexec_as_user-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:exec_as_user" priority="1000" mode="M414">
...
<!--PATTERN inetditemwait_status-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:inetd_item/unix-sc:wait_status" priority="1000" mode="M415">
...
<!--PATTERN unixinterfaceitemname-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:name" priority="1000" mode="M416">
...
<!--PATTERN unixinterfaceitemtype-->


	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:type" priority="1000" mode="M417">
...
<!--PATTERN unixinterfaceitemhardware_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:hardware_addr" priority="1000" mode="M418">
...
<!--PATTERN unixinterfaceiteminet_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:inet_addr" priority="1000" mode="M419">
...
<!--PATTERN unixinterfaceitembroadcast_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:broadcast_addr" priority="1000" mode="M420">
...
<!--PATTERN unixinterfaceitemnetmask-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:netmask" priority="1000" mode="M421">
...
<!--PATTERN unixinterfaceitemflag-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:interface_item/unix-sc:flag" priority="1000" mode="M422">
...
<!--PATTERN passworditemusername-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:username" priority="1000" mode="M423">
...
<!--PATTERN passworditempassword-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:password" priority="1000" mode="M424">
...
<!--PATTERN passworditemuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:user_id" priority="1000" mode="M425">
...
<!--PATTERN passworditemgroup_id-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:group_id" priority="1000" mode="M426">
...
<!--PATTERN passworditemgcos-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:gcos" priority="1000" mode="M427">
...
<!--PATTERN passworditemhome_dir-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:home_dir" priority="1000" mode="M428">
...
<!--PATTERN passworditemlogin_shell-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:password_item/unix-sc:login_shell" priority="1000" mode="M429">
...
<!--PATTERN unixprocessitemcommand-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:command" priority="1000" mode="M430">
...
<!--PATTERN unixprocessitemexec_time-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:exec_time" priority="1000" mode="M431">
...
<!--PATTERN unixprocessitempid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:pid" priority="1000" mode="M432">
...
<!--PATTERN unixprocessitemppid-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:ppid" priority="1000" mode="M433">
...
<!--PATTERN unixprocessitempriority-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:priority" priority="1000" mode="M434">
...
<!--PATTERN unixprocessitemscheduling_class-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:scheduling_class" priority="1000" mode="M435">
...
<!--PATTERN unixprocessitemstart_time-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:start_time" priority="1000" mode="M436">
...
<!--PATTERN unixprocessitemtty-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:tty" priority="1000" mode="M437">
...
<!--PATTERN unixprocessitemuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:process_item/unix-sc:user_id" priority="1000" mode="M438">
...
<!--PATTERN unixrlitemservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:runlevel_item/unix-sc:service_name" priority="1000" mode="M439">
...
<!--PATTERN unixrlitemrunlevel-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:runlevel_item/unix-sc:runlevel" priority="1000" mode="M440">
...
<!--PATTERN unixrlitemstart-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:runlevel_item/unix-sc:start" priority="1000" mode="M441">
...
<!--PATTERN unixrlitemkill-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:runlevel_item/unix-sc:kill" priority="1000" mode="M442">
...
<!--PATTERN sccsitemfilepath-->


	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:filepath" priority="1000" mode="M443">
...
<!--PATTERN sccsitempath-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:path" priority="1000" mode="M444">
...
<!--PATTERN sccsitemfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:filename" priority="1000" mode="M445">
...
<!--PATTERN sccsitemmodule_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:module_name" priority="1000" mode="M446">
...
<!--PATTERN sccsitemmodule_type-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:module_type" priority="1000" mode="M447">
...
<!--PATTERN sccsitemrelease-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:release" priority="1000" mode="M448">
...
<!--PATTERN sccsitemlevel-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:level" priority="1000" mode="M449">
...
<!--PATTERN sccsitembranch-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:branch" priority="1000" mode="M450">
...
<!--PATTERN sccsitemsequence-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:sequence" priority="1000" mode="M451">
...
<!--PATTERN sccsitemwhat_string-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:sccs_item/unix-sc:what_string" priority="1000" mode="M452">
...
<!--PATTERN shadowitemusername-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:username" priority="1000" mode="M453">
...
<!--PATTERN shadowitempassword-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:password" priority="1000" mode="M454">
...
<!--PATTERN shadowitemchg_lst-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:chg_lst" priority="1000" mode="M455">
...
<!--PATTERN shadowitemchg_allow-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:chg_allow" priority="1000" mode="M456">
...
<!--PATTERN shadowitemchg_req-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:chg_req" priority="1000" mode="M457">
...
<!--PATTERN shadowitemexp_warn-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:exp_warn" priority="1000" mode="M458">
...
<!--PATTERN shadowitemexp_inact-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:exp_inact" priority="1000" mode="M459">
...
<!--PATTERN shadowitemexp_date-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:exp_date" priority="1000" mode="M460">
...
<!--PATTERN shadowitemflag-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:shadow_item/unix-sc:flag" priority="1000" mode="M461">
...
<!--PATTERN unameitemmachine_class-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:machine_class" priority="1000" mode="M462">
...
<!--PATTERN unameitemnode_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:node_name" priority="1000" mode="M463">
...
<!--PATTERN unameitemos_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:os_name" priority="1000" mode="M464">
...
<!--PATTERN unameitemos_release-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:os_release" priority="1000" mode="M465">
...
<!--PATTERN unameitemos_version-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:os_version" priority="1000" mode="M466">
...
<!--PATTERN unameitemprocessor_type-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:uname_item/unix-sc:processor_type" priority="1000" mode="M467">
...
<!--PATTERN xinetditemprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:protocol" priority="1000" mode="M468">
...
<!--PATTERN xinetditemservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:service_name" priority="1000" mode="M469">
...
<!--PATTERN xinetditemflags-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:flags" priority="1000" mode="M470">
...
<!--PATTERN xinetditemnoaccess-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:no_access" priority="1000" mode="M471">
...
<!--PATTERN xinetditemonlyfrom-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:only_from" priority="1000" mode="M472">
...
<!--PATTERN xinetditemport-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:port" priority="1000" mode="M473">
...
<!--PATTERN xinetditemserver-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:server" priority="1000" mode="M474">
...
<!--PATTERN xinetditemserver_arguments-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:server_arguments" priority="1000" mode="M475">
...
<!--PATTERN xinetditemsockettype-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:socket_type" priority="1000" mode="M476">
...
<!--PATTERN xinetditemtype-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:type" priority="1000" mode="M477">
...
<!--PATTERN xinetditemuser-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:user" priority="1000" mode="M478">
...
<!--PATTERN xinetditemwait-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:wait" priority="1000" mode="M479">
...
<!--PATTERN xinetditemdisabled-->
	...
	<!--RULE -->
<axsl:template match="unix-sc:xinetd_item/unix-sc:disabled" priority="1000" mode="M480">
...
<!--PATTERN atitemsecurity_principle-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:security_principle" priority="1000" mode="M481">
...
<!--PATTERN atitemseassignprimarytokenprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seassignprimarytokenprivilege" priority="1000" mode="M482">
...
<!--PATTERN atitemseauditprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seauditprivilege" priority="1000" mode="M483">
...
<!--PATTERN atitemsebackupprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sebackupprivilege" priority="1000" mode="M484">
...
<!--PATTERN atitemsechangenotifyprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sechangenotifyprivilege" priority="1000" mode="M485">
...
<!--PATTERN atitemsecreateglobalprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:secreateglobalprivilege" priority="1000" mode="M486">
...
<!--PATTERN atitemsecreatepagefileprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:secreatepagefileprivilege" priority="1000" mode="M487">
...
<!--PATTERN atitemsecreatepermanentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:secreatepermanentprivilege" priority="1000" mode="M488">
...
<!--PATTERN atitemsecreatesymboliclinkprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:secreatesymboliclinkprivilege" priority="1000" mode="M489">
...
<!--PATTERN atitemsecreatetokenprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:secreatetokenprivilege" priority="1000" mode="M490">
...
<!--PATTERN atitemsedebugprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedebugprivilege" priority="1000" mode="M491">
...
<!--PATTERN atitemseenabledelegationprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seenabledelegationprivilege" priority="1000" mode="M492">
...
<!--PATTERN atitemseimpersonateprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seimpersonateprivilege" priority="1000" mode="M493">
...
<!--PATTERN atitemseincreasebasepriorityprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seincreasebasepriorityprivilege" priority="1000" mode="M494">
...
<!--PATTERN atitemseincreasequotaprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seincreasequotaprivilege" priority="1000" mode="M495">
...
<!--PATTERN atitemseincreaseworkingsetprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seincreaseworkingsetprivilege" priority="1000" mode="M496">
...
<!--PATTERN atitemseloaddriverprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seloaddriverprivilege" priority="1000" mode="M497">
...
<!--PATTERN atitemselockmemoryprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:selockmemoryprivilege" priority="1000" mode="M498">
...
<!--PATTERN atitemsemachineaccountprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:semachineaccountprivilege" priority="1000" mode="M499">
...
<!--PATTERN atitemsemanagevolumeprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:semanagevolumeprivilege" priority="1000" mode="M500">
...
<!--PATTERN atitemseprofilesingleprocessprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seprofilesingleprocessprivilege" priority="1000" mode="M501">
...
<!--PATTERN atitemserelabelprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:serelabelprivilege" priority="1000" mode="M502">
...
<!--PATTERN atitemseremoteshutdownprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seremoteshutdownprivilege" priority="1000" mode="M503">
...
<!--PATTERN atitemserestoreprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:serestoreprivilege" priority="1000" mode="M504">
...
<!--PATTERN atitemsesecurityprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sesecurityprivilege" priority="1000" mode="M505">
...
<!--PATTERN atitemseshutdownprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seshutdownprivilege" priority="1000" mode="M506">
...
<!--PATTERN atitemsesyncagentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sesyncagentprivilege" priority="1000" mode="M507">
...
<!--PATTERN atitemsesystemenvironmentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sesystemenvironmentprivilege" priority="1000" mode="M508">
...
<!--PATTERN atitemsesystemprofileprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sesystemprofileprivilege" priority="1000" mode="M509">
...
<!--PATTERN atitemsesystemtimeprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sesystemtimeprivilege" priority="1000" mode="M510">
...
<!--PATTERN atitemsetakeownershipprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:setakeownershipprivilege" priority="1000" mode="M511">
...
<!--PATTERN atitemsetcbprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:setcbprivilege" priority="1000" mode="M512">
...
<!--PATTERN atitemsetimezoneprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:setimezoneprivilege" priority="1000" mode="M513">
...
<!--PATTERN atitemseundockprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seundockprivilege" priority="1000" mode="M514">
...
<!--PATTERN atitemseunsolicitedinputprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seunsolicitedinputprivilege" priority="1000" mode="M515">
...
<!--PATTERN atitemsebatchlogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sebatchlogonright" priority="1000" mode="M516">
...
<!--PATTERN atitemseinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seinteractivelogonright" priority="1000" mode="M517">
...
<!--PATTERN atitemsenetworklogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:senetworklogonright" priority="1000" mode="M518">
...
<!--PATTERN atitemseremoteinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seremoteinteractivelogonright" priority="1000" mode="M519">
...
<!--PATTERN atitemseservicelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:seservicelogonright" priority="1000" mode="M520">
...
<!--PATTERN atitemsedenybatchLogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedenybatchLogonright" priority="1000" mode="M521">
...
<!--PATTERN atitemsedenyinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedenyinteractivelogonright" priority="1000" mode="M522">
...
<!--PATTERN atitemsedenynetworklogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedenynetworklogonright" priority="1000" mode="M523">
...
<!--PATTERN atitemsedenyremoteInteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedenyremoteInteractivelogonright" priority="1000" mode="M524">
...
<!--PATTERN atitemsedenyservicelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-sc:accesstoken_item/win-sc:sedenyservicelogonright" priority="1000" mode="M525">
...
<!--PATTERN aditemnaming_context-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:naming_context" priority="1000" mode="M526">
...
<!--PATTERN aditemrelative_dn-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:relative_dn" priority="1000" mode="M527">
...
<!--PATTERN aditemattribute-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:attribute" priority="1000" mode="M528">
...
<!--PATTERN aditemobject_class-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:object_class" priority="1000" mode="M529">
...
<!--PATTERN aditemadstype-->
	...
	<!--RULE -->
<axsl:template match="win-sc:activedirectory_item/win-sc:adstype" priority="1000" mode="M530">
...
<!--PATTERN aepitemaccount_logon-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:account_logon" priority="1000" mode="M531">
...
<!--PATTERN aepitemaccount_management-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:account_management" priority="1000" mode="M532">
...
<!--PATTERN aepitemdetailed_tracking-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:detailed_tracking" priority="1000" mode="M533">
...
<!--PATTERN aepitemdirectory_service_access-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:directory_service_access" priority="1000" mode="M534">
...
<!--PATTERN aepitemlogon-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:logon" priority="1000" mode="M535">
...
<!--PATTERN aepitemobject_access-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:object_access" priority="1000" mode="M536">
...
<!--PATTERN aepitempolicy_change-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:policy_change" priority="1000" mode="M537">
...
<!--PATTERN aepitemprivilege_use-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:privilege_use" priority="1000" mode="M538">
...
<!--PATTERN aepitemsystem-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicy_item/win-sc:system" priority="1000" mode="M539">
...
<!--PATTERN aepsitemcredentialvalidation-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:credential_validation" priority="1000" mode="M540">
...
<!--PATTERN aepsitemkerberosticketevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:kerberos_ticket_events" priority="1000" mode="M541">
...
<!--PATTERN aepsitemotheraccountlogonevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_account_logon_events" priority="1000" mode="M542">
...
<!--PATTERN aepsitemapplicationgroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:application_group_management" priority="1000" mode="M543">
...
<!--PATTERN aepsitemcomputeraccountmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:computer_account_management" priority="1000" mode="M544">
...
<!--PATTERN aepsitemdistributiongroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:distribution_group_management" priority="1000" mode="M545">
...
<!--PATTERN aepsitemotheraccountmanagementevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_account_management_events" priority="1000" mode="M546">
...
<!--PATTERN aepsitemsecuritygroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:security_group_management" priority="1000" mode="M547">
...
<!--PATTERN aepsitemuseraccountmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:user_account_management" priority="1000" mode="M548">
...
<!--PATTERN aepsitemdpapiactivity-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:dpapi_activity" priority="1000" mode="M549">
...
<!--PATTERN aepsitemprocesscreation-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:process_creation" priority="1000" mode="M550">
...
<!--PATTERN aepsitemprocesstermination-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:process_termination" priority="1000" mode="M551">
...
<!--PATTERN aepsitemrpcevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:rpc_events" priority="1000" mode="M552">
...
<!--PATTERN aepsitemdirectoryserviceaccess-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:directory_service_access" priority="1000" mode="M553">
...
<!--PATTERN aepsitemdirectoryservicechanges-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:xxx" priority="1000" mode="M554">
...
<!--PATTERN aepsitemdirectoryservicereplication-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:directory_service_replication" priority="1000" mode="M555">
...
<!--PATTERN aepsitemdetaileddirectoryservicereplication-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:detailed_directory_service_replication" priority="1000" mode="M556">
...
<!--PATTERN aepsitemaccountlockout-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:account_lockout" priority="1000" mode="M557">
...
<!--PATTERN aepsitemipsecextendedmode-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:ipsec_extended_mode" priority="1000" mode="M558">
...
<!--PATTERN aepsitemipsecmainmode-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:ipsec_main_mode" priority="1000" mode="M559">
...
<!--PATTERN aepsitemipsecquickmode-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:ipsec_quick_mode" priority="1000" mode="M560">
...
<!--PATTERN aepsitemlogoff-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:logoff" priority="1000" mode="M561">
...
<!--PATTERN aepsitemlogon-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:logon" priority="1000" mode="M562">
...
<!--PATTERN aepsitemotherlogonlogoffevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_logon_logoff_events" priority="1000" mode="M563">
...
<!--PATTERN aepsitemspeciallogon-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:special_logon" priority="1000" mode="M564">
...
<!--PATTERN aepsitemapplicationgenerated-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:application_generated" priority="1000" mode="M565">
...
<!--PATTERN aepsitemcertificationservices-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:certification_services" priority="1000" mode="M566">
...
<!--PATTERN aepsitemfileshare-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:file_share" priority="1000" mode="M567">
...
<!--PATTERN aepsitemfilesystem-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:file_system" priority="1000" mode="M568">
...
<!--PATTERN aepsitemfilteringplatformconnection-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:filtering_platform_connection" priority="1000" mode="M569">
...
<!--PATTERN aepsitemfilteringplatformpacketdrop-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:filtering_platform_packet_drop" priority="1000" mode="M570">
...
<!--PATTERN aepsitemhandlemanipulation-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:handle_manipulation" priority="1000" mode="M571">
...
<!--PATTERN aepsitemkernelobject-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:kernel_object" priority="1000" mode="M572">
...
<!--PATTERN aepsitemotherobjectaccessevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_object_access_events" priority="1000" mode="M573">
...
<!--PATTERN aepsitemregistry-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:registry" priority="1000" mode="M574">
...
<!--PATTERN aepsitemsam-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:sam" priority="1000" mode="M575">
...
<!--PATTERN aepsitemauditpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:audit_policy_change" priority="1000" mode="M576">
...
<!--PATTERN aepsitemauthenticationpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:authentication_policy_change" priority="1000" mode="M577">
...
<!--PATTERN aepsitemauthorizationpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:authorization_policy_change" priority="1000" mode="M578">
...
<!--PATTERN aepsitemfilteringplatformpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:filtering_platform_policy_change" priority="1000" mode="M579">
...
<!--PATTERN aepsitemmpssvcrulelevelpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:mpssvc_rule_level_policy_change" priority="1000" mode="M580">
...
<!--PATTERN aepsitemotherpolicychangeevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_policy_change_events" priority="1000" mode="M581">
...
<!--PATTERN aepsitemnonsensitiveprivilegeuse-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:non_sensitive_privilege_use" priority="1000" mode="M582">
...
<!--PATTERN aepsitemotherprivilegeuseevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_privilege_use_events" priority="1000" mode="M583">
...
<!--PATTERN aepsitemsensitiveprivilegeuse-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:sensitive_privilege_use" priority="1000" mode="M584">
...
<!--PATTERN aepsitemipsecdriver-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:ipsec_driver" priority="1000" mode="M585">
...
<!--PATTERN aepsitemothersystemevents-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:other_system_events" priority="1000" mode="M586">
...
<!--PATTERN aepsitemsecuritystatechange-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:security_state_change" priority="1000" mode="M587">
...
<!--PATTERN aepsitemsecuritysystemextension-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:security_system_extension" priority="1000" mode="M588">
...
<!--PATTERN aepsitemsystemintegrity-->
	...
	<!--RULE -->
<axsl:template match="win-sc:auditeventpolicysubcategories_item/win-sc:system_integrity" priority="1000" mode="M589">
...
<!--PATTERN fileitemfilepath-->


	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:filepath" priority="1000" mode="M590">
...
<!--PATTERN fileitempath-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:path" priority="1000" mode="M591">
...
<!--PATTERN fileitemfilename-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:filename" priority="1000" mode="M592">
...
<!--PATTERN fileitemowner-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:owner" priority="1000" mode="M593">
...
<!--PATTERN fileitemsize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:size" priority="1000" mode="M594">
...
<!--PATTERN fileitema_time-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:a_time" priority="1000" mode="M595">
...
<!--PATTERN fileitemc_time-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:c_time" priority="1000" mode="M596">
...
<!--PATTERN fileitemm_time-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:m_time" priority="1000" mode="M597">
...
<!--PATTERN fileitemms_checksum-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:ms_checksum" priority="1000" mode="M598">
...
<!--PATTERN fileitemversion-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:version" priority="1000" mode="M599">
...
<!--PATTERN fileitemtype-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:type" priority="1000" mode="M600">
...
<!--PATTERN fileitemdevelopment_class-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:development_class" priority="1000" mode="M601">
...
<!--PATTERN fileitemcompany-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:company" priority="1000" mode="M602">
...
<!--PATTERN fileiteminternalname-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:internal_name" priority="1000" mode="M603">
...
<!--PATTERN fileitemlanguage-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:language" priority="1000" mode="M604">
...
<!--PATTERN fileitemoriginalfilename-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:original_filename" priority="1000" mode="M605">
...
<!--PATTERN fileitemproductname-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:product_name" priority="1000" mode="M606">
...
<!--PATTERN fileitemproductversion-->
	...
	<!--RULE -->
<axsl:template match="win-sc:file_item/win-sc:product_version" priority="1000" mode="M607">
...
<!--PATTERN fileaudititemfilepath-->


	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:filepath" priority="1000" mode="M608">
...
<!--PATTERN fileaudititempath-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:path" priority="1000" mode="M609">
...
<!--PATTERN fileaudititemfilename-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:filename" priority="1000" mode="M610">
...
<!--PATTERN fileaudititemtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_sid" priority="1000" mode="M611">
...
<!--PATTERN fileaudititemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M612">
...
<!--PATTERN fileaudititemstandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:standard_delete" priority="1000" mode="M613">
...
<!--PATTERN fileaudititemstandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:standard_read_control" priority="1000" mode="M614">
...
<!--PATTERN fileaudititemstandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:standard_write_dac" priority="1000" mode="M615">
...
<!--PATTERN fileaudititemstandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:standard_write_owner" priority="1000" mode="M616">
...
<!--PATTERN fileaudititemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M617">
...
<!--PATTERN fileaudititemaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:access_system_security" priority="1000" mode="M618">
...
<!--PATTERN fileaudititemgeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:generic_read" priority="1000" mode="M619">
...
<!--PATTERN fileaudititemgeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:generic_write" priority="1000" mode="M620">
...
<!--PATTERN fileaudititemgeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:generic_execute" priority="1000" mode="M621">
...
<!--PATTERN fileaudititemgeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:generic_all" priority="1000" mode="M622">
...
<!--PATTERN fileaudititemfile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_read_data" priority="1000" mode="M623">
...
<!--PATTERN fileaudititemfile_write_data-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_write_data" priority="1000" mode="M624">
...
<!--PATTERN fileaudititemfile_append_data-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_append_data" priority="1000" mode="M625">
...
<!--PATTERN fileaudititemfile_read_ea-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_read_ea" priority="1000" mode="M626">
...
<!--PATTERN fileaudititemfile_write_ea-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_write_ea" priority="1000" mode="M627">
...
<!--PATTERN fileaudititemfile_execute-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_execute" priority="1000" mode="M628">
...
<!--PATTERN fileaudititemfile_delete_child-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_delete_child" priority="1000" mode="M629">
...
<!--PATTERN fileaudititemfile_read_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_read_attributes" priority="1000" mode="M630">
...
<!--PATTERN fileaudititemfile_write_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileauditedpermissions_item/win-sc:file_write_attributes" priority="1000" mode="M631">
...
<!--PATTERN ferititemfilepath-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:filepath" priority="1000" mode="M632">
...
<!--PATTERN feritempath-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:path" priority="1000" mode="M633">
...
<!--PATTERN feritemfilename-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:filename" priority="1000" mode="M634">
...
<!--PATTERN feritemtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_sid" priority="1000" mode="M635">
...
<!--PATTERN feritemtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M636">
...
<!--PATTERN feritemstandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:standard_delete" priority="1000" mode="M637">
...
<!--PATTERN feritemstandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:standard_read_control" priority="1000" mode="M638">
...
<!--PATTERN feritemstandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:standard_write_dac" priority="1000" mode="M639">
...
<!--PATTERN feritemstandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:standard_write_owner" priority="1000" mode="M640">
...
<!--PATTERN feritemstandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M641">
...
<!--PATTERN feritemaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:access_system_security" priority="1000" mode="M642">
...
<!--PATTERN feritemgeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:generic_read" priority="1000" mode="M643">
...
<!--PATTERN feritemgeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:generic_write" priority="1000" mode="M644">
...
<!--PATTERN feritemgeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:generic_execute" priority="1000" mode="M645">
...
<!--PATTERN feritemgeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:generic_all" priority="1000" mode="M646">
...
<!--PATTERN feritemfile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_read_data" priority="1000" mode="M647">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_read_data entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M647"/></axsl:template><axsl:template match="text()" priority="-1" mode="M647"/><axsl:template match="@*|node()" priority="-2" mode="M647"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M647"/></axsl:template>

<!--PATTERN feritemfile_write_data-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_write_data" priority="1000" mode="M648">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_write_data entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M648"/></axsl:template><axsl:template match="text()" priority="-1" mode="M648"/><axsl:template match="@*|node()" priority="-2" mode="M648"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M648"/></axsl:template>

<!--PATTERN feritemfile_append_data-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_append_data" priority="1000" mode="M649">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_append_data entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M649"/></axsl:template><axsl:template match="text()" priority="-1" mode="M649"/><axsl:template match="@*|node()" priority="-2" mode="M649"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M649"/></axsl:template>

<!--PATTERN feritemfile_read_ea-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_read_ea" priority="1000" mode="M650">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_read_ea entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M650"/></axsl:template><axsl:template match="text()" priority="-1" mode="M650"/><axsl:template match="@*|node()" priority="-2" mode="M650"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M650"/></axsl:template>

<!--PATTERN feritemfile_write_ea-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_write_ea" priority="1000" mode="M651">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_write_ea entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M651"/></axsl:template><axsl:template match="text()" priority="-1" mode="M651"/><axsl:template match="@*|node()" priority="-2" mode="M651"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M651"/></axsl:template>

<!--PATTERN feritemfile_execute-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_execute" priority="1000" mode="M652">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_execute entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M652"/></axsl:template><axsl:template match="text()" priority="-1" mode="M652"/><axsl:template match="@*|node()" priority="-2" mode="M652"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M652"/></axsl:template>

<!--PATTERN feritemfile_delete_child-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_delete_child" priority="1000" mode="M653">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_delete_child entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M653"/></axsl:template><axsl:template match="text()" priority="-1" mode="M653"/><axsl:template match="@*|node()" priority="-2" mode="M653"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M653"/></axsl:template>

<!--PATTERN feritemfile_read_attributes-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_read_attributes" priority="1000" mode="M654">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_read_attributes entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M654"/></axsl:template><axsl:template match="text()" priority="-1" mode="M654"/><axsl:template match="@*|node()" priority="-2" mode="M654"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M654"/></axsl:template>

<!--PATTERN feritemfile_write_attributes-->


	<!--RULE -->
<axsl:template match="win-sc:fileeffectiverights_item/win-sc:file_write_attributes" priority="1000" mode="M655">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_write_attributes entity of a fileeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M655"/></axsl:template><axsl:template match="text()" priority="-1" mode="M655"/><axsl:template match="@*|node()" priority="-2" mode="M655"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M655"/></axsl:template>

<!--PATTERN groupitemgroup-->


	<!--RULE -->
<axsl:template match="win-sc:group_item/win-sc:group" priority="1000" mode="M656">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the group entity of a group_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M656"/></axsl:template><axsl:template match="text()" priority="-1" mode="M656"/><axsl:template match="@*|node()" priority="-2" mode="M656"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M656"/></axsl:template>

<!--PATTERN groupitemuser-->


	<!--RULE -->
<axsl:template match="win-sc:group_item/win-sc:user" priority="1000" mode="M657">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user entity of a group_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M657"/></axsl:template><axsl:template match="text()" priority="-1" mode="M657"/><axsl:template match="@*|node()" priority="-2" mode="M657"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M657"/></axsl:template>

<!--PATTERN groupsiditemgroup-->


	<!--RULE -->
<axsl:template match="win-sc:group_sid_item/win-sc:group_sid" priority="1000" mode="M658">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the group_sid entity of a group_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M658"/></axsl:template><axsl:template match="text()" priority="-1" mode="M658"/><axsl:template match="@*|node()" priority="-2" mode="M658"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M658"/></axsl:template>

<!--PATTERN groupsiditemuser-->


	<!--RULE -->
<axsl:template match="win-sc:group_sid_item/win-sc:user_sid" priority="1000" mode="M659">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a group_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M659"/></axsl:template><axsl:template match="text()" priority="-1" mode="M659"/><axsl:template match="@*|node()" priority="-2" mode="M659"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M659"/></axsl:template>

<!--PATTERN wininterfaceitemname-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:name" priority="1000" mode="M660">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the name entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M660"/></axsl:template><axsl:template match="text()" priority="-1" mode="M660"/><axsl:template match="@*|node()" priority="-2" mode="M660"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M660"/></axsl:template>

<!--PATTERN wininterfaceitemindex-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:index" priority="1000" mode="M661">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the index entity of an interface_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M661"/></axsl:template><axsl:template match="text()" priority="-1" mode="M661"/><axsl:template match="@*|node()" priority="-2" mode="M661"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M661"/></axsl:template>

<!--PATTERN wininterfaceitemtype-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:type" priority="1000" mode="M662">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the type entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M662"/></axsl:template><axsl:template match="text()" priority="-1" mode="M662"/><axsl:template match="@*|node()" priority="-2" mode="M662"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M662"/></axsl:template>

<!--PATTERN wininterfaceitemhardware_addr-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:hardware_addr" priority="1000" mode="M663">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the hardware_addr entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M663"/></axsl:template><axsl:template match="text()" priority="-1" mode="M663"/><axsl:template match="@*|node()" priority="-2" mode="M663"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M663"/></axsl:template>

<!--PATTERN wininterfaceiteminet_addr-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:inet_addr" priority="1000" mode="M664">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the inet_addr entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M664"/></axsl:template><axsl:template match="text()" priority="-1" mode="M664"/><axsl:template match="@*|node()" priority="-2" mode="M664"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M664"/></axsl:template>

<!--PATTERN wininterfaceitembroadcast_addr-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:broadcast_addr" priority="1000" mode="M665">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the broadcast_addr entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M665"/></axsl:template><axsl:template match="text()" priority="-1" mode="M665"/><axsl:template match="@*|node()" priority="-2" mode="M665"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M665"/></axsl:template>

<!--PATTERN wininterfaceitemnetmask-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:netmask" priority="1000" mode="M666">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the netmask entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M666"/></axsl:template><axsl:template match="text()" priority="-1" mode="M666"/><axsl:template match="@*|node()" priority="-2" mode="M666"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M666"/></axsl:template>

<!--PATTERN wininterfaceitemaddr_type-->


	<!--RULE -->
<axsl:template match="win-sc:interface_item/win-sc:addr_type" priority="1000" mode="M667">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the addr_type entity of an interface_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M667"/></axsl:template><axsl:template match="text()" priority="-1" mode="M667"/><axsl:template match="@*|node()" priority="-2" mode="M667"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M667"/></axsl:template>

<!--PATTERN lpitemforce_logoff-->


	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:force_logoff" priority="1000" mode="M668">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the force_logoff entity of a lockoutpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M668"/></axsl:template><axsl:template match="text()" priority="-1" mode="M668"/><axsl:template match="@*|node()" priority="-2" mode="M668"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M668"/></axsl:template>

<!--PATTERN lpitemlockout_duration-->


	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:lockout_duration" priority="1000" mode="M669">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the lockout_duration entity of a lockoutpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M669"/></axsl:template><axsl:template match="text()" priority="-1" mode="M669"/><axsl:template match="@*|node()" priority="-2" mode="M669"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M669"/></axsl:template>

<!--PATTERN lpitemlockout_observation_window-->


	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:lockout_observation_window" priority="1000" mode="M670">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the lockout_observation_window entity of a lockoutpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M670"/></axsl:template><axsl:template match="text()" priority="-1" mode="M670"/><axsl:template match="@*|node()" priority="-2" mode="M670"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M670"/></axsl:template>

<!--PATTERN lpitemlockout_threshold-->


	<!--RULE -->
<axsl:template match="win-sc:lockoutpolicy_item/win-sc:lockout_threshold" priority="1000" mode="M671">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the lockout_threshold entity of a lockoutpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M671"/></axsl:template><axsl:template match="text()" priority="-1" mode="M671"/><axsl:template match="@*|node()" priority="-2" mode="M671"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M671"/></axsl:template>

<!--PATTERN metabaseitemkey-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:key" priority="1000" mode="M672">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key entity of a metabase_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M672"/></axsl:template><axsl:template match="text()" priority="-1" mode="M672"/><axsl:template match="@*|node()" priority="-2" mode="M672"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M672"/></axsl:template>

<!--PATTERN metabaseitemid-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:id" priority="1000" mode="M673">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the id entity of a metabase_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M673"/></axsl:template><axsl:template match="text()" priority="-1" mode="M673"/><axsl:template match="@*|node()" priority="-2" mode="M673"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M673"/></axsl:template>

<!--PATTERN metabaseitemname-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:name" priority="1000" mode="M674">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the name entity of a metabase_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M674"/></axsl:template><axsl:template match="text()" priority="-1" mode="M674"/><axsl:template match="@*|node()" priority="-2" mode="M674"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M674"/></axsl:template>

<!--PATTERN metabaseitemuser_type-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:user_type" priority="1000" mode="M675">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_type entity of a metabase_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M675"/></axsl:template><axsl:template match="text()" priority="-1" mode="M675"/><axsl:template match="@*|node()" priority="-2" mode="M675"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M675"/></axsl:template>

<!--PATTERN metabaseitemdata_type-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:data_type" priority="1000" mode="M676">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the data_type entity of a metabase_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M676"/></axsl:template><axsl:template match="text()" priority="-1" mode="M676"/><axsl:template match="@*|node()" priority="-2" mode="M676"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M676"/></axsl:template>

<!--PATTERN metabaseitemdata-->


	<!--RULE -->
<axsl:template match="win-sc:metabase_item/win-sc:data" priority="1000" mode="M677">

		<!--ASSERT -->
<axsl:choose><axsl:when test="(@datatype='int' and (floor(.) = number(.))) or not(@datatype='int') or not(node())"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The datatype has been set to 'int' but the value is not an integer.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M677"/></axsl:template><axsl:template match="text()" priority="-1" mode="M677"/><axsl:template match="@*|node()" priority="-2" mode="M677"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M677"/></axsl:template>

<!--PATTERN ppitemmax_passwd_age-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:max_passwd_age" priority="1000" mode="M678">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the max_passwd_age entity of a passwordpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M678"/></axsl:template><axsl:template match="text()" priority="-1" mode="M678"/><axsl:template match="@*|node()" priority="-2" mode="M678"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M678"/></axsl:template>

<!--PATTERN ppitemmin_passwd_age-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:min_passwd_age" priority="1000" mode="M679">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the min_passwd_age entity of a passwordpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M679"/></axsl:template><axsl:template match="text()" priority="-1" mode="M679"/><axsl:template match="@*|node()" priority="-2" mode="M679"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M679"/></axsl:template>

<!--PATTERN ppitemmin_passwd_len-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:min_passwd_len" priority="1000" mode="M680">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the min_passwd_len entity of a passwordpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M680"/></axsl:template><axsl:template match="text()" priority="-1" mode="M680"/><axsl:template match="@*|node()" priority="-2" mode="M680"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M680"/></axsl:template>

<!--PATTERN ppitempassword_hist_len-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:password_hist_len" priority="1000" mode="M681">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the password_hist_len entity of a passwordpolicy_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M681"/></axsl:template><axsl:template match="text()" priority="-1" mode="M681"/><axsl:template match="@*|node()" priority="-2" mode="M681"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M681"/></axsl:template>

<!--PATTERN ppitempassword_complexity-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:password_complexity" priority="1000" mode="M682">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the password_complexity entity of a passwordpolicy_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M682"/></axsl:template><axsl:template match="text()" priority="-1" mode="M682"/><axsl:template match="@*|node()" priority="-2" mode="M682"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M682"/></axsl:template>

<!--PATTERN ppitemreversible_encryption-->


	<!--RULE -->
<axsl:template match="win-sc:passwordpolicy_item/win-sc:reversible_encryption" priority="1000" mode="M683">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the reversible_encryption entity of a passwordpolicy_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M683"/></axsl:template><axsl:template match="text()" priority="-1" mode="M683"/><axsl:template match="@*|node()" priority="-2" mode="M683"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M683"/></axsl:template>

<!--PATTERN winportitemlocal_address-->


	<!--RULE -->
<axsl:template match="win-sc:port_item/win-sc:local_address" priority="1000" mode="M684">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the local_address entity of a port_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M684"/></axsl:template><axsl:template match="text()" priority="-1" mode="M684"/><axsl:template match="@*|node()" priority="-2" mode="M684"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M684"/></axsl:template>

<!--PATTERN winportitemlocal_port-->


	<!--RULE -->
<axsl:template match="win-sc:port_item/win-sc:local_port" priority="1000" mode="M685">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the local_port entity of a port_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M685"/></axsl:template><axsl:template match="text()" priority="-1" mode="M685"/><axsl:template match="@*|node()" priority="-2" mode="M685"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M685"/></axsl:template>

<!--PATTERN winportitemprotocol-->


	<!--RULE -->
<axsl:template match="win-sc:port_item/win-sc:protocol" priority="1000" mode="M686">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the protocol entity of a port_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M686"/></axsl:template><axsl:template match="text()" priority="-1" mode="M686"/><axsl:template match="@*|node()" priority="-2" mode="M686"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M686"/></axsl:template>

<!--PATTERN winportitempid-->


	<!--RULE -->
<axsl:template match="win-sc:port_item/win-sc:pid" priority="1000" mode="M687">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the pid entity of a port_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M687"/></axsl:template><axsl:template match="text()" priority="-1" mode="M687"/><axsl:template match="@*|node()" priority="-2" mode="M687"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M687"/></axsl:template>

<!--PATTERN peritemprinter_name-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:printer_name" priority="1000" mode="M688">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the printer_name entity of a printereffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M688"/></axsl:template><axsl:template match="text()" priority="-1" mode="M688"/><axsl:template match="@*|node()" priority="-2" mode="M688"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M688"/></axsl:template>

<!--PATTERN peritemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:trustee_sid" priority="1000" mode="M689">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a printereffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M689"/></axsl:template><axsl:template match="text()" priority="-1" mode="M689"/><axsl:template match="@*|node()" priority="-2" mode="M689"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M689"/></axsl:template>

<!--PATTERN peritemstandard_delete-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:standard_delete" priority="1000" mode="M690">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_delete entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M690"/></axsl:template><axsl:template match="text()" priority="-1" mode="M690"/><axsl:template match="@*|node()" priority="-2" mode="M690"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M690"/></axsl:template>

<!--PATTERN peritemstandard_read_control-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:standard_read_control" priority="1000" mode="M691">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_read_control entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M691"/></axsl:template><axsl:template match="text()" priority="-1" mode="M691"/><axsl:template match="@*|node()" priority="-2" mode="M691"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M691"/></axsl:template>

<!--PATTERN peritemstandard_write_dac-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:standard_write_dac" priority="1000" mode="M692">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_dac entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M692"/></axsl:template><axsl:template match="text()" priority="-1" mode="M692"/><axsl:template match="@*|node()" priority="-2" mode="M692"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M692"/></axsl:template>

<!--PATTERN peritemstandard_write_owner-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:standard_write_owner" priority="1000" mode="M693">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_owner entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M693"/></axsl:template><axsl:template match="text()" priority="-1" mode="M693"/><axsl:template match="@*|node()" priority="-2" mode="M693"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M693"/></axsl:template>

<!--PATTERN peritemstandard_synchronize-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M694">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_synchronize entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M694"/></axsl:template><axsl:template match="text()" priority="-1" mode="M694"/><axsl:template match="@*|node()" priority="-2" mode="M694"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M694"/></axsl:template>

<!--PATTERN peritemaccess_system_security-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:access_system_security" priority="1000" mode="M695">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_system_security entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M695"/></axsl:template><axsl:template match="text()" priority="-1" mode="M695"/><axsl:template match="@*|node()" priority="-2" mode="M695"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M695"/></axsl:template>

<!--PATTERN peritemgeneric_read-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:generic_read" priority="1000" mode="M696">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_read entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M696"/></axsl:template><axsl:template match="text()" priority="-1" mode="M696"/><axsl:template match="@*|node()" priority="-2" mode="M696"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M696"/></axsl:template>

<!--PATTERN peritemgeneric_write-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:generic_write" priority="1000" mode="M697">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_write entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M697"/></axsl:template><axsl:template match="text()" priority="-1" mode="M697"/><axsl:template match="@*|node()" priority="-2" mode="M697"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M697"/></axsl:template>

<!--PATTERN peritemgeneric_execute-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:generic_execute" priority="1000" mode="M698">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_execute entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M698"/></axsl:template><axsl:template match="text()" priority="-1" mode="M698"/><axsl:template match="@*|node()" priority="-2" mode="M698"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M698"/></axsl:template>

<!--PATTERN peritemgeneric_all-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:generic_all" priority="1000" mode="M699">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_all entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M699"/></axsl:template><axsl:template match="text()" priority="-1" mode="M699"/><axsl:template match="@*|node()" priority="-2" mode="M699"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M699"/></axsl:template>

<!--PATTERN peritemprinter_access_administer-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:printer_access_administer" priority="1000" mode="M700">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the printer_access_administer entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M700"/></axsl:template><axsl:template match="text()" priority="-1" mode="M700"/><axsl:template match="@*|node()" priority="-2" mode="M700"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M700"/></axsl:template>

<!--PATTERN peritemprinter_access_use-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:printer_access_use" priority="1000" mode="M701">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the printer_access_use entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M701"/></axsl:template><axsl:template match="text()" priority="-1" mode="M701"/><axsl:template match="@*|node()" priority="-2" mode="M701"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M701"/></axsl:template>

<!--PATTERN peritemjob_access_administer-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:job_access_administer" priority="1000" mode="M702">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the job_access_administer entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M702"/></axsl:template><axsl:template match="text()" priority="-1" mode="M702"/><axsl:template match="@*|node()" priority="-2" mode="M702"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M702"/></axsl:template>

<!--PATTERN peritemjob_access_read-->


	<!--RULE -->
<axsl:template match="win-sc:printereffectiverights_item/win-sc:job_access_read" priority="1000" mode="M703">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the job_access_read entity of a printereffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M703"/></axsl:template><axsl:template match="text()" priority="-1" mode="M703"/><axsl:template match="@*|node()" priority="-2" mode="M703"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M703"/></axsl:template>

<!--PATTERN processitemcommand_line-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:command_line" priority="1000" mode="M704">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the command_line entity of a process_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M704"/></axsl:template><axsl:template match="text()" priority="-1" mode="M704"/><axsl:template match="@*|node()" priority="-2" mode="M704"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M704"/></axsl:template>

<!--PATTERN processitempid-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:pid" priority="1000" mode="M705">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the pid entity of a process_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M705"/></axsl:template><axsl:template match="text()" priority="-1" mode="M705"/><axsl:template match="@*|node()" priority="-2" mode="M705"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M705"/></axsl:template>

<!--PATTERN processitemppid-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:ppid" priority="1000" mode="M706">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the ppid entity of a process_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M706"/></axsl:template><axsl:template match="text()" priority="-1" mode="M706"/><axsl:template match="@*|node()" priority="-2" mode="M706"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M706"/></axsl:template>

<!--PATTERN processitempriority-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:priority" priority="1000" mode="M707">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the priority entity of a process_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M707"/></axsl:template><axsl:template match="text()" priority="-1" mode="M707"/><axsl:template match="@*|node()" priority="-2" mode="M707"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M707"/></axsl:template>

<!--PATTERN processitemimage_path-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:image_path" priority="1000" mode="M708">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the image_path entity of a process_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M708"/></axsl:template><axsl:template match="text()" priority="-1" mode="M708"/><axsl:template match="@*|node()" priority="-2" mode="M708"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M708"/></axsl:template>

<!--PATTERN processitemcurrent_dir-->


	<!--RULE -->
<axsl:template match="win-sc:process_item/win-sc:current_dir" priority="1000" mode="M709">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the current_dir entity of a process_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M709"/></axsl:template><axsl:template match="text()" priority="-1" mode="M709"/><axsl:template match="@*|node()" priority="-2" mode="M709"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M709"/></axsl:template>

<!--PATTERN regitemhive-->


	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:hive" priority="1000" mode="M710">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the hive entity of a registry_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M710"/></axsl:template><axsl:template match="text()" priority="-1" mode="M710"/><axsl:template match="@*|node()" priority="-2" mode="M710"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M710"/></axsl:template>

<!--PATTERN regitemkey-->


	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:key" priority="1000" mode="M711">
...
<axsl:choose><axsl:when test="not(@xsi:nil='true') or ../win-sc:name/@xsi:nil='true'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - name entity must be nil when key is nil<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M711"/></axsl:template><axsl:template match="text()" priority="-1" mode="M711"/><axsl:template match="@*|node()" priority="-2" mode="M711"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M711"/></axsl:template>

<!--PATTERN regitemname-->


	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:name" priority="1000" mode="M712">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the name entity of a registry_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M712"/></axsl:template><axsl:template match="text()" priority="-1" mode="M712"/><axsl:template match="@*|node()" priority="-2" mode="M712"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M712"/></axsl:template>

<!--PATTERN regitemtype-->


	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:type" priority="1000" mode="M713">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the type entity of a registry_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M713"/></axsl:template><axsl:template match="text()" priority="-1" mode="M713"/><axsl:template match="@*|node()" priority="-2" mode="M713"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M713"/></axsl:template>

<!--PATTERN regitemvalue-->


	<!--RULE -->
<axsl:template match="win-sc:registry_item/win-sc:value" priority="1000" mode="M714">

		<!--ASSERT -->
<axsl:choose><axsl:when test="(@datatype='int' and (floor(.) = number(.))) or not(@datatype='int') or not(node())"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The datatype has been set to 'int' but the value is not an integer.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M714"/></axsl:template><axsl:template match="text()" priority="-1" mode="M714"/><axsl:template match="@*|node()" priority="-2" mode="M714"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M714"/></axsl:template>

<!--PATTERN rapitemhive-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:hive" priority="1000" mode="M715">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the hive entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M715"/></axsl:template><axsl:template match="text()" priority="-1" mode="M715"/><axsl:template match="@*|node()" priority="-2" mode="M715"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M715"/></axsl:template>

<!--PATTERN rapitemkey-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key" priority="1000" mode="M716">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M716"/></axsl:template><axsl:template match="text()" priority="-1" mode="M716"/><axsl:template match="@*|node()" priority="-2" mode="M716"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M716"/></axsl:template>

<!--PATTERN rapitemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_sid" priority="1000" mode="M717">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M717"/></axsl:template><axsl:template match="text()" priority="-1" mode="M717"/><axsl:template match="@*|node()" priority="-2" mode="M717"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M717"/></axsl:template>

<!--PATTERN rapitemtrustee_name-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:trustee_name" priority="1000" mode="M718">
...
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_name entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M718"/></axsl:template><axsl:template match="text()" priority="-1" mode="M718"/><axsl:template match="@*|node()" priority="-2" mode="M718"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M718"/></axsl:template>

<!--PATTERN rapitemstandard_delete-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_delete" priority="1000" mode="M719">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_delete entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M719"/></axsl:template><axsl:template match="text()" priority="-1" mode="M719"/><axsl:template match="@*|node()" priority="-2" mode="M719"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M719"/></axsl:template>

<!--PATTERN rapitemstandard_read_control-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_read_control" priority="1000" mode="M720">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_read_control entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M720"/></axsl:template><axsl:template match="text()" priority="-1" mode="M720"/><axsl:template match="@*|node()" priority="-2" mode="M720"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M720"/></axsl:template>

<!--PATTERN rapitemstandard_write_dac-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_write_dac" priority="1000" mode="M721">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_dac entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M721"/></axsl:template><axsl:template match="text()" priority="-1" mode="M721"/><axsl:template match="@*|node()" priority="-2" mode="M721"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M721"/></axsl:template>

<!--PATTERN rapitemstandard_write_owner-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_write_owner" priority="1000" mode="M722">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_owner entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M722"/></axsl:template><axsl:template match="text()" priority="-1" mode="M722"/><axsl:template match="@*|node()" priority="-2" mode="M722"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M722"/></axsl:template>

<!--PATTERN rapitemstandard_synchronize-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:standard_synchronize" priority="1000" mode="M723">
...
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_synchronize entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M723"/></axsl:template><axsl:template match="text()" priority="-1" mode="M723"/><axsl:template match="@*|node()" priority="-2" mode="M723"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M723"/></axsl:template>

<!--PATTERN rapitemaccess_system_security-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:access_system_security" priority="1000" mode="M724">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_system_security entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M724"/></axsl:template><axsl:template match="text()" priority="-1" mode="M724"/><axsl:template match="@*|node()" priority="-2" mode="M724"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M724"/></axsl:template>

<!--PATTERN rapitemgeneric_read-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:generic_read" priority="1000" mode="M725">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_read entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M725"/></axsl:template><axsl:template match="text()" priority="-1" mode="M725"/><axsl:template match="@*|node()" priority="-2" mode="M725"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M725"/></axsl:template>

<!--PATTERN rapitemgeneric_write-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:generic_write" priority="1000" mode="M726">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_write entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M726"/></axsl:template><axsl:template match="text()" priority="-1" mode="M726"/><axsl:template match="@*|node()" priority="-2" mode="M726"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M726"/></axsl:template>

<!--PATTERN rapitemgeneric_execute-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:generic_execute" priority="1000" mode="M727">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_execute entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M727"/></axsl:template><axsl:template match="text()" priority="-1" mode="M727"/><axsl:template match="@*|node()" priority="-2" mode="M727"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M727"/></axsl:template>

<!--PATTERN rapitemgeneric_all-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:generic_all" priority="1000" mode="M728">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_all entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M728"/></axsl:template><axsl:template match="text()" priority="-1" mode="M728"/><axsl:template match="@*|node()" priority="-2" mode="M728"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M728"/></axsl:template>

<!--PATTERN rapitemkey_query_value-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_query_value" priority="1000" mode="M729">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_query_value entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M729"/></axsl:template><axsl:template match="text()" priority="-1" mode="M729"/><axsl:template match="@*|node()" priority="-2" mode="M729"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M729"/></axsl:template>

<!--PATTERN rapitemkey_set_value-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_set_value" priority="1000" mode="M730">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_set_value entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M730"/></axsl:template><axsl:template match="text()" priority="-1" mode="M730"/><axsl:template match="@*|node()" priority="-2" mode="M730"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M730"/></axsl:template>

<!--PATTERN rapitemkey_create_sub_key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_create_sub_key" priority="1000" mode="M731">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_create_sub_key entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M731"/></axsl:template><axsl:template match="text()" priority="-1" mode="M731"/><axsl:template match="@*|node()" priority="-2" mode="M731"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M731"/></axsl:template>

<!--PATTERN rapitemkey_enumerate_sub_keys-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_enumerate_sub_keys" priority="1000" mode="M732">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_enumerate_sub_keys entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M732"/></axsl:template><axsl:template match="text()" priority="-1" mode="M732"/><axsl:template match="@*|node()" priority="-2" mode="M732"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M732"/></axsl:template>

<!--PATTERN rapitemkey_notify-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_notify" priority="1000" mode="M733">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_notify entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M733"/></axsl:template><axsl:template match="text()" priority="-1" mode="M733"/><axsl:template match="@*|node()" priority="-2" mode="M733"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M733"/></axsl:template>

<!--PATTERN rapitemkey_create_link-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_create_link" priority="1000" mode="M734">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_create_link entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M734"/></axsl:template><axsl:template match="text()" priority="-1" mode="M734"/><axsl:template match="@*|node()" priority="-2" mode="M734"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M734"/></axsl:template>

<!--PATTERN rapitemkey_wow64_64key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_wow64_64key" priority="1000" mode="M735">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_64key entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M735"/></axsl:template><axsl:template match="text()" priority="-1" mode="M735"/><axsl:template match="@*|node()" priority="-2" mode="M735"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M735"/></axsl:template>

<!--PATTERN rapitemkey_wow64_32key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_wow64_32key" priority="1000" mode="M736">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_32key entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M736"/></axsl:template><axsl:template match="text()" priority="-1" mode="M736"/><axsl:template match="@*|node()" priority="-2" mode="M736"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M736"/></axsl:template>

<!--PATTERN rapitemkey_wow64_res-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyauditedpermissions_item/win-sc:key_wow64_res" priority="1000" mode="M737">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_res entity of a regkeyauditedpermissions_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M737"/></axsl:template><axsl:template match="text()" priority="-1" mode="M737"/><axsl:template match="@*|node()" priority="-2" mode="M737"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M737"/></axsl:template>

<!--PATTERN reritemhive-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:hive" priority="1000" mode="M738">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the hive entity of a regkeyeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M738"/></axsl:template><axsl:template match="text()" priority="-1" mode="M738"/><axsl:template match="@*|node()" priority="-2" mode="M738"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M738"/></axsl:template>

<!--PATTERN reritemkey-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key" priority="1000" mode="M739">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key entity of a regkeyeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M739"/></axsl:template><axsl:template match="text()" priority="-1" mode="M739"/><axsl:template match="@*|node()" priority="-2" mode="M739"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M739"/></axsl:template>

<!--PATTERN reritemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_sid" priority="1000" mode="M740">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a regkeyeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M740"/></axsl:template><axsl:template match="text()" priority="-1" mode="M740"/><axsl:template match="@*|node()" priority="-2" mode="M740"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M740"/></axsl:template>

<!--PATTERN reritemtrustee_name-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:trustee_name" priority="1000" mode="M741">
...
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_name entity of a regkeyeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M741"/></axsl:template><axsl:template match="text()" priority="-1" mode="M741"/><axsl:template match="@*|node()" priority="-2" mode="M741"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M741"/></axsl:template>

<!--PATTERN reritemstandard_delete-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_delete" priority="1000" mode="M742">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_delete entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M742"/></axsl:template><axsl:template match="text()" priority="-1" mode="M742"/><axsl:template match="@*|node()" priority="-2" mode="M742"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M742"/></axsl:template>

<!--PATTERN reritemstandard_read_control-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_read_control" priority="1000" mode="M743">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_read_control entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M743"/></axsl:template><axsl:template match="text()" priority="-1" mode="M743"/><axsl:template match="@*|node()" priority="-2" mode="M743"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M743"/></axsl:template>

<!--PATTERN reritemstandard_write_dac-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_write_dac" priority="1000" mode="M744">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_dac entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M744"/></axsl:template><axsl:template match="text()" priority="-1" mode="M744"/><axsl:template match="@*|node()" priority="-2" mode="M744"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M744"/></axsl:template>

<!--PATTERN reritemstandard_write_owner-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_write_owner" priority="1000" mode="M745">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_owner entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M745"/></axsl:template><axsl:template match="text()" priority="-1" mode="M745"/><axsl:template match="@*|node()" priority="-2" mode="M745"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M745"/></axsl:template>

<!--PATTERN reritemstandard_synchronize-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:standard_synchronize" priority="1000" mode="M746">
...
<axsl:if test="true()">DEPRECATED ELEMENT: <axsl:text/><axsl:value-of select="name()"/><axsl:text/> ID: <axsl:text/><axsl:value-of select="@id"/><axsl:text/>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_synchronize entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M746"/></axsl:template><axsl:template match="text()" priority="-1" mode="M746"/><axsl:template match="@*|node()" priority="-2" mode="M746"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M746"/></axsl:template>

<!--PATTERN reritemaccess_system_security-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:access_system_security" priority="1000" mode="M747">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_system_security entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M747"/></axsl:template><axsl:template match="text()" priority="-1" mode="M747"/><axsl:template match="@*|node()" priority="-2" mode="M747"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M747"/></axsl:template>

<!--PATTERN reritemgeneric_read-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:generic_read" priority="1000" mode="M748">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_read entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M748"/></axsl:template><axsl:template match="text()" priority="-1" mode="M748"/><axsl:template match="@*|node()" priority="-2" mode="M748"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M748"/></axsl:template>

<!--PATTERN reritemgeneric_write-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:generic_write" priority="1000" mode="M749">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_write entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M749"/></axsl:template><axsl:template match="text()" priority="-1" mode="M749"/><axsl:template match="@*|node()" priority="-2" mode="M749"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M749"/></axsl:template>

<!--PATTERN reritemgeneric_execute-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:generic_execute" priority="1000" mode="M750">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_execute entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M750"/></axsl:template><axsl:template match="text()" priority="-1" mode="M750"/><axsl:template match="@*|node()" priority="-2" mode="M750"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M750"/></axsl:template>

<!--PATTERN reritemgeneric_all-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:generic_all" priority="1000" mode="M751">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_all entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M751"/></axsl:template><axsl:template match="text()" priority="-1" mode="M751"/><axsl:template match="@*|node()" priority="-2" mode="M751"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M751"/></axsl:template>

<!--PATTERN reritemkey_query_value-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_query_value" priority="1000" mode="M752">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_query_value entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M752"/></axsl:template><axsl:template match="text()" priority="-1" mode="M752"/><axsl:template match="@*|node()" priority="-2" mode="M752"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M752"/></axsl:template>

<!--PATTERN reritemkey_set_value-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_set_value" priority="1000" mode="M753">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_set_value entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M753"/></axsl:template><axsl:template match="text()" priority="-1" mode="M753"/><axsl:template match="@*|node()" priority="-2" mode="M753"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M753"/></axsl:template>

<!--PATTERN reritemkey_create_sub_key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_create_sub_key" priority="1000" mode="M754">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_create_sub_key entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M754"/></axsl:template><axsl:template match="text()" priority="-1" mode="M754"/><axsl:template match="@*|node()" priority="-2" mode="M754"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M754"/></axsl:template>

<!--PATTERN reritemkey_enumerate_sub_keys-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_enumerate_sub_keys" priority="1000" mode="M755">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_enumerate_sub_keys entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M755"/></axsl:template><axsl:template match="text()" priority="-1" mode="M755"/><axsl:template match="@*|node()" priority="-2" mode="M755"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M755"/></axsl:template>

<!--PATTERN reritemkey_notify-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_notify" priority="1000" mode="M756">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_notify entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M756"/></axsl:template><axsl:template match="text()" priority="-1" mode="M756"/><axsl:template match="@*|node()" priority="-2" mode="M756"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M756"/></axsl:template>

<!--PATTERN reritemkey_create_link-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_create_link" priority="1000" mode="M757">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_create_link entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M757"/></axsl:template><axsl:template match="text()" priority="-1" mode="M757"/><axsl:template match="@*|node()" priority="-2" mode="M757"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M757"/></axsl:template>

<!--PATTERN reritemkey_wow64_64key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_wow64_64key" priority="1000" mode="M758">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_64key entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M758"/></axsl:template><axsl:template match="text()" priority="-1" mode="M758"/><axsl:template match="@*|node()" priority="-2" mode="M758"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M758"/></axsl:template>

<!--PATTERN reritemkey_wow64_32key-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_wow64_32key" priority="1000" mode="M759">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_32key entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M759"/></axsl:template><axsl:template match="text()" priority="-1" mode="M759"/><axsl:template match="@*|node()" priority="-2" mode="M759"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M759"/></axsl:template>

<!--PATTERN reritemkey_wow64_res-->


	<!--RULE -->
<axsl:template match="win-sc:regkeyeffectiverights_item/win-sc:key_wow64_res" priority="1000" mode="M760">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the key_wow64_res entity of a regkeyeffectiverights_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M760"/></axsl:template><axsl:template match="text()" priority="-1" mode="M760"/><axsl:template match="@*|node()" priority="-2" mode="M760"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M760"/></axsl:template>

<!--PATTERN svceitemservice_name-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_name" priority="1000" mode="M761">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item  - datatype attribute for the service_name entity of a serviceeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M761"/></axsl:template><axsl:template match="text()" priority="-1" mode="M761"/><axsl:template match="@*|node()" priority="-2" mode="M761"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M761"/></axsl:template>

<!--PATTERN svceitemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:trustee_sid" priority="1000" mode="M762">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a serviceeffectiverights_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M762"/></axsl:template><axsl:template match="text()" priority="-1" mode="M762"/><axsl:template match="@*|node()" priority="-2" mode="M762"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M762"/></axsl:template>

<!--PATTERN svceitemstandard_delete-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:standard_delete" priority="1000" mode="M763">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_delete entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M763"/></axsl:template><axsl:template match="text()" priority="-1" mode="M763"/><axsl:template match="@*|node()" priority="-2" mode="M763"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M763"/></axsl:template>

<!--PATTERN svceitemstandard_read_control-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:standard_read_control" priority="1000" mode="M764">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_read_control entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M764"/></axsl:template><axsl:template match="text()" priority="-1" mode="M764"/><axsl:template match="@*|node()" priority="-2" mode="M764"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M764"/></axsl:template>

<!--PATTERN svceitemstandard_write_dac-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:standard_write_dac" priority="1000" mode="M765">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_dac entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M765"/></axsl:template><axsl:template match="text()" priority="-1" mode="M765"/><axsl:template match="@*|node()" priority="-2" mode="M765"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M765"/></axsl:template>

<!--PATTERN svceitemstandard_write_owner-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:standard_write_owner" priority="1000" mode="M766">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the standard_write_owner entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M766"/></axsl:template><axsl:template match="text()" priority="-1" mode="M766"/><axsl:template match="@*|node()" priority="-2" mode="M766"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M766"/></axsl:template>

<!--PATTERN svceitemgeneric_read-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:generic_read" priority="1000" mode="M767">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_read entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M767"/></axsl:template><axsl:template match="text()" priority="-1" mode="M767"/><axsl:template match="@*|node()" priority="-2" mode="M767"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M767"/></axsl:template>

<!--PATTERN svceitemgeneric_write-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:generic_write" priority="1000" mode="M768">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_write entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M768"/></axsl:template><axsl:template match="text()" priority="-1" mode="M768"/><axsl:template match="@*|node()" priority="-2" mode="M768"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M768"/></axsl:template>

<!--PATTERN svceitemgeneric_execute-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:generic_execute" priority="1000" mode="M769">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the generic_execute entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M769"/></axsl:template><axsl:template match="text()" priority="-1" mode="M769"/><axsl:template match="@*|node()" priority="-2" mode="M769"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M769"/></axsl:template>

<!--PATTERN svceitemservice_query_conf-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_query_conf" priority="1000" mode="M770">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_query_conf entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M770"/></axsl:template><axsl:template match="text()" priority="-1" mode="M770"/><axsl:template match="@*|node()" priority="-2" mode="M770"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M770"/></axsl:template>

<!--PATTERN svceitemservice_change_conf-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_change_conf" priority="1000" mode="M771">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_change_conf entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M771"/></axsl:template><axsl:template match="text()" priority="-1" mode="M771"/><axsl:template match="@*|node()" priority="-2" mode="M771"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M771"/></axsl:template>

<!--PATTERN svceitemservice_query_stat-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_query_stat" priority="1000" mode="M772">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_query_stat entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M772"/></axsl:template><axsl:template match="text()" priority="-1" mode="M772"/><axsl:template match="@*|node()" priority="-2" mode="M772"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M772"/></axsl:template>

<!--PATTERN svceitemservice_enum_dependents-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_enum_dependents" priority="1000" mode="M773">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_enum_dependents entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M773"/></axsl:template><axsl:template match="text()" priority="-1" mode="M773"/><axsl:template match="@*|node()" priority="-2" mode="M773"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M773"/></axsl:template>

<!--PATTERN svceitemservice_start-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_start" priority="1000" mode="M774">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_start entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M774"/></axsl:template><axsl:template match="text()" priority="-1" mode="M774"/><axsl:template match="@*|node()" priority="-2" mode="M774"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M774"/></axsl:template>

<!--PATTERN svceitemservice_stop-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_stop" priority="1000" mode="M775">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_stop entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M775"/></axsl:template><axsl:template match="text()" priority="-1" mode="M775"/><axsl:template match="@*|node()" priority="-2" mode="M775"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M775"/></axsl:template>

<!--PATTERN svceitemservice_pause-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_pause" priority="1000" mode="M776">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_pause entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M776"/></axsl:template><axsl:template match="text()" priority="-1" mode="M776"/><axsl:template match="@*|node()" priority="-2" mode="M776"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M776"/></axsl:template>

<!--PATTERN svceitemservice_interrogate-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_interrogate" priority="1000" mode="M777">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_interrogate entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M777"/></axsl:template><axsl:template match="text()" priority="-1" mode="M777"/><axsl:template match="@*|node()" priority="-2" mode="M777"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M777"/></axsl:template>

<!--PATTERN svceitemservice_user_defined-->


	<!--RULE -->
<axsl:template match="win-sc:serviceeffectiverights_item/win-sc:service_user_defined" priority="1000" mode="M778">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the service_user_defined entity of a serviceeffectiverights_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M778"/></axsl:template><axsl:template match="text()" priority="-1" mode="M778"/><axsl:template match="@*|node()" priority="-2" mode="M778"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M778"/></axsl:template>

<!--PATTERN sritemnetname-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:netname" priority="1000" mode="M779">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the netname entity of a sharedresource_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M779"/></axsl:template><axsl:template match="text()" priority="-1" mode="M779"/><axsl:template match="@*|node()" priority="-2" mode="M779"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M779"/></axsl:template>

<!--PATTERN sritemshared_type-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:shared_type" priority="1000" mode="M780">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the shared_type entity of a sharedresource_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M780"/></axsl:template><axsl:template match="text()" priority="-1" mode="M780"/><axsl:template match="@*|node()" priority="-2" mode="M780"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M780"/></axsl:template>

<!--PATTERN sritemmax_uses-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:max_uses" priority="1000" mode="M781">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the max_uses entity of a sharedresource_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M781"/></axsl:template><axsl:template match="text()" priority="-1" mode="M781"/><axsl:template match="@*|node()" priority="-2" mode="M781"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M781"/></axsl:template>

<!--PATTERN sritemcurrent_uses-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:current_uses" priority="1000" mode="M782">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the current_uses entity of a sharedresource_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M782"/></axsl:template><axsl:template match="text()" priority="-1" mode="M782"/><axsl:template match="@*|node()" priority="-2" mode="M782"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M782"/></axsl:template>

<!--PATTERN sritemlocal_path-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:local_path" priority="1000" mode="M783">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the local_path entity of a sharedresource_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M783"/></axsl:template><axsl:template match="text()" priority="-1" mode="M783"/><axsl:template match="@*|node()" priority="-2" mode="M783"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M783"/></axsl:template>

<!--PATTERN sritemaccess_read_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_read_permission" priority="1000" mode="M784">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_read_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M784"/></axsl:template><axsl:template match="text()" priority="-1" mode="M784"/><axsl:template match="@*|node()" priority="-2" mode="M784"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M784"/></axsl:template>

<!--PATTERN sritemaccess_write_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_write_permission" priority="1000" mode="M785">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_write_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M785"/></axsl:template><axsl:template match="text()" priority="-1" mode="M785"/><axsl:template match="@*|node()" priority="-2" mode="M785"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M785"/></axsl:template>

<!--PATTERN sritemaccess_create_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_create_permission" priority="1000" mode="M786">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_create_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M786"/></axsl:template><axsl:template match="text()" priority="-1" mode="M786"/><axsl:template match="@*|node()" priority="-2" mode="M786"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M786"/></axsl:template>

<!--PATTERN sritemaccess_exec_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_exec_permission" priority="1000" mode="M787">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_exec_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M787"/></axsl:template><axsl:template match="text()" priority="-1" mode="M787"/><axsl:template match="@*|node()" priority="-2" mode="M787"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M787"/></axsl:template>

<!--PATTERN sritemaccess_delete_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_delete_permission" priority="1000" mode="M788">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_delete_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M788"/></axsl:template><axsl:template match="text()" priority="-1" mode="M788"/><axsl:template match="@*|node()" priority="-2" mode="M788"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M788"/></axsl:template>

<!--PATTERN sritemaccess_atrib_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_atrib_permission" priority="1000" mode="M789">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_atrib_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M789"/></axsl:template><axsl:template match="text()" priority="-1" mode="M789"/><axsl:template match="@*|node()" priority="-2" mode="M789"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M789"/></axsl:template>

<!--PATTERN sritemaccess_perm_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_perm_permission" priority="1000" mode="M790">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_perm_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M790"/></axsl:template><axsl:template match="text()" priority="-1" mode="M790"/><axsl:template match="@*|node()" priority="-2" mode="M790"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M790"/></axsl:template>

<!--PATTERN sritemaccess_all_permission-->


	<!--RULE -->
<axsl:template match="win-sc:sharedresource_item/win-sc:access_all_permission" priority="1000" mode="M791">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_all_permission entity of a sharedresource_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M791"/></axsl:template><axsl:template match="text()" priority="-1" mode="M791"/><axsl:template match="@*|node()" priority="-2" mode="M791"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M791"/></axsl:template>

<!--PATTERN siditemtrustee_name-->


	<!--RULE -->
<axsl:template match="win-sc:sid_item/win-sc:trustee_name" priority="1000" mode="M792">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_name entity of a sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M792"/></axsl:template><axsl:template match="text()" priority="-1" mode="M792"/><axsl:template match="@*|node()" priority="-2" mode="M792"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M792"/></axsl:template>

<!--PATTERN siditemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:sid_item/win-sc:trustee_sid" priority="1000" mode="M793">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M793"/></axsl:template><axsl:template match="text()" priority="-1" mode="M793"/><axsl:template match="@*|node()" priority="-2" mode="M793"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M793"/></axsl:template>

<!--PATTERN siditemtrustee_domain-->


	<!--RULE -->
<axsl:template match="win-sc:sid_item/win-sc:trustee_domain" priority="1000" mode="M794">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_domain entity of a sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M794"/></axsl:template><axsl:template match="text()" priority="-1" mode="M794"/><axsl:template match="@*|node()" priority="-2" mode="M794"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M794"/></axsl:template>

<!--PATTERN sidsiditemtrustee_sid-->


	<!--RULE -->
<axsl:template match="win-sc:sid_sid_item/win-sc:trustee_sid" priority="1000" mode="M795">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_sid entity of a sid_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M795"/></axsl:template><axsl:template match="text()" priority="-1" mode="M795"/><axsl:template match="@*|node()" priority="-2" mode="M795"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M795"/></axsl:template>

<!--PATTERN sidsiditemtrustee_name-->


	<!--RULE -->
<axsl:template match="win-sc:sid_sid_item/win-sc:trustee_name" priority="1000" mode="M796">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_name entity of a sid_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M796"/></axsl:template><axsl:template match="text()" priority="-1" mode="M796"/><axsl:template match="@*|node()" priority="-2" mode="M796"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M796"/></axsl:template>

<!--PATTERN sidsiditemtrustee_domain-->


	<!--RULE -->
<axsl:template match="win-sc:sid_sid_item/win-sc:trustee_domain" priority="1000" mode="M797">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the trustee_domain entity of a sid_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M797"/></axsl:template><axsl:template match="text()" priority="-1" mode="M797"/><axsl:template match="@*|node()" priority="-2" mode="M797"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M797"/></axsl:template>

<!--PATTERN uacitemadminapprovalmode-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:admin_approval_mode" priority="1000" mode="M798">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the admin_approval_mode entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M798"/></axsl:template><axsl:template match="text()" priority="-1" mode="M798"/><axsl:template match="@*|node()" priority="-2" mode="M798"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M798"/></axsl:template>

<!--PATTERN uacitemelevationpromptadmin-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:elevation_prompt_admin" priority="1000" mode="M799">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the elevation_prompt_admin entity of a uac_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M799"/></axsl:template><axsl:template match="text()" priority="-1" mode="M799"/><axsl:template match="@*|node()" priority="-2" mode="M799"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M799"/></axsl:template>

<!--PATTERN uacitemelevationpromptstandard-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:elevation_prompt_standard" priority="1000" mode="M800">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the elevation_prompt_standard entity of a uac_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M800"/></axsl:template><axsl:template match="text()" priority="-1" mode="M800"/><axsl:template match="@*|node()" priority="-2" mode="M800"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M800"/></axsl:template>

<!--PATTERN uacitemdetectinstallations-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:detect_installations" priority="1000" mode="M801">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the detect_installations entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M801"/></axsl:template><axsl:template match="text()" priority="-1" mode="M801"/><axsl:template match="@*|node()" priority="-2" mode="M801"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M801"/></axsl:template>

<!--PATTERN uacitemelevatesignedexecutables-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:elevate_signed_executables" priority="1000" mode="M802">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the elevate_signed_executables entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M802"/></axsl:template><axsl:template match="text()" priority="-1" mode="M802"/><axsl:template match="@*|node()" priority="-2" mode="M802"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M802"/></axsl:template>

<!--PATTERN uacitemelevateuiaccess-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:elevate_uiaccess" priority="1000" mode="M803">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the elevate_uiaccess entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M803"/></axsl:template><axsl:template match="text()" priority="-1" mode="M803"/><axsl:template match="@*|node()" priority="-2" mode="M803"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M803"/></axsl:template>

<!--PATTERN uacitemrunadminsaam-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:run_admins_aam" priority="1000" mode="M804">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the run_admins_aam entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M804"/></axsl:template><axsl:template match="text()" priority="-1" mode="M804"/><axsl:template match="@*|node()" priority="-2" mode="M804"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M804"/></axsl:template>

<!--PATTERN uacitemsecuredesktop-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:secure_desktop" priority="1000" mode="M805">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the secure_desktop entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M805"/></axsl:template><axsl:template match="text()" priority="-1" mode="M805"/><axsl:template match="@*|node()" priority="-2" mode="M805"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M805"/></axsl:template>

<!--PATTERN uacitemvirtualizewritefailures-->


	<!--RULE -->
<axsl:template match="win-sc:uac_item/win-sc:virtualize_write_failures" priority="1000" mode="M806">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the virtualize_write_failures entity of a uac_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M806"/></axsl:template><axsl:template match="text()" priority="-1" mode="M806"/><axsl:template match="@*|node()" priority="-2" mode="M806"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M806"/></axsl:template>

<!--PATTERN useritemuser-->


	<!--RULE -->
<axsl:template match="win-sc:user_item/win-sc:user" priority="1000" mode="M807">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user entity of a user_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M807"/></axsl:template><axsl:template match="text()" priority="-1" mode="M807"/><axsl:template match="@*|node()" priority="-2" mode="M807"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M807"/></axsl:template>

<!--PATTERN useritemenabled-->


	<!--RULE -->
<axsl:template match="win-sc:user_item/win-sc:enabled" priority="1000" mode="M808">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the enabled entity of a user_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M808"/></axsl:template><axsl:template match="text()" priority="-1" mode="M808"/><axsl:template match="@*|node()" priority="-2" mode="M808"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M808"/></axsl:template>

<!--PATTERN useritemgroup-->


	<!--RULE -->
<axsl:template match="win-sc:user_item/win-sc:group" priority="1000" mode="M809">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for a group entity of a user_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M809"/></axsl:template><axsl:template match="text()" priority="-1" mode="M809"/><axsl:template match="@*|node()" priority="-2" mode="M809"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M809"/></axsl:template>

<!--PATTERN usersiditemuser-->


	<!--RULE -->
<axsl:template match="win-sc:user_sid_item/win-sc:user_sid" priority="1000" mode="M810">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a user_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M810"/></axsl:template><axsl:template match="text()" priority="-1" mode="M810"/><axsl:template match="@*|node()" priority="-2" mode="M810"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M810"/></axsl:template>

<!--PATTERN usersiditemenabled-->


	<!--RULE -->
<axsl:template match="win-sc:user_sid_item/win-sc:enabled" priority="1000" mode="M811">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the enabled entity of a user_sid_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M811"/></axsl:template><axsl:template match="text()" priority="-1" mode="M811"/><axsl:template match="@*|node()" priority="-2" mode="M811"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M811"/></axsl:template>

<!--PATTERN usersiditemgroup-->


	<!--RULE -->
<axsl:template match="win-sc:user_sid_item/win-sc:group_sid" priority="1000" mode="M812">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for a group_sid entity of a user_sid_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M812"/></axsl:template><axsl:template match="text()" priority="-1" mode="M812"/><axsl:template match="@*|node()" priority="-2" mode="M812"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M812"/></axsl:template>

<!--PATTERN volitemrootpath-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:rootpath" priority="1000" mode="M813">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the rootpath entity of a volume_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M813"/></axsl:template><axsl:template match="text()" priority="-1" mode="M813"/><axsl:template match="@*|node()" priority="-2" mode="M813"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M813"/></axsl:template>

<!--PATTERN volitemfile_system-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_system" priority="1000" mode="M814">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_system entity of a volume_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M814"/></axsl:template><axsl:template match="text()" priority="-1" mode="M814"/><axsl:template match="@*|node()" priority="-2" mode="M814"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M814"/></axsl:template>

<!--PATTERN volitemname-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:name" priority="1000" mode="M815">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the name entity of a volume_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M815"/></axsl:template><axsl:template match="text()" priority="-1" mode="M815"/><axsl:template match="@*|node()" priority="-2" mode="M815"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M815"/></axsl:template>

<!--PATTERN volitemvolume_max_component_length-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:volume_max_component_length" priority="1000" mode="M816">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the volume_max_component_length entity of a volume_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M816"/></axsl:template><axsl:template match="text()" priority="-1" mode="M816"/><axsl:template match="@*|node()" priority="-2" mode="M816"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M816"/></axsl:template>

<!--PATTERN volitemserial_number-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:serial_number" priority="1000" mode="M817">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the serial_number entity of a volume_item should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M817"/></axsl:template><axsl:template match="text()" priority="-1" mode="M817"/><axsl:template match="@*|node()" priority="-2" mode="M817"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M817"/></axsl:template>

<!--PATTERN volitemfile_case_sensitive_search-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_case_sensitive_search" priority="1000" mode="M818">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_case_sensitive_search entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M818"/></axsl:template><axsl:template match="text()" priority="-1" mode="M818"/><axsl:template match="@*|node()" priority="-2" mode="M818"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M818"/></axsl:template>

<!--PATTERN volitemfile_case_preserved_names-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_case_preserved_names" priority="1000" mode="M819">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_case_preserved_names entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M819"/></axsl:template><axsl:template match="text()" priority="-1" mode="M819"/><axsl:template match="@*|node()" priority="-2" mode="M819"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M819"/></axsl:template>

<!--PATTERN volitemfile_unicode_on_disk-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_unicode_on_disk" priority="1000" mode="M820">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_unicode_on_disk entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M820"/></axsl:template><axsl:template match="text()" priority="-1" mode="M820"/><axsl:template match="@*|node()" priority="-2" mode="M820"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M820"/></axsl:template>

<!--PATTERN volitemfile_persistent_acls-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_persistent_acls" priority="1000" mode="M821">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_persistent_acls entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M821"/></axsl:template><axsl:template match="text()" priority="-1" mode="M821"/><axsl:template match="@*|node()" priority="-2" mode="M821"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M821"/></axsl:template>

<!--PATTERN volitemfile_file_compression-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_file_compression" priority="1000" mode="M822">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_file_compression entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M822"/></axsl:template><axsl:template match="text()" priority="-1" mode="M822"/><axsl:template match="@*|node()" priority="-2" mode="M822"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M822"/></axsl:template>

<!--PATTERN volitemfile_volume_quotas-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_volume_quotas" priority="1000" mode="M823">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_volume_quotas entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M823"/></axsl:template><axsl:template match="text()" priority="-1" mode="M823"/><axsl:template match="@*|node()" priority="-2" mode="M823"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M823"/></axsl:template>

<!--PATTERN volitemfile_supports_sparse_files-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_supports_sparse_files" priority="1000" mode="M824">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_sparse_files entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M824"/></axsl:template><axsl:template match="text()" priority="-1" mode="M824"/><axsl:template match="@*|node()" priority="-2" mode="M824"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M824"/></axsl:template>

<!--PATTERN volitemfile_supports_reparse_points-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_supports_reparse_points" priority="1000" mode="M825">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_reparse_points entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M825"/></axsl:template><axsl:template match="text()" priority="-1" mode="M825"/><axsl:template match="@*|node()" priority="-2" mode="M825"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M825"/></axsl:template>

<!--PATTERN volitemfile_supports_remote_storage-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_supports_remote_storage" priority="1000" mode="M826">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_remote_storage entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M826"/></axsl:template><axsl:template match="text()" priority="-1" mode="M826"/><axsl:template match="@*|node()" priority="-2" mode="M826"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M826"/></axsl:template>

<!--PATTERN volitemfile_volume_is_compressed-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_volume_is_compressed" priority="1000" mode="M827">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_volume_is_compressed entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M827"/></axsl:template><axsl:template match="text()" priority="-1" mode="M827"/><axsl:template match="@*|node()" priority="-2" mode="M827"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M827"/></axsl:template>

<!--PATTERN volitemfile_supports_object_ids-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_supports_object_ids" priority="1000" mode="M828">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_object_ids entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M828"/></axsl:template><axsl:template match="text()" priority="-1" mode="M828"/><axsl:template match="@*|node()" priority="-2" mode="M828"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M828"/></axsl:template>

<!--PATTERN volitemfile_supports_encryption-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_supports_encryption" priority="1000" mode="M829">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_encryption entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M829"/></axsl:template><axsl:template match="text()" priority="-1" mode="M829"/><axsl:template match="@*|node()" priority="-2" mode="M829"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M829"/></axsl:template>

<!--PATTERN volitemfile_named_streams-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_named_streams" priority="1000" mode="M830">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_named_streams entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M830"/></axsl:template><axsl:template match="text()" priority="-1" mode="M830"/><axsl:template match="@*|node()" priority="-2" mode="M830"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M830"/></axsl:template>

<!--PATTERN volitemfile_read_only_volume-->


	<!--RULE -->
<axsl:template match="win-sc:volume_item/win-sc:file_read_only_volume" priority="1000" mode="M831">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_read_only_volume entity of a volume_item should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M831"/></axsl:template><axsl:template match="text()" priority="-1" mode="M831"/><axsl:template match="@*|node()" priority="-2" mode="M831"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M831"/></axsl:template>

<!--PATTERN wmiitemnamespace-->


	<!--RULE -->
<axsl:template match="win-sc:wmi_item/win-sc:namespace" priority="1000" mode="M832">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the namespace entity of a wmi_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M832"/></axsl:template><axsl:template match="text()" priority="-1" mode="M832"/><axsl:template match="@*|node()" priority="-2" mode="M832"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M832"/></axsl:template>

<!--PATTERN wmiitemwql-->


	<!--RULE -->
<axsl:template match="win-sc:wmi_item/win-sc:wql" priority="1000" mode="M833">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the wql entity of a wmi_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M833"/></axsl:template><axsl:template match="text()" priority="-1" mode="M833"/><axsl:template match="@*|node()" priority="-2" mode="M833"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M833"/></axsl:template>

<!--PATTERN wmiitemresult-->


	<!--RULE -->
<axsl:template match="win-sc:wmi_item/win-sc:result" priority="1000" mode="M834">

		<!--ASSERT -->
<axsl:choose><axsl:when test="(@datatype='int' and (floor(.) = number(.))) or not(@datatype='int') or not(node())"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The datatype has been set to 'int' but the value is not an integer.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M834"/></axsl:template><axsl:template match="text()" priority="-1" mode="M834"/><axsl:template match="@*|node()" priority="-2" mode="M834"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M834"/></axsl:template>

<!--PATTERN wuaupdatesearcheritemsearchcriteria-->


	<!--RULE -->
<axsl:template match="win-sc:wuaupdatesearcher_item/win-sc:search_criteria" priority="1000" mode="M835">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the search_criteria entity of a wuaupdatesearcher_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M835"/></axsl:template><axsl:template match="text()" priority="-1" mode="M835"/><axsl:template match="@*|node()" priority="-2" mode="M835"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M835"/></axsl:template>

<!--PATTERN wuaupdatesearcheritemresult-->


	<!--RULE -->
<axsl:template match="win-sc:wuaupdatesearcher_item/win-sc:update_id" priority="1000" mode="M836">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>item <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the update_id entity of a wuaupdatesearcher_item should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M836"/></axsl:template><axsl:template match="text()" priority="-1" mode="M836"/><axsl:template match="@*|node()" priority="-2" mode="M836"><axsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M836"/></axsl:template></axsl:stylesheet>
