...
<!--PATTERN empty_def_doc-->
	...
	<!--RULE -->
<axsl:template match="oval-def:oval_definitions" priority="1000" mode="M18">
...
<!--PATTERN required_criteria-->
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:definitions/oval-def:definition[@deprecated='false' or not(@deprecated)]" priority="1000" mode="M19">
...
<!--PATTERN test_type-->
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:tests/*[@check_existence='none_exist']" priority="1000" mode="M20">
...
<!--PATTERN setobjref-->
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:object_reference" priority="1002" mode="M21">
...
<axsl:choose><axsl:when test="name(./../..) = name(/oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:object_reference" priority="1001" mode="M21">
...
<axsl:choose><axsl:when test="name(./../../..) = name(/oval-def:oval_definitions/oval-def:objects/*[@id=current()])"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="/oval-def:oval_definitions/oval-def:objects/*/oval-def:set/oval-def:set/oval-def:set/oval-def:object_reference" priority="1000" mode="M21">
...
<!--PATTERN value-->
	...
	<!--RULE -->
<axsl:template match="oval-def:constant_variable/oval-def:value" priority="1000" mode="M22">
...
<!--PATTERN literal_component-->
	...
	<!--RULE -->
<axsl:template match="oval-def:literal_component" priority="1000" mode="M23">
...
<!--PATTERN item_field-->
	...
	<!--RULE -->
<axsl:template match="oval-def:object_component" priority="1000" mode="M24">
...
<!--PATTERN arithmeticfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:literal_component" priority="1001" mode="M25">
...
<axsl:choose><axsl:when test="@datatype='float' or @datatype='int'"/><axsl:otherwise>A literal_component used by an arithmetic function must have a datatype of float or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M25"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:arithmetic/oval-def:variable_component" priority="1000" mode="M25"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN beginfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:literal_component" priority="1001" mode="M26">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the begin function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M26"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:begin/oval-def:variable_component" priority="1000" mode="M26"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN concatfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:literal_component" priority="1001" mode="M27">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the concat function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M27"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:concat/oval-def:variable_component" priority="1000" mode="M27"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN endfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:literal_component" priority="1001" mode="M28">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the end function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M28"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:end/oval-def:variable_component" priority="1000" mode="M28"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN escaperegexfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:literal_component" priority="1001" mode="M29">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the escape_regex function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M29"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:escape_regex/oval-def:variable_component" priority="1000" mode="M29"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN splitfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:literal_component" priority="1001" mode="M30">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the split function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M30"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:split/oval-def:variable_component" priority="1000" mode="M30"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN substringfunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:literal_component" priority="1001" mode="M31">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the substring function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M31"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:substring/oval-def:variable_component" priority="1000" mode="M31"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN timedifferencefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:literal_component" priority="1001" mode="M32">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string' or @datatype='int'"/><axsl:otherwise>A literal_component used by the time_difference function must have a datatype of string or int.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M32"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:time_difference/oval-def:variable_component" priority="1000" mode="M32"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN regexcapturefunctionrules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:literal_component" priority="1001" mode="M33">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>A literal_component used by the regex_capture function must have a datatype of string.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M33"/></axsl:template>
	...
	<!--RULE -->
<axsl:template match="oval-def:regex_capture/oval-def:variable_component" priority="1000" mode="M33"><axsl:variable name="var_ref" select="@var_ref"/>
...
<!--PATTERN definition_entity_rules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]|oval-def:states/*/*[@var_ref]" priority="1010" mode="M34"><axsl:variable name="var_ref" select="@var_ref"/>
...
<axsl:choose><axsl:when test="( (not(@datatype)) and ('string' = //oval-def:variables/*[@id=$var_ref]/@datatype) ) or (@datatype = //oval-def:variables/*[@id=$var_ref]/@datatype)"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[not(@datatype)]|oval-def:states/*/*[not(@datatype)]" priority="1009" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='binary']|oval-def:states/*/*[@datatype='binary']" priority="1008" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='boolean']|oval-def:states/*/*[@datatype='boolean']" priority="1007" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='evr_string']|oval-def:states/*/*[@datatype='evr_string']" priority="1006" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='fileset_revision']|oval-def:states/*/*[@datatype='fileset_revision']" priority="1005" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or  @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='float']|oval-def:states/*/*[@datatype='float']" priority="1004" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='ios_version']|oval-def:states/*/*[@datatype='ios_version']" priority="1003" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='int']|oval-def:states/*/*[@datatype='int']" priority="1002" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='greater than' or @operation='greater than or equal' or @operation='less than' or @operation='less than or equal' or @operation='bitwise and' or @operation='bitwise or'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='string']|oval-def:states/*/*[@datatype='string']" priority="1001" mode="M34">
...
<axsl:choose><axsl:when test="not(@operation) or @operation='equals' or @operation='not equal' or @operation='case insensitive equals' or @operation='case insensitive not equal' or @operation='pattern match'"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@datatype='version']|oval-def:states/*/*[@datatype='version']" priority="1000" mode="M34">
...
<!--PATTERN entityobjectbaserules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:objects/*/*[@var_ref]" priority="1000" mode="M35">
...
<!--PATTERN entitystatebaserules-->
	...
	<!--RULE -->
<axsl:template match="oval-def:states/*/*[@var_ref]" priority="1000" mode="M36">
...
<!--PATTERN famtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:object" priority="1001" mode="M37">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:family_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:family_test/ind-def:state" priority="1000" mode="M37">
...
<!--PATTERN famstefamily-->
	...
	<!--RULE -->
<axsl:template match="ind-def:family_state/ind-def:family" priority="1000" mode="M38">
...
<!--PATTERN md5tst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_test/ind-def:object" priority="1001" mode="M39">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:filemd5_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_test/ind-def:state" priority="1000" mode="M39">
...
<!--PATTERN md5objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_object/ind-def:path" priority="1000" mode="M40">
...
<!--PATTERN md5objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_object/ind-def:filename" priority="1000" mode="M41">
...
<!--PATTERN md5stepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_state/ind-def:path" priority="1000" mode="M42">
...
<!--PATTERN md5stefilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_state/ind-def:filename" priority="1000" mode="M43">
...
<!--PATTERN md5stemd5-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filemd5_state/ind-def:md5" priority="1000" mode="M44">
...
<!--PATTERN hashtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:object" priority="1001" mode="M45">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:filehash_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_test/ind-def:state" priority="1000" mode="M45">
...
<!--PATTERN hashobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:path" priority="1000" mode="M46">
...
<!--PATTERN hashobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_object/ind-def:filename" priority="1000" mode="M47">
...
<!--PATTERN hashstepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state/ind-def:path" priority="1000" mode="M48">
...
<!--PATTERN hashstefilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state/ind-def:filename" priority="1000" mode="M49">
...
<!--PATTERN hashstemd5-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state/ind-def:md5" priority="1000" mode="M50">
...
<!--PATTERN hashstesha1-->
	...
	<!--RULE -->
<axsl:template match="ind-def:filehash_state/ind-def:sha1" priority="1000" mode="M51">
...
<!--PATTERN envtst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:object" priority="1001" mode="M52">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:environmentvariable_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_test/ind-def:state" priority="1000" mode="M52">
...
<!--PATTERN envobjname-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_object/ind-def:name" priority="1000" mode="M53">
...
<!--PATTERN envstename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_state/ind-def:name" priority="1000" mode="M54">
...
<!--PATTERN envstevalue-->
	...
	<!--RULE -->
<axsl:template match="ind-def:environmentvariable_state/ind-def:value" priority="1000" mode="M55">
...
<!--PATTERN sqltst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:object" priority="1001" mode="M56">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:sql_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_test/ind-def:state" priority="1000" mode="M56">
...
<!--PATTERN sqlobjdengine-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:engine" priority="1000" mode="M57">
...
<!--PATTERN sqlobjversion-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:version" priority="1000" mode="M58">
...
<!--PATTERN sqlobjconnection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:connection_string" priority="1000" mode="M59">
...
<!--PATTERN sqlobjsql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_object/ind-def:sql" priority="1000" mode="M60">
...
<!--PATTERN sqlsteengine-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state/ind-def:engine" priority="1000" mode="M61">
...
<!--PATTERN sqlsteversion-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state/ind-def:version" priority="1000" mode="M62">
...
<!--PATTERN sqlsteconnection_string-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state/ind-def:connection_string" priority="1000" mode="M63">
...
<!--PATTERN sqlstesql-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state/ind-def:sql" priority="1000" mode="M64">
...
<!--PATTERN sqlsteresult-->
	...
	<!--RULE -->
<axsl:template match="ind-def:sql_state/ind-def:result" priority="1000" mode="M65">
...
<!--PATTERN txt54tst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_test/ind-def:object" priority="1001" mode="M66">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:textfilecontent54_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_test/ind-def:state" priority="1000" mode="M66">
...
<!--PATTERN txt54objpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:path" priority="1000" mode="M67">
...
<!--PATTERN txt54objfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:filename" priority="1000" mode="M68">
...
<!--PATTERN txt54objpattern-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:pattern" priority="1000" mode="M69">
...
<!--PATTERN txt54objinstance-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_object/ind-def:instance" priority="1000" mode="M70">
...
<!--PATTERN txt54stepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_state/ind-def:path" priority="1000" mode="M71">
...
<!--PATTERN txt54stefilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_state/ind-def:filename" priority="1000" mode="M72">
...
<!--PATTERN txt54stepattern-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_state/ind-def:pattern" priority="1000" mode="M73">
...
<!--PATTERN txt54steinstance-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_state/ind-def:instance" priority="1000" mode="M74">
...
<!--PATTERN txt54stesubexpression-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent54_state/ind-def:subexpression" priority="1000" mode="M75">
...
<!--PATTERN txttst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:object" priority="1001" mode="M76">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:textfilecontent_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_test/ind-def:state" priority="1000" mode="M76">
...
<!--PATTERN txtobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:path" priority="1000" mode="M77">
...
<!--PATTERN txtobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:filename" priority="1000" mode="M78">
...
<!--PATTERN txtobjline-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_object/ind-def:line" priority="1000" mode="M79">
...
<!--PATTERN txtstepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state/ind-def:path" priority="1000" mode="M80">
...
<!--PATTERN txtstefilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state/ind-def:filename" priority="1000" mode="M81">
...
<!--PATTERN txtsteline-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state/ind-def:line" priority="1000" mode="M82">
...
<!--PATTERN txtstesubexpression-->
	...
	<!--RULE -->
<axsl:template match="ind-def:textfilecontent_state/ind-def:subexpression" priority="1000" mode="M83">
...
<!--PATTERN vattst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:object" priority="1001" mode="M84">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:variable_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_test/ind-def:state" priority="1000" mode="M84">
...
<!--PATTERN varobjvar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_object/ind-def:var_ref" priority="1000" mode="M85">
...
<!--PATTERN varstevar_ref-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:var_ref" priority="1000" mode="M86">
...
<!--PATTERN varstevalue-->
	...
	<!--RULE -->
<axsl:template match="ind-def:variable_state/ind-def:value" priority="1000" mode="M87">
...
<!--PATTERN xmltst-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:object" priority="1001" mode="M88">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ind-def:xmlfilecontent_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_test/ind-def:state" priority="1000" mode="M88">
...
<!--PATTERN xmlobjpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:path" priority="1000" mode="M89">
...
<!--PATTERN xmlobjfilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:filename" priority="1000" mode="M90">
...
<!--PATTERN xmlobjxpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_object/ind-def:xpath" priority="1000" mode="M91">
...
<!--PATTERN xmlstepath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_state/ind-def:path" priority="1000" mode="M92">
...
<!--PATTERN xmlstefilename-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_state/ind-def:filename" priority="1000" mode="M93">
...
<!--PATTERN xmlstexpath-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_state/ind-def:xpath" priority="1000" mode="M94">
...
<!--PATTERN xmlstevalue_of-->
	...
	<!--RULE -->
<axsl:template match="ind-def:xmlfilecontent_state/ind-def:value_of" priority="1000" mode="M95">
...
<!--PATTERN filesettst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:object" priority="1001" mode="M96">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/aix-def:fileset_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a fileset_test must reference a fileset_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M96"/></axsl:template>

	<!--RULE -->
<axsl:template match="aix-def:fileset_test/aix-def:state" priority="1000" mode="M96">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/aix-def:fileset_state/@id"/><axsl:otherwise>
...
<!--PATTERN filesetobjflstinst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_object/aix-def:flstinst" priority="1000" mode="M97">
...
<!--PATTERN filesetsteflstinst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_state/aix-def:flstinst" priority="1000" mode="M98">
...
<!--PATTERN filesetstelevel-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_state/aix-def:level" priority="1000" mode="M99">
...
<!--PATTERN filesetstestate-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_state/aix-def:state" priority="1000" mode="M100">
...
<!--PATTERN filesetstedescription-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fileset_state/aix-def:description" priority="1000" mode="M101">
...
<!--PATTERN fixtst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_test/aix-def:object" priority="1001" mode="M102">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/aix-def:fix_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_test/aix-def:state" priority="1000" mode="M102">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/aix-def:fix_state/@id"/><axsl:otherwise>
...
<!--PATTERN fixobjapar_number-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_object/aix-def:apar_number" priority="1000" mode="M103">
...
<!--PATTERN fixsteapar_number-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_state/aix-def:apar_number" priority="1000" mode="M104">
...
<!--PATTERN fixsteabstract-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_state/aix-def:abstract" priority="1000" mode="M105">
...
<!--PATTERN fixstesymptom-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_state/aix-def:symptom" priority="1000" mode="M106">
...
<!--PATTERN fixsteinstallation_status-->
	...
	<!--RULE -->
<axsl:template match="aix-def:fix_state/aix-def:installation_status" priority="1000" mode="M107">
...
<!--PATTERN osleveltst-->
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:object" priority="1001" mode="M108">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/aix-def:oslevel_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_test/aix-def:state" priority="1000" mode="M108">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/aix-def:oslevel_state/@id"/><axsl:otherwise>
...
<!--PATTERN oslevelstemaintenance_level-->
	...
	<!--RULE -->
<axsl:template match="aix-def:oslevel_state/aix-def:maintenance_level" priority="1000" mode="M109">
...
<!--PATTERN httpdtst-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test/apache-def:object" priority="1001" mode="M110">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/apache-def:httpd_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_test/apache-def:state" priority="1000" mode="M110">
...
<!--PATTERN httpdstepath-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_state/apache-def:path" priority="1000" mode="M111">
...
<!--PATTERN httpdstebinaryname-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_state/apache-def:binary_name" priority="1000" mode="M112">
...
<!--PATTERN httpdsteversion-->
	...
	<!--RULE -->
<axsl:template match="apache-def:httpd_state/apache-def:version" priority="1000" mode="M113">
...
<!--PATTERN apachevertst-->
	...
	<!--RULE -->
<axsl:template match="apache-def:version_test/apache-def:object" priority="1001" mode="M114">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/apache-def:version_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="apache-def:version_test/apache-def:state" priority="1000" mode="M114">
...
<!--PATTERN apcheversteversion-->
	...
	<!--RULE -->
<axsl:template match="apache-def:version_state/apache-def:version" priority="1000" mode="M115">
...
<!--PATTERN catoslinetst-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:object" priority="1001" mode="M116">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/catos-def:line_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="catos-def:line_test/catos-def:state" priority="1000" mode="M116">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/catos-def:line_state/@id"/><axsl:otherwise>
...
<!--PATTERN catoslineobjshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_object/catos-def:show_subcommand" priority="1000" mode="M117">
...
<!--PATTERN catoslinesteshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_state/catos-def:show_subcommand" priority="1000" mode="M118">
...
<!--PATTERN catoslinesteconfig_line-->
	...
	<!--RULE -->
<axsl:template match="catos-def:line_state/catos-def:config_line" priority="1000" mode="M119">
...
<axsl:template match="catos-def:module_test/catos-def:state" priority="1000" mode="M120">
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/catos-def:module_state/@id"/><axsl:otherwise>
...
<!--PATTERN moduleobjmodule_number-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_object/catos-def:module_number" priority="1000" mode="M121">
...
<!--PATTERN catosmodulestemodule_number-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:module_number" priority="1000" mode="M122">
...
<!--PATTERN catosmodulestetype-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:type" priority="1000" mode="M123">
...
<!--PATTERN catosmodulestemodel-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:model" priority="1000" mode="M124">
...
<!--PATTERN catosmodulestesoftware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:software_major_release" priority="1000" mode="M125">
...
<!--PATTERN catosmodulestesoftware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:software_individual_release" priority="1000" mode="M126">
...
<!--PATTERN catosmodulestesoftware_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:software_version_id" priority="1000" mode="M127">
...
<!--PATTERN catosmodulestehardware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:hardware_major_release" priority="1000" mode="M128">
...
<!--PATTERN catosmodulestehardware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:hardware_individual_release" priority="1000" mode="M129">
...
<!--PATTERN catosmodulestefirmware_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:firmware_major_release" priority="1000" mode="M130">
...
<!--PATTERN catosmodulestefirmware_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:module_state/catos-def:firmware_individual_release" priority="1000" mode="M131">
...
<!--PATTERN catosver55stedevice_series-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version55_state/catos-def:swtich_series" priority="1000" mode="M132">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the swtich_series entity of a version55_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M132"/></axsl:template><axsl:template match="text()" priority="-1" mode="M132"/><axsl:template match="@*|node()" priority="-2" mode="M132"><axsl:apply-templates select="@*|*" mode="M132"/></axsl:template>

<!--PATTERN catosver55steimage_name-->


	<!--RULE -->
<axsl:template match="catos-def:version55_state/catos-def:image_name" priority="1000" mode="M133">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the image_name entity of a version55_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M133"/></axsl:template><axsl:template match="text()" priority="-1" mode="M133"/><axsl:template match="@*|node()" priority="-2" mode="M133"><axsl:apply-templates select="@*|*" mode="M133"/></axsl:template>

<!--PATTERN catosver55stecatos_release-->


	<!--RULE -->
<axsl:template match="catos-def:version55_state/catos-def:catos_release" priority="1000" mode="M134">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='version'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the catos_release entity of a version55_state should be 'version'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M134"/></axsl:template><axsl:template match="text()" priority="-1" mode="M134"/><axsl:template match="@*|node()" priority="-2" mode="M134"><axsl:apply-templates select="@*|*" mode="M134"/></axsl:template>

<!--PATTERN catosverstedevice_series-->


	<!--RULE -->
<axsl:template match="catos-def:version_state/catos-def:swtich_series" priority="1000" mode="M135">
...
<!--PATTERN catosversteimage_name-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state/catos-def:image_name" priority="1000" mode="M136">
...
<!--PATTERN catosverstecatos_major_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state/catos-def:catos_major_release" priority="1000" mode="M137">
...
<!--PATTERN catosverstecatos_individual_release-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state/catos-def:catos_individual_release" priority="1000" mode="M138">
...
<!--PATTERN catosverstecatos_version_id-->
	...
	<!--RULE -->
<axsl:template match="catos-def:version_state/catos-def:catos_version_id" priority="1000" mode="M139">
...
<!--PATTERN esxpatchobjpatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_object/esx-def:patch_number" priority="1000" mode="M140">
...
<!--PATTERN esxpatchstepatch_number-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_state/esx-def:patch_number" priority="1000" mode="M141">
...
<!--PATTERN esxpatchstestatus-->
	...
	<!--RULE -->
<axsl:template match="esx-def:patch_state/esx-def:status" priority="1000" mode="M142">
...
<!--PATTERN versionsterelease-->
	...
	<!--RULE -->
<axsl:template match="esx-def:version_state/esx-def:release" priority="1000" mode="M143">
...
<!--PATTERN versionstebuild-->
	...
	<!--RULE -->
<axsl:template match="esx-def:version_state/esx-def:build" priority="1000" mode="M144">
...
<!--PATTERN portinfotst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:object" priority="1001" mode="M145">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/freebsd-def:portinfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_test/freebsd-def:state" priority="1000" mode="M145">
...
<!--PATTERN portinfoobjpkginst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_object/freebsd-def:pkginst" priority="1000" mode="M146">
...
<!--PATTERN portinfostepkginst-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:pkginst" priority="1000" mode="M147">
...
<!--PATTERN portinfostename-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:name" priority="1000" mode="M148">
...
<!--PATTERN portinfostecategory-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:category" priority="1000" mode="M149">
...
<!--PATTERN portinfosteversion-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:version" priority="1000" mode="M150">
...
<!--PATTERN portinfostevendor-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:vendor" priority="1000" mode="M151">
...
<!--PATTERN portinfostedescription-->
	...
	<!--RULE -->
<axsl:template match="freebsd-def:portinfo_state/freebsd-def:description" priority="1000" mode="M152">
...
<!--PATTERN gcobjparameter_name-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_object/hpux-def:parameter_name" priority="1000" mode="M153">
...
<!--PATTERN gcobjpathname-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_object/hpux-def:pathname" priority="1000" mode="M154">
...
<!--PATTERN gcsteparameter_name-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_state/hpux-def:parameter_name" priority="1000" mode="M155">
...
<!--PATTERN gcstepathname-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_state/hpux-def:pathname" priority="1000" mode="M156">
...
<!--PATTERN gcsteoutput-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:getconf_state/hpux-def:output" priority="1000" mode="M157">
...
<!--PATTERN patch53objswtype-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_object/hpux-def:swtype" priority="1000" mode="M158">
...
<!--PATTERN patch53objarea_patched-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_object/hpux-def:area_patched" priority="1000" mode="M159">
...
<!--PATTERN patch53objpatch_base-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_object/hpux-def:patch_base" priority="1000" mode="M160">
...
<!--PATTERN patch53steswtype-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_state/hpux-def:swtype" priority="1000" mode="M161">
...
<!--PATTERN patch53stearea_patched-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_state/hpux-def:area_patched" priority="1000" mode="M162">
...
<!--PATTERN patch53stepatch_base-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch53_state/hpux-def:patch_base" priority="1000" mode="M163">
...
<!--PATTERN patchobjpatch_name-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_object/hpux-def:patch_name" priority="1000" mode="M164">
...
<!--PATTERN patchstepatch_name-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_state/hpux-def:patch_name" priority="1000" mode="M165">
...
<!--PATTERN patchsteswtype-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_state/hpux-def:swtype" priority="1000" mode="M166">
...
<!--PATTERN patchstearea_patched-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_state/hpux-def:area_patched" priority="1000" mode="M167">
...
<!--PATTERN patchstepatch_base-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:patch_state/hpux-def:patch_base" priority="1000" mode="M168">
...
<!--PATTERN swlistobjswlist-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_object/hpux-def:swlist" priority="1000" mode="M169">
...
<!--PATTERN swliststeswlist-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:swlist" priority="1000" mode="M170">
...
<!--PATTERN swliststebundle-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:bundle" priority="1000" mode="M171">
...
<!--PATTERN swliststefileset-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:fileset" priority="1000" mode="M172">
...
<!--PATTERN swliststeversion-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:version" priority="1000" mode="M173">
...
<!--PATTERN swliststetitle-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:title" priority="1000" mode="M174">
...
<!--PATTERN swliststevendor-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:swlist_state/hpux-def:vendor" priority="1000" mode="M175">
...
<!--PATTERN trustobjusername-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_object/hpux-def:username" priority="1000" mode="M176">
...
<!--PATTERN truststeusername-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:username" priority="1000" mode="M177">
...
<!--PATTERN truststeuid-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:uid" priority="1000" mode="M178">
...
<!--PATTERN truststepassword-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:password" priority="1000" mode="M179">
...
<!--PATTERN truststeaccount_owner-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:account_owner" priority="1000" mode="M180">
...
<!--PATTERN truststeboot_auth-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:boot_auth" priority="1000" mode="M181">
...
<!--PATTERN truststeaudit_id-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:audit_id" priority="1000" mode="M182">
...
<!--PATTERN truststeaudit_flag-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:audit_flag" priority="1000" mode="M183">
...
<!--PATTERN truststepw_change_min-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_change_min" priority="1000" mode="M184">
...
<!--PATTERN truststepw_max_size-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_max_size" priority="1000" mode="M185">
...
<!--PATTERN truststepw_expiration-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_expiration" priority="1000" mode="M186">
...
<!--PATTERN truststepw_life-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_life" priority="1000" mode="M187">
...
<!--PATTERN truststepw_change_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_change_s" priority="1000" mode="M188">
...
<!--PATTERN truststepw_change_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_change_u" priority="1000" mode="M189">
...
<!--PATTERN truststeacct_expire-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:acct_expire" priority="1000" mode="M190">
...
<!--PATTERN truststemax_llogin-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:max_llogin" priority="1000" mode="M191">
...
<!--PATTERN truststeexp_warning-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:exp_warning" priority="1000" mode="M192">
...
<!--PATTERN truststeusr_chg_pw-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:usr_chg_pw" priority="1000" mode="M193">
...
<!--PATTERN truststegen_pw-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:gen_pw" priority="1000" mode="M194">
...
<!--PATTERN truststepw_restrict-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_restrict" priority="1000" mode="M195">
...
<!--PATTERN truststepw_null-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_null" priority="1000" mode="M196">
...
<!--PATTERN truststepw_gen_char-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_gen_char" priority="1000" mode="M197">
...
<!--PATTERN truststepw_gen_let-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_gen_let" priority="1000" mode="M198">
...
<!--PATTERN truststelogin_time-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:login_time" priority="1000" mode="M199">
...
<!--PATTERN truststepw_changer-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:pw_changer" priority="1000" mode="M200">
...
<!--PATTERN truststelogin_time_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:login_time_s" priority="1000" mode="M201">
...
<!--PATTERN truststelogin_time_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:login_time_u" priority="1000" mode="M202">
...
<!--PATTERN truststelogin_tty_s-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:login_tty_s" priority="1000" mode="M203">
...
<!--PATTERN truststelogin_tty_u-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:login_tty_u" priority="1000" mode="M204">
...
<!--PATTERN truststenum_u_logins-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:num_u_logins" priority="1000" mode="M205">
...
<!--PATTERN truststemax_u_logins-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:max_u_logins" priority="1000" mode="M206">
...
<!--PATTERN truststelock_flag-->
	...
	<!--RULE -->
<axsl:template match="hpux-def:trusted_state/hpux-def:lock_flag" priority="1000" mode="M207">
...
<!--PATTERN globaltst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:object" priority="1001" mode="M208">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:global_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:global_test/ios-def:state" priority="1000" mode="M208">
...
<!--PATTERN globalobjglobal_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_object/ios-def:global_command" priority="1000" mode="M209">
...
<!--PATTERN globalsteglobal_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:global_state/ios-def:global_command" priority="1000" mode="M210">
...
<!--PATTERN iosinterfacetst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:object" priority="1001" mode="M211">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:interface_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_test/ios-def:state" priority="1000" mode="M211">
...
<!--PATTERN iosinterfaceobjname-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_object/ios-def:name" priority="1000" mode="M212">
...
<!--PATTERN iosinterfacestename-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:name" priority="1000" mode="M213">
...
<!--PATTERN iosinterfacesteip_directed_broadcast_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:ip_directed_broadcast_command" priority="1000" mode="M214">
...
<!--PATTERN iosinterfacesteno_ip_directed_broadcast_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:no_ip_directed_broadcast_command" priority="1000" mode="M215">
...
<!--PATTERN iosinterfacesteproxy_arp_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:proxy_arp_command" priority="1000" mode="M216">
...
<!--PATTERN iosinterfacesteshutdown_command-->
	...
	<!--RULE -->
<axsl:template match="ios-def:interface_state/ios-def:shutdown_command" priority="1000" mode="M217">
...
<!--PATTERN ioslinetst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:object" priority="1001" mode="M218">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:line_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:line_test/ios-def:state" priority="1000" mode="M218">
...
<!--PATTERN ioslineobjshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_object/ios-def:show_subcommand" priority="1000" mode="M219">
...
<!--PATTERN ioslinesteshow_subcommand-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_state/ios-def:show_subcommand" priority="1000" mode="M220">
...
<!--PATTERN ioslinesteconfig_line-->
	...
	<!--RULE -->
<axsl:template match="ios-def:line_state/ios-def:config_line" priority="1000" mode="M221">
...
<!--PATTERN snmptst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:object" priority="1001" mode="M222">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:snmp_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_test/ios-def:state" priority="1000" mode="M222">
...
<!--PATTERN snmpsteaccess_list-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_state/ios-def:access_list" priority="1000" mode="M223">
...
<!--PATTERN snmpstecommunity_name-->
	...
	<!--RULE -->
<axsl:template match="ios-def:snmp_state/ios-def:community_name" priority="1000" mode="M224">
...
<!--PATTERN tclshtst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:object" priority="1001" mode="M225">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:tclsh_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_test/ios-def:state" priority="1000" mode="M225">
...
<!--PATTERN tclshsteavailable-->
	...
	<!--RULE -->
<axsl:template match="ios-def:tclsh_state/ios-def:available" priority="1000" mode="M226">
...
<!--PATTERN iosver55tst-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:object" priority="1001" mode="M227">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:version55_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_test/ios-def:state" priority="1000" mode="M227">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/ios-def:version55_state/@id"/><axsl:otherwise>
...
<!--PATTERN iosver55stemajorversion-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version55_state/ios-def:major_version" priority="1000" mode="M228">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the major_version entity of a version55_state should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M228"/></axsl:template><axsl:template match="text()" priority="-1" mode="M228"/><axsl:template match="@*|node()" priority="-2" mode="M228"><axsl:apply-templates select="@*|*" mode="M228"/></axsl:template>

<!--PATTERN iosver55steminorversion-->


	<!--RULE -->
<axsl:template match="ios-def:version55_state/ios-def:minor_version" priority="1000" mode="M229">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the minor_version entity of a version55_state should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M229"/></axsl:template><axsl:template match="text()" priority="-1" mode="M229"/><axsl:template match="@*|node()" priority="-2" mode="M229"><axsl:apply-templates select="@*|*" mode="M229"/></axsl:template>

<!--PATTERN iosver55sterelease-->


	<!--RULE -->
<axsl:template match="ios-def:version55_state/ios-def:release" priority="1000" mode="M230">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the release entity of a version55_state should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M230"/></axsl:template><axsl:template match="text()" priority="-1" mode="M230"/><axsl:template match="@*|node()" priority="-2" mode="M230"><axsl:apply-templates select="@*|*" mode="M230"/></axsl:template>

<!--PATTERN iosver55stetrain_identifier-->


	<!--RULE -->
<axsl:template match="ios-def:version_state/ios-def:train_identifier" priority="1000" mode="M231">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/ios-def:version_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="ios-def:version_test/ios-def:state" priority="1000" mode="M236">
...
<!--PATTERN iosverstemajor_release-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_state/ios-def:major_release" priority="1000" mode="M237">
...
<!--PATTERN iosverstetrain_number-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_state/ios-def:train_number" priority="1000" mode="M238">
...
<!--PATTERN iosverstetrain_identifier-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_state/ios-def:train_identifier" priority="1000" mode="M239">
...
<!--PATTERN iosversteversion_string-->
	...
	<!--RULE -->
<axsl:template match="ios-def:version_state/ios-def:version_string" priority="1000" mode="M240">
...
<!--PATTERN dpkgobjname-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_object/linux-def:name" priority="1000" mode="M241">
...
<!--PATTERN dpkgstename-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:name" priority="1000" mode="M242">
...
<!--PATTERN dpkgstearch-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:arch" priority="1000" mode="M243">
...
<!--PATTERN dpkgsteepoch-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:epoch" priority="1000" mode="M244">
...
<!--PATTERN dpkgsterelease-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:release" priority="1000" mode="M245">
...
<!--PATTERN dpkgsteversion-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:version" priority="1000" mode="M246">
...
<!--PATTERN dpkgsteevr-->
	...
	<!--RULE -->
<axsl:template match="linux-def:dpkginfo_state/linux-def:evr" priority="1000" mode="M247">
...
<!--PATTERN ilsobjprotocol-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_object/linux-def:protocol" priority="1000" mode="M248">
...
<!--PATTERN ilsobjlocal_address-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_object/linux-def:local_address" priority="1000" mode="M249">
...
<!--PATTERN ilsobjlocal_port-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_object/linux-def:local_port" priority="1000" mode="M250">
...
<!--PATTERN ilssteprotocol-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:protocol" priority="1000" mode="M251">
...
<!--PATTERN ilsstelocal_address-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:local_address" priority="1000" mode="M252">
...
<!--PATTERN ilsstelocal_port-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:local_port" priority="1000" mode="M253">
...
<!--PATTERN ilsstelocal_full_address-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:local_full_address" priority="1000" mode="M254">
...
<!--PATTERN ilssteprogram_name-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:program_name" priority="1000" mode="M255">
...
<!--PATTERN ilssteforeign_address-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:foreign_address" priority="1000" mode="M256">
...
<!--PATTERN ilssteforeign_port-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:foreign_port" priority="1000" mode="M257">
...
<!--PATTERN ilssteforeign_full_address-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:foreign_full_address" priority="1000" mode="M258">
...
<!--PATTERN ilsstepid-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:pid" priority="1000" mode="M259">
...
<!--PATTERN ilssteuser_id-->
	...
	<!--RULE -->
<axsl:template match="linux-def:inetlisteningservers_state/linux-def:user_id" priority="1000" mode="M260">
...
<!--PATTERN rpmobjname-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_object/linux-def:name" priority="1000" mode="M261">
...
<!--PATTERN rpmstename-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:name" priority="1000" mode="M262">
...
<!--PATTERN rpmstearch-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:arch" priority="1000" mode="M263">
...
<!--PATTERN rpmsteepoch-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:epoch" priority="1000" mode="M264">
...
<!--PATTERN rpmsterelease-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:release" priority="1000" mode="M265">
...
<!--PATTERN rpmsteversion-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:version" priority="1000" mode="M266">
...
<!--PATTERN rpmsteevr-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:evr" priority="1000" mode="M267">
...
<!--PATTERN rpmstesignaturekeyid-->
	...
	<!--RULE -->
<axsl:template match="linux-def:rpminfo_state/linux-def:signature_keyid" priority="1000" mode="M268">
...
<!--PATTERN spkginfoobjname-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_object/linux-def:name" priority="1000" mode="M269">
...
<!--PATTERN spkginfostename-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_state/linux-def:name" priority="1000" mode="M270">
...
<!--PATTERN spkginfosteversion-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_state/linux-def:version" priority="1000" mode="M271">
...
<!--PATTERN spkginfostearch-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_state/linux-def:architecture" priority="1000" mode="M272">
...
<!--PATTERN spkginfosterevision-->
	...
	<!--RULE -->
<axsl:template match="linux-def:slackwarepkginfo_state/linux-def:revision" priority="1000" mode="M273">
...
<!--PATTERN accountobjusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_object/macos-def:username" priority="1000" mode="M274">
...
<!--PATTERN accountsteusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:username" priority="1000" mode="M275">
...
<!--PATTERN accountstepassword-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:password" priority="1000" mode="M276">
...
<!--PATTERN accountsteuid-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:uid" priority="1000" mode="M277">
...
<!--PATTERN accountstegid-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:gid" priority="1000" mode="M278">
...
<!--PATTERN accountsterealname-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:realname" priority="1000" mode="M279">
...
<!--PATTERN accountstehome_dir-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:home_dir" priority="1000" mode="M280">
...
<!--PATTERN accountstelogin_shell-->
	...
	<!--RULE -->
<axsl:template match="macos-def:accountinfo_state/macos-def:login_shell" priority="1000" mode="M281">
...
<!--PATTERN macosilsobjprogram_name-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_object/macos-def:program_name" priority="1000" mode="M282">
...
<!--PATTERN macosilssteprogram_name-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:program_name" priority="1000" mode="M283">
...
<!--PATTERN macosilsstelocal_address-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:local_address" priority="1000" mode="M284">
...
<!--PATTERN macosilsstelocal_full_address-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:local_full_address" priority="1000" mode="M285">
...
<!--PATTERN macosilsstelocal_port-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:local_port" priority="1000" mode="M286">
...
<!--PATTERN macosilssteforeign_address-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:foreign_address" priority="1000" mode="M287">
...
<!--PATTERN macosilssteforeign_full_address-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:foreign_full_address" priority="1000" mode="M288">
...
<!--PATTERN macosilssteforeign_port-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:foreign_port" priority="1000" mode="M289">
...
<!--PATTERN macosilsstepid-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:pid" priority="1000" mode="M290">
...
<!--PATTERN macosilssteprotocol-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:protocol" priority="1000" mode="M291">
...
<!--PATTERN macosilssteuser_id-->
	...
	<!--RULE -->
<axsl:template match="macos-def:inetlisteningservers_state/macos-def:user_id" priority="1000" mode="M292">
...
<!--PATTERN nvramobjnvram_var-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_object/macos-def:nvram_var" priority="1000" mode="M293">
...
<!--PATTERN nvramstenvram_var-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_state/macos-def:nvram_var" priority="1000" mode="M294">
...
<!--PATTERN nvramstenvram_value-->
	...
	<!--RULE -->
<axsl:template match="macos-def:nvram_state/macos-def:nvram_value" priority="1000" mode="M295">
...
<!--PATTERN pwpobjusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:username" priority="1000" mode="M296">
...
<!--PATTERN pwpobjuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:userpass" priority="1000" mode="M297">
...
<!--PATTERN pwpobjdirectory_node-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_object/macos-def:directory_node" priority="1000" mode="M298">
...
<!--PATTERN pwpsteusername-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:username" priority="1000" mode="M299">
...
<!--PATTERN pwpsteuserpass-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:userpass" priority="1000" mode="M300">
...
<!--PATTERN pwpstedirectory_node-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:directory_node" priority="1000" mode="M301">
...
<!--PATTERN pwpstemaxChars-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:maxChars" priority="1000" mode="M302">
...
<!--PATTERN pwpstemaxFailedLoginAttempts-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:maxFailedLoginAttempts" priority="1000" mode="M303">
...
<!--PATTERN pwpsteminChars-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:minChars" priority="1000" mode="M304">
...
<!--PATTERN pwpstepasswordCannotBeName-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:passwordCannotBeName" priority="1000" mode="M305">
...
<!--PATTERN pwpsterequiresAlpha-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:requiresAlpha" priority="1000" mode="M306">
...
<!--PATTERN pwpsterequiresNumeric-->
	...
	<!--RULE -->
<axsl:template match="macos-def:pwpolicy_state/macos-def:requiresNumeric" priority="1000" mode="M307">
...
<!--PATTERN isainfotst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:object" priority="1001" mode="M308">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/sol-def:isainfo_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_test/sol-def:state" priority="1000" mode="M308">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/sol-def:isainfo_state/@id"/><axsl:otherwise>
...
<!--PATTERN isastebits-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_state/sol-def:bits" priority="1000" mode="M309">
...
<!--PATTERN isastekernel_isa-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_state/sol-def:kernel_isa" priority="1000" mode="M310">
...
<!--PATTERN isasteapplication_isa-->
	...
	<!--RULE -->
<axsl:template match="sol-def:isainfo_state/sol-def:application_isa" priority="1000" mode="M311">
...
<!--PATTERN packagetst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:object" priority="1001" mode="M312">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/sol-def:package_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:package_test/sol-def:state" priority="1000" mode="M312">
...
<!--PATTERN packageobjpkginst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_object/sol-def:pkginst" priority="1000" mode="M313">
...
<!--PATTERN packagestepkginst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:pkginst" priority="1000" mode="M314">
...
<!--PATTERN packagestename-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:name" priority="1000" mode="M315">
...
<!--PATTERN packagestecategory-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:category" priority="1000" mode="M316">
...
<!--PATTERN packagesteversion-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:version" priority="1000" mode="M317">
...
<!--PATTERN packagestevendor-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:vendor" priority="1000" mode="M318">
...
<!--PATTERN packagestedescription-->
	...
	<!--RULE -->
<axsl:template match="sol-def:package_state/sol-def:description" priority="1000" mode="M319">
...
<!--PATTERN patch54tst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:object" priority="1001" mode="M320">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/sol-def:patch54_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_test/sol-def:state" priority="1000" mode="M320">
...
<!--PATTERN patchtst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:object" priority="1001" mode="M321">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/sol-def:patch_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_test/sol-def:state" priority="1000" mode="M321">
...
<!--PATTERN patch54objbase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_object/sol-def:base" priority="1000" mode="M322">
...
<!--PATTERN patch54objversion-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch54_object/sol-def:version" priority="1000" mode="M323">
...
<!--PATTERN patchobjbase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_object/sol-def:base" priority="1000" mode="M324">
...
<!--PATTERN patchstebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_state/sol-def:base" priority="1000" mode="M325">
...
<!--PATTERN patchsteversion-->
	...
	<!--RULE -->
<axsl:template match="sol-def:patch_state/sol-def:version" priority="1000" mode="M326">
...
<!--PATTERN smftst-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:object" priority="1001" mode="M327">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/sol-def:smf_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_test/sol-def:state" priority="1000" mode="M327">
...
<!--PATTERN fmriobjbase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_object/sol-def:fmri" priority="1000" mode="M328">
...
<!--PATTERN fmristebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:fmri" priority="1000" mode="M329">
...
<!--PATTERN srvnamestebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:service_name" priority="1000" mode="M330">
...
<!--PATTERN srvstatestebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:service_state" priority="1000" mode="M331">
...
<!--PATTERN protocolstebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:protocol" priority="1000" mode="M332">
...
<!--PATTERN srvexestebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:server_executable" priority="1000" mode="M333">
...
<!--PATTERN srvargsstebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:server_arguements" priority="1000" mode="M334">
...
<!--PATTERN execasuserstebase-->
	...
	<!--RULE -->
<axsl:template match="sol-def:smf_state/sol-def:exec_as_user" priority="1000" mode="M335">
...
<!--PATTERN unixfileobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:path" priority="1000" mode="M336">
...
<!--PATTERN unixfileobjfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filename" priority="1000" mode="M337">
...
<!--PATTERN unixfilestepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:path" priority="1000" mode="M338">
...
<!--PATTERN unixfilestefilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:filename" priority="1000" mode="M339">
...
<!--PATTERN unixfilestetype-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:type" priority="1000" mode="M340">
...
<!--PATTERN unixfilestegroup_id-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:group_id" priority="1000" mode="M341">
...
<!--PATTERN unixfilesteuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:user_id" priority="1000" mode="M342">
...
<!--PATTERN unixfilestea_time-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:a_time" priority="1000" mode="M343">
...
<!--PATTERN unixfilestec_time-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:c_time" priority="1000" mode="M344">
...
<!--PATTERN unixfilestem_time-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:m_time" priority="1000" mode="M345">
...
<!--PATTERN unixfilestesize-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:size" priority="1000" mode="M346">
...
<!--PATTERN unixfilestesuid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:suid" priority="1000" mode="M347">
...
<!--PATTERN unixfilestesgid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:sgid" priority="1000" mode="M348">
...
<!--PATTERN unixfilestesticky-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:sticky" priority="1000" mode="M349">
...
<!--PATTERN unixfilesteuread-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:uread" priority="1000" mode="M350">
...
<!--PATTERN unixfilesteuwrite-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:uwrite" priority="1000" mode="M351">
...
<!--PATTERN unixfilesteuexec-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:uexec" priority="1000" mode="M352">
...
<!--PATTERN unixfilestegread-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:gread" priority="1000" mode="M353">
...
<!--PATTERN unixfilestegwrite-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:gwrite" priority="1000" mode="M354">
...
<!--PATTERN unixfilestegexec-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:gexec" priority="1000" mode="M355">
...
<!--PATTERN unixfilesteoread-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:oread" priority="1000" mode="M356">
...
<!--PATTERN unixfilesteowrite-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:owrite" priority="1000" mode="M357">
...
<!--PATTERN unixfilesteoexec-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_state/unix-def:oexec" priority="1000" mode="M358">
...
<!--PATTERN inetdobjprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_object/unix-def:protocol" priority="1000" mode="M359">
...
<!--PATTERN inetdobjservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_object/unix-def:service_name" priority="1000" mode="M360">
...
<!--PATTERN inetdsteprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:protocol" priority="1000" mode="M361">
...
<!--PATTERN inetdsteservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:service_name" priority="1000" mode="M362">
...
<!--PATTERN inetdsteserver_program-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:server_program" priority="1000" mode="M363">
...
<!--PATTERN inetdsteserver_arguments-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:server_arguments" priority="1000" mode="M364">
...
<!--PATTERN inetdsteendpoint_type-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:endpoint_type" priority="1000" mode="M365">
...
<!--PATTERN inetdsteexec_as_user-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:exec_as_user" priority="1000" mode="M366">
...
<!--PATTERN inetdstewait_status-->
	...
	<!--RULE -->
<axsl:template match="unix-def:inetd_state/unix-def:wait_status" priority="1000" mode="M367">
...
<!--PATTERN unixinterfaceobjname-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_object/unix-def:name" priority="1000" mode="M368">
...
<!--PATTERN unixinterfacestename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:name" priority="1000" mode="M369">
...
<!--PATTERN unixinterfacestehardware_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:hardware_addr" priority="1000" mode="M370">
...
<!--PATTERN unixinterfacesteinet_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:inet_addr" priority="1000" mode="M371">
...
<!--PATTERN unixinterfacestebroadcast_addr-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:broadcast_addr" priority="1000" mode="M372">
...
<!--PATTERN unixinterfacestenetmask-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:netmask" priority="1000" mode="M373">
...
<!--PATTERN unixinterfacesteflag-->
	...
	<!--RULE -->
<axsl:template match="unix-def:interface_state/unix-def:flag" priority="1000" mode="M374">
...
<!--PATTERN passwordobjusername-->
	...
	<!--RULE -->
<axsl:template match="unix-def:password_object/unix-def:username" priority="1000" mode="M375">
...
<!--PATTERN passwordsteusername-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:username" priority="1000" mode="M376">
...
<!--PATTERN passwordstepassword-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:password" priority="1000" mode="M377">
...
<!--PATTERN passwordsteuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:user_id" priority="1000" mode="M378">
...
<!--PATTERN passwordstegroup_id-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:group_id" priority="1000" mode="M379">
...
<!--PATTERN passwordstegcos-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:gcos" priority="1000" mode="M380">
...
<!--PATTERN passwordstehome_dir-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:home_dir" priority="1000" mode="M381">
...
<!--PATTERN passwordstelogin_shell-->
	...
	<!--RULE -->
<axsl:template match="unix-def:package_state/unix-def:login_shell" priority="1000" mode="M382">
...
<!--PATTERN unixprocessobjcommand-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_object/unix-def:command" priority="1000" mode="M383">
...
<!--PATTERN unixprocessstecommand-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:command" priority="1000" mode="M384">
...
<!--PATTERN unixprocesssteexec_time-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:exec_time" priority="1000" mode="M385">
...
<!--PATTERN unixprocessstepid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:pid" priority="1000" mode="M386">
...
<!--PATTERN unixprocesssteppid-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:ppid" priority="1000" mode="M387">
...
<!--PATTERN unixprocessstepriority-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:priority" priority="1000" mode="M388">
...
<!--PATTERN unixprocessstescheduling_class-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:scheduling_class" priority="1000" mode="M389">
...
<!--PATTERN unixprocessstestart_time-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:start_time" priority="1000" mode="M390">
...
<!--PATTERN unixprocessstetty-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:tty" priority="1000" mode="M391">
...
<!--PATTERN unixprocesssteuser_id-->
	...
	<!--RULE -->
<axsl:template match="unix-def:process_state/unix-def:user_id" priority="1000" mode="M392">
...
<!--PATTERN unixrlobjservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_object/unix-def:service_name" priority="1000" mode="M393">
...
<!--PATTERN unixrlobjrunlevel-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_object/unix-def:runlevel" priority="1000" mode="M394">
...
<!--PATTERN unixrlsteservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_state/unix-def:service_name" priority="1000" mode="M395">
...
<!--PATTERN unixrlsterunlevel-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_state/unix-def:runlevel" priority="1000" mode="M396">
...
<!--PATTERN unixrlstestart-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_state/unix-def:start" priority="1000" mode="M397">
...
<!--PATTERN unixrlstekill-->
	...
	<!--RULE -->
<axsl:template match="unix-def:runlevel_state/unix-def:kill" priority="1000" mode="M398">
...
<!--PATTERN sccsobjpath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:path" priority="1000" mode="M399">
...
<!--PATTERN sccsobjfilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:file_object/unix-def:filename" priority="1000" mode="M400">
...
<!--PATTERN sccsstepath-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:path" priority="1000" mode="M401">
...
<!--PATTERN sccsstefilename-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:filename" priority="1000" mode="M402">
...
<!--PATTERN sccsstemodule_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:module_name" priority="1000" mode="M403">
...
<!--PATTERN sccsstemodule_type-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:module_type" priority="1000" mode="M404">
...
<!--PATTERN sccssterelease-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:release" priority="1000" mode="M405">
...
<!--PATTERN sccsstelevel-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:level" priority="1000" mode="M406">
...
<!--PATTERN sccsstebranch-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:branch" priority="1000" mode="M407">
...
<!--PATTERN sccsstesequence-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:sequence" priority="1000" mode="M408">
...
<!--PATTERN sccsstewhat_string-->
	...
	<!--RULE -->
<axsl:template match="unix-def:sccs_state/unix-def:what_string" priority="1000" mode="M409">
...
<!--PATTERN shadowobjusername-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_object/unix-def:username" priority="1000" mode="M410">
...
<!--PATTERN shadowsteusername-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:username" priority="1000" mode="M411">
...
<!--PATTERN shadowstepassword-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:password" priority="1000" mode="M412">
...
<!--PATTERN shadowstechg_lst-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:chg_lst" priority="1000" mode="M413">
...
<!--PATTERN shadowstechg_allow-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:chg_allow" priority="1000" mode="M414">
...
<!--PATTERN shadowstechg_req-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:chg_req" priority="1000" mode="M415">
...
<!--PATTERN shadowsteexp_warn-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:exp_warn" priority="1000" mode="M416">
...
<!--PATTERN shadowsteexp_inact-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:exp_inact" priority="1000" mode="M417">
...
<!--PATTERN shadowsteexp_date-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:exp_date" priority="1000" mode="M418">
...
<!--PATTERN shadowsteflag-->
	...
	<!--RULE -->
<axsl:template match="unix-def:shadow_state/unix-def:flag" priority="1000" mode="M419">
...
<!--PATTERN unamestemachine_class-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:machine_class" priority="1000" mode="M420">
...
<!--PATTERN unamestenode_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:node_name" priority="1000" mode="M421">
...
<!--PATTERN unamesteos_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:os_name" priority="1000" mode="M422">
...
<!--PATTERN unamesteos_release-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:os_release" priority="1000" mode="M423">
...
<!--PATTERN unamesteos_version-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:os_version" priority="1000" mode="M424">
...
<!--PATTERN unamesteprocessor_type-->
	...
	<!--RULE -->
<axsl:template match="unix-def:uname_state/unix-def:processor_type" priority="1000" mode="M425">
...
<!--PATTERN xinetdobjprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_object/unix-def:protocol" priority="1000" mode="M426">
...
<!--PATTERN xinetdobjservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_object/unix-def:service_name" priority="1000" mode="M427">
...
<!--PATTERN xinetdsteprotocol-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:protocol" priority="1000" mode="M428">
...
<!--PATTERN xinetdsteservice_name-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:service_name" priority="1000" mode="M429">
...
<!--PATTERN xinetdsteflags-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:flags" priority="1000" mode="M430">
...
<!--PATTERN xinetdstenoaccess-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:no_access" priority="1000" mode="M431">
...
<!--PATTERN xinetdsteonlyfrom-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:only_from" priority="1000" mode="M432">
...
<!--PATTERN xinetdsteport-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:port" priority="1000" mode="M433">
...
<!--PATTERN xinetdsteserver-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:server" priority="1000" mode="M434">
...
<!--PATTERN xinetdsteserverarguments-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:server_arguments" priority="1000" mode="M435">
...
<!--PATTERN xinetdstesockettype-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:socket_type" priority="1000" mode="M436">
...
<!--PATTERN xinetdstetype-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:type" priority="1000" mode="M437">
...
<!--PATTERN xinetdsteuser-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:user" priority="1000" mode="M438">
...
<!--PATTERN xinetdstewait-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:wait" priority="1000" mode="M439">
...
<!--PATTERN xinetdstedisabled-->
	...
	<!--RULE -->
<axsl:template match="unix-def:xinetd_state/unix-def:disabled" priority="1000" mode="M440">
...
<!--PATTERN affected_platform-->
	...
	<!--RULE -->
<axsl:template match="oval-def:affected[@family='windows']" priority="1000" mode="M441">
...
<!--PATTERN attst-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test/win-def:object" priority="1001" mode="M442">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:accesstoken_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_test/win-def:state" priority="1000" mode="M442">
...
<!--PATTERN atobjsecurity_principle-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_object/win-def:security_principle" priority="1000" mode="M443">
...
<!--PATTERN atstesecurity_principle-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:security_principle" priority="1000" mode="M444">
...
<!--PATTERN atsteseassignprimarytokenprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seassignprimarytokenprivilege" priority="1000" mode="M445">
...
<!--PATTERN atsteseauditprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seauditprivilege" priority="1000" mode="M446">
...
<!--PATTERN atstesebackupprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sebackupprivilege" priority="1000" mode="M447">
...
<!--PATTERN atstesechangenotifyprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sechangenotifyprivilege" priority="1000" mode="M448">
...
<!--PATTERN atstesecreateglobalprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:secreateglobalprivilege" priority="1000" mode="M449">
...
<!--PATTERN atstesecreatepagefileprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:secreatepagefileprivilege" priority="1000" mode="M450">
...
<!--PATTERN atstesecreatepermanentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:secreatepermanentprivilege" priority="1000" mode="M451">
...
<!--PATTERN atstesecreatesymboliclinkprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:secreatesymboliclinkprivilege" priority="1000" mode="M452">
...
<!--PATTERN atstesecreatetokenprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:secreatetokenprivilege" priority="1000" mode="M453">
...
<!--PATTERN atstesedebugprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedebugprivilege" priority="1000" mode="M454">
...
<!--PATTERN atsteseenabledelegationprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seenabledelegationprivilege" priority="1000" mode="M455">
...
<!--PATTERN atsteseimpersonateprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seimpersonateprivilege" priority="1000" mode="M456">
...
<!--PATTERN atsteseincreasebasepriorityprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seincreasebasepriorityprivilege" priority="1000" mode="M457">
...
<!--PATTERN atsteseincreasequotaprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seincreasequotaprivilege" priority="1000" mode="M458">
...
<!--PATTERN atsteseincreaseworkingsetprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seincreaseworkingsetprivilege" priority="1000" mode="M459">
...
<!--PATTERN atsteseloaddriverprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seloaddriverprivilege" priority="1000" mode="M460">
...
<!--PATTERN atsteselockmemoryprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:selockmemoryprivilege" priority="1000" mode="M461">
...
<!--PATTERN atstesemachineaccountprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:semachineaccountprivilege" priority="1000" mode="M462">
...
<!--PATTERN atstesemanagevolumeprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:semanagevolumeprivilege" priority="1000" mode="M463">
...
<!--PATTERN atsteseprofilesingleprocessprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seprofilesingleprocessprivilege" priority="1000" mode="M464">
...
<!--PATTERN atsteserelabelprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:serelabelprivilege" priority="1000" mode="M465">
...
<!--PATTERN atsteseremoteshutdownprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seremoteshutdownprivilege" priority="1000" mode="M466">
...
<!--PATTERN atsteserestoreprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:serestoreprivilege" priority="1000" mode="M467">
...
<!--PATTERN atstesesecurityprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sesecurityprivilege" priority="1000" mode="M468">
...
<!--PATTERN atsteseshutdownprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seshutdownprivilege" priority="1000" mode="M469">
...
<!--PATTERN atstesesyncagentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sesyncagentprivilege" priority="1000" mode="M470">
...
<!--PATTERN atstesesystemenvironmentprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sesystemenvironmentprivilege" priority="1000" mode="M471">
...
<!--PATTERN atstesesystemprofileprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sesystemprofileprivilege" priority="1000" mode="M472">
...
<!--PATTERN atstesesystemtimeprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sesystemtimeprivilege" priority="1000" mode="M473">
...
<!--PATTERN atstesetakeownershipprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:setakeownershipprivilege" priority="1000" mode="M474">
...
<!--PATTERN atstesetcbprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:setcbprivilege" priority="1000" mode="M475">
...
<!--PATTERN atstesetimezoneprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:setimezoneprivilege" priority="1000" mode="M476">
...
<!--PATTERN atsteseundockprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seundockprivilege" priority="1000" mode="M477">
...
<!--PATTERN atsteseunsolicitedinputprivilege-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seunsolicitedinputprivilege" priority="1000" mode="M478">
...
<!--PATTERN atstesebatchlogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sebatchlogonright" priority="1000" mode="M479">
...
<!--PATTERN atsteseinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seinteractivelogonright" priority="1000" mode="M480">
...
<!--PATTERN atstesenetworklogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:senetworklogonright" priority="1000" mode="M481">
...
<!--PATTERN atsteseremoteinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seremoteinteractivelogonright" priority="1000" mode="M482">
...
<!--PATTERN atsteseservicelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:seservicelogonright" priority="1000" mode="M483">
...
<!--PATTERN atstesedenybatchLogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedenybatchLogonright" priority="1000" mode="M484">
...
<!--PATTERN atstesedenyinteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedenyinteractivelogonright" priority="1000" mode="M485">
...
<!--PATTERN atstesedenynetworklogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedenynetworklogonright" priority="1000" mode="M486">
...
<!--PATTERN atstesedenyremoteInteractivelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedenyremoteInteractivelogonright" priority="1000" mode="M487">
...
<!--PATTERN atstesedenyservicelogonright-->
	...
	<!--RULE -->
<axsl:template match="win-def:accesstoken_state/win-def:sedenyservicelogonright" priority="1000" mode="M488">
...
<!--PATTERN adtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_test/win-def:object" priority="1001" mode="M489">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:activedirectory_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of an activedirectory_test must reference an activedirectory_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M489"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:activedirectory_test/win-def:state" priority="1000" mode="M489">
...
<!--PATTERN adobjnaming_context-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_object/win-def:naming_context" priority="1000" mode="M490">
...
<!--PATTERN adobjrelative_dn-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_object/win-def:relative_dn" priority="1000" mode="M491">
...
<!--PATTERN adobjattribute-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_object/win-def:attribute" priority="1000" mode="M492">
...
<!--PATTERN adstenaming_context-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:naming_context" priority="1000" mode="M493">
...
<!--PATTERN adsterelative_dn-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:relative_dn" priority="1000" mode="M494">
...
<!--PATTERN adsteattribute-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:attribute" priority="1000" mode="M495">
...
<!--PATTERN adsteobject_class-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:object_class" priority="1000" mode="M496">
...
<!--PATTERN adsteadstype-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:adstype" priority="1000" mode="M497">
...
<!--PATTERN adstevalue-->
	...
	<!--RULE -->
<axsl:template match="win-def:activedirectory_state/win-def:value" priority="1000" mode="M498">
...
<!--PATTERN aeptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:object" priority="1001" mode="M499">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_test/win-def:state" priority="1000" mode="M499">
...
<!--PATTERN aepsteaccount_logon-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:account_logon" priority="1000" mode="M500">
...
<!--PATTERN aepsteaccount_management-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:account_management" priority="1000" mode="M501">
...
<!--PATTERN aepstedetailed_tracking-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:detailed_tracking" priority="1000" mode="M502">
...
<!--PATTERN aepstedirectory_service_access-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:directory_service_access" priority="1000" mode="M503">
...
<!--PATTERN aepstelogon-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:logon" priority="1000" mode="M504">
...
<!--PATTERN aepsteobject_access-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:object_access" priority="1000" mode="M505">
...
<!--PATTERN aepstepolicy_change-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:policy_change" priority="1000" mode="M506">
...
<!--PATTERN aepsteprivilege_use-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:privilege_use" priority="1000" mode="M507">
...
<!--PATTERN aepstesystem-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicy_state/win-def:system" priority="1000" mode="M508">
...
<!--PATTERN aepstst-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:object" priority="1001" mode="M509">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:auditeventpolicysubcategories_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_test/win-def:state" priority="1000" mode="M509">
...
<!--PATTERN aepsstecredentialvalidation-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:credential_validation" priority="1000" mode="M510">
...
<!--PATTERN aepsstekerberosticketevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:kerberos_ticket_events" priority="1000" mode="M511">
...
<!--PATTERN aepssteotheraccountlogonevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_account_logon_events" priority="1000" mode="M512">
...
<!--PATTERN aepssteapplicationgroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:application_group_management" priority="1000" mode="M513">
...
<!--PATTERN aepsstecomputeraccountmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:computer_account_management" priority="1000" mode="M514">
...
<!--PATTERN aepsstedistributiongroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:distribution_group_management" priority="1000" mode="M515">
...
<!--PATTERN aepssteotheraccountmanagementevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_account_management_events" priority="1000" mode="M516">
...
<!--PATTERN aepsstesecuritygroupmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:security_group_management" priority="1000" mode="M517">
...
<!--PATTERN aepssteuseraccountmanagement-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:user_account_management" priority="1000" mode="M518">
...
<!--PATTERN aepsstedpapiactivity-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:dpapi_activity" priority="1000" mode="M519">
...
<!--PATTERN aepssteprocesscreation-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:process_creation" priority="1000" mode="M520">
...
<!--PATTERN aepssteprocesstermination-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:process_termination" priority="1000" mode="M521">
...
<!--PATTERN aepssterpcevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:rpc_events" priority="1000" mode="M522">
...
<!--PATTERN aepsstedirectoryserviceaccess-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:directory_service_access" priority="1000" mode="M523">
...
<!--PATTERN aepsstedirectoryservicechanges-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:directory_service_changes" priority="1000" mode="M524">
...
<!--PATTERN aepsstedirectoryservicereplication-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:directory_service_replication" priority="1000" mode="M525">
...
<!--PATTERN aepsstedetaileddirectoryservicereplication-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:detailed_directory_service_replication" priority="1000" mode="M526">
...
<!--PATTERN aepssteaccountlockout-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:account_lockout" priority="1000" mode="M527">
...
<!--PATTERN aepssteipsecextendedmode-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:ipsec_extended_mode" priority="1000" mode="M528">
...
<!--PATTERN aepssteipsecmainmode-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:ipsec_main_mode" priority="1000" mode="M529">
...
<!--PATTERN aepssteipsec_quick_mode-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:ipsec_quick_mode" priority="1000" mode="M530">
...
<!--PATTERN aepsstelogoff-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:logoff" priority="1000" mode="M531">
...
<!--PATTERN aepsstelogon-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:logon" priority="1000" mode="M532">
...
<!--PATTERN aepssteotherlogonlogoffevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_logon_logoff_events" priority="1000" mode="M533">
...
<!--PATTERN aepsstespeciallogon-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:special_logon" priority="1000" mode="M534">
...
<!--PATTERN aepssteapplicationgenerated-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:application_generated" priority="1000" mode="M535">
...
<!--PATTERN aepsstecertificationservices-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:certification_services" priority="1000" mode="M536">
...
<!--PATTERN aepsstefileshare-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:file_share" priority="1000" mode="M537">
...
<!--PATTERN aepsstefilesystem-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:file_system" priority="1000" mode="M538">
...
<!--PATTERN aepsstefilteringplatformconnection-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:filtering_platform_connection" priority="1000" mode="M539">
...
<!--PATTERN aepsstefilteringplatformpacketdrop-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:filtering_platform_packet_drop" priority="1000" mode="M540">
...
<!--PATTERN aepsstehandlemanipulation-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:handle_manipulation" priority="1000" mode="M541">
...
<!--PATTERN aepsstekernelobject-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:kernel_object" priority="1000" mode="M542">
...
<!--PATTERN aepssteotherobjectaccessevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_object_access_events" priority="1000" mode="M543">
...
<!--PATTERN aepssteregistry-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:registry" priority="1000" mode="M544">
...
<!--PATTERN aepsstesam-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:sam" priority="1000" mode="M545">
...
<!--PATTERN aepssteauditpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:audit_policy_change" priority="1000" mode="M546">
...
<!--PATTERN aepssteauthenticationpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:authentication_policy_change" priority="1000" mode="M547">
...
<!--PATTERN aepssteauthorizationpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:authorization_policy_change" priority="1000" mode="M548">
...
<!--PATTERN aepsstefilteringplatformpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:filtering_platform_policy_change" priority="1000" mode="M549">
...
<!--PATTERN aepsstempssvcrulelevelpolicychange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:mpssvc_rule_level_policy_change" priority="1000" mode="M550">
...
<!--PATTERN aepssteotherpolicychangeevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_policy_change_events" priority="1000" mode="M551">
...
<!--PATTERN aepsstenonsensitiveprivilegeuse-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:non_sensitive_privilege_use" priority="1000" mode="M552">
...
<!--PATTERN aepssteotherprivilegeuseevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_privilege_use_events" priority="1000" mode="M553">
...
<!--PATTERN aepsstesensitive_privilege_use-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:sensitive_privilege_use" priority="1000" mode="M554">
...
<!--PATTERN aepssteipsecdriver-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:ipsec_driver" priority="1000" mode="M555">
...
<!--PATTERN aepssteothersystemevents-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:other_system_events" priority="1000" mode="M556">
...
<!--PATTERN aepsstesecuritystatechange-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:security_state_change" priority="1000" mode="M557">
...
<!--PATTERN aepsstesecuritysystemextension-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:security_system_extension" priority="1000" mode="M558">
...
<!--PATTERN aepsstesystemintegrity-->
	...
	<!--RULE -->
<axsl:template match="win-def:auditeventpolicysubcategories_state/win-def:system_integrity" priority="1000" mode="M559">
...
<!--PATTERN fileobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:path" priority="1000" mode="M561">
...
<!--PATTERN fileobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_object/win-def:filename" priority="1000" mode="M562">
...
<!--PATTERN filestefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:filename" priority="1000" mode="M564">
...
<!--PATTERN filesteowner-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:owner" priority="1000" mode="M565">
...
<!--PATTERN filestesize-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:size" priority="1000" mode="M566">
...
<!--PATTERN filestea_time-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:a_time" priority="1000" mode="M567">
...
<!--PATTERN filestec_time-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:c_time" priority="1000" mode="M568">
...
<!--PATTERN filestem_time-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:m_time" priority="1000" mode="M569">
...
<!--PATTERN filestems_checksum-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:ms_checksum" priority="1000" mode="M570">
...
<!--PATTERN filesteversion-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:version" priority="1000" mode="M571">
...
<!--PATTERN filestetype-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:type" priority="1000" mode="M572">
...
<!--PATTERN filestedevelopment_class-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:development_class" priority="1000" mode="M573">
...
<!--PATTERN filestecompany-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:company" priority="1000" mode="M574">
...
<!--PATTERN filesteinternalname-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:internal_name" priority="1000" mode="M575">
...
<!--PATTERN filestelanguage-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:language" priority="1000" mode="M576">
...
<!--PATTERN filesteoriginalfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:original_filename" priority="1000" mode="M577">
...
<!--PATTERN filesteproductname-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:product_name" priority="1000" mode="M578">
...
<!--PATTERN filesteproductversion-->
	...
	<!--RULE -->
<axsl:template match="win-def:file_state/win-def:product_version" priority="1000" mode="M579">
...
<!--PATTERN fap53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:object" priority="1001" mode="M580">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions53_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_test/win-def:state" priority="1000" mode="M580">
...
<!--PATTERN fap53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:path" priority="1000" mode="M581">
...
<!--PATTERN fap53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:filename" priority="1000" mode="M582">
...
<!--PATTERN fap53objtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_object/win-def:trustee_sid" priority="1000" mode="M583">
...
<!--PATTERN fap53stepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:path" priority="1000" mode="M584">
...
<!--PATTERN fap53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:filename" priority="1000" mode="M585">
...
<!--PATTERN fap53stetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:trustee_sid" priority="1000" mode="M586">
...
<!--PATTERN fap53stestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:standard_delete" priority="1000" mode="M587">
...
<!--PATTERN fap53stestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:standard_read_control" priority="1000" mode="M588">
...
<!--PATTERN fap53stestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:standard_write_dac" priority="1000" mode="M589">
...
<!--PATTERN fap53stestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:standard_write_owner" priority="1000" mode="M590">
...
<!--PATTERN fap53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:standard_synchronize" priority="1000" mode="M591">
...
<!--PATTERN fap53steaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:access_system_security" priority="1000" mode="M592">
...
<!--PATTERN fap53stegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:generic_read" priority="1000" mode="M593">
...
<!--PATTERN fap53stegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:generic_write" priority="1000" mode="M594">
...
<!--PATTERN fap53stegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:generic_execute" priority="1000" mode="M595">
...
<!--PATTERN fap53stegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:generic_all" priority="1000" mode="M596">
...
<!--PATTERN fap53stefile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_read_data" priority="1000" mode="M597">
...
<!--PATTERN fap53stefile_write_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_write_data" priority="1000" mode="M598">
...
<!--PATTERN fap53stefile_append_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_append_data" priority="1000" mode="M599">
...
<!--PATTERN fap53stefile_read_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_read_ea" priority="1000" mode="M600">
...
<!--PATTERN fap53stefile_write_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_write_ea" priority="1000" mode="M601">
...
<!--PATTERN fap53stefile_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_execute" priority="1000" mode="M602">
...
<!--PATTERN fap53stefile_delete_child-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_delete_child" priority="1000" mode="M603">
...
<!--PATTERN fap53stefile_read_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_read_attributes" priority="1000" mode="M604">
...
<!--PATTERN fap53stefile_write_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions53_state/win-def:file_write_attributes" priority="1000" mode="M605">
...
<!--PATTERN faptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:object" priority="1001" mode="M606">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:fileauditedpermissions_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_test/win-def:state" priority="1000" mode="M606">
...
<!--PATTERN fapobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object/win-def:path" priority="1000" mode="M607">
...
<!--PATTERN fapobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object/win-def:filename" priority="1000" mode="M608">
...
<!--PATTERN fapobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_object/win-def:trustee_name" priority="1000" mode="M609">
...
<!--PATTERN fapstepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:path" priority="1000" mode="M610">
...
<!--PATTERN fapstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:filename" priority="1000" mode="M611">
...
<!--PATTERN fapstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:trustee_name" priority="1000" mode="M612">
...
<!--PATTERN fapstestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:standard_delete" priority="1000" mode="M613">
...
<!--PATTERN fapstestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:standard_read_control" priority="1000" mode="M614">
...
<!--PATTERN fapstestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:standard_write_dac" priority="1000" mode="M615">
...
<!--PATTERN fapstestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:standard_write_owner" priority="1000" mode="M616">
...
<!--PATTERN fapstestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:standard_synchronize" priority="1000" mode="M617">
...
<!--PATTERN fapsteaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:access_system_security" priority="1000" mode="M618">
...
<!--PATTERN fapstegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:generic_read" priority="1000" mode="M619">
...
<!--PATTERN fapstegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:generic_write" priority="1000" mode="M620">
...
<!--PATTERN fapstegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:generic_execute" priority="1000" mode="M621">
...
<!--PATTERN fapstegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:generic_all" priority="1000" mode="M622">
...
<!--PATTERN fapstefile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_read_data" priority="1000" mode="M623">
...
<!--PATTERN fapstefile_write_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_write_data" priority="1000" mode="M624">
...
<!--PATTERN fapstefile_append_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_append_data" priority="1000" mode="M625">
...
<!--PATTERN fapstefile_read_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_read_ea" priority="1000" mode="M626">
...
<!--PATTERN fapstefile_write_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_write_ea" priority="1000" mode="M627">
...
<!--PATTERN fapstefile_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_execute" priority="1000" mode="M628">
...
<!--PATTERN fapstefile_delete_child-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_delete_child" priority="1000" mode="M629">
...
<!--PATTERN fapstefile_read_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_read_attributes" priority="1000" mode="M630">
...
<!--PATTERN fapstefile_write_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileauditedpermissions_state/win-def:file_write_attributes" priority="1000" mode="M631">
...
<!--PATTERN fer53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_test/win-def:object" priority="1001" mode="M632">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights53_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_test/win-def:state" priority="1000" mode="M632">
...
<!--PATTERN fer53objpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:path" priority="1000" mode="M633">
...
<!--PATTERN fer53objfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:filename" priority="1000" mode="M634">
...
<!--PATTERN fer53objtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_object/win-def:trustee_sid" priority="1000" mode="M635">
...
<!--PATTERN fer53stepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:path" priority="1000" mode="M636">
...
<!--PATTERN fer53stefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:filename" priority="1000" mode="M637">
...
<!--PATTERN fer53stetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:trustee_sid" priority="1000" mode="M638">
...
<!--PATTERN fer53stestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:standard_delete" priority="1000" mode="M639">
...
<!--PATTERN fer53stestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:standard_read_control" priority="1000" mode="M640">
...
<!--PATTERN fer53stestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:standard_write_dac" priority="1000" mode="M641">
...
<!--PATTERN fer53stestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:standard_write_owner" priority="1000" mode="M642">
...
<!--PATTERN fer53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:standard_synchronize" priority="1000" mode="M643">
...
<!--PATTERN fer53steaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:access_system_security" priority="1000" mode="M644">
...
<!--PATTERN fer53stegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:generic_read" priority="1000" mode="M645">
...
<!--PATTERN fer53stegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:generic_write" priority="1000" mode="M646">
...
<!--PATTERN fer53stegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:generic_execute" priority="1000" mode="M647">
...
<!--PATTERN fer53stegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:generic_all" priority="1000" mode="M648">
...
<!--PATTERN fer53stefile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_read_data" priority="1000" mode="M649">
...
<!--PATTERN fer53stefile_write_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_write_data" priority="1000" mode="M650">
...
<!--PATTERN fer53stefile_append_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_append_data" priority="1000" mode="M651">
...
<!--PATTERN fer53stefile_read_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_read_ea" priority="1000" mode="M652">
...
<!--PATTERN fer53stefile_write_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_write_ea" priority="1000" mode="M653">
...
<!--PATTERN fer53stefile_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_execute" priority="1000" mode="M654">
...
<!--PATTERN fer53stefile_delete_child-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_delete_child" priority="1000" mode="M655">
...
<!--PATTERN fer53stefile_read_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_read_attributes" priority="1000" mode="M656">
...
<!--PATTERN fer53stefile_write_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights53_state/win-def:file_write_attributes" priority="1000" mode="M657">
...
<!--PATTERN fertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:object" priority="1001" mode="M658">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:fileeffectiverights_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_test/win-def:state" priority="1000" mode="M658">
...
<!--PATTERN fefobjpath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object/win-def:path" priority="1000" mode="M659">
...
<!--PATTERN fefobjfilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object/win-def:filename" priority="1000" mode="M660">
...
<!--PATTERN fefobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_object/win-def:trustee_name" priority="1000" mode="M661">
...
<!--PATTERN ferstepath-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:path" priority="1000" mode="M662">
...
<!--PATTERN ferstefilename-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:filename" priority="1000" mode="M663">
...
<!--PATTERN ferstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:trustee_name" priority="1000" mode="M664">
...
<!--PATTERN ferstestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:standard_delete" priority="1000" mode="M665">
...
<!--PATTERN ferstestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:standard_read_control" priority="1000" mode="M666">
...
<!--PATTERN ferstestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:standard_write_dac" priority="1000" mode="M667">
...
<!--PATTERN ferstestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:standard_write_owner" priority="1000" mode="M668">
...
<!--PATTERN ferstestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:standard_synchronize" priority="1000" mode="M669">
...
<!--PATTERN fersteaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:access_system_security" priority="1000" mode="M670">
...
<!--PATTERN ferstegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:generic_read" priority="1000" mode="M671">
...
<!--PATTERN ferstegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:generic_write" priority="1000" mode="M672">
...
<!--PATTERN ferstegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:generic_execute" priority="1000" mode="M673">
...
<!--PATTERN ferstegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:generic_all" priority="1000" mode="M674">
...
<!--PATTERN ferstefile_read_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_read_data" priority="1000" mode="M675">
...
<!--PATTERN ferstefile_write_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_write_data" priority="1000" mode="M676">
...
<!--PATTERN ferstefile_append_data-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_append_data" priority="1000" mode="M677">
...
<!--PATTERN ferstefile_read_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_read_ea" priority="1000" mode="M678">
...
<!--PATTERN ferstefile_write_ea-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_write_ea" priority="1000" mode="M679">
...
<!--PATTERN ferstefile_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_execute" priority="1000" mode="M680">
...
<!--PATTERN ferstefile_delete_child-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_delete_child" priority="1000" mode="M681">
...
<!--PATTERN ferstefile_read_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_read_attributes" priority="1000" mode="M682">
...
<!--PATTERN ferstefile_write_attributes-->
	...
	<!--RULE -->
<axsl:template match="win-def:fileeffectiverights_state/win-def:file_write_attributes" priority="1000" mode="M683">
...
<!--PATTERN groupobjgroup-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_object/win-def:group" priority="1000" mode="M685">
...
<!--PATTERN groupstegroup-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_state/win-def:group" priority="1000" mode="M686">
...
<!--PATTERN groupsteuser-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_state/win-def:user" priority="1000" mode="M687">
...
<!--PATTERN groupsidtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:object" priority="1001" mode="M688">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:group_sid_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_test/win-def:state" priority="1000" mode="M688">
...
<!--PATTERN groupsidobjgroup-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_object/win-def:group_sid" priority="1000" mode="M689">
...
<!--PATTERN groupsidstegroup-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_state/win-def:group_sid" priority="1000" mode="M690">
...
<!--PATTERN groupsidsteuser-->
	...
	<!--RULE -->
<axsl:template match="win-def:group_sid_state/win-def:user_sid" priority="1000" mode="M691">
...
<!--PATTERN wininterfacetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_test/win-def:object" priority="1001" mode="M692">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:interface_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:interface_test/win-def:state" priority="1000" mode="M692">
...
<!--PATTERN wininterfaceobjname-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_object/win-def:name" priority="1000" mode="M693">
...
<!--PATTERN wininterfacestename-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:name" priority="1000" mode="M694">
...
<!--PATTERN wininterfacesteindex-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:index" priority="1000" mode="M695">
...
<!--PATTERN wininterfacestetype-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:type" priority="1000" mode="M696">
...
<!--PATTERN wininterfacestehardware_addr-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:hardware_addr" priority="1000" mode="M697">
...
<!--PATTERN wininterfacesteinet_addr-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:inet_addr" priority="1000" mode="M698">
...
<!--PATTERN wininterfacestebroadcast_addr-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:broadcast_addr" priority="1000" mode="M699">
...
<!--PATTERN wininterfacestenetmask-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:netmask" priority="1000" mode="M700">
...
<!--PATTERN wininterfacesteaddr_type-->
	...
	<!--RULE -->
<axsl:template match="win-def:interface_state/win-def:addr_type" priority="1000" mode="M701">
...
<!--PATTERN lptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_test/win-def:object" priority="1001" mode="M702">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:lockoutpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_test/win-def:state" priority="1000" mode="M702">
...
<!--PATTERN lpsteforce_logoff-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:force_logoff" priority="1000" mode="M703">
...
<!--PATTERN lpstelockout_duration-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:lockout_duration" priority="1000" mode="M704">
...
<!--PATTERN lpstelockout_observation_window-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:lockout_observation_window" priority="1000" mode="M705">
...
<!--PATTERN lpstelockout_threshold-->
	...
	<!--RULE -->
<axsl:template match="win-def:lockoutpolicy_state/win-def:lockout_threshold" priority="1000" mode="M706">
...
<!--PATTERN metabasetst-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_test/win-def:object" priority="1001" mode="M707">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:metabase_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_test/win-def:state" priority="1000" mode="M707">
...
<!--PATTERN metabaseobjkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_object/win-def:key" priority="1000" mode="M708">
...
<!--PATTERN metabaseobjid-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_object/win-def:id" priority="1000" mode="M709">
...
<!--PATTERN metabasestekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:key" priority="1000" mode="M710">
...
<!--PATTERN metabasesteid-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:id" priority="1000" mode="M711">
...
<!--PATTERN metabasestename-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:name" priority="1000" mode="M712">
...
<!--PATTERN metabasesteuser_type-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:user_type" priority="1000" mode="M713">
...
<!--PATTERN metabasestedata_type-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:data_type" priority="1000" mode="M714">
...
<!--PATTERN metabasestedata-->
	...
	<!--RULE -->
<axsl:template match="win-def:metabase_state/win-def:data" priority="1000" mode="M715">
...
<!--PATTERN pptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_test/win-def:object" priority="1001" mode="M716">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:passwordpolicy_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_test/win-def:state" priority="1000" mode="M716">
...
<!--PATTERN ppstemax_passwd_age-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:max_passwd_age" priority="1000" mode="M717">
...
<!--PATTERN ppstemin_passwd_age-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:min_passwd_age" priority="1000" mode="M718">
...
<!--PATTERN ppstemin_passwd_len-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:min_passwd_len" priority="1000" mode="M719">
...
<!--PATTERN ppstepassword_hist_len-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:password_hist_len" priority="1000" mode="M720">
...
<!--PATTERN ppstepassword_complexity-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:password_complexity" priority="1000" mode="M721">
...
<!--PATTERN ppstereversible_encryption-->
	...
	<!--RULE -->
<axsl:template match="win-def:passwordpolicy_state/win-def:reversible_encryption" priority="1000" mode="M722">
...
<!--PATTERN winportobjlocal_address-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_object/win-def:local_address" priority="1000" mode="M724">
...
<!--PATTERN winportobjlocal_port-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_object/win-def:local_port" priority="1000" mode="M725">
...
<!--PATTERN winportobjprotocol-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_object/win-def:protocol" priority="1000" mode="M726">
...
<!--PATTERN winportstelocal_address-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:local_address" priority="1000" mode="M727">
...
<!--PATTERN winportstelocal_port-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:local_port" priority="1000" mode="M728">
...
<!--PATTERN winportsteprotocol-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:protocol" priority="1000" mode="M729">
...
<!--PATTERN winportstepid-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:pid" priority="1000" mode="M730">
...
<!--PATTERN pertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_test/win-def:object" priority="1001" mode="M731">
...
<!--PATTERN perobjprinter_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_object/win-def:printer_name" priority="1000" mode="M732">
...
<!--PATTERN perobjtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_object/win-def:trustee_sid" priority="1000" mode="M733">
...
<!--PATTERN rersteprinter_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:printer_name" priority="1000" mode="M734">
...
<!--PATTERN perstetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:trustee_sid" priority="1000" mode="M735">
...
<!--PATTERN perstestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:standard_delete" priority="1000" mode="M736">
...
<!--PATTERN perstestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:standard_read_control" priority="1000" mode="M737">
...
<!--PATTERN perstestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:standard_write_dac" priority="1000" mode="M738">
...
<!--PATTERN perstestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:standard_write_owner" priority="1000" mode="M739">
...
<!--PATTERN perstestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:standard_synchronize" priority="1000" mode="M740">
...
<!--PATTERN persteaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:access_system_security" priority="1000" mode="M741">
...
<!--PATTERN perstegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:generic_read" priority="1000" mode="M742">
...
<!--PATTERN perstegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:generic_write" priority="1000" mode="M743">
...
<!--PATTERN perstegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:generic_execute" priority="1000" mode="M744">
...
<!--PATTERN perstegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:generic_all" priority="1000" mode="M745">
...
<!--PATTERN persteprinter_access_administer-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:printer_access_administer" priority="1000" mode="M746">
...
<!--PATTERN persteprinter_access_use-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:printer_access_use" priority="1000" mode="M747">
...
<!--PATTERN perstejob_access_administer-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:job_access_administer" priority="1000" mode="M748">
...
<!--PATTERN perstejob_access_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:printereffectiverights_state/win-def:job_access_read" priority="1000" mode="M749">
...
<!--PATTERN processtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:object" priority="1001" mode="M750">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:process_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a process_test must reference a process_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M750"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:process_test/win-def:state" priority="1000" mode="M750">
...
<!--PATTERN processobjcommand_line-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_object/win-def:command_line" priority="1000" mode="M751">
...
<!--PATTERN processstecommand_line-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state/win-def:command_line" priority="1000" mode="M752">
...
<!--PATTERN processstepid-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:pid" priority="1000" mode="M753">
...
<!--PATTERN processsteppid-->
	...
	<!--RULE -->
<axsl:template match="win-def:port_state/win-def:ppid" priority="1000" mode="M754">
...
<!--PATTERN processstepriority-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state/win-def:priority" priority="1000" mode="M755">
...
<!--PATTERN processsteimage_path-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state/win-def:image_path" priority="1000" mode="M756">
...
<!--PATTERN processstecurrent_dir-->
	...
	<!--RULE -->
<axsl:template match="win-def:process_state/win-def:current_dir" priority="1000" mode="M757">
...
<!--PATTERN regtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_test/win-def:object" priority="1001" mode="M758">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:registry_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a registry_test must reference a registry_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M758"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:registry_test/win-def:state" priority="1000" mode="M758">
...
<!--PATTERN regobjhive-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object/win-def:hive" priority="1000" mode="M759">
...
<!--PATTERN regobjkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object/win-def:key" priority="1000" mode="M760">
...
<!--PATTERN regobjname-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_object/win-def:name" priority="1000" mode="M761">
...
<!--PATTERN regstehive-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_state/win-def:hive" priority="1000" mode="M762">
...
<!--PATTERN regstekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_state/win-def:key" priority="1000" mode="M763">
...
<!--PATTERN regstename-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_state/win-def:name" priority="1000" mode="M764">
...
<!--PATTERN regstetype-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_state/win-def:type" priority="1000" mode="M765">
...
<!--PATTERN regstevalue-->
	...
	<!--RULE -->
<axsl:template match="win-def:registry_state/win-def:value" priority="1000" mode="M766">
...
<!--PATTERN rap53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_test/win-def:object" priority="1001" mode="M767">
...
<!--PATTERN rap53objhive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object/win-def:hive" priority="1000" mode="M768">
...
<!--PATTERN rap53objkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object/win-def:key" priority="1000" mode="M769">
...
<!--PATTERN rap53objtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_object/win-def:trustee_sid" priority="1000" mode="M770">
...
<!--PATTERN rap53stehive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:hive" priority="1000" mode="M771">
...
<!--PATTERN rap53stekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key" priority="1000" mode="M772">
...
<!--PATTERN rap53stetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:trustee_sid" priority="1000" mode="M773">
...
<!--PATTERN rap53stestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_delete" priority="1000" mode="M774">
...
<!--PATTERN rap53stestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_read_control" priority="1000" mode="M775">
...
<!--PATTERN rap53stestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_write_dac" priority="1000" mode="M776">
...
<!--PATTERN rap53stestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_write_owner" priority="1000" mode="M777">
...
<!--PATTERN rap53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:standard_synchronize" priority="1000" mode="M778">
...
<!--PATTERN rap53steaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:access_system_security" priority="1000" mode="M779">
...
<!--PATTERN rap53stegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:generic_read" priority="1000" mode="M780">
...
<!--PATTERN rap53stegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:generic_write" priority="1000" mode="M781">
...
<!--PATTERN rap53stegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:generic_execute" priority="1000" mode="M782">
...
<!--PATTERN rap53stegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:generic_all" priority="1000" mode="M783">
...
<!--PATTERN rap53stekey_query_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_query_value" priority="1000" mode="M784">
...
<!--PATTERN rap53stekey_set_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_set_value" priority="1000" mode="M785">
...
<!--PATTERN rap53stekey_create_sub_key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_create_sub_key" priority="1000" mode="M786">
...
<!--PATTERN rap53stekey_enumerate_sub_keys-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_enumerate_sub_keys" priority="1000" mode="M787">
...
<!--PATTERN rap53stekey_notify-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_notify" priority="1000" mode="M788">
...
<!--PATTERN rap53stekey_create_link-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_create_link" priority="1000" mode="M789">
...
<!--PATTERN rap53stekey_wow64_64key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_wow64_64key" priority="1000" mode="M790">
...
<!--PATTERN rap53stekey_wow64_32key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_wow64_32key" priority="1000" mode="M791">
...
<!--PATTERN rap53stekey_wow64_res-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions53_state/win-def:key_wow64_res" priority="1000" mode="M792">
...
<!--PATTERN raptst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_test/win-def:object" priority="1001" mode="M793">
...
<!--PATTERN rapobjhive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object/win-def:hive" priority="1000" mode="M794">
...
<!--PATTERN rapobjkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object/win-def:key" priority="1000" mode="M795">
...
<!--PATTERN rapobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_object/win-def:trustee_name" priority="1000" mode="M796">
...
<!--PATTERN rapstehive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:hive" priority="1000" mode="M797">
...
<!--PATTERN rapstekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key" priority="1000" mode="M798">
...
<!--PATTERN rapstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:trustee_name" priority="1000" mode="M799">
...
<!--PATTERN rapstestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:standard_delete" priority="1000" mode="M800">
...
<!--PATTERN rapstestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:standard_read_control" priority="1000" mode="M801">
...
<!--PATTERN rapstestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:standard_write_dac" priority="1000" mode="M802">
...
<!--PATTERN rapstestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:standard_write_owner" priority="1000" mode="M803">
...
<!--PATTERN rapstestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:standard_synchronize" priority="1000" mode="M804">
...
<!--PATTERN rapsteaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:access_system_security" priority="1000" mode="M805">
...
<!--PATTERN rapstegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:generic_read" priority="1000" mode="M806">
...
<!--PATTERN rapstegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:generic_write" priority="1000" mode="M807">
...
<!--PATTERN rapstegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:generic_execute" priority="1000" mode="M808">
...
<!--PATTERN rapstegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:generic_all" priority="1000" mode="M809">
...
<!--PATTERN rapstekey_query_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_query_value" priority="1000" mode="M810">
...
<!--PATTERN rapstekey_set_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_set_value" priority="1000" mode="M811">
...
<!--PATTERN rapstekey_create_sub_key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_create_sub_key" priority="1000" mode="M812">
...
<!--PATTERN rapstekey_enumerate_sub_keys-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_enumerate_sub_keys" priority="1000" mode="M813">
...
<!--PATTERN rapstekey_notify-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_notify" priority="1000" mode="M814">
...
<!--PATTERN rapstekey_create_link-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_create_link" priority="1000" mode="M815">
...
<!--PATTERN rapstekey_wow64_64key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_wow64_64key" priority="1000" mode="M816">
...
<!--PATTERN rapstekey_wow64_32key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_wow64_32key" priority="1000" mode="M817">
...
<!--PATTERN rapstekey_wow64_res-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyauditedpermissions_state/win-def:key_wow64_res" priority="1000" mode="M818">
...
<!--PATTERN rer53tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_test/win-def:object" priority="1001" mode="M819">
...
<!--PATTERN rer53objhive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object/win-def:hive" priority="1000" mode="M820">
...
<!--PATTERN rer53objkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object/win-def:key" priority="1000" mode="M821">
...
<!--PATTERN rer53objtrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_object/win-def:trustee_sid" priority="1000" mode="M822">
...
<!--PATTERN rer53stehive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:hive" priority="1000" mode="M823">
...
<!--PATTERN rer53stekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key" priority="1000" mode="M824">
...
<!--PATTERN rer53stetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:trustee_sid" priority="1000" mode="M825">
...
<!--PATTERN rer53stestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_delete" priority="1000" mode="M826">
...
<!--PATTERN rer53stestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_read_control" priority="1000" mode="M827">
...
<!--PATTERN rer53stestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_write_dac" priority="1000" mode="M828">
...
<!--PATTERN rer53stestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_write_owner" priority="1000" mode="M829">
...
<!--PATTERN rer53stestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:standard_synchronize" priority="1000" mode="M830">
...
<!--PATTERN rer53steaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:access_system_security" priority="1000" mode="M831">
...
<!--PATTERN rer53stegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:generic_read" priority="1000" mode="M832">
...
<!--PATTERN rer53stegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:generic_write" priority="1000" mode="M833">
...
<!--PATTERN rer53stegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:generic_execute" priority="1000" mode="M834">
...
<!--PATTERN rer53stegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:generic_all" priority="1000" mode="M835">
...
<!--PATTERN rer53stekey_query_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_query_value" priority="1000" mode="M836">
...
<!--PATTERN rer53stekey_set_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_set_value" priority="1000" mode="M837">
...
<!--PATTERN rer53stekey_create_sub_key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_create_sub_key" priority="1000" mode="M838">
...
<!--PATTERN rer53stekey_enumerate_sub_keys-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_enumerate_sub_keys" priority="1000" mode="M839">
...
<!--PATTERN rer53stekey_notify-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_notify" priority="1000" mode="M840">
...
<!--PATTERN rer53stekey_create_link-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_create_link" priority="1000" mode="M841">
...
<!--PATTERN rer53stekey_wow64_64key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_wow64_64key" priority="1000" mode="M842">
...
<!--PATTERN rer53stekey_wow64_32key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_wow64_32key" priority="1000" mode="M843">
...
<!--PATTERN rer53stekey_wow64_res-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights53_state/win-def:key_wow64_res" priority="1000" mode="M844">
...
<!--PATTERN rertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_test/win-def:object" priority="1001" mode="M845">
...
<!--PATTERN rerobjhive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object/win-def:hive" priority="1000" mode="M846">
...
<!--PATTERN rerobjkey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object/win-def:key" priority="1000" mode="M847">
...
<!--PATTERN rerobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_object/win-def:trustee_name" priority="1000" mode="M848">
...
<!--PATTERN rerstehive-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:hive" priority="1000" mode="M849">
...
<!--PATTERN rerstekey-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key" priority="1000" mode="M850">
...
<!--PATTERN rerstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:trustee_name" priority="1000" mode="M851">
...
<!--PATTERN rerstestandard_delete-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:standard_delete" priority="1000" mode="M852">
...
<!--PATTERN rerstestandard_read_control-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:standard_read_control" priority="1000" mode="M853">
...
<!--PATTERN rerstestandard_write_dac-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:standard_write_dac" priority="1000" mode="M854">
...
<!--PATTERN rerstestandard_write_owner-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:standard_write_owner" priority="1000" mode="M855">
...
<!--PATTERN rerstestandard_synchronize-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:standard_synchronize" priority="1000" mode="M856">
...
<!--PATTERN rersteaccess_system_security-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:access_system_security" priority="1000" mode="M857">
...
<!--PATTERN rerstegeneric_read-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:generic_read" priority="1000" mode="M858">
...
<!--PATTERN rerstegeneric_write-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:generic_write" priority="1000" mode="M859">
...
<!--PATTERN rerstegeneric_execute-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:generic_execute" priority="1000" mode="M860">
...
<!--PATTERN rerstegeneric_all-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:generic_all" priority="1000" mode="M861">
...
<!--PATTERN rerstekey_query_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_query_value" priority="1000" mode="M862">
...
<!--PATTERN rerstekey_set_value-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_set_value" priority="1000" mode="M863">
...
<!--PATTERN rerstekey_create_sub_key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_create_sub_key" priority="1000" mode="M864">
...
<!--PATTERN rerstekey_enumerate_sub_keys-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_enumerate_sub_keys" priority="1000" mode="M865">
...
<!--PATTERN rerstekey_notify-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_notify" priority="1000" mode="M866">
...
<!--PATTERN rerstekey_create_link-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_create_link" priority="1000" mode="M867">
...
<!--PATTERN rerstekey_wow64_64key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_wow64_64key" priority="1000" mode="M868">
...
<!--PATTERN rerstekey_wow64_32key-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_wow64_32key" priority="1000" mode="M869">
...
<!--PATTERN rerstekey_wow64_res-->
	...
	<!--RULE -->
<axsl:template match="win-def:regkeyeffectiverights_state/win-def:key_wow64_res" priority="1000" mode="M870">
...
<!--PATTERN srtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:object" priority="1001" mode="M871">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:sharedresource_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sharedresource_test must reference a sharedresource_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M871"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sharedresource_test/win-def:state" priority="1000" mode="M871">
...
<!--PATTERN srobjnetname-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_object/win-def:netname" priority="1000" mode="M872">
...
<!--PATTERN srstenetname-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:netname" priority="1000" mode="M873">
...
<!--PATTERN srsteshared_type-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:shared_type" priority="1000" mode="M874">
...
<!--PATTERN srstemax_uses-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:max_uses" priority="1000" mode="M875">
...
<!--PATTERN srstecurrent_uses-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:current_uses" priority="1000" mode="M876">
...
<!--PATTERN srstelocal_path-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:local_path" priority="1000" mode="M877">
...
<!--PATTERN srsteaccess_read_permission-->
	...
	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_read_permission" priority="1000" mode="M878">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_read_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M878"/></axsl:template><axsl:template match="text()" priority="-1" mode="M878"/><axsl:template match="@*|node()" priority="-2" mode="M878"><axsl:apply-templates select="@*|*" mode="M878"/></axsl:template>

<!--PATTERN srsteaccess_write_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_write_permission" priority="1000" mode="M879">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_write_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M879"/></axsl:template><axsl:template match="text()" priority="-1" mode="M879"/><axsl:template match="@*|node()" priority="-2" mode="M879"><axsl:apply-templates select="@*|*" mode="M879"/></axsl:template>

<!--PATTERN srsteaccess_create_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_create_permission" priority="1000" mode="M880">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_create_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M880"/></axsl:template><axsl:template match="text()" priority="-1" mode="M880"/><axsl:template match="@*|node()" priority="-2" mode="M880"><axsl:apply-templates select="@*|*" mode="M880"/></axsl:template>

<!--PATTERN srsteaccess_exec_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_exec_permission" priority="1000" mode="M881">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_exec_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M881"/></axsl:template><axsl:template match="text()" priority="-1" mode="M881"/><axsl:template match="@*|node()" priority="-2" mode="M881"><axsl:apply-templates select="@*|*" mode="M881"/></axsl:template>

<!--PATTERN srsteaccess_delete_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_delete_permission" priority="1000" mode="M882">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_delete_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M882"/></axsl:template><axsl:template match="text()" priority="-1" mode="M882"/><axsl:template match="@*|node()" priority="-2" mode="M882"><axsl:apply-templates select="@*|*" mode="M882"/></axsl:template>

<!--PATTERN srsteaccess_atrib_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_atrib_permission" priority="1000" mode="M883">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_atrib_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M883"/></axsl:template><axsl:template match="text()" priority="-1" mode="M883"/><axsl:template match="@*|node()" priority="-2" mode="M883"><axsl:apply-templates select="@*|*" mode="M883"/></axsl:template>

<!--PATTERN srsteaccess_perm_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_perm_permission" priority="1000" mode="M884">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_perm_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M884"/></axsl:template><axsl:template match="text()" priority="-1" mode="M884"/><axsl:template match="@*|node()" priority="-2" mode="M884"><axsl:apply-templates select="@*|*" mode="M884"/></axsl:template>

<!--PATTERN srsteaccess_all_permission-->


	<!--RULE -->
<axsl:template match="win-def:sharedresource_state/win-def:access_all_permission" priority="1000" mode="M885">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the access_all_permission entity of a sharedresource_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M885"/></axsl:template><axsl:template match="text()" priority="-1" mode="M885"/><axsl:template match="@*|node()" priority="-2" mode="M885"><axsl:apply-templates select="@*|*" mode="M885"/></axsl:template>

<!--PATTERN sidtst-->


	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:object" priority="1001" mode="M886">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:sid_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sid_test must reference a sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M886"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sid_test/win-def:state" priority="1000" mode="M886">
...
<!--PATTERN sidobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_object/win-def:trustee_name" priority="1000" mode="M887">
...
<!--PATTERN sidstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_state/win-def:trustee_name" priority="1000" mode="M888">
...
<!--PATTERN sidstetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_state/win-def:trustee_sid" priority="1000" mode="M889">
...
<!--PATTERN sidstetrustee_domain-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_state/win-def:trustee_domain" priority="1000" mode="M890">
...
<!--PATTERN sidsidtst-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_test/win-def:object" priority="1001" mode="M891">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:sid_sid_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a sid_sid_test must reference a sid_sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M891"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:sid_sid_test/win-def:state" priority="1000" mode="M891">
...
<!--PATTERN sidsidobjtrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_object/win-def:trustee_sid" priority="1000" mode="M892">
...
<!--PATTERN sidsidstetrustee_sid-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_state/win-def:trustee_sid" priority="1000" mode="M893">
...
<!--PATTERN sidsidstetrustee_name-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_state/win-def:trustee_name" priority="1000" mode="M894">
...
<!--PATTERN sidsidstetrustee_domain-->
	...
	<!--RULE -->
<axsl:template match="win-def:sid_sid_state/win-def:trustee_domain" priority="1000" mode="M895">
...
<!--PATTERN uacsteadminapprovalmode-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:admin_approval_mode" priority="1000" mode="M897">
...
<!--PATTERN uacstebehaviorelevationadmin-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:elevation_prompt_admin" priority="1000" mode="M898">
...
<!--PATTERN uacsteelevationpromptstandard-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:elevation_prompt_standard" priority="1000" mode="M899">
...
<!--PATTERN uacstedetectinstallations-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:detect_installations" priority="1000" mode="M900">
...
<!--PATTERN uacsteelevatesignedexecutables-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:elevate_signed_executables" priority="1000" mode="M901">
...
<!--PATTERN uacsteelevateuiaccess-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:elevate_uiaccess" priority="1000" mode="M902">
...
<!--PATTERN uacsterunadminsaam-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:run_admins_aam" priority="1000" mode="M903">
...
<!--PATTERN uacstesecuredesktop-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:secure_desktop" priority="1000" mode="M904">
...
<!--PATTERN uacstevirtualizewritefailures-->
	...
	<!--RULE -->
<axsl:template match="win-def:uac_state/win-def:virtualize_write_failures" priority="1000" mode="M905">
...
<!--PATTERN usertst-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:object" priority="1001" mode="M906">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:user_object/@id"/><axsl:otherwise>
	...
	<!--RULE -->
<axsl:template match="win-def:user_test/win-def:state" priority="1000" mode="M906">
...
<!--PATTERN userobjuser-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_object/win-def:user" priority="1000" mode="M907">
...
<!--PATTERN usersteuser-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_state/win-def:user" priority="1000" mode="M908">
...
<!--PATTERN usersteenabled-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_state/win-def:enabled" priority="1000" mode="M909">
...
<!--PATTERN userstegroup-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_state/win-def:group" priority="1000" mode="M910">
...
<!--PATTERN usersid55tst-->
	...
	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:object" priority="1001" mode="M911">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:user_sid55_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_sid55_test must reference a user_sid55_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M911"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:user_sid55_test/win-def:state" priority="1000" mode="M911">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/win-def:user_sid55_state/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the state child element of a user_sid55_test must reference a user_sid55_state<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M911"/></axsl:template><axsl:template match="text()" priority="-1" mode="M911"/><axsl:template match="@*|node()" priority="-2" mode="M911"><axsl:apply-templates select="@*|*" mode="M911"/></axsl:template>

<!--PATTERN usersid55objuser-->


	<!--RULE -->
<axsl:template match="win-def:user_sid55_object/win-def:user_sid" priority="1000" mode="M912">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a user_sid55_object should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M912"/></axsl:template><axsl:template match="text()" priority="-1" mode="M912"/><axsl:template match="@*|node()" priority="-2" mode="M912"><axsl:apply-templates select="@*|*" mode="M912"/></axsl:template>

<!--PATTERN usersid55steuser-->


	<!--RULE -->
<axsl:template match="win-def:user_sid55_state/win-def:user_sid" priority="1000" mode="M913">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a user_sid55_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M913"/></axsl:template><axsl:template match="text()" priority="-1" mode="M913"/><axsl:template match="@*|node()" priority="-2" mode="M913"><axsl:apply-templates select="@*|*" mode="M913"/></axsl:template>

<!--PATTERN usersid55steenabled-->


	<!--RULE -->
<axsl:template match="win-def:user_sid55_state/win-def:enabled" priority="1000" mode="M914">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the enabled entity of a user_sid55_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M914"/></axsl:template><axsl:template match="text()" priority="-1" mode="M914"/><axsl:template match="@*|node()" priority="-2" mode="M914"><axsl:apply-templates select="@*|*" mode="M914"/></axsl:template>

<!--PATTERN usersid55stegroup-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_55state/win-def:group_sid" priority="1000" mode="M915">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the group_sid entity of a user_sid55_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M915"/></axsl:template><axsl:template match="text()" priority="-1" mode="M915"/><axsl:template match="@*|node()" priority="-2" mode="M915"><axsl:apply-templates select="@*|*" mode="M915"/></axsl:template>

<!--PATTERN usersidtst-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:object" priority="1001" mode="M916">
...
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:user_sid_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a user_sid_test must reference a user_sid_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M916"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:user_sid_test/win-def:state" priority="1000" mode="M916">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/win-def:user_sid_state/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the state child element of a user_sid_test must reference a user_sid_state<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M916"/></axsl:template><axsl:template match="text()" priority="-1" mode="M916"/><axsl:template match="@*|node()" priority="-2" mode="M916"><axsl:apply-templates select="@*|*" mode="M916"/></axsl:template>

<!--PATTERN usersidobjuser-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_object/win-def:user_sid" priority="1000" mode="M917">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a user_sid_object should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M917"/></axsl:template><axsl:template match="text()" priority="-1" mode="M917"/><axsl:template match="@*|node()" priority="-2" mode="M917"><axsl:apply-templates select="@*|*" mode="M917"/></axsl:template>

<!--PATTERN usersidsteuser-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_state/win-def:user_sid" priority="1000" mode="M918">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the user_sid entity of a user_sid_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M918"/></axsl:template><axsl:template match="text()" priority="-1" mode="M918"/><axsl:template match="@*|node()" priority="-2" mode="M918"><axsl:apply-templates select="@*|*" mode="M918"/></axsl:template>

<!--PATTERN usersidsteenabled-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_state/win-def:enabled" priority="1000" mode="M919">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the enabled entity of a user_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M919"/></axsl:template><axsl:template match="text()" priority="-1" mode="M919"/><axsl:template match="@*|node()" priority="-2" mode="M919"><axsl:apply-templates select="@*|*" mode="M919"/></axsl:template>

<!--PATTERN usersidstegroup-->


	<!--RULE -->
<axsl:template match="win-def:user_sid_state/win-def:group_sid" priority="1000" mode="M920">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the group_sid entity of a user_sid_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M920"/></axsl:template><axsl:template match="text()" priority="-1" mode="M920"/><axsl:template match="@*|node()" priority="-2" mode="M920"><axsl:apply-templates select="@*|*" mode="M920"/></axsl:template>

<!--PATTERN volumetst-->


	<!--RULE -->
<axsl:template match="win-def:volume_test/win-def:object" priority="1001" mode="M921">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:volume_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a volume_test must reference a volume_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M921"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:volume_test/win-def:state" priority="1000" mode="M921">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/win-def:volume_state/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the state child element of a volume_test must reference a volume_state<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M921"/></axsl:template><axsl:template match="text()" priority="-1" mode="M921"/><axsl:template match="@*|node()" priority="-2" mode="M921"><axsl:apply-templates select="@*|*" mode="M921"/></axsl:template>

<!--PATTERN volobjrootpath-->


	<!--RULE -->
<axsl:template match="win-def:volume_object/win-def:rootpath" priority="1000" mode="M922">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the rootpath entity of a volume_object should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M922"/></axsl:template><axsl:template match="text()" priority="-1" mode="M922"/><axsl:template match="@*|node()" priority="-2" mode="M922"><axsl:apply-templates select="@*|*" mode="M922"/></axsl:template>

<!--PATTERN volumesterootpath-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:rootpath" priority="1000" mode="M923">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the rootpath entity of a volume_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M923"/></axsl:template><axsl:template match="text()" priority="-1" mode="M923"/><axsl:template match="@*|node()" priority="-2" mode="M923"><axsl:apply-templates select="@*|*" mode="M923"/></axsl:template>

<!--PATTERN volumestefile_system-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_system" priority="1000" mode="M924">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_system entity of a volume_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M924"/></axsl:template><axsl:template match="text()" priority="-1" mode="M924"/><axsl:template match="@*|node()" priority="-2" mode="M924"><axsl:apply-templates select="@*|*" mode="M924"/></axsl:template>

<!--PATTERN volumestename-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:name" priority="1000" mode="M925">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the name entity of a volume_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M925"/></axsl:template><axsl:template match="text()" priority="-1" mode="M925"/><axsl:template match="@*|node()" priority="-2" mode="M925"><axsl:apply-templates select="@*|*" mode="M925"/></axsl:template>

<!--PATTERN volstevolume_max_component_length-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:volume_max_component_length" priority="1000" mode="M926">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the volume_max_component_length entity of a volume_state should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M926"/></axsl:template><axsl:template match="text()" priority="-1" mode="M926"/><axsl:template match="@*|node()" priority="-2" mode="M926"><axsl:apply-templates select="@*|*" mode="M926"/></axsl:template>

<!--PATTERN volsteserial_number-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:serial_number" priority="1000" mode="M927">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='int'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the serial_number entity of a volume_state should be 'int'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M927"/></axsl:template><axsl:template match="text()" priority="-1" mode="M927"/><axsl:template match="@*|node()" priority="-2" mode="M927"><axsl:apply-templates select="@*|*" mode="M927"/></axsl:template>

<!--PATTERN volstefile_case_sensitive_search-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_case_sensitive_search" priority="1000" mode="M928">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_case_sensitive_search entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M928"/></axsl:template><axsl:template match="text()" priority="-1" mode="M928"/><axsl:template match="@*|node()" priority="-2" mode="M928"><axsl:apply-templates select="@*|*" mode="M928"/></axsl:template>

<!--PATTERN volstefile_case_preserved_names-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_case_preserved_names" priority="1000" mode="M929">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_case_preserved_names entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M929"/></axsl:template><axsl:template match="text()" priority="-1" mode="M929"/><axsl:template match="@*|node()" priority="-2" mode="M929"><axsl:apply-templates select="@*|*" mode="M929"/></axsl:template>

<!--PATTERN volstefile_unicode_on_disk-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_unicode_on_disk" priority="1000" mode="M930">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_unicode_on_disk entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M930"/></axsl:template><axsl:template match="text()" priority="-1" mode="M930"/><axsl:template match="@*|node()" priority="-2" mode="M930"><axsl:apply-templates select="@*|*" mode="M930"/></axsl:template>

<!--PATTERN volstefile_persistent_acls-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_persistent_acls" priority="1000" mode="M931">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_persistent_acls entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M931"/></axsl:template><axsl:template match="text()" priority="-1" mode="M931"/><axsl:template match="@*|node()" priority="-2" mode="M931"><axsl:apply-templates select="@*|*" mode="M931"/></axsl:template>

<!--PATTERN volstefile_file_compression-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_file_compression" priority="1000" mode="M932">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_file_compression entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M932"/></axsl:template><axsl:template match="text()" priority="-1" mode="M932"/><axsl:template match="@*|node()" priority="-2" mode="M932"><axsl:apply-templates select="@*|*" mode="M932"/></axsl:template>

<!--PATTERN volstefile_volume_quotas-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_volume_quotas" priority="1000" mode="M933">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_volume_quotas entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M933"/></axsl:template><axsl:template match="text()" priority="-1" mode="M933"/><axsl:template match="@*|node()" priority="-2" mode="M933"><axsl:apply-templates select="@*|*" mode="M933"/></axsl:template>

<!--PATTERN volstefile_supports_sparse_files-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_supports_sparse_files" priority="1000" mode="M934">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_sparse_files entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M934"/></axsl:template><axsl:template match="text()" priority="-1" mode="M934"/><axsl:template match="@*|node()" priority="-2" mode="M934"><axsl:apply-templates select="@*|*" mode="M934"/></axsl:template>

<!--PATTERN volstefile_supports_reparse_points-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_supports_reparse_points" priority="1000" mode="M935">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_reparse_points entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M935"/></axsl:template><axsl:template match="text()" priority="-1" mode="M935"/><axsl:template match="@*|node()" priority="-2" mode="M935"><axsl:apply-templates select="@*|*" mode="M935"/></axsl:template>

<!--PATTERN volstefile_supports_remote_storage-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_supports_remote_storage" priority="1000" mode="M936">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_remote_storage entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M936"/></axsl:template><axsl:template match="text()" priority="-1" mode="M936"/><axsl:template match="@*|node()" priority="-2" mode="M936"><axsl:apply-templates select="@*|*" mode="M936"/></axsl:template>

<!--PATTERN volstefile_volume_is_compressed-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_volume_is_compressed" priority="1000" mode="M937">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_volume_is_compressed entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M937"/></axsl:template><axsl:template match="text()" priority="-1" mode="M937"/><axsl:template match="@*|node()" priority="-2" mode="M937"><axsl:apply-templates select="@*|*" mode="M937"/></axsl:template>

<!--PATTERN volstefile_supports_object_ids-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_supports_object_ids" priority="1000" mode="M938">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_object_ids entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M938"/></axsl:template><axsl:template match="text()" priority="-1" mode="M938"/><axsl:template match="@*|node()" priority="-2" mode="M938"><axsl:apply-templates select="@*|*" mode="M938"/></axsl:template>

<!--PATTERN volstefile_supports_encryption-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_supports_encryption" priority="1000" mode="M939">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_supports_encryption entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M939"/></axsl:template><axsl:template match="text()" priority="-1" mode="M939"/><axsl:template match="@*|node()" priority="-2" mode="M939"><axsl:apply-templates select="@*|*" mode="M939"/></axsl:template>

<!--PATTERN volstefile_named_streams-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_named_streams" priority="1000" mode="M940">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_named_streams entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M940"/></axsl:template><axsl:template match="text()" priority="-1" mode="M940"/><axsl:template match="@*|node()" priority="-2" mode="M940"><axsl:apply-templates select="@*|*" mode="M940"/></axsl:template>

<!--PATTERN volstefile_read_only_volume-->


	<!--RULE -->
<axsl:template match="win-def:volume_state/win-def:file_read_only_volume" priority="1000" mode="M941">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@datatype='boolean'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the file_read_only_volume entity of a volume_state should be 'boolean'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M941"/></axsl:template><axsl:template match="text()" priority="-1" mode="M941"/><axsl:template match="@*|node()" priority="-2" mode="M941"><axsl:apply-templates select="@*|*" mode="M941"/></axsl:template>

<!--PATTERN wmitst-->


	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:object" priority="1001" mode="M942">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:wmi_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a wmi_test must reference a wmi_object<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M942"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:wmi_test/win-def:state" priority="1000" mode="M942">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/win-def:wmi_state/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the state child element of a wmi_test must reference a wmi_state<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M942"/></axsl:template><axsl:template match="text()" priority="-1" mode="M942"/><axsl:template match="@*|node()" priority="-2" mode="M942"><axsl:apply-templates select="@*|*" mode="M942"/></axsl:template>

<!--PATTERN wmiobjnamespace-->


	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:namespace" priority="1000" mode="M943">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@operation) or @operation='equals'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - operation attribute for the namespace entity of a wmi_object should be 'equals', note that this overrules the general operation attribute validation (i.e. follow this one)<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M943"/></axsl:template><axsl:template match="text()" priority="-1" mode="M943"/><axsl:template match="@*|node()" priority="-2" mode="M943"><axsl:apply-templates select="@*|*" mode="M943"/></axsl:template>

<!--PATTERN wmiobjwql-->


	<!--RULE -->
<axsl:template match="win-def:wmi_object/win-def:wql" priority="1000" mode="M944">
...
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
		...
		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@operation) or @operation='equals'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - operation attribute for the wql entity of a wmi_object should be 'equals', note that this overrules the general operation attribute validation (i.e. follow this one)<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M944"/></axsl:template><axsl:template match="text()" priority="-1" mode="M944"/><axsl:template match="@*|node()" priority="-2" mode="M944"><axsl:apply-templates select="@*|*" mode="M944"/></axsl:template>

<!--PATTERN wmistenamespace-->


	<!--RULE -->
<axsl:template match="win-def:wmi_state/win-def:namespace" priority="1000" mode="M945">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the namespace entity of a wmi_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M945"/></axsl:template><axsl:template match="text()" priority="-1" mode="M945"/><axsl:template match="@*|node()" priority="-2" mode="M945"><axsl:apply-templates select="@*|*" mode="M945"/></axsl:template>

<!--PATTERN wmistewql-->


	<!--RULE -->
<axsl:template match="win-def:wmi_state/win-def:wql" priority="1000" mode="M946">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the wql entity of a wmi_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M946"/></axsl:template><axsl:template match="text()" priority="-1" mode="M946"/><axsl:template match="@*|node()" priority="-2" mode="M946"><axsl:apply-templates select="@*|*" mode="M946"/></axsl:template>

<!--PATTERN wmisteresult-->


	<!--RULE -->
<axsl:template match="win-def:wmi_state/win-def:result" priority="1000" mode="M947">

		<!--ASSERT -->
<axsl:choose><axsl:when test="(@datatype='int' and (floor(.) = number(.))) or not(@datatype='int') or not(node())"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - The datatype has been set to 'int' but the value is not an integer.<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M947"/></axsl:template><axsl:template match="text()" priority="-1" mode="M947"/><axsl:template match="@*|node()" priority="-2" mode="M947"><axsl:apply-templates select="@*|*" mode="M947"/></axsl:template>

<!--PATTERN wuaupdatesearchertst-->


	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:object" priority="1001" mode="M948">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@object_ref=/oval-def:oval_definitions/oval-def:objects/win-def:wuasearch_object/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the object child element of a wuaupdatesearcher_test must reference a wuaupdatesearcher_object <axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M948"/></axsl:template>

	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_test/win-def:state" priority="1000" mode="M948">

		<!--ASSERT -->
<axsl:choose><axsl:when test="@state_ref=/oval-def:oval_definitions/oval-def:states/win-def:wuasearch_state/@id"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - the state child element of a wuaupdatesearcher_test must reference a wuaupdatesearcher_state <axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M948"/></axsl:template><axsl:template match="text()" priority="-1" mode="M948"/><axsl:template match="@*|node()" priority="-2" mode="M948"><axsl:apply-templates select="@*|*" mode="M948"/></axsl:template>

<!--PATTERN wuaupdatesearcherobjsearchcriteria-->


	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_object/win-def:search_criteria" priority="1000" mode="M949">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the search_criteria entity of a wuaupdatesearcher_object should be 'string' <axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose>

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@operation) or @operation='equals'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - operation attribute for the search_criteria entity of a wuaupdatesearcher_object should be 'equals' <axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M949"/></axsl:template><axsl:template match="text()" priority="-1" mode="M949"/><axsl:template match="@*|node()" priority="-2" mode="M949"><axsl:apply-templates select="@*|*" mode="M949"/></axsl:template>

<!--PATTERN wuaupdatesearcherstesearchcriteria-->


	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_state/win-def:search_criteria" priority="1000" mode="M950">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the search_criteria entity of a wuaupdatesearcher_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M950"/></axsl:template><axsl:template match="text()" priority="-1" mode="M950"/><axsl:template match="@*|node()" priority="-2" mode="M950"><axsl:apply-templates select="@*|*" mode="M950"/></axsl:template>

<!--PATTERN wuaupdatesearchersteupdateid-->


	<!--RULE -->
<axsl:template match="win-def:wuaupdatesearcher_state/win-def:update_id" priority="1000" mode="M951">

		<!--ASSERT -->
<axsl:choose><axsl:when test="not(@datatype) or @datatype='string'"/><axsl:otherwise>
                <axsl:text/><axsl:value-of select="../@id"/><axsl:text/> - datatype attribute for the update_id entity of a wuaupdatesearcher_state should be 'string'<axsl:value-of select="string('&#10;')"/></axsl:otherwise></axsl:choose><axsl:apply-templates select="@*|*" mode="M951"/></axsl:template><axsl:template match="text()" priority="-1" mode="M951"/><axsl:template match="@*|node()" priority="-2" mode="M951"><axsl:apply-templates select="@*|*" mode="M951"/></axsl:template></axsl:stylesheet>
