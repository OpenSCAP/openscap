...
# ARG_OPTIONAL_BOOL([clean], [c], [Clean the repository before proceeding. Use with care, as you will lose all uncommitted local modifications and all untracked files.], [off])
