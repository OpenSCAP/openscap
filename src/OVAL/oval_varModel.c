...
static _oval_variable_model_frame_t *_oval_variable_model_frame_new(char *id, const char *comm,
								      oval_datatype_t datatype);
...
#define NAMESPACE_COMMON    "http://oval.mitre.org/XMLSchema/oval-common-5"
    ...
    (xmlTextReader * reader,  struct oval_parser_context * context, struct oval_variable_model * model) {
	    ...
	    oval_parser_parse_tag(reader, context, (oval_xml_tag_parser) _oval_variable_model_parse_variable_values,
				  frame);
    ...
    (xmlTextReader * reader,  struct oval_parser_context * context, struct oval_variable_model * model) {
		    ...
		    oval_parser_parse_tag(reader, context, (oval_xml_tag_parser) _oval_generator_parse_tag,
					  "oval_variables");
	} else if (is_variable_ns && strcmp("variables", tagname) == 0) {
		return_code =
		    oval_parser_parse_tag(reader, context, (oval_xml_tag_parser) _oval_variable_model_parse_variables,
					  model);
    ...
    (struct oval_variable_model * model, xmlTextReader * reader, void *user_param) {
	    ...
	    (strcmp(NAMESPACE_VARIABLES, namespace) == 0) && (strcmp("oval_variables", tagname) == 0);
		    ...
		    oval_parser_parse_tag(reader, &context, (oval_xml_tag_parser) _oval_variable_model_parse_tag,
					  model);
