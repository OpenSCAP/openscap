...
#include <liboval/oval_system_characteristics.h>
	...
	struct oval_collection_result_item_s;

	struct oval_result_test_s;
	struct oval_collection_result_test_s;

	struct oval_result_criteria_node_s;
	struct oval_collection_result_criteria_node_s;

	struct oval_result_directives_s;

	struct oval_result_s;
	struct oval_collection_result_s;

	int  oval_collection_result_item_has_more                   (struct oval_collection_result_item_s*);
	struct oval_result_item_s *oval_collection_result_item_next(struct oval_collection_result_item_s*);
	...
	int  oval_collection_result_test_has_more                    (struct oval_collection_result_test_s*);
	struct oval_result_test_s *oval_collection_result_test_next (struct oval_collection_result_test_s*);
	...
	struct oval_collection_result_item_s *oval_result_test_items(struct oval_result_test_s*);

	int  oval_collection_result_criteria_node_has_more                            (struct oval_collection_result_criteria_node_s*);
	struct oval_result_criteria_node_s *oval_collection_result_criteria_node_next(struct oval_collection_result_criteria_node_s*);
	...
	struct oval_collection_criteria_node_s *oval_result_criteria_node_subnodes(struct oval_result_criteria_node_s*);//type==NODETYPE_CRITERIA
	...
	int  oval_collection_result_has_more              (struct oval_collection_result_s*);
	struct oval_result_s *oval_collection_result_next(struct oval_collection_result_s*);
