...
struct oval_definition_model *oval_definition_model_new()
{
	oval_definition_model_t *newmodel =
	    (oval_definition_model_t *) oscap_alloc(sizeof(oval_definition_model_t));
        if (newmodel == NULL) 
                return NULL;
		...
		struct oval_definition_model *definition_model)
{
	oval_syschar_model_t *newmodel =
	    (oval_syschar_model_t *) oscap_alloc(sizeof(oval_syschar_model_t));
        if (newmodel == NULL)
                return NULL;
...
static void _oval_syschar_model_clone(struct oval_string_map *oldmap, 
                                      struct oval_syschar_model *newmodel, 
...
struct oval_syschar_model *oval_syschar_model_clone(struct oval_syschar_model *old_model) {
        ...
        struct oval_syschar_model *new_model = 
            oval_syschar_model_new(old_model->definition_model);
...
void oval_syschar_model_probe_objects(struct oval_syschar_model *syschar_model)
{
	...
	if (definition_model) {
		...
		struct oval_object_iterator *objects = 
                    oval_definition_model_get_objects(definition_model);
...
void oval_syschar_model_bind_variable_model(struct oval_syschar_model *sysmodel, 
                                            struct oval_variable_model *varmodel)
{
...
struct oval_test_iterator *oval_definition_model_get_tests(struct oval_definition_model *model)
{
	...
	struct oval_test_iterator *iterator = 
            (struct oval_test_iterator *)oval_string_map_values(model->test_map);
...
struct oval_state_iterator *oval_definition_model_get_states(struct oval_definition_model *model)
{
	...
	struct oval_state_iterator *iterator = 
            (struct oval_state_iterator *)oval_string_map_values(model->state_map);
...
struct oval_syschar *oval_syschar_get_new(struct oval_syschar_model *model, 
                                          struct oval_object *object)
{
...
{
	oval_results_model_t *model = 
            (oval_results_model_t *) oscap_alloc(sizeof(oval_results_model_t));
        if (model == NULL)
                return NULL;
...
{
	struct oval_definition_model *old_defmodel = 
            oval_results_model_get_definition_model(old_resmodel);
	struct oval_results_model *new_resmodel = 
            oval_results_model_new(old_defmodel, NULL);
	struct oval_result_system_iterator *old_systems = 
            oval_results_model_get_systems(old_resmodel);

	while (oval_result_system_iterator_has_more(old_systems)) {

		struct oval_result_system *old_system = 
                    oval_result_system_iterator_next(old_systems);
...
void oval_results_model_add_system(struct oval_results_model *model, 
...
static void _oval_agent_scan_for_extensions_tests(struct oval_criteria_node *node,
	                                          struct oval_string_map *extmap,
                                                  ...
                                                  oval_definitions_resolver resolver,
                                                  void *user_arg)
{
...
int oval_definition_model_export(struct oval_definition_model *model, 
...
xmlNode *oval_syschar_model_to_dom(struct oval_syschar_model *syschar_model, 
                                    xmlDocPtr doc, 
                                    xmlNode *parent,
                                    oval_syschar_resolver resolver, 
                                    void *user_arg) {
...
int oval_syschar_model_export(struct oval_syschar_model *model, 
                              struct oscap_export_target *target)
{
...
static void _scan_for_viewable_definitions(struct oval_results_model *results_model, 
                                           ...
                                           struct oval_string_map *defids)
{
        int i;
	struct oval_result_system_iterator *systems = 
            oval_results_model_get_systems(results_model);
...
static bool _resolve_oval_definition_from_map(struct oval_definition *oval_definition, 
                                              struct oval_string_map *defids)
{
	char *defid = oval_definition_get_id(oval_definition);
