...
struct oscap_schema_table_entry OSCAP_SCHEMAS_TABLE[] = {
	...
	{OSCAP_DOCUMENT_OVAL_DIRECTIVES,	"5.5",	"oval/5.5/oval-directives-schema.xsd"},
	{OSCAP_DOCUMENT_OVAL_DIRECTIVES,	"5.6",	"oval/5.6/oval-directives-schema.xsd"},
	{OSCAP_DOCUMENT_OVAL_DIRECTIVES,	"5.7",	"oval/5.7/oval-directives-schema.xsd"},
