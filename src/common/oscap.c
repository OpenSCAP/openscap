...
struct oscap_schema_table_entry OSCAP_SCHEMAS_TABLE[] = {
	...
	{OSCAP_DOCUMENT_OVAL_RESULTS,		"5.3",	"oval/5.5/oval-results-schema.xsd"},
	{OSCAP_DOCUMENT_OVAL_RESULTS,		"5.4",	"oval/5.5/oval-results-schema.xsd"},
	...
	{OSCAP_DOCUMENT_OVAL_SYSCHAR,		"5.3",	"oval/5.5/oval-system-characteristics-schema.xsd"},
	{OSCAP_DOCUMENT_OVAL_SYSCHAR,		"5.4",	"oval/5.5/oval-system-characteristics-schema.xsd"},
	...
	{OSCAP_DOCUMENT_OVAL_VARIABLES,		"5.3",	"oval/5.5/oval-variables-schema.xsd"},
	{OSCAP_DOCUMENT_OVAL_VARIABLES,		"5.4",	"oval/5.5/oval-variables-schema.xsd"},
